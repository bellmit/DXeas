 ...
 * output class name
 */
public class CardRelationListUI extends AbstractCardRelationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CardRelationListUI.class);
    
    /**
     * output class constructor
     */
    public CardRelationListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.publicdata.client.CardRelationTreeEditUI.class.getName();
    }
	...
	public void onShow() throws Exception {
		super.onShow();
		this.tblMain.getHead().getRow(0).getCell(this.tblMain.getColumnIndex("baseData.number")).setValue("车辆");
	}
}
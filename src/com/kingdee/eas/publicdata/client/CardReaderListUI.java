 ...
 * output class name
 */
public class CardReaderListUI extends AbstractCardReaderListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CardReaderListUI.class);
    
    /**
     * output class constructor
     */
    public CardReaderListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.publicdata.client.CardReaderTreeEditUI.class.getName();
    }

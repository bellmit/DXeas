 ...
 * output class name
 */
public abstract class AbstractCardSettingEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCardSettingEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtBIMUDF0021;
    protected com.kingdee.eas.publicdata.CardSettingInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCardSettingEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCardSettingEditUI.class.getName());
        ...
        this.txtBIMUDF0021 = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        // kdtEntry
		String kdtEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"card\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"remark\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{card}</t:Cell><t:Cell>$Resource{remark}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntry.setFormatXml(resHelper.translateString("kdtEntry",kdtEntryStrXML));

                this.kdtEntry.putBindContents("editData",new String[] {"seq","card","remark"});
        ...
        final KDBizPromptBox kdtEntry_card_PromptBox = new KDBizPromptBox();
        kdtEntry_card_PromptBox.setQueryInfo("com.kingdee.eas.publicdata.app.CardReaderQuery");
        kdtEntry_card_PromptBox.setVisible(true);
        kdtEntry_card_PromptBox.setEditable(true);
        kdtEntry_card_PromptBox.setDisplayFormat("$number$");
        kdtEntry_card_PromptBox.setEditFormat("$number$");
        kdtEntry_card_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntry_card_CellEditor = new KDTDefaultCellEditor(kdtEntry_card_PromptBox);
        this.kdtEntry.getColumn("card").setEditor(kdtEntry_card_CellEditor);
        ObjectValueRender kdtEntry_card_OVR = new ObjectValueRender();
        kdtEntry_card_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntry.getColumn("card").setRenderer(kdtEntry_card_OVR);
        			kdtEntry_card_PromptBox.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.publicdata.client.CardReaderListUI kdtEntry_card_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtEntry_card_PromptBox_F7ListUI == null) {
					try {
						kdtEntry_card_PromptBox_F7ListUI = new com.kingdee.eas.publicdata.client.CardReaderListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(kdtEntry_card_PromptBox_F7ListUI));
					kdtEntry_card_PromptBox_F7ListUI.setF7Use(true,ctx);
					kdtEntry_card_PromptBox.setSelector(kdtEntry_card_PromptBox_F7ListUI);
				}
			}
		});
        ...
        // txtBIMUDF0021		
        this.txtBIMUDF0021.setVisible(false);		
        this.txtBIMUDF0021.setHorizontalAlignment(2);		
        this.txtBIMUDF0021.setMaxLength(100);		
        this.txtBIMUDF0021.setRequired(false);		
        this.txtBIMUDF0021.setEnabled(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,txtmac,prmtstorageOrgUnit}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer4.setBounds(new Rectangle(306, 36, 270, 19));
        ...
        kdtEntry.setBounds(new Rectangle(18, 128, 558, 245));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.publicdata.CardSettingEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, null);
        contBIMUDF0021.setBounds(new Rectangle(357, 77, 270, 19));
        this.add(contBIMUDF0021, null);
        //kDLabelContainer1
        ...
        //contBIMUDF0021
        contBIMUDF0021.setBoundEditor(txtBIMUDF0021);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.publicdata.CardSettingEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("Entry.card", java.lang.Object.class, this.kdtEntry, "card.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.publicdata.app.CardSettingEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.publicdata.CardSettingInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entry.card", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("Entry.card.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("Entry.card.id"));
			sic.add(new SelectorItemInfo("Entry.card.name"));
        	sic.add(new SelectorItemInfo("Entry.card.number"));
		}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.publicdata.client", "CardSettingEditUI");
    }
    ...
    {
        return com.kingdee.eas.publicdata.client.CardSettingEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.publicdata.CardSettingFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.publicdata.CardSettingInfo objectValue = new com.kingdee.eas.publicdata.CardSettingInfo();

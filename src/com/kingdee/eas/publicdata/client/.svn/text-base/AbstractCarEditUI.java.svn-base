...
public abstract class AbstractCarEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcarOrder;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtcarOrder;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.contcarOrder = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtcarOrder = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contcarOrder.setName("contcarOrder");
        ...
        this.txtcarOrder.setName("txtcarOrder");
        ...
        // contcarOrder		
        this.contcarOrder.setBoundLabelText(resHelper.getString("contcarOrder.boundLabelText"));		
        this.contcarOrder.setBoundLabelLength(100);		
        this.contcarOrder.setBoundLabelUnderline(true);		
        this.contcarOrder.setVisible(true);
        // contBIMUDF0009		
        ...
        this.prmtdriver.setDisplayFormat("$number$");		
        ...
        // txtcarOrder		
        this.txtcarOrder.setVisible(true);		
        this.txtcarOrder.setHorizontalAlignment(2);		
        this.txtcarOrder.setMaxLength(100);		
        this.txtcarOrder.setRequired(false);
        // txtBIMUDF0009		
        this.txtBIMUDF0009.setVisible(false);		
        this.txtBIMUDF0009.setHorizontalAlignment(2);		
        this.txtBIMUDF0009.setMaxLength(100);		
        this.txtBIMUDF0009.setRequired(false);		
        this.txtBIMUDF0009.setEnabled(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txttare,carType,txtdriverName,prmtdriver,txtcarOrder}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 464, 388));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(99, 127, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(99, 166, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(683, 138, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(99, 323, 270, 19));
        this.add(kDLabelContainer4, null);
        conttare.setBounds(new Rectangle(99, 205, 270, 19));
        this.add(conttare, null);
        contcarType.setBounds(new Rectangle(99, 47, 270, 19));
        this.add(contcarType, null);
        contdriverName.setBounds(new Rectangle(99, 283, 270, 19));
        this.add(contdriverName, null);
        contdriver.setBounds(new Rectangle(99, 244, 270, 19));
        this.add(contdriver, null);
        contcarOrder.setBounds(new Rectangle(99, 88, 270, 19));
        this.add(contcarOrder, null);
        contBIMUDF0009.setBounds(new Rectangle(113, 354, 270, 19));
        ...
        //contcarOrder
        contcarOrder.setBoundEditor(txtcarOrder);
        //contBIMUDF0009
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("carOrder", String.class, this.txtcarOrder, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.publicdata.app.CarEditUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("carOrder", ValidateHelper.ON_SAVE);    
    ...
    public void prmtdriver_Changed() throws Exception
    {
        System.out.println("prmtdriver_Changed() Function is executed!");
            txtdriverName.setText(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)prmtdriver.getData(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("carOrder"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.publicdata.client", "CarEditUI");
    }
    ...
    {
        return com.kingdee.eas.publicdata.client.CarEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(carType.getSelectedItem())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"≥µ¡æ¿‡–Õ"});
		}

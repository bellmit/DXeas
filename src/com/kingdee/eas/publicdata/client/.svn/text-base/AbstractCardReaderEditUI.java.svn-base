 ...
 * output class name
 */
public abstract class AbstractCardReaderEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCardReaderEditUI.class);
    ...
    protected com.kingdee.eas.publicdata.CardReaderInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCardReaderEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCardReaderEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        btnTest.setBounds(new Rectangle(473, 344, 58, 21));
        ...
        contBIMUDF0013.setBounds(new Rectangle(338, 19, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.publicdata.app.CardReaderEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.publicdata.CardReaderInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.publicdata.client", "CardReaderEditUI");
    }

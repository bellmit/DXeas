 ...
 * output class name
 */
public class DatabaseSettingListUI extends AbstractDatabaseSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DatabaseSettingListUI.class);
    
    /**
     * output class constructor
     */
    public DatabaseSettingListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.publicdata.client.DatabaseSettingTreeEditUI.class.getName();
    }
	...
	protected FilterInfo getDefaultFilterForQuery() {
		...
		filter.getFilterItems().add(new FilterItemInfo("orgUnit.id",SysContext.getSysContext().getCurrentOrgUnit().get("id"),CompareType.EQUALS));
		return filter;
	}

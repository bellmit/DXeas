...
public class CarEntry extends CoreBillEntryBase implements ICarEntry
{
    public CarEntry()
    {
        super();
        registerInterface(ICarEntry.class, this);
    }
    public CarEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICarEntry.class, this);
    }
    ...
    private CarEntryController getController() throws BOSException
    {
        return (CarEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCarEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

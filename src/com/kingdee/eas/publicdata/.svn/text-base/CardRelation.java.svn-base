...
public class CardRelation extends DataBase implements ICardRelation
{
    public CardRelation()
    {
        super();
        registerInterface(ICardRelation.class, this);
    }
    public CardRelation(Context ctx)
    {
        super(ctx);
        registerInterface(ICardRelation.class, this);
    }
    ...
    private CardRelationController getController() throws BOSException
    {
        return (CardRelationController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCardRelationInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getCardRelationInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCardRelationInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCardRelationCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCardRelationCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCardRelationCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

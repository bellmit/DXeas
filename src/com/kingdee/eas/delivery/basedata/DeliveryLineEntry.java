...
public class DeliveryLineEntry extends BillEntryBase implements IDeliveryLineEntry
{
    public DeliveryLineEntry()
    {
        super();
        registerInterface(IDeliveryLineEntry.class, this);
    }
    public DeliveryLineEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IDeliveryLineEntry.class, this);
    }
    ...
    private DeliveryLineEntryController getController() throws BOSException
    {
        return (DeliveryLineEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDeliveryLineEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDeliveryLineEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDeliveryLineEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDeliveryLineEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDeliveryLineEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDeliveryLineEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

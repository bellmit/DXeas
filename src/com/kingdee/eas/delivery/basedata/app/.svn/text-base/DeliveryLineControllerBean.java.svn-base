...
public class DeliveryLineControllerBean extends AbstractDeliveryLineControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.delivery.basedata.app.DeliveryLineControllerBean");
}
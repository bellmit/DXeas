...
public class DeliveryLineEntryControllerBean extends AbstractDeliveryLineEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.delivery.basedata.app.DeliveryLineEntryControllerBean");
}
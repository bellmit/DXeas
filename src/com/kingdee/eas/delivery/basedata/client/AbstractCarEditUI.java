...
public abstract class AbstractCarEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.contvolume.setVisible(true);
        // txtNumber		
        ...
        // txtvolume		
        this.txtvolume.setVisible(true);		
        this.txtvolume.setHorizontalAlignment(2);		
        this.txtvolume.setDataType(0);		
        this.txtvolume.setSupportedEmpty(true);		
        this.txtvolume.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txttare,carType,txtvolume}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(92, 102, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(92, 184, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(683, 138, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(92, 269, 270, 19));
        this.add(kDLabelContainer4, null);
        conttare.setBounds(new Rectangle(92, 143, 270, 19));
        this.add(conttare, null);
        contcarType.setBounds(new Rectangle(92, 61, 270, 19));
        this.add(contcarType, null);
        contvolume.setBounds(new Rectangle(92, 225, 270, 19));
        this.add(contvolume, null);
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("volume", int.class, this.txtvolume, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.delivery.basedata.app.CarEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.delivery.basedata.client", "CarEditUI");
    }

...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.delivery.basedata.app.CarListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.delivery.basedata.client", "CarListUI");
    }
    ...
    {
        return com.kingdee.eas.delivery.basedata.client.CarEditUI.class.getName();
    }

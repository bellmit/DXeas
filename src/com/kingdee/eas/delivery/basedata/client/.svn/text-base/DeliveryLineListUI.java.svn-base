 ...
 * output class name
 */
public class DeliveryLineListUI extends AbstractDeliveryLineListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliveryLineListUI.class);
    
    /**
     * output class constructor
     */
    public DeliveryLineListUI() throws Exception
    {
        super();
    }

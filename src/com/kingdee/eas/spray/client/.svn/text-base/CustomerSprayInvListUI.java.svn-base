 ...
 * output class name
 */
public class CustomerSprayInvListUI extends AbstractCustomerSprayInvListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerSprayInvListUI.class);
    
    /**
     * output class constructor
     */
    public CustomerSprayInvListUI() throws Exception
    {
        super();
    }

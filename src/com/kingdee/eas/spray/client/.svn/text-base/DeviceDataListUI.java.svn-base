 ...
 * output class name
 */
public class DeviceDataListUI extends AbstractDeviceDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeviceDataListUI.class);
    
    /**
     * output class constructor
     */
    public DeviceDataListUI() throws Exception
    {
        super();
    }
    ...
    {
    	if(SysContext.getSysContext().getCurrentCtrlUnit().get("id").equals("00000000-0000-0000-0000-000000000000CCE7AED4")) {
    		MsgBox.showWarning("只能在集团新增！");
    		SysUtil.abort();
    	}
    	TreePath patch = this.treeMain.getSelectionPath();
    	DefaultKingdeeTreeNode node=(DefaultKingdeeTreeNode)patch.getLastPathComponent();
    	if(!node.isLeaf()) {
    		MsgBox.showWarning("请在明细节点添加资料！");
    		SysUtil.abort();
    	}
    ...
    {
        return com.kingdee.eas.spray.client.DeviceDataTreeEditUI.class.getName();
    }

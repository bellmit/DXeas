 ...
 * output class name
 */
public class SparyRecordListUI extends AbstractSparyRecordListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SparyRecordListUI.class);
    
    /**
     * output class constructor
     */
    public SparyRecordListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractDeviceDataListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDeviceDataListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractDeviceDataListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractDeviceDataListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.spray.app.DeviceDataListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.spray.client", "DeviceDataListUI");
    }

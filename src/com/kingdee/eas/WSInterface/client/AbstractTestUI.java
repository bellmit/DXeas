 ...
 * output package name
 */
package com.kingdee.eas.WSInterface.client;
...
public abstract class AbstractTestUI extends CoreUIObject
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnTest.setBounds(new Rectangle(229, 179, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.WSInterface.app.TestUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.WSInterface.client", "TestUI");
    }

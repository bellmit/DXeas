...
//BillTypeEnum 有点问题
public class FIBillsImportUtils implements IImportBill {
	...
	protected synchronized void registerBills() {
		if (billClassMap != null) {
			...
			/*registBill(BillTypeEnum.PURORDER.getNumber(), com.kingdee.eas.wmWs.app.billdata.PurOrderBillSupport.class);
			registBill(BillTypeEnum.PURREQUEST.getNumber(),
					com.kingdee.eas.wmWs.app.billdata.PurRequestBillSupport.class);
			registBill(BillTypeEnum.SALEORDER.getNumber(), com.kingdee.eas.wmWs.app.billdata.SaleOrderBillSupport.class);
			registBill(BillTypeEnum.PURINWARE.getNumber(),
					com.kingdee.eas.wmWs.app.billdata.PurInWarehsBillSupport.class);
			registBill(BillTypeEnum.SALEISSUE.getNumber(), com.kingdee.eas.wmWs.app.billdata.SaleIssueBillSupport.class);*/
			//registBill(BillTypeEnum.Requisition.getNumber(), com.kingdee.eas.wmWs.app.billdata.PurOrderBillSupport.class);
			registeExt();
			return;
		}
	}

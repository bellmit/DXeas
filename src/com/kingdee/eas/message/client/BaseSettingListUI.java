 ...
 * output class name
 */
public class BaseSettingListUI extends AbstractBaseSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BaseSettingListUI.class);
    
    /**
     * output class constructor
     */
    public BaseSettingListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.message.client.BaseSettingTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public abstract class AbstractBaseSettingListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseSettingListUI.class);
		...
		public AbstractBaseSettingListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.message.app.BaseSettingListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.message.client", "BaseSettingListUI");
    }

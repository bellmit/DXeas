...
public abstract class AbstractBaseSettingControllerBean extends DataBaseControllerBean implements BaseSettingController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("4409d4cd-b1e1-4a3a-b051-f78f14e1ab92"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2b69282e-e023-4042-b722-3dcbce303e51"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3cc82b63-c91f-43f2-92ed-c7757832ee46"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c522176b-084c-4540-829a-a809e768d4e9"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("8da3b0c1-38fb-4e06-bc84-e39addfa08e6"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("8ff59d82-8e22-4937-982f-0c80c7160ad8"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {

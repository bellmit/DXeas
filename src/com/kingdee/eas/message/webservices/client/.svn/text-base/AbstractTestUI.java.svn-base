...
public abstract class AbstractTestUI extends CoreUIObject
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabel1.setBounds(new Rectangle(109, 59, 135, 42));
        this.add(kDLabel1, null);
        btnOK.setBounds(new Rectangle(143, 166, 73, 21));
        this.add(btnOK, null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.message.webservices.app.TestUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.message.webservices.client", "TestUI");
    }

...
public class MaterialReqConstant {
	public static final String BOSTYPE = "500AB75E";
	public static final String XMLROOTTAGNAME = "MaterialReqBill";
	...
	public static final String COSTOBJECTSUITE = "costObjectSuite";
	...
	public static final String PRODUCTLINEWP = "productLineWP";
	public static final String TRACENO = "traceNo";
	public static final String SALEORDERNUM = "saleOrderNum";
	public static final String ISSUEQTY = "issueQty";
	public static final String BASEISSUEQTY = "baseIssueQty";
	public static final String PICKINGDATE = "pickingDate";
	public static final String DEMANDDATE = "demandDate";
	public static final String FACARDQTY = "faCardQty";
	public static final String INVUPDATETYPE = "invUpdateType";
	private static String[] NOTCUFILTERPROPERTIES = { "transactionType", "billType","bizType" };
	...
	private static String[] mustValidateEntryProperties = { "seq", "material", "unit", "baseUnit", "baseStatus", "storageOrgUnit", "companyOrgUnit", "warehouse",  "qty", "baseQty","invUpdateType" };// "location","stocker", 
	...
	private static String[] entryBooleanProperties = { "isPresent","isReWork" };



	private static String[] entryintProperties = { "baseStatus", "seq", "sourceBillEntrySeq" };

	private static String[] entryDecimalProperties = { "assCoefficient", "associateQty", "qty", "assistQty", "baseQty", "reverseQty", "returnsQty", "price", "amount", "unitStandardCost", "standardCost", "unitActualCost", "actualCost", "reverseBaseQty", "returnBaseQty", "issueQty", "baseIssueQty", "faCardQty" };


	private static String[] entryDatetProperties = { "mfg", "exp", "pickingDate", "demandDate" };

	private static String[] entryStrProperties = { "sourceBillId", "sourceBillNumber", "sourceBillEntryId", "remark", "lot", "remark", "orderNumber", "traceNo", "saleOrderNum" ,"qylot"};




	private static String[] entryLinkProperties = { "material", "assistProperty", "unit", "sourceBillType", "baseUnit", "assistUnit", "reasonCode", "storageOrgUnit", "companyOrgUnit", "warehouse", "location", "stocker", "costObject", "costObjectSuite", "costItem", "productLineWP", "productLine", "classGroup", "person" ,"costCenterOrgUnit","invUpdateType"};

 ...
 * output class name
 */
public abstract class AbstractHappyHolidayListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHappyHolidayListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractHappyHolidayListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractHappyHolidayListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.festival.app.HappyHolidayListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("festivalName"));
        sic.add(new SelectorItemInfo("date"));
        sic.add(new SelectorItemInfo("isLegalHolidays"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.festival.client", "HappyHolidayListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.festival.client.HappyHolidayEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.festival.HappyHolidayFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.festival.HappyHolidayInfo objectValue = new com.kingdee.eas.custom.festival.HappyHolidayInfo();		
        return objectValue;
    }

 ...
 * output class name
 */
public class HappyHolidayListUI extends AbstractHappyHolidayListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HappyHolidayListUI.class);
    
    /**
     * output class constructor
     */
    public HappyHolidayListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.festival.client.HappyHolidayTreeEditUI.class.getName();
    }

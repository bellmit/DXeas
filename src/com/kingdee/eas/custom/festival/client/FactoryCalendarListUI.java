 ...
 * output class name
 */
public class FactoryCalendarListUI extends AbstractFactoryCalendarListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FactoryCalendarListUI.class);
    
    /**
     * output class constructor
     */
    public FactoryCalendarListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractFactoryCalendarListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFactoryCalendarListUI.class);
     ...
     */
    public AbstractFactoryCalendarListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFactoryCalendarListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.festival.app", "FactoryCalendarQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.festival.app.FactoryCalendarListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.festivalA.festivalName"));
        sic.add(new SelectorItemInfo("entrys.festivalB.festivalName"));
        sic.add(new SelectorItemInfo("entrys.isLegalFestivalA"));
        sic.add(new SelectorItemInfo("entrys.isLegalFestivalB"));
        sic.add(new SelectorItemInfo("entrys.festivalC.festivalName"));
        sic.add(new SelectorItemInfo("entrys.isLegalFestivalC"));
        sic.add(new SelectorItemInfo("entrys.solarTerm"));
        sic.add(new SelectorItemInfo("entrys.lunarCalendar"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFactoryCalendarListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFactoryCalendarListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.festival.client", "FactoryCalendarListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","entrys.festivalA.festivalName","entrys.festivalB.festivalName","entrys.festivalC.festivalName","year","status","auditDate"};
    }

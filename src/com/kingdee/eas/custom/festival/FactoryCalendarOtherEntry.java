...
public class FactoryCalendarOtherEntry extends CoreBillEntryBase implements IFactoryCalendarOtherEntry
{
    public FactoryCalendarOtherEntry()
    {
        super();
        registerInterface(IFactoryCalendarOtherEntry.class, this);
    }
    public FactoryCalendarOtherEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFactoryCalendarOtherEntry.class, this);
    }
    ...
    private FactoryCalendarOtherEntryController getController() throws BOSException
    {
        return (FactoryCalendarOtherEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFactoryCalendarOtherEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

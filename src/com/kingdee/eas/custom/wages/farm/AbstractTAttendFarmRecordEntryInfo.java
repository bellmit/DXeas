...
public class AbstractTAttendFarmRecordEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractTAttendFarmRecordEntryInfo()
    {
        this("id");
    }
    protected AbstractTAttendFarmRecordEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.custom.wages.farm.TAttendFarmRecordInfo getParent()
    {
        return (com.kingdee.eas.custom.wages.farm.TAttendFarmRecordInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.custom.wages.farm.TAttendFarmRecordInfo item)
    {
        put("parent", item);
    }
    /**

 ...
 * output class name
 */
public abstract class AbstractAdjustFarmmoneyEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustFarmmoneyEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyInfo editData = null;
     ...
     */
    public AbstractAdjustFarmmoneyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustFarmmoneyEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 119, 991, 393, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contcompany.setBounds(new Rectangle(351, 24, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(351, 24, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.farm.app.AdjustFarmmoneyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    {
        com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAdjustFarmmoneyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustFarmmoneyEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustFarmmoneyEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.farm.client", "AdjustFarmmoneyEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.farm.client.AdjustFarmmoneyEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyInfo objectValue = new com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyInfo();
    	...
    	return "/bim/custom/wages/farm/AdjustFarmmoney";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.farm.app.AdjustFarmmoneyQuery");
	}

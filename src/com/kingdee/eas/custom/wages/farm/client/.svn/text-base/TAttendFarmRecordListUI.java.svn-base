...
import com.kingdee.eas.custom.wages.farm.ITAttendFarmRecord;
 ...
 * output class name
 */
public class TAttendFarmRecordListUI extends AbstractTAttendFarmRecordListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TAttendFarmRecordListUI.class);
    
    /**
     * output class constructor
     */
    public TAttendFarmRecordListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		ITAttendFarmRecord purorder = (ITAttendFarmRecord) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getTAttendFarmRecordInfo(pk));

 ...
 * output class name
 */
public class TAttendFarmRecordEditUI extends AbstractTAttendFarmRecordEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TAttendFarmRecordEditUI.class);
    
    /**
     * output class constructor
     */
    public TAttendFarmRecordEditUI() throws Exception
    {
        super();
    }
    /**

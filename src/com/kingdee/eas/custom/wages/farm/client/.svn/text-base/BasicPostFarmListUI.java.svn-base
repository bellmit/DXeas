 ...
 * output class name
 */
public class BasicPostFarmListUI extends AbstractBasicPostFarmListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BasicPostFarmListUI.class);
    
    /**
     * output class constructor
     */
    public BasicPostFarmListUI() throws Exception
    {
        super();
    }

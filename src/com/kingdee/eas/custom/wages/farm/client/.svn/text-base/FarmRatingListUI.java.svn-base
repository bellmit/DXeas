 ...
 * output class name
 */
public class FarmRatingListUI extends AbstractFarmRatingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmRatingListUI.class);
    
    /**
     * output class constructor
     */
    public FarmRatingListUI() throws Exception
    {
        super();
    }

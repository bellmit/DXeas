 ...
 * output class name
 */
public class MaintenTeamEditUI extends AbstractMaintenTeamEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaintenTeamEditUI.class);
    
    /**
     * output class constructor
     */
    public MaintenTeamEditUI() throws Exception
    {
        super();
    }
    /**
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					while(rs.next()){
						...
						kdtEntrys.getCell(kdtEntrys.getRowCount()-1, "timenumber").setValue("0");
						kdtEntrys.getCell(kdtEntrys.getRowCount()-1, "companytime").setValue("0");
					}
    ...
    private IRowSet getExeQueryRowSet() throws BOSException {
		...
		sql.append("select t3.FID FID from T_ORG_Position t1").append(sp);
		...
		sql.append("t1.FNumber in ('3087','3086','306','3088','3089','3106','30515')").append(sp);

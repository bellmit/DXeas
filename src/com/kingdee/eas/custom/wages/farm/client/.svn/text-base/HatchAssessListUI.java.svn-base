 ...
 * output class name
 */
public class HatchAssessListUI extends AbstractHatchAssessListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchAssessListUI.class);
    
    /**
     * output class constructor
     */
    public HatchAssessListUI() throws Exception
    {
        super();
    }

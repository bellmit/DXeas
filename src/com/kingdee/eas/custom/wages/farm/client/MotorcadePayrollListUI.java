 ...
 * output class name
 */
public class MotorcadePayrollListUI extends AbstractMotorcadePayrollListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MotorcadePayrollListUI.class);
    
    /**
     * output class constructor
     */
    public MotorcadePayrollListUI() throws Exception
    {
        super();
    }

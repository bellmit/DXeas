 ...
 * output class name
 */
public class MaintenTeamListUI extends AbstractMaintenTeamListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaintenTeamListUI.class);
    
    /**
     * output class constructor
     */
    public MaintenTeamListUI() throws Exception
    {
        super();
    }

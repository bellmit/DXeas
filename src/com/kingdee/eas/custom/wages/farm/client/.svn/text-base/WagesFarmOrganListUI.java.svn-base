 ...
 * output class name
 */
public class WagesFarmOrganListUI extends AbstractWagesFarmOrganListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WagesFarmOrganListUI.class);
    
    /**
     * output class constructor
     */
    public WagesFarmOrganListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.farm.client.WagesFarmOrganTreeEditUI.class.getName();
    }

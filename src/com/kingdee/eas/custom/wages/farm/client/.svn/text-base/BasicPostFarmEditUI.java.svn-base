 ...
 * output class name
 */
public class BasicPostFarmEditUI extends AbstractBasicPostFarmEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BasicPostFarmEditUI.class);
    
    /**
     * output class constructor
     */
    public BasicPostFarmEditUI() throws Exception
    {
        super();
    }
    /**
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.farm.client.AbstractBasicPostFarmEditUI#onShow()
	 */
	@Override

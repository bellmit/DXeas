...
import com.kingdee.eas.custom.wages.farm.IAdjustFarmmoney;
 ...
 * output class name
 */
public class AdjustFarmmoneyListUI extends AbstractAdjustFarmmoneyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AdjustFarmmoneyListUI.class);
    
    /**
     * output class constructor
     */
    public AdjustFarmmoneyListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IAdjustFarmmoney purorder = (IAdjustFarmmoney) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getAdjustFarmmoneyInfo(pk));

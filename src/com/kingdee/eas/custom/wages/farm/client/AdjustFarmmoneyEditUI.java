 ...
 * output class name
 */
public class AdjustFarmmoneyEditUI extends AbstractAdjustFarmmoneyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AdjustFarmmoneyEditUI.class);
    
    /**
     * output class constructor
     */
    public AdjustFarmmoneyEditUI() throws Exception
    {
        super();
    }
    /**

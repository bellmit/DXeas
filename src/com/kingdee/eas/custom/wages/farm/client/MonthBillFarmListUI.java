...
import com.kingdee.eas.custom.wages.farm.IMonthBillFarm;
 ...
 * output class name
 */
public class MonthBillFarmListUI extends AbstractMonthBillFarmListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthBillFarmListUI.class);
    
    /**
     * output class constructor
     */
    public MonthBillFarmListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IMonthBillFarm purorder = (IMonthBillFarm) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getMonthBillFarmInfo(pk));

...
public class MaintenTeam extends CoreBillBase implements IMaintenTeam
{
    public MaintenTeam()
    {
        super();
        registerInterface(IMaintenTeam.class, this);
    }
    public MaintenTeam(Context ctx)
    {
        super(ctx);
        registerInterface(IMaintenTeam.class, this);
    }
    ...
    private MaintenTeamController getController() throws BOSException
    {
        return (MaintenTeamController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMaintenTeamCollection(getContext());
        }
    ...
    {
        try {
            return getController().getMaintenTeamCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenTeamCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenTeamInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenTeamInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaintenTeamInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class AdjustFarmmoney extends CoreBillBase implements IAdjustFarmmoney
{
    public AdjustFarmmoney()
    {
        super();
        registerInterface(IAdjustFarmmoney.class, this);
    }
    public AdjustFarmmoney(Context ctx)
    {
        super(ctx);
        registerInterface(IAdjustFarmmoney.class, this);
    }
    ...
    private AdjustFarmmoneyController getController() throws BOSException
    {
        return (AdjustFarmmoneyController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAdjustFarmmoneyCollection(getContext());
        }
    ...
    {
        try {
            return getController().getAdjustFarmmoneyCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAdjustFarmmoneyCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAdjustFarmmoneyInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAdjustFarmmoneyInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAdjustFarmmoneyInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

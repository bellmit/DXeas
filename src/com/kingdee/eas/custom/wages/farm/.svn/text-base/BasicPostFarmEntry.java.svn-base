...
public class BasicPostFarmEntry extends CoreBillEntryBase implements IBasicPostFarmEntry
{
    public BasicPostFarmEntry()
    {
        super();
        registerInterface(IBasicPostFarmEntry.class, this);
    }
    public BasicPostFarmEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBasicPostFarmEntry.class, this);
    }
    ...
    private BasicPostFarmEntryController getController() throws BOSException
    {
        return (BasicPostFarmEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBasicPostFarmEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBasicPostFarmEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBasicPostFarmEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBasicPostFarmEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBasicPostFarmEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBasicPostFarmEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

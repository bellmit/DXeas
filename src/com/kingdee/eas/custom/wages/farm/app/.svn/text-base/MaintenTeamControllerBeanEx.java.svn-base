...
public class MaintenTeamControllerBeanEx extends com.kingdee.eas.custom.wages.farm.app.MaintenTeamControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.MaintenTeamControllerBeanEx");

...
import com.kingdee.eas.custom.wages.farm.TAttendFarmRecordFactory;
import com.kingdee.bos.metadata.entity.EntityViewInfo;
...
public class TAttendFarmRecordControllerBean extends AbstractTAttendFarmRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.TAttendFarmRecordControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		TAttendFarmRecordInfo info = (TAttendFarmRecordInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		TAttendFarmRecordInfo info = TAttendFarmRecordFactory.getLocalInstance(ctx).getTAttendFarmRecordInfo(pk);

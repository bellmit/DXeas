...
public class WagesFarmOrganControllerBean extends AbstractWagesFarmOrganControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.WagesFarmOrganControllerBean");
}
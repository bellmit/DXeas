...
public class FarmPostStandControllerBean extends AbstractFarmPostStandControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.FarmPostStandControllerBean");
}
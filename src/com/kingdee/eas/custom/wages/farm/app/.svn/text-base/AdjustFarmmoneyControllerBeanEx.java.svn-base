...
public class AdjustFarmmoneyControllerBeanEx extends com.kingdee.eas.custom.wages.farm.app.AdjustFarmmoneyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.AdjustFarmmoneyControllerBeanEx");

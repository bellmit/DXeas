...
public class BasicPostFarmControllerBean extends AbstractBasicPostFarmControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.BasicPostFarmControllerBean");
}
...
import com.kingdee.eas.custom.wages.farm.AdjustFarmmoneyFactory;
import com.kingdee.bos.metadata.entity.EntityViewInfo;
...
public class AdjustFarmmoneyControllerBean extends AbstractAdjustFarmmoneyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.farm.app.AdjustFarmmoneyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustFarmmoneyInfo info = (AdjustFarmmoneyInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustFarmmoneyInfo info = AdjustFarmmoneyFactory.getLocalInstance(ctx).getAdjustFarmmoneyInfo(pk);

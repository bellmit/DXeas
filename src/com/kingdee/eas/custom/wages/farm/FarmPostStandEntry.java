...
public class FarmPostStandEntry extends CoreBillEntryBase implements IFarmPostStandEntry
{
    public FarmPostStandEntry()
    {
        super();
        registerInterface(IFarmPostStandEntry.class, this);
    }
    public FarmPostStandEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFarmPostStandEntry.class, this);
    }
    ...
    private FarmPostStandEntryController getController() throws BOSException
    {
        return (FarmPostStandEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFarmPostStandEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmPostStandEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmPostStandEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmPostStandEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmPostStandEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmPostStandEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

 ...
 * output class name
 */
public abstract class AbstractQualityawardticketEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQualityawardticketEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.QualityawardticketInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnaudit actionUnaudit = null;
    /**
     * output class constructor
     */
    public AbstractQualityawardticketEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQualityawardticketEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personnumber","amount","remark","AdjustCause"});
        ...
        final KDBizPromptBox kdtEntrys_AdjustCause_PromptBox = new KDBizPromptBox();
        kdtEntrys_AdjustCause_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.AdjustCauseQuery");
        kdtEntrys_AdjustCause_PromptBox.setVisible(true);
        kdtEntrys_AdjustCause_PromptBox.setEditable(true);
        kdtEntrys_AdjustCause_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_AdjustCause_PromptBox.setEditFormat("$number$");
        kdtEntrys_AdjustCause_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_AdjustCause_CellEditor = new KDTDefaultCellEditor(kdtEntrys_AdjustCause_PromptBox);
        this.kdtEntrys.getColumn("AdjustCause").setEditor(kdtEntrys_AdjustCause_CellEditor);
        ObjectValueRender kdtEntrys_AdjustCause_OVR = new ObjectValueRender();
        kdtEntrys_AdjustCause_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("AdjustCause").setRenderer(kdtEntrys_AdjustCause_OVR);
        // contBillStatus		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,BillStatus,pkstartDate,prmtcompany,prmtcompanyOrg,kdtEntrys,prmttheGroup}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.QualityawardticketEntryInfo(),null,false);
        ...
        contcompany.setBounds(new Rectangle(350, 25, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(350, 25, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcompanyOrg.setBounds(new Rectangle(13, 102, 270, 19));
        this.add(contcompanyOrg, new KDLayout.Constraints(13, 102, 270, 19, 0));
        ...
        conttheGroup.setBounds(new Rectangle(351, 102, 270, 19));
        this.add(conttheGroup, new KDLayout.Constraints(351, 102, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.QualityawardticketEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.AdjustCause", java.lang.Object.class, this.kdtEntrys, "AdjustCause.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.QualityawardticketEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.QualityawardticketInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.AdjustCause", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.AdjustCause.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.AdjustCause.id"));
			sic.add(new SelectorItemInfo("entrys.AdjustCause.name"));
        	sic.add(new SelectorItemInfo("entrys.AdjustCause.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.custom.wages.QualityawardticketFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.QualityawardticketFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractQualityawardticketEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractQualityawardticketEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "QualityawardticketEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.QualityawardticketEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.QualityawardticketFactory.getRemoteInstance();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/wages/Qualityawardticket";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.QualityawardticketQuery");
	}
    
        
					protected void beforeStoreFields(ActionEvent arg0) throws Exception {
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"AdjustCause").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"奖罚事由"});
			}
		}

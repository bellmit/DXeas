 ...
 * output class name
 */
public class WorkAgeAwardListUI extends AbstractWorkAgeAwardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkAgeAwardListUI.class);
    
    /**
     * output class constructor
     */
    public WorkAgeAwardListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractProControlWithholdEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProControlWithholdEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.ProControlWithholdInfo editData = null;
     ...
     */
    public AbstractProControlWithholdEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProControlWithholdEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personnumber","amount","remark"});
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {BillStatus,pkstartDate,prmtcompany}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contCreator, new KDLayout.Constraints(394, 524, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(contLastUpdateUser, new KDLayout.Constraints(394, 555, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(12, 119, 991, 393));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.ProControlWithholdEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 119, 991, 393, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        importEx.setBounds(new Rectangle(661, 85, 23, 21));
        this.add(importEx, new KDLayout.Constraints(661, 85, 23, 21, 0));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.ProControlWithholdEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.ProControlWithholdEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.ProControlWithholdInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    {
        com.kingdee.eas.custom.wages.ProControlWithholdFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.ProControlWithholdFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProControlWithholdEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProControlWithholdEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProControlWithholdEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "ProControlWithholdEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.ProControlWithholdEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.ProControlWithholdFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.ProControlWithholdInfo objectValue = new com.kingdee.eas.custom.wages.ProControlWithholdInfo();
    	...
    	return "/bim/custom/wages/ProControlWithhold";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.ProControlWithholdQuery");
	}

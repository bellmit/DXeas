 ...
 * output class name
 */
public abstract class AbstractHRwagesEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHRwagesEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.HRwagesInfo editData = null;
     ...
     */
    public AbstractHRwagesEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHRwagesEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personnumber","amount","healthCar","IsCommute","remark"});
        ...
        KDFormattedTextField kdtEntrys_healthCar_TextField = new KDFormattedTextField();
        kdtEntrys_healthCar_TextField.setName("kdtEntrys_healthCar_TextField");
        kdtEntrys_healthCar_TextField.setVisible(true);
        kdtEntrys_healthCar_TextField.setEditable(true);
        kdtEntrys_healthCar_TextField.setHorizontalAlignment(2);
        kdtEntrys_healthCar_TextField.setDataType(1);
        	kdtEntrys_healthCar_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_healthCar_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_healthCar_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_healthCar_CellEditor = new KDTDefaultCellEditor(kdtEntrys_healthCar_TextField);
        this.kdtEntrys.getColumn("healthCar").setEditor(kdtEntrys_healthCar_CellEditor);
        KDCheckBox kdtEntrys_IsCommute_CheckBox = new KDCheckBox();
        kdtEntrys_IsCommute_CheckBox.setName("kdtEntrys_IsCommute_CheckBox");
        KDTDefaultCellEditor kdtEntrys_IsCommute_CellEditor = new KDTDefaultCellEditor(kdtEntrys_IsCommute_CheckBox);
        this.kdtEntrys.getColumn("IsCommute").setEditor(kdtEntrys_IsCommute_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,BillStatus,pkstartDate,kdtEntrys,prmtcompany,prmtcompanyOrg}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(359, 524, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(359, 524, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contLastUpdateUser.setBounds(new Rectangle(359, 555, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(359, 555, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(12, 141, 991, 371));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.HRwagesEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 141, 991, 371, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        importEx.setBounds(new Rectangle(644, 83, 22, 21));
        this.add(importEx, new KDLayout.Constraints(644, 83, 22, 21, 0));
        contcompanyOrg.setBounds(new Rectangle(13, 100, 270, 19));
        this.add(contcompanyOrg, new KDLayout.Constraints(13, 100, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.HRwagesEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.healthCar", java.math.BigDecimal.class, this.kdtEntrys, "healthCar.text");
		dataBinder.registerBinding("entrys.IsCommute", boolean.class, this.kdtEntrys, "IsCommute.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.HRwagesEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.HRwagesInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.healthCar", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.IsCommute", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.healthCar"));
    	sic.add(new SelectorItemInfo("entrys.IsCommute"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.custom.wages.HRwagesFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.HRwagesFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractHRwagesEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractHRwagesEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractHRwagesEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "HRwagesEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.HRwagesEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.HRwagesFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.HRwagesInfo objectValue = new com.kingdee.eas.custom.wages.HRwagesInfo();
    	...
    	return "/bim/custom/wages/HRwages";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.HRwagesQuery");
	}

 ...
 * output class name
 */
public abstract class AbstractScoreStandardListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScoreStandardListUI.class);
    protected ActionApprove actionApprove = null;
    protected ActionUnApprove actionUnApprove = null;
    /**
     * output class constructor
     */
    public AbstractScoreStandardListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScoreStandardListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.app", "ScoreStandardQuery");
        //actionApprove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.ScoreStandardListUIHandler";
	}
...
com.kingdee.eas.custom.wages.ScoreStandardInfo editData = (com.kingdee.eas.custom.wages.ScoreStandardInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.custom.wages.ScoreStandardFactory.getRemoteInstance().unApprove(editData);
    ...
    protected class ActionApprove extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractScoreStandardListUI.this, "ActionApprove", "actionApprove_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnApprove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScoreStandardListUI.this, "ActionUnApprove", "actionUnApprove_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "ScoreStandardListUI");
    }

 ...
 * output class name
 */
public class EmploySecurityEditUI extends AbstractEmploySecurityEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmploySecurityEditUI.class);
    
    /**
     * output class constructor
     */
    public EmploySecurityEditUI() throws Exception
    {
        super();
    }
    /**
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractEmploySecurityEditUI#onShow()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractEmploySecurityEditUI#actionImportEx_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override

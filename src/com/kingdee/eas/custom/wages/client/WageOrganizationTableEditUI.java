 ...
 * output class name
 */
public class WageOrganizationTableEditUI extends AbstractWageOrganizationTableEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(WageOrganizationTableEditUI.class);
    
    /**
     * output class constructor
     */
    public WageOrganizationTableEditUI() throws Exception
    {
        super();
    }

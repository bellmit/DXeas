 ...
 * output class name
 */
public abstract class AbstractAdjustCauseMonthListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustCauseMonthListUI.class);
    /**
     * output class constructor
     */
    public AbstractAdjustCauseMonthListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustCauseMonthListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.app", "AdjustCauseMonthQuery");
        // CoreUI
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","simpleName","description","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","id","bizdate","company.name"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.AdjustCauseMonthListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "AdjustCauseMonthListUI");
    }

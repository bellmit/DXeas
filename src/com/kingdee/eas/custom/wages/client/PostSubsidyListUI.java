 ...
 * output class name
 */
public class PostSubsidyListUI extends AbstractPostSubsidyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PostSubsidyListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public PostSubsidyListUI() throws Exception
    {
        super();
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "Entry.postWages"};
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IPostSubsidy purorder = (IPostSubsidy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getPostSubsidyInfo(pk));

...
import com.kingdee.eas.custom.wages.IMonthlysalarybill;
 ...
 * output class name
 */
public class MonthlysalarybillListUI extends AbstractMonthlysalarybillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthlysalarybillListUI.class);
    
    /**
     * output class constructor
     */
    public MonthlysalarybillListUI() throws Exception
    {
        super();
    }
...
//		this.unaudit.setIcon(EASResource.getIcon("imgTbtn_unaudit"));
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IMonthlysalarybill purorder = (IMonthlysalarybill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getMonthlysalarybillInfo(pk));

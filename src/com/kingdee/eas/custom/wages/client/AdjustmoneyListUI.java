...
import com.kingdee.eas.custom.wages.IAdjustmoney;
 ...
 * output class name
 */
public class AdjustmoneyListUI extends AbstractAdjustmoneyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AdjustmoneyListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public AdjustmoneyListUI() throws Exception
    {
        super();
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("entrys.adjustmentWages");
    	sumField.add("entrys.house");
    	sumField.add("entrys.trai");
        return sumField;
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IAdjustmoney purorder = (IAdjustmoney) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getAdjustmoneyInfo(pk));

 ...
 * output class name
 */
public abstract class AbstractAdjustCauseListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustCauseListUI.class);
    /**
     * output class constructor
     */
    public AbstractAdjustCauseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustCauseListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.app", "AdjustCauseQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.AdjustCauseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "AdjustCauseListUI");
    }

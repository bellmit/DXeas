 ...
 * output class name
 */
public class InsuranceRegistListUI extends AbstractInsuranceRegistListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InsuranceRegistListUI.class);
    
    /**
     * output class constructor
     */
    public InsuranceRegistListUI() throws Exception
    {
        super();
    }
   ...
   public void actionAudit_actionPerformed(ActionEvent e) throws Exception
   {
   	if (this.getBizInterface().getValue(
		...
		IInsuranceRegist purorder = (IInsuranceRegist) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getInsuranceRegistInfo(pk));

...
import com.kingdee.eas.custom.wages.IPostSubsidy;
 ...
 * output class name
 */
public class MiddlemanFeeBillListUI extends AbstractMiddlemanFeeBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MiddlemanFeeBillListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public MiddlemanFeeBillListUI() throws Exception
    {
        super();
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("Entry.middlemanFee");
    	sumField.add("Entry.midWages");
        return sumField;
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IMiddlemanFeeBill purorder = (IMiddlemanFeeBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getMiddlemanFeeBillInfo(pk));

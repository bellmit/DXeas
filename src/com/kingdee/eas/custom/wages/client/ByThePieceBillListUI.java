...
import com.kingdee.eas.custom.wages.IByThePieceBill;
import com.kingdee.eas.custom.wages.IMiddlemanFeeBill;
 ...
 * output class name
 */
public class ByThePieceBillListUI extends AbstractByThePieceBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ByThePieceBillListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public ByThePieceBillListUI() throws Exception
    {
        super();
...
//	}
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("Entry.pieceAmount");
    	sumField.add("Entry.pieceMoney");
        return sumField;
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IByThePieceBill purorder = (IByThePieceBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getByThePieceBillInfo(pk));

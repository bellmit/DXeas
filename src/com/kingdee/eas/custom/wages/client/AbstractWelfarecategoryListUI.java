 ...
 * output class name
 */
public abstract class AbstractWelfarecategoryListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWelfarecategoryListUI.class);
    /**
     * output class constructor
     */
    public AbstractWelfarecategoryListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWelfarecategoryListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.app", "WelfarecategoryQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.WelfarecategoryListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "WelfarecategoryListUI");
    }

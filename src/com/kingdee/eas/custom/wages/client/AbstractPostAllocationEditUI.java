 ...
 * output class name
 */
public abstract class AbstractPostAllocationEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPostAllocationEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.PostAllocationInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnaudit actionUnaudit = null;
    /**
     * output class constructor
     */
    public AbstractPostAllocationEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPostAllocationEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personnumber","fromgroup","togroup","remarks"});
        ...
        kdtEntrys_fromgroup_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.BasicPostQuery");
        ...
        final KDBizPromptBox kdtEntrys_togroup_PromptBox = new KDBizPromptBox();
        kdtEntrys_togroup_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.BasicPostQuery");
        kdtEntrys_togroup_PromptBox.setVisible(true);
        kdtEntrys_togroup_PromptBox.setEditable(true);
        kdtEntrys_togroup_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_togroup_PromptBox.setEditFormat("$number$");
        kdtEntrys_togroup_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_togroup_CellEditor = new KDTDefaultCellEditor(kdtEntrys_togroup_PromptBox);
        this.kdtEntrys.getColumn("togroup").setEditor(kdtEntrys_togroup_CellEditor);
        ObjectValueRender kdtEntrys_togroup_OVR = new ObjectValueRender();
        kdtEntrys_togroup_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("togroup").setRenderer(kdtEntrys_togroup_OVR);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {BillStatus}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(390, 528, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(390, 528, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contLastUpdateUser.setBounds(new Rectangle(390, 559, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(390, 559, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contDescription.setBounds(new Rectangle(727, 64, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(727, 64, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.PostAllocationEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.PostAllocationEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.togroup", java.lang.Object.class, this.kdtEntrys, "togroup.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.PostAllocationEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.PostAllocationInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.togroup", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.togroup.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.togroup.id"));
			sic.add(new SelectorItemInfo("entrys.togroup.name"));
        	sic.add(new SelectorItemInfo("entrys.togroup.number"));
		}
    ...
    {
        com.kingdee.eas.custom.wages.PostAllocationFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.PostAllocationFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPostAllocationEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPostAllocationEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "PostAllocationEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.PostAllocationEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.PostAllocationFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.PostAllocationInfo objectValue = new com.kingdee.eas.custom.wages.PostAllocationInfo();
    	...
    	return "/bim/custom/wages/PostAllocation";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.PostAllocationQuery");
	}

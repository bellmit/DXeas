 ...
 * output class name
 */
public abstract class AbstractMonthlysalarybillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMonthlysalarybillEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.MonthlysalarybillInfo editData = null;
     ...
     */
    public AbstractMonthlysalarybillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMonthlysalarybillEditUI.class.getName());
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol7\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol8\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol9\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol10\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol11\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol12\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol13\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol14\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol15\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol16\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol17\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol18\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol19\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol20\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol23\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol24\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol25\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol26\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol27\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol28\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol29\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol30\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol31\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol33\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol34\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol35\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol36\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol37\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol38\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol39\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol40\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol41\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol42\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"person\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"banknumber\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"Accountopening\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"personnumber\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"post\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"fromgroup\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"timeofentry\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol7\" /><t:Column t:key=\"attendanceday\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol8\" /><t:Column t:key=\"actualattenday\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol9\" /><t:Column t:key=\"leaveday\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol10\" /><t:Column t:key=\"absenteeismday\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol11\" /><t:Column t:key=\"yieldwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol12\" /><t:Column t:key=\"fullworkwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol13\" /><t:Column t:key=\"assessmentwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol14\" /><t:Column t:key=\"basicwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol15\" /><t:Column t:key=\"checkworkwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol16\" /><t:Column t:key=\"overtimeH\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol17\" /><t:Column t:key=\"overtimeD\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol18\" /><t:Column t:key=\"temwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol19\" /><t:Column t:key=\"nightwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol20\" /><t:Column t:key=\"Commute\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"nightwork\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"subsidywages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol23\" /><t:Column t:key=\"recruitwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol24\" /><t:Column t:key=\"qualitydebit\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol25\" /><t:Column t:key=\"notificationwages\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol26\" /><t:Column t:key=\"repairmonth\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol27\" /><t:Column t:key=\"jgzbx\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol28\" /><t:Column t:key=\"adjustAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol29\" /><t:Column t:key=\"traiamount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol30\" /><t:Column t:key=\"houseamount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol31\" /><t:Column t:key=\"adjustRemarks\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"wagespay\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol33\" /><t:Column t:key=\"socialsecurity\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol34\" /><t:Column t:key=\"persontax\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol35\" /><t:Column t:key=\"taxableincome\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol36\" /><t:Column t:key=\"Withholdincometax\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol37\" /><t:Column t:key=\"Payroll\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol38\" /><t:Column t:key=\"PayrollPart\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol39\" /><t:Column t:key=\"Deductedloss\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol40\" /><t:Column t:key=\"Accidentinsurance\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol41\" /><t:Column t:key=\"newEntry\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol42\" /><t:Column t:key=\"isSpeedfrom\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"Remarks\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{person}</t:Cell><t:Cell>$Resource{banknumber}</t:Cell><t:Cell>$Resource{Accountopening}</t:Cell><t:Cell>$Resource{personnumber}</t:Cell><t:Cell>$Resource{post}</t:Cell><t:Cell>$Resource{fromgroup}</t:Cell><t:Cell>$Resource{timeofentry}</t:Cell><t:Cell>$Resource{attendanceday}</t:Cell><t:Cell>$Resource{actualattenday}</t:Cell><t:Cell>$Resource{leaveday}</t:Cell><t:Cell>$Resource{absenteeismday}</t:Cell><t:Cell>$Resource{yieldwages}</t:Cell><t:Cell>$Resource{fullworkwages}</t:Cell><t:Cell>$Resource{assessmentwages}</t:Cell><t:Cell>$Resource{basicwages}</t:Cell><t:Cell>$Resource{checkworkwages}</t:Cell><t:Cell>$Resource{overtimeH}</t:Cell><t:Cell>$Resource{overtimeD}</t:Cell><t:Cell>$Resource{temwages}</t:Cell><t:Cell>$Resource{nightwages}</t:Cell><t:Cell>$Resource{Commute}</t:Cell><t:Cell>$Resource{nightwork}</t:Cell><t:Cell>$Resource{subsidywages}</t:Cell><t:Cell>$Resource{recruitwages}</t:Cell><t:Cell>$Resource{qualitydebit}</t:Cell><t:Cell>$Resource{notificationwages}</t:Cell><t:Cell>$Resource{repairmonth}</t:Cell><t:Cell>$Resource{jgzbx}</t:Cell><t:Cell>$Resource{adjustAmount}</t:Cell><t:Cell>$Resource{traiamount}</t:Cell><t:Cell>$Resource{houseamount}</t:Cell><t:Cell>$Resource{adjustRemarks}</t:Cell><t:Cell>$Resource{wagespay}</t:Cell><t:Cell>$Resource{socialsecurity}</t:Cell><t:Cell>$Resource{persontax}</t:Cell><t:Cell>$Resource{taxableincome}</t:Cell><t:Cell>$Resource{Withholdincometax}</t:Cell><t:Cell>$Resource{Payroll}</t:Cell><t:Cell>$Resource{PayrollPart}</t:Cell><t:Cell>$Resource{Deductedloss}</t:Cell><t:Cell>$Resource{Accidentinsurance}</t:Cell><t:Cell>$Resource{newEntry}</t:Cell><t:Cell>$Resource{isSpeedfrom}</t:Cell><t:Cell>$Resource{Remarks}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntrys.setFormatXml(resHelper.translateString("kdtEntrys",kdtEntrysStrXML));

                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","banknumber","Accountopening","personnumber","post","fromgroup","timeofentry","attendanceday","actualattenday","leaveday","absenteeismday","yieldwages","fullworkwages","assessmentwages","basicwages","checkworkwages","overtimeH","overtimeD","temwages","nightwages","Commute","nightwork","subsidywages","recruitwages","qualitydebit","notificationwages","repairmonth","jgzbx","adjustAmount","traiamount","houseamount","adjustRemarks","wagespay","socialsecurity","persontax","taxableincome","Withholdincometax","Payroll","PayrollPart","Deductedloss","Accidentinsurance","newEntry","isSpeedfrom","Remarks"});
        ...
        kdtEntrys_post_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.BasicPostQuery");
        ...
        kdtEntrys_fromgroup_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.WageOrganizationQuery");
        ...
        this.kdtEntrys.getColumn("fromgroup").setRenderer(kdtEntrys_fromgroup_OVR);
			...
			com.kingdee.eas.custom.wages.client.WageOrganizationListUI kdtEntrys_fromgroup_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtEntrys_fromgroup_PromptBox_F7ListUI == null) {
					try {
						kdtEntrys_fromgroup_PromptBox_F7ListUI = new com.kingdee.eas.custom.wages.client.WageOrganizationListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
        ...
        KDFormattedTextField kdtEntrys_yieldwages_TextField = new KDFormattedTextField();
        kdtEntrys_yieldwages_TextField.setName("kdtEntrys_yieldwages_TextField");
        kdtEntrys_yieldwages_TextField.setVisible(true);
        kdtEntrys_yieldwages_TextField.setEditable(true);
        kdtEntrys_yieldwages_TextField.setHorizontalAlignment(2);
        kdtEntrys_yieldwages_TextField.setDataType(1);
        	kdtEntrys_yieldwages_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_yieldwages_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_yieldwages_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_yieldwages_CellEditor = new KDTDefaultCellEditor(kdtEntrys_yieldwages_TextField);
        this.kdtEntrys.getColumn("yieldwages").setEditor(kdtEntrys_yieldwages_CellEditor);
        ...
        KDFormattedTextField kdtEntrys_temwages_TextField = new KDFormattedTextField();
        kdtEntrys_temwages_TextField.setName("kdtEntrys_temwages_TextField");
        kdtEntrys_temwages_TextField.setVisible(true);
        kdtEntrys_temwages_TextField.setEditable(true);
        kdtEntrys_temwages_TextField.setHorizontalAlignment(2);
        kdtEntrys_temwages_TextField.setDataType(1);
        	kdtEntrys_temwages_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_temwages_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_temwages_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_temwages_CellEditor = new KDTDefaultCellEditor(kdtEntrys_temwages_TextField);
        this.kdtEntrys.getColumn("temwages").setEditor(kdtEntrys_temwages_CellEditor);
        ...
        KDFormattedTextField kdtEntrys_traiamount_TextField = new KDFormattedTextField();
        kdtEntrys_traiamount_TextField.setName("kdtEntrys_traiamount_TextField");
        kdtEntrys_traiamount_TextField.setVisible(true);
        kdtEntrys_traiamount_TextField.setEditable(true);
        kdtEntrys_traiamount_TextField.setHorizontalAlignment(2);
        kdtEntrys_traiamount_TextField.setDataType(1);
        	kdtEntrys_traiamount_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_traiamount_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_traiamount_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_traiamount_CellEditor = new KDTDefaultCellEditor(kdtEntrys_traiamount_TextField);
        this.kdtEntrys.getColumn("traiamount").setEditor(kdtEntrys_traiamount_CellEditor);
        KDFormattedTextField kdtEntrys_houseamount_TextField = new KDFormattedTextField();
        kdtEntrys_houseamount_TextField.setName("kdtEntrys_houseamount_TextField");
        kdtEntrys_houseamount_TextField.setVisible(true);
        kdtEntrys_houseamount_TextField.setEditable(true);
        kdtEntrys_houseamount_TextField.setHorizontalAlignment(2);
        kdtEntrys_houseamount_TextField.setDataType(1);
        	kdtEntrys_houseamount_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_houseamount_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_houseamount_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_houseamount_CellEditor = new KDTDefaultCellEditor(kdtEntrys_houseamount_TextField);
        this.kdtEntrys.getColumn("houseamount").setEditor(kdtEntrys_houseamount_CellEditor);
        ...
        KDFormattedTextField kdtEntrys_PayrollPart_TextField = new KDFormattedTextField();
        kdtEntrys_PayrollPart_TextField.setName("kdtEntrys_PayrollPart_TextField");
        kdtEntrys_PayrollPart_TextField.setVisible(true);
        kdtEntrys_PayrollPart_TextField.setEditable(true);
        kdtEntrys_PayrollPart_TextField.setHorizontalAlignment(2);
        kdtEntrys_PayrollPart_TextField.setDataType(1);
        	kdtEntrys_PayrollPart_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_PayrollPart_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_PayrollPart_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_PayrollPart_CellEditor = new KDTDefaultCellEditor(kdtEntrys_PayrollPart_TextField);
        this.kdtEntrys.getColumn("PayrollPart").setEditor(kdtEntrys_PayrollPart_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.MonthlysalarybillEntryInfo(),null,false);
		...
		vo.put("yieldwages",new java.math.BigDecimal(0));
		...
		vo.put("temwages",new java.math.BigDecimal(0));
		...
		vo.put("PayrollPart",new java.math.BigDecimal(0));
        ...
        contbegindate.setBounds(new Rectangle(379, 14, 270, 19));
        this.add(contbegindate, new KDLayout.Constraints(379, 14, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contenddate.setBounds(new Rectangle(729, 14, 270, 19));
        this.add(contenddate, new KDLayout.Constraints(729, 14, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.MonthlysalarybillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.yieldwages", java.math.BigDecimal.class, this.kdtEntrys, "yieldwages.text");
		...
		dataBinder.registerBinding("entrys.temwages", java.math.BigDecimal.class, this.kdtEntrys, "temwages.text");
		...
		dataBinder.registerBinding("entrys.PayrollPart", java.math.BigDecimal.class, this.kdtEntrys, "PayrollPart.text");
		...
		dataBinder.registerBinding("entrys.traiamount", java.math.BigDecimal.class, this.kdtEntrys, "traiamount.text");
		dataBinder.registerBinding("entrys.houseamount", java.math.BigDecimal.class, this.kdtEntrys, "houseamount.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.MonthlysalarybillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.MonthlysalarybillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.yieldwages", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.temwages", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.PayrollPart", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.traiamount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.houseamount", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.yieldwages"));
    	...
    	sic.add(new SelectorItemInfo("entrys.temwages"));
    	...
    	sic.add(new SelectorItemInfo("entrys.PayrollPart"));
    	...
    	sic.add(new SelectorItemInfo("entrys.traiamount"));
    	sic.add(new SelectorItemInfo("entrys.houseamount"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.custom.wages.MonthlysalarybillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.MonthlysalarybillFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.MonthlysalarybillFactory.getRemoteInstance().getPerson(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.MonthlysalarybillFactory.getRemoteInstance().wagecalculation(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMonthlysalarybillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMonthlysalarybillEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionGetPerson extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMonthlysalarybillEditUI.this, "ActionGetPerson", "actionGetPerson_actionPerformed", e);
        }
    }
    ...
    protected class ActionWagecalculation extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMonthlysalarybillEditUI.this, "ActionWagecalculation", "actionWagecalculation_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "MonthlysalarybillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.MonthlysalarybillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/wages/Monthlysalarybill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.MonthlysalarybillQuery");
	}

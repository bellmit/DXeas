 ...
 * output class name
 */
public class SocialwelfareListUI extends AbstractSocialwelfareListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocialwelfareListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public SocialwelfareListUI() throws Exception
    {
        super();
  ...
  //3.重写getQuickFilteringSupport 返回QuickFilteringSupportItems
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "entrys.Amount"};
    }

...
import com.kingdee.eas.custom.wages.IDailyOutPut;
 ...
 * output class name
 */
public class PostAllocationListUI extends AbstractPostAllocationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PostAllocationListUI.class);
    
    /**
     * output class constructor
     */
    public PostAllocationListUI() throws Exception
    {
        super();
    }
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractPostAllocationListUI#actionAudit_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		// TODO Auto-generated method stub
		if (this.getBizInterface().getValue(
				new ObjectUuidPK(getSelectedKeyValue())).get("BillStatus")
				.equals(BillBaseStatusEnum.AUDITED_VALUE)) {
			MsgBox.showInfo("单据已经审核，禁止再次审核！");
			// 状态不正确，终止处理
			SysUtil.abort();
		}
		IDailyOutPut purorder = (IDailyOutPut) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getDailyOutPutInfo(pk));
 ...
 // 得到当前选中行的 id
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractPostAllocationListUI#actionUnaudit_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override

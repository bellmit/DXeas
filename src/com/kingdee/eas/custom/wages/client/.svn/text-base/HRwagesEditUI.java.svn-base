 ...
 * output class name
 */
public class HRwagesEditUI extends AbstractHRwagesEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HRwagesEditUI.class);
    
    /**
     * output class constructor
     */
    public HRwagesEditUI() throws Exception
    {
        super();
    }
    /**
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractHRwagesEditUI#actionImportEx_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override

 ...
 * output class name
 */
public class ScoreStandardListUI extends AbstractScoreStandardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScoreStandardListUI.class);
    
    /**
     * output class constructor
     */
    public ScoreStandardListUI() throws Exception
    {
        super();
    }

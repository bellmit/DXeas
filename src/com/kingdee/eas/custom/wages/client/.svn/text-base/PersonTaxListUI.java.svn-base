 ...
 * output class name
 */
public class PersonTaxListUI extends AbstractPersonTaxListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonTaxListUI.class);
    
    /**
     * output class constructor
     */
    public PersonTaxListUI() throws Exception
    {
        super();
    }

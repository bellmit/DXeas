...
import com.kingdee.eas.custom.wages.IProControlWithhold;
 ...
 * output class name
 */
public class ProControlWithholdListUI extends AbstractProControlWithholdListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProControlWithholdListUI.class);
    
    /**
     * output class constructor
     */
    public ProControlWithholdListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IProControlWithhold purorder = (IProControlWithhold) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getProControlWithholdInfo(pk));

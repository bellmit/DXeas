 ...
 * output class name
 */
public class ScoreStandardEditUI extends AbstractScoreStandardEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ScoreStandardEditUI.class);
    
    /**
     * output class constructor
     */
    public ScoreStandardEditUI() throws Exception
    {
        super();
    }
    /**

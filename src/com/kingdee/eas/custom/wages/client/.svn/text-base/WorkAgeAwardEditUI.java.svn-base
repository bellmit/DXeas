 ...
 * output class name
 */
public class WorkAgeAwardEditUI extends AbstractWorkAgeAwardEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkAgeAwardEditUI.class);
    
    /**
     * output class constructor
     */
    public WorkAgeAwardEditUI() throws Exception
    {
        super();
    }
    /**

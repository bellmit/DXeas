 ...
 * output class name
 */
public abstract class AbstractWagesPersonInfoEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWagesPersonInfoEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.WagesPersonInfoInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnaudit actionUnaudit = null;
    /**
     * output class constructor
     */
    public AbstractWagesPersonInfoEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWagesPersonInfoEditUI.class.getName());
        ...
        KDTextField kdtEntrys_bankcard_TextField = new KDTextField();
        kdtEntrys_bankcard_TextField.setName("kdtEntrys_bankcard_TextField");
        kdtEntrys_bankcard_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_bankcard_CellEditor = new KDTDefaultCellEditor(kdtEntrys_bankcard_TextField);
        this.kdtEntrys.getColumn("bankcard").setEditor(kdtEntrys_bankcard_CellEditor);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,BillStatus,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(394, 524, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(394, 524, 270, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(730, 524, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(730, 524, 270, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(394, 555, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(394, 555, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(730, 555, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(730, 555, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        this.add(contAuditor, new KDLayout.Constraints(15, 528, 270, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(12, 99, 991, 413));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.WagesPersonInfoEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.WagesPersonInfoEntryInfo.class, this.kdtEntrys, "userObject");
		dataBinder.registerBinding("entrys.remark", String.class, this.kdtEntrys, "remark.text");
		dataBinder.registerBinding("entrys.enterdate", java.util.Date.class, this.kdtEntrys, "enterdate.text");
		dataBinder.registerBinding("entrys.bankcard", String.class, this.kdtEntrys, "bankcard.text");
		dataBinder.registerBinding("entrys.person", String.class, this.kdtEntrys, "person.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.WagesPersonInfoEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.WagesPersonInfoInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.bankcard", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.bankcard"));
    ...
    {
        com.kingdee.eas.custom.wages.WagesPersonInfoFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.WagesPersonInfoFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractWagesPersonInfoEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractWagesPersonInfoEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "WagesPersonInfoEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.WagesPersonInfoEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.WagesPersonInfoFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.WagesPersonInfoInfo objectValue = new com.kingdee.eas.custom.wages.WagesPersonInfoInfo();
    	...
    	return "/bim/custom/wages/WagesPersonInfo";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.WagesPersonInfoQuery");
	}

 ...
 * output class name
 */
public abstract class AbstractWorkAgeAwardListUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWorkAgeAwardListUI.class);
    /**
     * output class constructor
     */
    public AbstractWorkAgeAwardListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.WorkAgeAwardListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "WorkAgeAwardListUI");
    }

 ...
 * output class name
 */
public abstract class AbstractSocialwelfareEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSocialwelfareEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.SocialwelfareInfo editData = null;
     ...
     */
    public AbstractSocialwelfareEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSocialwelfareEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personName","Amount","subsidy"});
        ...
        final KDBizPromptBox kdtEntrys_subsidy_PromptBox = new KDBizPromptBox();
        kdtEntrys_subsidy_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.WelfarecategoryQuery");
        kdtEntrys_subsidy_PromptBox.setVisible(true);
        kdtEntrys_subsidy_PromptBox.setEditable(true);
        kdtEntrys_subsidy_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_subsidy_PromptBox.setEditFormat("$number$");
        kdtEntrys_subsidy_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_subsidy_CellEditor = new KDTDefaultCellEditor(kdtEntrys_subsidy_PromptBox);
        this.kdtEntrys.getColumn("subsidy").setEditor(kdtEntrys_subsidy_CellEditor);
        ObjectValueRender kdtEntrys_subsidy_OVR = new ObjectValueRender();
        kdtEntrys_subsidy_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("subsidy").setRenderer(kdtEntrys_subsidy_OVR);
        // contBillStatus		
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(12, 163, 991, 349));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.SocialwelfareEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 163, 991, 349, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabel1.setBounds(new Rectangle(14, 123, 398, 19));
        this.add(kDLabel1, new KDLayout.Constraints(14, 123, 398, 19, 0));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.SocialwelfareEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.subsidy", java.lang.Object.class, this.kdtEntrys, "subsidy.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.SocialwelfareEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.SocialwelfareInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.subsidy", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"personName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.subsidy.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.subsidy.id"));
			sic.add(new SelectorItemInfo("entrys.subsidy.name"));
        	sic.add(new SelectorItemInfo("entrys.subsidy.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.custom.wages.SocialwelfareFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.SocialwelfareFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSocialwelfareEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSocialwelfareEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSocialwelfareEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "SocialwelfareEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.SocialwelfareEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/wages/Socialwelfare";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.SocialwelfareQuery");
	}

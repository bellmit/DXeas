 ...
 * output class name
 */
public abstract class AbstractFractionOtherBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFractionOtherBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contFZ;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtFZ;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton audit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton unaudit;
    protected com.kingdee.eas.custom.wages.FractionOtherBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnaudit actionUnaudit = null;
    /**
     * output class constructor
     */
    public AbstractFractionOtherBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFractionOtherBillEditUI.class.getName());
        ...
        this.contFZ = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtFZ = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personnumber","personPost","score","amount","Remark"});
        ...
        kdtEntrys_personPost_OVR.setFormat(new BizDataFormat("$name$"));
        ...
        // contFZ		
        this.contFZ.setBoundLabelText(resHelper.getString("contFZ.boundLabelText"));		
        this.contFZ.setBoundLabelLength(100);		
        this.contFZ.setBoundLabelUnderline(true);		
        this.contFZ.setVisible(true);
        // prmtCreator		
        ...
        // txtFZ		
        this.txtFZ.setHorizontalAlignment(2);		
        this.txtFZ.setDataType(1);		
        this.txtFZ.setSupportedEmpty(true);		
        this.txtFZ.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtFZ.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtFZ.setPrecision(4);		
        this.txtFZ.setRequired(false);
        // audit
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,BillStatus,pkstartDate,prmtcompany,prmtcompanyOrg,txtFZ,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contCreator, new KDLayout.Constraints(377, 524, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(contLastUpdateUser, new KDLayout.Constraints(377, 555, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contNumber.setBounds(new Rectangle(13, 25, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(13, 25, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(12, 139, 991, 373));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.FractionOtherBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 139, 991, 373, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contcompany.setBounds(new Rectangle(728, 25, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(728, 25, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contcompanyOrg.setBounds(new Rectangle(351, 25, 270, 19));
        this.add(contcompanyOrg, new KDLayout.Constraints(351, 25, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        importPerson.setBounds(new Rectangle(879, 105, 120, 21));
        this.add(importPerson, new KDLayout.Constraints(879, 105, 120, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contFZ.setBounds(new Rectangle(13, 101, 270, 19));
        this.add(contFZ, new KDLayout.Constraints(13, 101, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.FractionOtherBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("FZ", java.math.BigDecimal.class, this.txtFZ, "value");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.FractionOtherBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.FractionOtherBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("FZ", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("FZ"));
        return sic;
    }        
    ...
    {
        com.kingdee.eas.custom.wages.FractionOtherBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.FractionOtherBillFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFractionOtherBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFractionOtherBillEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "FractionOtherBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.FractionOtherBillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/wages/FractionOtherBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.FractionOtherBillQuery");
	}

 ...
 * output class name
 */
public class PersonTaxEditUI extends AbstractPersonTaxEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonTaxEditUI.class);
    
    /**
     * output class constructor
     */
    public PersonTaxEditUI() throws Exception
    {
        super();
    }
    @Override

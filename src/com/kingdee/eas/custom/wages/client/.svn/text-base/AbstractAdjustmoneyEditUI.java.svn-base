 ...
 * output class name
 */
public abstract class AbstractAdjustmoneyEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustmoneyEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.AdjustmoneyInfo editData = null;
     ...
     */
    public AbstractAdjustmoneyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustmoneyEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","person","personName","personPost","adjustmentWages","remark","Adjust","house","trai"});
        ...
        kdtEntrys_personPost_PromptBox.setDisplayFormat("$number$");
        ...
        KDFormattedTextField kdtEntrys_adjustmentWages_TextField = new KDFormattedTextField();
        kdtEntrys_adjustmentWages_TextField.setName("kdtEntrys_adjustmentWages_TextField");
        kdtEntrys_adjustmentWages_TextField.setVisible(true);
        kdtEntrys_adjustmentWages_TextField.setEditable(true);
        kdtEntrys_adjustmentWages_TextField.setHorizontalAlignment(2);
        kdtEntrys_adjustmentWages_TextField.setDataType(1);
        	kdtEntrys_adjustmentWages_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_adjustmentWages_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_adjustmentWages_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_adjustmentWages_CellEditor = new KDTDefaultCellEditor(kdtEntrys_adjustmentWages_TextField);
        this.kdtEntrys.getColumn("adjustmentWages").setEditor(kdtEntrys_adjustmentWages_CellEditor);
        ...
        final KDBizPromptBox kdtEntrys_Adjust_PromptBox = new KDBizPromptBox();
        kdtEntrys_Adjust_PromptBox.setQueryInfo("com.kingdee.eas.custom.wages.app.AdjustCauseMonthQuery");
        kdtEntrys_Adjust_PromptBox.setVisible(true);
        kdtEntrys_Adjust_PromptBox.setEditable(true);
        kdtEntrys_Adjust_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_Adjust_PromptBox.setEditFormat("$number$");
        kdtEntrys_Adjust_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_Adjust_CellEditor = new KDTDefaultCellEditor(kdtEntrys_Adjust_PromptBox);
        this.kdtEntrys.getColumn("Adjust").setEditor(kdtEntrys_Adjust_CellEditor);
        ObjectValueRender kdtEntrys_Adjust_OVR = new ObjectValueRender();
        kdtEntrys_Adjust_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("Adjust").setRenderer(kdtEntrys_Adjust_OVR);
        ...
        KDTextField kdtEntrys_trai_TextField = new KDTextField();
        kdtEntrys_trai_TextField.setName("kdtEntrys_trai_TextField");
        kdtEntrys_trai_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_trai_CellEditor = new KDTDefaultCellEditor(kdtEntrys_trai_TextField);
        this.kdtEntrys.getColumn("trai").setEditor(kdtEntrys_trai_CellEditor);
        // contBillStatus		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,BillStatus,prmtcompanyOrg,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.AdjustmoneyEntryInfo(),null,false);
        ...
        importEx.setBounds(new Rectangle(669, 89, 20, 21));
        this.add(importEx, new KDLayout.Constraints(669, 89, 20, 21, 0));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.AdjustmoneyEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.adjustmentWages", java.math.BigDecimal.class, this.kdtEntrys, "adjustmentWages.text");
		dataBinder.registerBinding("entrys.personPost", java.lang.Object.class, this.kdtEntrys, "personPost.text");
		dataBinder.registerBinding("entrys.Adjust", java.lang.Object.class, this.kdtEntrys, "Adjust.text");
		dataBinder.registerBinding("entrys.house", String.class, this.kdtEntrys, "house.text");
		dataBinder.registerBinding("entrys.trai", String.class, this.kdtEntrys, "trai.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.AdjustmoneyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.AdjustmoneyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.adjustmentWages", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.personPost", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.Adjust", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.house", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.trai", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"personName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.adjustmentWages"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.personPost.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.personPost.id"));
			sic.add(new SelectorItemInfo("entrys.personPost.postname"));
			sic.add(new SelectorItemInfo("entrys.personPost.name"));
        	sic.add(new SelectorItemInfo("entrys.personPost.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.Adjust.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.Adjust.id"));
			sic.add(new SelectorItemInfo("entrys.Adjust.name"));
        	sic.add(new SelectorItemInfo("entrys.Adjust.number"));
		}
    	sic.add(new SelectorItemInfo("entrys.house"));
    	sic.add(new SelectorItemInfo("entrys.trai"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.custom.wages.AdjustmoneyFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.AdjustmoneyFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAdjustmoneyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustmoneyEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustmoneyEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "AdjustmoneyEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.client.AdjustmoneyEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/custom/wages/Adjustmoney";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.app.AdjustmoneyQuery");
	}
    
        
					protected void beforeStoreFields(ActionEvent arg0) throws Exception {
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"Adjust").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"调整事由"});
			}
		}

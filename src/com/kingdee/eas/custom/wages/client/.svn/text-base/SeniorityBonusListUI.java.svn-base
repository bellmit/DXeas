...
import com.kingdee.eas.custom.wages.IQualityawardticket;
import com.kingdee.eas.custom.wages.ISeniorityBonus;
 ...
 * output class name
 */
public class SeniorityBonusListUI extends AbstractSeniorityBonusListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SeniorityBonusListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public SeniorityBonusListUI() throws Exception
    {
        super();
...
//	}
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "Entry.moneys"};
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		ISeniorityBonus purorder = (ISeniorityBonus) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getSeniorityBonusInfo(pk));

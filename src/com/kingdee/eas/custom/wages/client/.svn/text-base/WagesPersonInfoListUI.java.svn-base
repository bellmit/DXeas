 ...
 * output class name
 */
public class WagesPersonInfoListUI extends AbstractWagesPersonInfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WagesPersonInfoListUI.class);
    
    /**
     * output class constructor
     */
    public WagesPersonInfoListUI() throws Exception
    {
        super();
    }

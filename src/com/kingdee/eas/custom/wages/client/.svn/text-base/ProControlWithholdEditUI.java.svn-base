 ...
 * output class name
 */
public class ProControlWithholdEditUI extends AbstractProControlWithholdEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProControlWithholdEditUI.class);
    
    /**
     * output class constructor
     */
    public ProControlWithholdEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    /* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.client.AbstractProControlWithholdEditUI#actionImportEx_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override

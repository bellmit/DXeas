 ...
 * output class name
 */
public class WageOrganizationListUI extends AbstractWageOrganizationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WageOrganizationListUI.class);
    
    /**
     * output class constructor
     */
    public WageOrganizationListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.client.WageOrganizationTreeEditUI.class.getName();
    }

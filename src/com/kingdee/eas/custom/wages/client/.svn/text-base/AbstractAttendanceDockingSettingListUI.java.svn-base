 ...
 * output class name
 */
public abstract class AbstractAttendanceDockingSettingListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttendanceDockingSettingListUI.class);
    /**
     * output class constructor
     */
    public AbstractAttendanceDockingSettingListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.AttendanceDockingSettingListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "AttendanceDockingSettingListUI");
    }

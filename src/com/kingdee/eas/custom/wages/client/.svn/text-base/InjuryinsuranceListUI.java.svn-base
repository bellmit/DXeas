...
import com.kingdee.eas.custom.wages.IInjuryinsurance;
import com.kingdee.eas.custom.wages.IInsuranceRegist;
 ...
 * output class name
 */
public class InjuryinsuranceListUI extends AbstractInjuryinsuranceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InjuryinsuranceListUI.class);
    
    /**
     * output class constructor
     */
    public InjuryinsuranceListUI() throws Exception
    {
        super();
    }
    /* (non-Javadoc)
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
    	if (this.getBizInterface().getValue(
 		...
 		IInjuryinsurance purorder = (IInjuryinsurance) getBizInterface();
 		...
 		for(int j=0;j<billIdlist.length;j++){
 				...
 				purorder.audit(purorder.getInjuryinsuranceInfo(pk));

...
import com.kingdee.eas.custom.wages.IFractionBill;
 ...
 * output class name
 */
public class FractionBillListUI extends AbstractFractionBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FractionBillListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public FractionBillListUI() throws Exception
    {
        super();
...
//	}
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "Entry.dayWages","Entry.fraction"};
    }
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("Entry.dayWages");
    	sumField.add("Entry.fraction");
        return sumField;
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IFractionBill purorder = (IFractionBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getFractionBillInfo(pk));

 ...
 * output class name
 */
public class AttendanceDockingListUI extends AbstractAttendanceDockingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttendanceDockingListUI.class);
    
    /**
     * output class constructor
     */
    public AttendanceDockingListUI() throws Exception
    {
        super();
    }

...
import com.kingdee.eas.custom.wages.IFractionOtherBill;
 ...
 * output class name
 */
public class FractionOtherBillListUI extends AbstractFractionOtherBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FractionOtherBillListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public FractionOtherBillListUI() throws Exception
    {
        super();
...
//	}
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "entrys.score"};
    }
...
//        this.actionRefresh_actionPerformed(null);
		...
		IFractionOtherBill purorder = (IFractionOtherBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getFractionOtherBillInfo(pk));

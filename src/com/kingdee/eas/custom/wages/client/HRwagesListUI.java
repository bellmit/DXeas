...
import com.kingdee.eas.custom.wages.IHRwages;
 ...
 * output class name
 */
public class HRwagesListUI extends AbstractHRwagesListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HRwagesListUI.class);
    
    /**
     * output class constructor
     */
    public HRwagesListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IHRwages purorder = (IHRwages) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getHRwagesInfo(pk));

 ...
 * output class name
 */
public abstract class AbstractAttendanceDockingEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttendanceDockingEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDButton getMassages;
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kdtEntry;
	protected com.kingdee.eas.framework.client.multiDetail.DetailPanel kdtEntry_detailPanel = null;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcompany;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcompany;
    protected com.kingdee.eas.custom.wages.AttendanceDockingInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAttendanceDockingEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttendanceDockingEditUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        this.getMassages = new com.kingdee.bos.ctrl.swing.KDButton();
        this.kdtEntry = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        this.contcompany = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtcompany = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.getMassages.setName("getMassages");
        ...
        // getMassages		
        this.getMassages.setText(resHelper.getString("getMassages.text"));
        // kdtEntry
		String kdtEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style><c:Style id=\"sCol4\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"personNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"personName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"person\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"punchCardTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol4\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{personNum}</t:Cell><t:Cell>$Resource{personName}</t:Cell><t:Cell>$Resource{person}</t:Cell><t:Cell>$Resource{punchCardTime}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntry.setFormatXml(resHelper.translateString("kdtEntry",kdtEntryStrXML));

                this.kdtEntry.putBindContents("editData",new String[] {"seq","personNum","personName","person","punchCardTime"});


        this.kdtEntry.checkParsed();
        KDTextField kdtEntry_personNum_TextField = new KDTextField();
        kdtEntry_personNum_TextField.setName("kdtEntry_personNum_TextField");
        kdtEntry_personNum_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntry_personNum_CellEditor = new KDTDefaultCellEditor(kdtEntry_personNum_TextField);
        this.kdtEntry.getColumn("personNum").setEditor(kdtEntry_personNum_CellEditor);
        ...
        kdtEntry_personName_TextField.setMaxLength(100);
        ...
        KDDatePicker kdtEntry_punchCardTime_DatePicker = new KDDatePicker();
        kdtEntry_punchCardTime_DatePicker.setName("kdtEntry_punchCardTime_DatePicker");
        kdtEntry_punchCardTime_DatePicker.setVisible(true);
        kdtEntry_punchCardTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntry_punchCardTime_CellEditor = new KDTDefaultCellEditor(kdtEntry_punchCardTime_DatePicker);
        this.kdtEntry.getColumn("punchCardTime").setEditor(kdtEntry_punchCardTime_CellEditor);
        // contcompany		
    ...
    public void initUIContentLayout()
    {
        ...
        getMassages.setBounds(new Rectangle(717, 51, 127, 21));
        this.add(getMassages, new KDLayout.Constraints(717, 51, 127, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntry.setBounds(new Rectangle(25, 96, 964, 421));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.custom.wages.AttendanceDockingEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, new KDLayout.Constraints(25, 96, 964, 421, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.custom.wages.AttendanceDockingEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("Entry.person", java.lang.Object.class, this.kdtEntry, "person.text");
		dataBinder.registerBinding("Entry.personNum", String.class, this.kdtEntry, "personNum.text");
		dataBinder.registerBinding("Entry.personName", String.class, this.kdtEntry, "personName.text");
		dataBinder.registerBinding("Entry.punchCardTime", java.util.Date.class, this.kdtEntry, "punchCardTime.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.AttendanceDockingEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.AttendanceDockingInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entry.personNum", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("Entry.personName", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("Entry.punchCardTime", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "AttendanceDockingEditUI");
    }

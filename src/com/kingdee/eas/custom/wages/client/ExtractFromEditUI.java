 ...
 * output class name
 */
public class ExtractFromEditUI extends AbstractExtractFromEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ExtractFromEditUI.class);
    
    /**
     * output class constructor
     */
    public ExtractFromEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public class DailyOutPutListUI extends AbstractDailyOutPutListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DailyOutPutListUI.class);
    
    /**
     * output class constructor
     */
    public DailyOutPutListUI() throws Exception
    {
        super();
    }

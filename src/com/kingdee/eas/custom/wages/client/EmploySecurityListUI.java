...
import com.kingdee.eas.custom.wages.IEmploySecurity;
 ...
 * output class name
 */
public class EmploySecurityListUI extends AbstractEmploySecurityListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EmploySecurityListUI.class);
    
    /**
     * output class constructor
     */
    public EmploySecurityListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IEmploySecurity purorder = (IEmploySecurity) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getEmploySecurityInfo(pk));

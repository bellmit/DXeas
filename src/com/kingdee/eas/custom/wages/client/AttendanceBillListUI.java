 ...
 * output class name
 */
public class AttendanceBillListUI extends AbstractAttendanceBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttendanceBillListUI.class);
    QuickFilteringSupportItems qfsi;
    /**
     * output class constructor
     */
    public AttendanceBillListUI() throws Exception
    {
        super();

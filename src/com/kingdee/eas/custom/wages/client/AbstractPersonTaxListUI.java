 ...
 * output class name
 */
public abstract class AbstractPersonTaxListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPersonTaxListUI.class);
    protected ActionApprove actionApprove = null;
    protected ActionUnApprove actionUnApprove = null;
    /**
     * output class constructor
     */
    public AbstractPersonTaxListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPersonTaxListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.app", "PersonTaxQuery");
        //actionApprove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.app.PersonTaxListUIHandler";
	}
...
com.kingdee.eas.custom.wages.PersonTaxInfo editData = (com.kingdee.eas.custom.wages.PersonTaxInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.custom.wages.PersonTaxFactory.getRemoteInstance().unApprove(editData);
    ...
    protected class ActionApprove extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPersonTaxListUI.this, "ActionApprove", "actionApprove_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnApprove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPersonTaxListUI.this, "ActionUnApprove", "actionUnApprove_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.client", "PersonTaxListUI");
    }

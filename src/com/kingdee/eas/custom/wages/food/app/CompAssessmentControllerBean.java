...
public class CompAssessmentControllerBean extends AbstractCompAssessmentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.CompAssessmentControllerBean");
	...
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model)
		...
		CompAssessmentInfo info = (CompAssessmentInfo)model;

...
public class TAttendanceRecordsControllerBeanEx extends com.kingdee.eas.custom.wages.food.app.TAttendanceRecordsControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.TAttendanceRecordsControllerBeanEx");

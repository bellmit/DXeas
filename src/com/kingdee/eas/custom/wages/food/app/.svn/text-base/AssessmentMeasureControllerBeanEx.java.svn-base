...
public class AssessmentMeasureControllerBeanEx extends com.kingdee.eas.custom.wages.food.app.AssessmentMeasureControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.AssessmentMeasureControllerBeanEx");

...
public class ProdasseindexControllerBean extends AbstractProdasseindexControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.ProdasseindexControllerBean");
	...
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model)
		...
		ProdasseindexInfo info = (ProdasseindexInfo)model;

...
public class AdjustFoodmoneyControllerBeanEx extends com.kingdee.eas.custom.wages.food.app.AdjustFoodmoneyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.AdjustFoodmoneyControllerBeanEx");

...
import com.kingdee.eas.custom.wages.food.AdjustFoodmoneyFactory;
...
public class AdjustFoodmoneyControllerBean extends AbstractAdjustFoodmoneyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.food.app.AdjustFoodmoneyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustFoodmoneyInfo info = (AdjustFoodmoneyInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustFoodmoneyInfo info = AdjustFoodmoneyFactory.getLocalInstance(ctx).getAdjustFoodmoneyInfo(pk);

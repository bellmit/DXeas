...
public class WageFoodOrgan extends DataBase implements IWageFoodOrgan
{
    public WageFoodOrgan()
    {
        super();
        registerInterface(IWageFoodOrgan.class, this);
    }
    public WageFoodOrgan(Context ctx)
    {
        super(ctx);
        registerInterface(IWageFoodOrgan.class, this);
    }
    ...
    private WageFoodOrganController getController() throws BOSException
    {
        return (WageFoodOrganController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWageFoodOrganInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getWageFoodOrganInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWageFoodOrganInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWageFoodOrganCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWageFoodOrganCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWageFoodOrganCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

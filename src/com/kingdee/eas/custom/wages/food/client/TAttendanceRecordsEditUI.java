 ...
 * output class name
 */
public class TAttendanceRecordsEditUI extends AbstractTAttendanceRecordsEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TAttendanceRecordsEditUI.class);
    
    /**
     * output class constructor
     */
    public TAttendanceRecordsEditUI() throws Exception
    {
        super();
    }
    /**
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.food.client.AbstractTAttendanceRecordsEditUI#actionImportEx_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.food.client.AbstractTAttendanceRecordsEditUI#onShow()
	 */
	@Override

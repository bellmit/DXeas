...
import com.kingdee.eas.custom.wages.food.IAchievement;
 ...
 * output class name
 */
public class AchievementListUI extends AbstractAchievementListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AchievementListUI.class);
    
    /**
     * output class constructor
     */
    public AchievementListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IAchievement purorder = (IAchievement) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getAchievementInfo(pk));

 ...
 * output class name
 */
public abstract class AbstractProdasseindexListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProdasseindexListUI.class);
    /**
     * output class constructor
     */
    public AbstractProdasseindexListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProdasseindexListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.wages.food.app", "ProdasseindexQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.food.app.ProdasseindexListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.food.client", "ProdasseindexListUI");
    }

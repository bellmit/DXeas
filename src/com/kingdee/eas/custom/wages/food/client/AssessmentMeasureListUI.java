...
import com.kingdee.eas.custom.wages.food.IAssessmentMeasure;
 ...
 * output class name
 */
public class AssessmentMeasureListUI extends AbstractAssessmentMeasureListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AssessmentMeasureListUI.class);
    
    /**
     * output class constructor
     */
    public AssessmentMeasureListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IAssessmentMeasure purorder = (IAssessmentMeasure) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getAssessmentMeasureInfo(pk));

...
import com.kingdee.eas.custom.wages.food.ITAttendanceRecords;
 ...
 * output class name
 */
public class TAttendanceRecordsListUI extends AbstractTAttendanceRecordsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TAttendanceRecordsListUI.class);
    
    /**
     * output class constructor
     */
    public TAttendanceRecordsListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		ITAttendanceRecords purorder = (ITAttendanceRecords) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getTAttendanceRecordsInfo(pk));

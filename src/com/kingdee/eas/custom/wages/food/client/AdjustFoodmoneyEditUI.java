 ...
 * output class name
 */
public class AdjustFoodmoneyEditUI extends AbstractAdjustFoodmoneyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AdjustFoodmoneyEditUI.class);
    
    /**
     * output class constructor
     */
    public AdjustFoodmoneyEditUI() throws Exception
    {
        super();
    }
    /**

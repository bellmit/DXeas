 ...
 * output class name
 */
public class CompAssessmentListUI extends AbstractCompAssessmentListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompAssessmentListUI.class);
    
    /**
     * output class constructor
     */
    public CompAssessmentListUI() throws Exception
    {
        super();
    }

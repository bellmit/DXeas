...
import com.kingdee.eas.custom.wages.food.IMonthFoodBill;
 ...
 * output class name
 */
public class MonthFoodBillListUI extends AbstractMonthFoodBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthFoodBillListUI.class);
    
    /**
     * output class constructor
     */
    public MonthFoodBillListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		IMonthFoodBill purorder = (IMonthFoodBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				purorder.audit(purorder.getMonthFoodBillInfo(pk));
 ...
 // 得到当前选中行的 id
    ...
    /**
     * output actionGetPerson_actionPerformed
     */

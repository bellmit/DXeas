 ...
 * output class name
 */
public class ProdasseindexListUI extends AbstractProdasseindexListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProdasseindexListUI.class);
    
    /**
     * output class constructor
     */
    public ProdasseindexListUI() throws Exception
    {
        super();
    }

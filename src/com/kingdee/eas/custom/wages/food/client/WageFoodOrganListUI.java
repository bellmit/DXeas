 ...
 * output class name
 */
public class WageFoodOrganListUI extends AbstractWageFoodOrganListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WageFoodOrganListUI.class);
    
    /**
     * output class constructor
     */
    public WageFoodOrganListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.food.client.WageFoodOrganTreeEditUI.class.getName();
    }

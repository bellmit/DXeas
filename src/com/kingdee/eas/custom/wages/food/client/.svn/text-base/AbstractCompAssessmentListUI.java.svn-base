 ...
 * output class name
 */
public abstract class AbstractCompAssessmentListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompAssessmentListUI.class);
    /**
     * output class constructor
     */
    public AbstractCompAssessmentListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.food.app.CompAssessmentListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.food.client", "CompAssessmentListUI");
    }

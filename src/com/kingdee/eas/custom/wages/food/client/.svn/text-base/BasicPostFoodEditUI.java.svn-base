 ...
 * output class name
 */
public class BasicPostFoodEditUI extends AbstractBasicPostFoodEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BasicPostFoodEditUI.class);
    
    /**
     * output class constructor
     */
    public BasicPostFoodEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    private void initUI() {
    	...
    	chkisAssessment.addChangeListener(new ChangeListener() {
    		public void stateChanged(ChangeEvent e) {
    			try {
    				chkisAssessment_Changed();
    			}
    			catch (Exception exc) {
    				handUIException(exc);
    			}
    	 ...
    	 prmtAssessmentIndex.addChangeListener(new ChangeListener(){

			
			public void stateChanged(ChangeEvent e) {
				// TODO Auto-generated method stub
				try {
					prmtAssessmentIndex_Changed();
				} catch (Exception e1) {
    ...
    /**
     * output chkisAssessment_Changed() method
     */
    public void chkisAssessment_Changed() throws Exception
    {
        if (chkisAssessment.isSelected()) {
            contAssessmentIndex.setVisible(true);
            prmtAssessmentIndex.setVisible(true);
            txtFullAssessment.setEnabled(false);
            //prmtAssessmentIndex.set
            //contAssessmentIndex.setEnabled(true);
        }else{
        	 contAssessmentIndex.setVisible(false);
             prmtAssessmentIndex.setVisible(false);
             //contAssessmentIndex.setEnabled(true);
             txtFullAssessment.setEnabled(true);
        }
    }
    /**
     * 更新分录
     */
    public void prmtAssessmentIndex_Changed() throws Exception
    {
    ...
    private IRowSet getExeQueryRowSet(String id) throws BOSException {
		...
		sql.append("select t3.FID FID,t3.FName_l2 Name,t3.FNumber FNumber from T_ORG_Position t1").append(sp);
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        objectValue.setFullAssessment(new BigDecimal("0"));
        return objectValue;
    }

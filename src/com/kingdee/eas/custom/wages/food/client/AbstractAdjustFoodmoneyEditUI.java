 ...
 * output class name
 */
public abstract class AbstractAdjustFoodmoneyEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAdjustFoodmoneyEditUI.class);
    ...
    protected com.kingdee.eas.custom.wages.food.AdjustFoodmoneyInfo editData = null;
     ...
     */
    public AbstractAdjustFoodmoneyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAdjustFoodmoneyEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.wages.food.AdjustFoodmoneyEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.wages.food.AdjustFoodmoneyEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.food.app.AdjustFoodmoneyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.food.AdjustFoodmoneyInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"person").getValue(),"number")));
    ...
    {
        com.kingdee.eas.custom.wages.food.AdjustFoodmoneyFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.custom.wages.food.AdjustFoodmoneyFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAdjustFoodmoneyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustFoodmoneyEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    protected class actionImportEx extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAdjustFoodmoneyEditUI.this, "actionImportEx", "actionImportEx_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.food.client", "AdjustFoodmoneyEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.wages.food.client.AdjustFoodmoneyEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.food.AdjustFoodmoneyFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.food.AdjustFoodmoneyInfo objectValue = new com.kingdee.eas.custom.wages.food.AdjustFoodmoneyInfo();
    	...
    	return "/bim/custom/wages/food/AdjustFoodmoney";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.wages.food.app.AdjustFoodmoneyQuery");
	}

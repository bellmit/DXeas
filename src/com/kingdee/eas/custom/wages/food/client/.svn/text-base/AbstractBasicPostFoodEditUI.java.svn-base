 ...
 * output class name
 */
public abstract class AbstractBasicPostFoodEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBasicPostFoodEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfoodamount;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conttheGroup;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contFullwork;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contFullAssessment;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisAssessment;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtfoodamount;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmttheGroup;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtFullwork;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtFullAssessment;
    ...
    protected com.kingdee.eas.custom.wages.food.BasicPostFoodInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBasicPostFoodEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBasicPostFoodEditUI.class.getName());
        ...
        this.contfoodamount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.conttheGroup = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contFullwork = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contFullAssessment = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.chkisAssessment = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.txtfoodamount = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.prmttheGroup = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtFullwork = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtFullAssessment = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contfoodamount.setName("contfoodamount");
        this.conttheGroup.setName("conttheGroup");
        this.contFullwork.setName("contFullwork");
        this.contFullAssessment.setName("contFullAssessment");
        this.chkisAssessment.setName("chkisAssessment");
        ...
        this.txtfoodamount.setName("txtfoodamount");
        this.prmttheGroup.setName("prmttheGroup");
        this.txtFullwork.setName("txtFullwork");
        this.txtFullAssessment.setName("txtFullAssessment");
        ...
        // contfoodamount		
        this.contfoodamount.setBoundLabelText(resHelper.getString("contfoodamount.boundLabelText"));		
        this.contfoodamount.setBoundLabelLength(100);		
        this.contfoodamount.setBoundLabelUnderline(true);		
        this.contfoodamount.setVisible(true);
        // conttheGroup		
        ...
        // contFullwork		
        this.contFullwork.setBoundLabelText(resHelper.getString("contFullwork.boundLabelText"));		
        this.contFullwork.setBoundLabelLength(100);		
        this.contFullwork.setBoundLabelUnderline(true);		
        this.contFullwork.setVisible(true);
        // contFullAssessment		
        this.contFullAssessment.setBoundLabelText(resHelper.getString("contFullAssessment.boundLabelText"));		
        this.contFullAssessment.setBoundLabelLength(100);		
        this.contFullAssessment.setBoundLabelUnderline(true);		
        this.contFullAssessment.setVisible(true);
        // chkisAssessment		
        this.chkisAssessment.setText(resHelper.getString("chkisAssessment.text"));		
        this.chkisAssessment.setVisible(true);		
        this.chkisAssessment.setHorizontalAlignment(2);
        // contAssessmentIndex		
        ...
        this.contAssessmentIndex.setVisible(false);
        // contposition		
        ...
        // UnitMetering		
        this.UnitMetering.setVisible(false);		
        ...
        // txtfoodamount		
        this.txtfoodamount.setVisible(true);		
        this.txtfoodamount.setHorizontalAlignment(2);		
        this.txtfoodamount.setDataType(1);		
        this.txtfoodamount.setSupportedEmpty(true);		
        this.txtfoodamount.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtfoodamount.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtfoodamount.setPrecision(2);		
        this.txtfoodamount.setRequired(false);
        // prmttheGroup		
        this.prmttheGroup.setQueryInfo("com.kingdee.eas.custom.wages.food.app.WageFoodOrganQuery");		
        ...
        this.prmttheGroup.setRequired(false);
			...
			com.kingdee.eas.custom.wages.food.client.WageFoodOrganListUI prmttheGroup_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmttheGroup_F7ListUI == null) {
					try {
						prmttheGroup_F7ListUI = new com.kingdee.eas.custom.wages.food.client.WageFoodOrganListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
        ...
        // txtFullwork		
        this.txtFullwork.setVisible(true);		
        this.txtFullwork.setHorizontalAlignment(2);		
        this.txtFullwork.setDataType(1);		
        this.txtFullwork.setSupportedEmpty(true);		
        this.txtFullwork.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtFullwork.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtFullwork.setPrecision(2);		
        this.txtFullwork.setRequired(false);
        // txtFullAssessment		
        this.txtFullAssessment.setVisible(true);		
        this.txtFullAssessment.setHorizontalAlignment(2);		
        this.txtFullAssessment.setDataType(1);		
        this.txtFullAssessment.setSupportedEmpty(true);		
        this.txtFullAssessment.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtFullAssessment.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtFullAssessment.setPrecision(2);		
        this.txtFullAssessment.setRequired(false);
        // prmtAssessmentIndex		
        this.prmtAssessmentIndex.setQueryInfo("com.kingdee.eas.custom.wages.food.app.ProdasseindexQuery");		
        this.prmtAssessmentIndex.setVisible(false);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtProductRatio,txtPostSalary,txtSimpleName,txtDescription,txtNumber,txtName,UnitMetering,BaseStatus,txtfoodamount,prmttheGroup,txtFullwork,txtFullAssessment,chkisAssessment,prmtAssessmentIndex,prmtposition,txtpostname}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(-700, 164, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(-700, 164, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        this.add(kDLabelContainer4, new KDLayout.Constraints(-695, 66, 270, 19, 0));
        contPostSalary.setBounds(new Rectangle(697, 115, 270, 19));
        this.add(contPostSalary, new KDLayout.Constraints(697, 115, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDTabbedPane1.setBounds(new Rectangle(30, 199, 939, 396));
        this.add(kDTabbedPane1, new KDLayout.Constraints(30, 199, 939, 396, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contfoodamount.setBounds(new Rectangle(344, 115, 270, 19));
        this.add(contfoodamount, new KDLayout.Constraints(344, 115, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttheGroup.setBounds(new Rectangle(31, 72, 270, 19));
        this.add(conttheGroup, new KDLayout.Constraints(31, 72, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFullwork.setBounds(new Rectangle(344, 161, 270, 19));
        this.add(contFullwork, new KDLayout.Constraints(344, 161, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFullAssessment.setBounds(new Rectangle(697, 66, 270, 19));
        this.add(contFullAssessment, new KDLayout.Constraints(697, 66, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        chkisAssessment.setBounds(new Rectangle(32, 117, 270, 19));
        this.add(chkisAssessment, new KDLayout.Constraints(32, 117, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAssessmentIndex.setBounds(new Rectangle(30, 163, 270, 19));
        this.add(contAssessmentIndex, new KDLayout.Constraints(30, 163, 270, 19, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contposition.setBounds(new Rectangle(343, 23, 270, 19));
        this.add(contposition, new KDLayout.Constraints(343, 23, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpostname.setBounds(new Rectangle(697, 166, 270, 19));
        this.add(contpostname, new KDLayout.Constraints(697, 166, 270, 19, KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDLabelContainer1
        ...
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 938, 363));        kdtEntry.setBounds(new Rectangle(1, 1, 931, 362));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.custom.wages.food.BasicPostFoodEntryInfo(),null,false);
        kDPanel1.add(kdtEntry_detailPanel, new KDLayout.Constraints(1, 1, 931, 362, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contUnitMetering
        contUnitMetering.setBoundEditor(UnitMetering);
        //contBaseStatus
        contBaseStatus.setBoundEditor(BaseStatus);
        //contfoodamount
        contfoodamount.setBoundEditor(txtfoodamount);
        //conttheGroup
        conttheGroup.setBoundEditor(prmttheGroup);
        //contFullwork
        contFullwork.setBoundEditor(txtFullwork);
        //contFullAssessment
        contFullAssessment.setBoundEditor(txtFullAssessment);
        //contAssessmentIndex
	...
	private void registerBindings(){
		dataBinder.registerBinding("isAssessment", boolean.class, this.chkisAssessment, "selected");
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.custom.wages.food.BasicPostFoodEntryInfo.class, this.kdtEntry, "userObject");
		...
		dataBinder.registerBinding("foodamount", java.math.BigDecimal.class, this.txtfoodamount, "value");
		dataBinder.registerBinding("theGroup", com.kingdee.eas.custom.wages.food.WageFoodOrganInfo.class, this.prmttheGroup, "data");
		dataBinder.registerBinding("Fullwork", java.math.BigDecimal.class, this.txtFullwork, "value");
		dataBinder.registerBinding("FullAssessment", java.math.BigDecimal.class, this.txtFullAssessment, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.wages.food.app.BasicPostFoodEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.wages.food.BasicPostFoodInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isAssessment", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("foodamount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("theGroup", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("Fullwork", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("FullAssessment", ValidateHelper.ON_SAVE);    
...
kdtEntry.getCell(rowIndex,"personnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntry.getCell(rowIndex,"person").getValue(),"number")));
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("isAssessment"));
        ...
        sic.add(new SelectorItemInfo("foodamount"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("Fullwork"));
        sic.add(new SelectorItemInfo("FullAssessment"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.wages.food.client", "BasicPostFoodEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.wages.food.client.BasicPostFoodEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.wages.food.BasicPostFoodFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.wages.food.BasicPostFoodInfo objectValue = new com.kingdee.eas.custom.wages.food.BasicPostFoodInfo();

 ...
 * output class name
 */
public class AdjustFoodmoneyListUI extends AbstractAdjustFoodmoneyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AdjustFoodmoneyListUI.class);
    
    /**
     * output class constructor
     */
    public AdjustFoodmoneyListUI() throws Exception
    {
        super();
    }

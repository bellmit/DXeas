 ...
 * output class name
 */
public class CompAssessmentEditUI extends AbstractCompAssessmentEditUI
{
   

	private static final Logger logger = CoreUIObject.getLogger(CompAssessmentEditUI.class);
    
    /**
     * output class constructor
     */
    public CompAssessmentEditUI() throws Exception
    {
        super();
    }
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.custom.wages.food.client.AbstractCompAssessmentEditUI#onShow()
	 */
	@Override

...
public class ExtractFromEntry extends CoreBillEntryBase implements IExtractFromEntry
{
    public ExtractFromEntry()
    {
        super();
        registerInterface(IExtractFromEntry.class, this);
    }
    public ExtractFromEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IExtractFromEntry.class, this);
    }
    ...
    private ExtractFromEntryController getController() throws BOSException
    {
        return (ExtractFromEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExtractFromEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExtractFromEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExtractFromEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExtractFromEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExtractFromEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExtractFromEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

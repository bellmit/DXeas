...
public class WorkAgeAwardBonu extends CoreBillEntryBase implements IWorkAgeAwardBonu
{
    public WorkAgeAwardBonu()
    {
        super();
        registerInterface(IWorkAgeAwardBonu.class, this);
    }
    public WorkAgeAwardBonu(Context ctx)
    {
        super(ctx);
        registerInterface(IWorkAgeAwardBonu.class, this);
    }
    ...
    private WorkAgeAwardBonuController getController() throws BOSException
    {
        return (WorkAgeAwardBonuController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardBonuCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

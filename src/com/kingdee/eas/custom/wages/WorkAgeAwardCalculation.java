...
public class WorkAgeAwardCalculation extends CoreBillEntryBase implements IWorkAgeAwardCalculation
{
    public WorkAgeAwardCalculation()
    {
        super();
        registerInterface(IWorkAgeAwardCalculation.class, this);
    }
    public WorkAgeAwardCalculation(Context ctx)
    {
        super(ctx);
        registerInterface(IWorkAgeAwardCalculation.class, this);
    }
    ...
    private WorkAgeAwardCalculationController getController() throws BOSException
    {
        return (WorkAgeAwardCalculationController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkAgeAwardCalculationCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class AttendanceDockingControllerBean extends AbstractAttendanceDockingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.AttendanceDockingControllerBean");
}
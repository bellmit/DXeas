...
public class QualityawardticketControllerBean extends AbstractQualityawardticketControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.QualityawardticketControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		QualityawardticketInfo info = (QualityawardticketInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		QualityawardticketInfo info = QualityawardticketFactory.getLocalInstance(ctx).getQualityawardticketInfo(pk);

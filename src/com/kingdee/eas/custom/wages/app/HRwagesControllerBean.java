...
public class HRwagesControllerBean extends AbstractHRwagesControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.HRwagesControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		HRwagesInfo info = (HRwagesInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		HRwagesInfo info = HRwagesFactory.getLocalInstance(ctx).getHRwagesInfo(pk);

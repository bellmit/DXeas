...
public class BasicPostControllerBean extends AbstractBasicPostControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.BasicPostControllerBean");
	...
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model)
		...
		BasicPostInfo info = (BasicPostInfo)model;

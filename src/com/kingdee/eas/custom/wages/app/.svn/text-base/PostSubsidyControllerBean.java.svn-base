...
public class PostSubsidyControllerBean extends AbstractPostSubsidyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.PostSubsidyControllerBean");
}
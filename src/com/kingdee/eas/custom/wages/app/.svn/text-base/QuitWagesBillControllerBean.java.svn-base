...
public class QuitWagesBillControllerBean extends AbstractQuitWagesBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.QuitWagesBillControllerBean");
}
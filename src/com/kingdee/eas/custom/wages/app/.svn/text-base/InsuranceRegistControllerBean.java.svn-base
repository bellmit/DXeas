...
public class InsuranceRegistControllerBean extends AbstractInsuranceRegistControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.InsuranceRegistControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		InsuranceRegistInfo info = (InsuranceRegistInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		InsuranceRegistInfo info = InsuranceRegistFactory.getLocalInstance(ctx).getInsuranceRegistInfo(pk);

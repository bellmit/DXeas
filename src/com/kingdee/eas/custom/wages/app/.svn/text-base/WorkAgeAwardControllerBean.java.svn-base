...
public class WorkAgeAwardControllerBean extends AbstractWorkAgeAwardControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.WorkAgeAwardControllerBean");
}
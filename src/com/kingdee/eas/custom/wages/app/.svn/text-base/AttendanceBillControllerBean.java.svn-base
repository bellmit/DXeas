...
public class AttendanceBillControllerBean extends AbstractAttendanceBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.AttendanceBillControllerBean");
}
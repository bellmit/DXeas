...
public class FractionBillControllerBean extends AbstractFractionBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.FractionBillControllerBean");
}
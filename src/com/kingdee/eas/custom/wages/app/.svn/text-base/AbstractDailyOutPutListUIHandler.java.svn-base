 ...
 * output class name
 */
public abstract class AbstractDailyOutPutListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionSalaryCount(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionSalaryCount(request,response,context);
	}
	protected void _handleActionSalaryCount(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
...
public class EmploySecurityControllerBean extends AbstractEmploySecurityControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.EmploySecurityControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		EmploySecurityInfo info = (EmploySecurityInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		EmploySecurityInfo info = EmploySecurityFactory.getLocalInstance(ctx).getEmploySecurityInfo(pk);

...
public class PersonTaxControllerBeanEx extends com.kingdee.eas.custom.wages.app.PersonTaxControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.PersonTaxControllerBeanEx");

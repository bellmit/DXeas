...
public class ByThePieceBillControllerBean extends AbstractByThePieceBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.ByThePieceBillControllerBean");
}
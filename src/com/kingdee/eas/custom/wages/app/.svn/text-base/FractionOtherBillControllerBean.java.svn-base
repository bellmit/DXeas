...
import com.kingdee.eas.custom.wages.FractionOtherBillFactory;
...
public class FractionOtherBillControllerBean extends AbstractFractionOtherBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.FractionOtherBillControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FractionOtherBillInfo info = (FractionOtherBillInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FractionOtherBillInfo info = FractionOtherBillFactory.getLocalInstance(ctx).getFractionOtherBillInfo(pk);

...
import com.kingdee.eas.custom.wages.HRwagesFactory;
...
public class AdjustmoneyControllerBean extends AbstractAdjustmoneyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.AdjustmoneyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustmoneyInfo info = (AdjustmoneyInfo) model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		AdjustmoneyInfo info = AdjustmoneyFactory.getLocalInstance(ctx).getAdjustmoneyInfo(pk);

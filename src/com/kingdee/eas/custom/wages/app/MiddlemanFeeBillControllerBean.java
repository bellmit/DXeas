...
public class MiddlemanFeeBillControllerBean extends AbstractMiddlemanFeeBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wages.app.MiddlemanFeeBillControllerBean");
}
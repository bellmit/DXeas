...
public class PostSubsidyEntry extends CoreBillEntryBase implements IPostSubsidyEntry
{
    public PostSubsidyEntry()
    {
        super();
        registerInterface(IPostSubsidyEntry.class, this);
    }
    public PostSubsidyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPostSubsidyEntry.class, this);
    }
    ...
    private PostSubsidyEntryController getController() throws BOSException
    {
        return (PostSubsidyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPostSubsidyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPostSubsidyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPostSubsidyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPostSubsidyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPostSubsidyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPostSubsidyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

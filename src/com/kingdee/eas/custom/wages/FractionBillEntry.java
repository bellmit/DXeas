...
public class FractionBillEntry extends CoreBillEntryBase implements IFractionBillEntry
{
    public FractionBillEntry()
    {
        super();
        registerInterface(IFractionBillEntry.class, this);
    }
    public FractionBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFractionBillEntry.class, this);
    }
    ...
    private FractionBillEntryController getController() throws BOSException
    {
        return (FractionBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFractionBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFractionBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFractionBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFractionBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFractionBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFractionBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

 ...
 * output class name
 */
public class PermissionSettingListUI extends AbstractPermissionSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PermissionSettingListUI.class);
    
    /**
     * output class constructor
     */
    public PermissionSettingListUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionPurOrderUpdateTax_actionPerformed
     */
    public void actionPurOrderUpdateTax_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionPurOrderUpdateTax_actionPerformed(e);
    }
    ...
    {
        return com.kingdee.eas.custom.independence.client.PermissionSettingTreeEditUI.class.getName();
    }

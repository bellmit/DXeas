...
public class OrganizationRelationShrAdminOrg extends CoreBillEntryBase implements IOrganizationRelationShrAdminOrg
{
    public OrganizationRelationShrAdminOrg()
    {
        super();
        registerInterface(IOrganizationRelationShrAdminOrg.class, this);
    }
    public OrganizationRelationShrAdminOrg(Context ctx)
    {
        super(ctx);
        registerInterface(IOrganizationRelationShrAdminOrg.class, this);
    }
    ...
    private OrganizationRelationShrAdminOrgController getController() throws BOSException
    {
        return (OrganizationRelationShrAdminOrgController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrganizationRelationShrAdminOrgCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

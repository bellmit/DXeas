...
public class SalaryVoucherEntryCmpItem extends CoreBillEntryBase implements ISalaryVoucherEntryCmpItem
{
    public SalaryVoucherEntryCmpItem()
    {
        super();
        registerInterface(ISalaryVoucherEntryCmpItem.class, this);
    }
    public SalaryVoucherEntryCmpItem(Context ctx)
    {
        super(ctx);
        registerInterface(ISalaryVoucherEntryCmpItem.class, this);
    }
    ...
    private SalaryVoucherEntryCmpItemController getController() throws BOSException
    {
        return (SalaryVoucherEntryCmpItemController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherEntryCmpItemCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

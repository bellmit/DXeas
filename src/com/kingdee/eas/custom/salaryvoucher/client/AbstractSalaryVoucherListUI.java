 ...
 * output class name
 */
public abstract class AbstractSalaryVoucherListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSalaryVoucherListUI.class);
     ...
     */
    public AbstractSalaryVoucherListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSalaryVoucherListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.salaryvoucher.app", "SalaryVoucherQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salaryvoucher.app.SalaryVoucherListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSalaryVoucherListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSalaryVoucherListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salaryvoucher.client", "SalaryVoucherListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","name","companyOrg.name","voucherType.name","bizDate","createTime","lastUpdateTime","auditor.number","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","status","PeriodDeviationValue","auditor.name","creator.name","description","AuditTime","entrys.Accounting.name","entrys.scaleScheme.name"};
    }

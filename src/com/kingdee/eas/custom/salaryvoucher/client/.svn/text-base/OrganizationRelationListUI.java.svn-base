 ...
 * output class name
 */
public class OrganizationRelationListUI extends AbstractOrganizationRelationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OrganizationRelationListUI.class);
    
    /**
     * output class constructor
     */
    public OrganizationRelationListUI() throws Exception
    {
        super();
    }

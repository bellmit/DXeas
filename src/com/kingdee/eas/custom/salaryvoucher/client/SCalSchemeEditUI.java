 ...
 * output class name
 */
public class SCalSchemeEditUI extends AbstractSCalSchemeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SCalSchemeEditUI.class);
    
    /**
     * output class constructor
     */
    public SCalSchemeEditUI() throws Exception
    {
        super();
    }
    /**
	...
	public void onLoad() throws Exception {
		...
		contscalSchemeID.setEnabled(false);
	}
	/**

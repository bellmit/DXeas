 ...
 * output class name
 */
public class SCalSchemeListUI extends AbstractSCalSchemeListUI
{
	/**
	 * 更新  薪酬方案
	 */
    @Override
	public void actionGetSCalScheme_actionPerformed(ActionEvent e)
			throws Exception {
		// TODO Auto-generated method stub
    	
        String[] con = getSHRDbConnection();
    	com.kingdee.eas.custom.salaryvoucher.salaryVoucherFacadeFactory.getRemoteInstance().updateSCalScheme(con);
//		super.actionGetSCalScheme_actionPerformed(e);
		refreshList();
	}
	...
	private static final Logger logger = CoreUIObject.getLogger(SCalSchemeListUI.class);
    
    /**
     * output class constructor
     */
    public SCalSchemeListUI() throws Exception
    {
        super();
    }

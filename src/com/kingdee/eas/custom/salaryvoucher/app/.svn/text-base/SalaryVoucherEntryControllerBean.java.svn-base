...
public class SalaryVoucherEntryControllerBean extends AbstractSalaryVoucherEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salaryvoucher.app.SalaryVoucherEntryControllerBean");
}
...
public class OrganizationRelationControllerBean extends AbstractOrganizationRelationControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salaryvoucher.app.OrganizationRelationControllerBean");
}
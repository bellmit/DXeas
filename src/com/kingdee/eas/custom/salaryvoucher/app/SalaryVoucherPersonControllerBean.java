...
public class SalaryVoucherPersonControllerBean extends AbstractSalaryVoucherPersonControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salaryvoucher.app.SalaryVoucherPersonControllerBean");
}
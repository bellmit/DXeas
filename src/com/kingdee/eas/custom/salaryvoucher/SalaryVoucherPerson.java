...
public class SalaryVoucherPerson extends CoreBillEntryBase implements ISalaryVoucherPerson
{
    public SalaryVoucherPerson()
    {
        super();
        registerInterface(ISalaryVoucherPerson.class, this);
    }
    public SalaryVoucherPerson(Context ctx)
    {
        super(ctx);
        registerInterface(ISalaryVoucherPerson.class, this);
    }
    ...
    private SalaryVoucherPersonController getController() throws BOSException
    {
        return (SalaryVoucherPersonController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSalaryVoucherPersonInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherPersonInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherPersonInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherPersonCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherPersonCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSalaryVoucherPersonCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

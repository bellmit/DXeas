 ...
 *
 */
public class TransferOrderBillEditDep {
//
//	// 编辑界面
//	protected TransferOrderBillEditUIPIEx ui;
//	// 界面 对象
//	protected TransferOrderBillInfo editData;
//	
//	
//	
//	/**
...
//		 ui = (TransferOrderBillEditUIPIEx) param.getUI();
//		 editData = (TransferOrderBillInfo) ui.getEditData();
//		 
...
//	    	   }
//	       }else{
//	    	   //this.detailTable.getRow(selectRow).getCell("manufactureDate").setValue(new Date());
//	    	   //this.detailTable.getRow(selectRow).getCell("expirationDate").setValue(new Date()); 
//	    	   //this.detailTable.getRow(selectRow).getCell("checkInforM").setValue("待检");
//	       }
//	 }
//	 /**
//	 * 初始化时添加  计算投料量事件
...
//							int warehousecol = detailTable.getColumnIndex("warehouse");

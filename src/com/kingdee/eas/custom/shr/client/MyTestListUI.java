 ...
 * output class name
 */
public class MyTestListUI extends AbstractMyTestListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MyTestListUI.class);
    
    /**
     * output class constructor
     */
    public MyTestListUI() throws Exception
    {
        super();
    }

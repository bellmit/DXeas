 ...
 * output class name
 */
public class WincosForSHRListUI extends AbstractWincosForSHRListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WincosForSHRListUI.class);
    
    /**
     * output class constructor
     */
    public WincosForSHRListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractWincosForSHRListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWincosForSHRListUI.class);
    /**
     * output class constructor
     */
    public AbstractWincosForSHRListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.shr.app.WincosForSHRListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.shr.client", "WincosForSHRListUI");
    }

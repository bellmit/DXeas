 ...
 * output class name
 */
public class RecordBusChangeListUI extends AbstractRecordBusChangeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RecordBusChangeListUI.class);
    
    /**
     * output class constructor
     */
    public RecordBusChangeListUI() throws Exception
    {
        super();
    }

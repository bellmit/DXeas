 ...
 * output class name
 */
public class WincosForSHREditUI extends AbstractWincosForSHREditUI
{
    private static final Logger logger = CoreUIObject.getLogger(WincosForSHREditUI.class);
    
    /**
     * output class constructor
     */
    public WincosForSHREditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
        super.txtdbPort_actionPerformed(e);
    }

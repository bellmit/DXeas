...
public class ComplainedTypeControllerBean extends AbstractComplainedTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.sale.app.ComplainedTypeControllerBean");
}
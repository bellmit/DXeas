...
public class ComplaintTableControllerBean extends AbstractComplaintTableControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.sale.app.ComplaintTableControllerBean");
}
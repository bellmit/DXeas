 ...
 * output class name
 */
public class ComplaintTableListUI extends AbstractComplaintTableListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ComplaintTableListUI.class);
    
    /**
     * output class constructor
     */
    public ComplaintTableListUI() throws Exception
    {
        super();
    }
	...
	protected boolean initDefaultFilter() {
		...
		filter.getFilterItems().add(new FilterItemInfo("complainedCompany.id",companyID,CompareType.EQUALS));

 ...
 * output class name
 */
public class ComplainedTypeListUI extends AbstractComplainedTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ComplainedTypeListUI.class);
    
    /**
     * output class constructor
     */
    public ComplainedTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.sale.client.ComplainedTypeTreeEditUI.class.getName();
    }

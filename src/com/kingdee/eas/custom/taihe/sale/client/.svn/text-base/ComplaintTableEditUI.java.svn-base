 ...
 * output class name
 */
public class ComplaintTableEditUI extends AbstractComplaintTableEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ComplaintTableEditUI.class);
    
    /**
     * output class constructor
     */
    public ComplaintTableEditUI() throws Exception
    {
        super();
    }
    /**

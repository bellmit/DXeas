 ...
 * output class name
 */
public class VisitBillListUI extends AbstractVisitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(VisitBillListUI.class);
    
    /**
     * output class constructor
     */
    public VisitBillListUI() throws Exception
    {
        super();
    }

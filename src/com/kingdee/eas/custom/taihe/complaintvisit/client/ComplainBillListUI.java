 ...
 * output class name
 */
public class ComplainBillListUI extends AbstractComplainBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ComplainBillListUI.class);
    
    /**
     * output class constructor
     */
    public ComplainBillListUI() throws Exception
    {
        super();
    }

...
public class VisitBillControllerBean extends AbstractVisitBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.complaintvisit.app.VisitBillControllerBean");
}
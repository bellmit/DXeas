...
public class ComplainBillControllerBean extends AbstractComplainBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.complaintvisit.app.ComplainBillControllerBean");
}
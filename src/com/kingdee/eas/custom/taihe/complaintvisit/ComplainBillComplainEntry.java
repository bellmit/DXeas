...
public class ComplainBillComplainEntry extends CoreBillEntryBase implements IComplainBillComplainEntry
{
    public ComplainBillComplainEntry()
    {
        super();
        registerInterface(IComplainBillComplainEntry.class, this);
    }
    public ComplainBillComplainEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IComplainBillComplainEntry.class, this);
    }
    ...
    private ComplainBillComplainEntryController getController() throws BOSException
    {
        return (ComplainBillComplainEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getComplainBillComplainEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getComplainBillComplainEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getComplainBillComplainEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getComplainBillComplainEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getComplainBillComplainEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getComplainBillComplainEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

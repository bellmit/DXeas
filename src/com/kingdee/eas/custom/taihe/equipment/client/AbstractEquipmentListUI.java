 ...
 * output class name
 */
public abstract class AbstractEquipmentListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEquipmentListUI.class);
		...
		public AbstractEquipmentListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.equipment.app.EquipmentListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.equipment.client", "EquipmentListUI");
    }

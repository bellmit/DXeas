 ...
 * output package name
 */
package com.kingdee.eas.custom.taihe.equipment.client;
...
public abstract class AbstractEquipmentEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    protected com.kingdee.eas.custom.taihe.equipment.EquipmentInfo editData = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,prmtdepartment}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 336, 305));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(18, 20, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(18, 68, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(18, 116, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(18, 164, 270, 19));
        this.add(kDLabelContainer4, null);
        contcompany.setBounds(new Rectangle(18, 212, 270, 19));
        this.add(contcompany, null);
        contdepartment.setBounds(new Rectangle(18, 260, 270, 19));
        this.add(contdepartment, null);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.equipment.app.EquipmentEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.taihe.equipment.EquipmentInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.equipment.client", "EquipmentEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.equipment.client.EquipmentEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.equipment.EquipmentFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.taihe.equipment.EquipmentInfo objectValue = new com.kingdee.eas.custom.taihe.equipment.EquipmentInfo();

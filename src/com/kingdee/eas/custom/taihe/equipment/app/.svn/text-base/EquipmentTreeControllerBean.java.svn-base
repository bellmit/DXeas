...
public class EquipmentTreeControllerBean extends AbstractEquipmentTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.equipment.app.EquipmentTreeControllerBean");
}
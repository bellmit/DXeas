...
public class VcWhiteList extends DataBase implements IVcWhiteList
{
    public VcWhiteList()
    {
        super();
        registerInterface(IVcWhiteList.class, this);
    }
    public VcWhiteList(Context ctx)
    {
        super(ctx);
        registerInterface(IVcWhiteList.class, this);
    }
    ...
    private VcWhiteListController getController() throws BOSException
    {
        return (VcWhiteListController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getVcWhiteListInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getVcWhiteListInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVcWhiteListInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVcWhiteListCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVcWhiteListCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVcWhiteListCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

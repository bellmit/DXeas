 ...
 * output class name
 */
public abstract class AbstractVdChannelSettingListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVdChannelSettingListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractVdChannelSettingListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractVdChannelSettingListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.vehicledetection.app.VdChannelSettingListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("inOrOut"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.vehicledetection.client", "VdChannelSettingListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.vehicledetection.client.VdChannelSettingEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.vehicledetection.VdChannelSettingFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.taihe.vehicledetection.VdChannelSettingInfo objectValue = new com.kingdee.eas.custom.taihe.vehicledetection.VdChannelSettingInfo();		
        return objectValue;
    }

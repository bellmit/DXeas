 ...
 * output class name
 */
public class VcWhiteListListUI extends AbstractVcWhiteListListUI
{
    private static final Logger logger = CoreUIObject.getLogger(VcWhiteListListUI.class);
    
    /**
     * output class constructor
     */
    public VcWhiteListListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.vehicledetection.client.VcWhiteListTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class VdChannelSettingListUI extends AbstractVdChannelSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(VdChannelSettingListUI.class);
    
    /**
     * output class constructor
     */
    public VdChannelSettingListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.vehicledetection.client.VdChannelSettingTreeEditUI.class.getName();
    }

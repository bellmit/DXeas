...
public class VcWhiteListTreeControllerBean extends AbstractVcWhiteListTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.vehicledetection.app.VcWhiteListTreeControllerBean");
}
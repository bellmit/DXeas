...
public class VdChannelSettingControllerBean extends AbstractVdChannelSettingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.vehicledetection.app.VdChannelSettingControllerBean");
}
...
public class VdChannelSettingTreeControllerBean extends AbstractVdChannelSettingTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.vehicledetection.app.VdChannelSettingTreeControllerBean");
}
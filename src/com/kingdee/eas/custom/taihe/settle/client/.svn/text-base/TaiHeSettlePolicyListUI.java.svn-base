 ...
 * output class name
 */
public class TaiHeSettlePolicyListUI extends AbstractTaiHeSettlePolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TaiHeSettlePolicyListUI.class);
    
    /**
     * output class constructor
     */
    public TaiHeSettlePolicyListUI() throws Exception
    {
        super();
    }

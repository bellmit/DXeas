 ...
 * output class name
 */
public class ChickenDailyPriceEditUI extends AbstractChickenDailyPriceEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChickenDailyPriceEditUI.class);
    
    /**
     * output class constructor
     */
    public ChickenDailyPriceEditUI() throws Exception
    {
        super();
    }
    /**

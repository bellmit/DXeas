 ...
 * output class name
 */
public class StdCarassRateEditUI extends AbstractStdCarassRateEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(StdCarassRateEditUI.class);
    
    /**
     * output class constructor
     */
    public StdCarassRateEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        StdCarassRateEntryInfo entryInfo=new StdCarassRateEntryInfo();
        entryInfo.setLow(BigDecimal.ZERO);
        entryInfo.setTop(new BigDecimal(99));

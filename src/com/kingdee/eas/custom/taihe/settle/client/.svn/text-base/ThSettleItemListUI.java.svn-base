 ...
 * output class name
 */
public class ThSettleItemListUI extends AbstractThSettleItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ThSettleItemListUI.class);
    
    /**
     * output class constructor
     */
    public ThSettleItemListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class CarcassDisrateListUI extends AbstractCarcassDisrateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarcassDisrateListUI.class);
    
    /**
     * output class constructor
     */
    public CarcassDisrateListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.settle.client.CarcassDisrateTreeEditUI.class.getName();
    }

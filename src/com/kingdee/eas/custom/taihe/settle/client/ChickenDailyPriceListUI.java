 ...
 * output class name
 */
public class ChickenDailyPriceListUI extends AbstractChickenDailyPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChickenDailyPriceListUI.class);
    
    /**
     * output class constructor
     */
    public ChickenDailyPriceListUI() throws Exception
    {
        super();
    }

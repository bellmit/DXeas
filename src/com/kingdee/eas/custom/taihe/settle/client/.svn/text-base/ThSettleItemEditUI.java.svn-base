 ...
 * output class name
 */
public class ThSettleItemEditUI extends AbstractThSettleItemEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ThSettleItemEditUI.class);
    
    /**
     * output class constructor
     */
    public ThSettleItemEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public class StdCarassRateListUI extends AbstractStdCarassRateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StdCarassRateListUI.class);
    
    /**
     * output class constructor
     */
    public StdCarassRateListUI() throws Exception
    {
        super();
    }

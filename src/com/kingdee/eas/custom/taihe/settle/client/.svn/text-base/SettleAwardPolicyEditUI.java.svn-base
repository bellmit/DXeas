 ...
 * output class name
 */
public class SettleAwardPolicyEditUI extends AbstractSettleAwardPolicyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleAwardPolicyEditUI.class);
    
    /**
     * output class constructor
     */
    public SettleAwardPolicyEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public abstract class AbstractChickenDailyPriceEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractChickenDailyPriceEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsmallChickPrice;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtsmallChickPrice;
    protected com.kingdee.eas.custom.taihe.settle.ChickenDailyPriceInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractChickenDailyPriceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractChickenDailyPriceEditUI.class.getName());
        ...
        this.contsmallChickPrice = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtsmallChickPrice = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contsmallChickPrice.setName("contsmallChickPrice");
        ...
        this.txtsmallChickPrice.setName("txtsmallChickPrice");
        // CoreUI		
        ...
        this.contaddPrice.setBoundLabelLength(100);		
        this.contaddPrice.setBoundLabelUnderline(true);		
        this.contaddPrice.setVisible(true);
        // contsmallChickPrice		
        this.contsmallChickPrice.setBoundLabelText(resHelper.getString("contsmallChickPrice.boundLabelText"));		
        this.contsmallChickPrice.setBoundLabelLength(100);		
        this.contsmallChickPrice.setBoundLabelUnderline(true);		
        this.contsmallChickPrice.setVisible(true);
        // pkunEffectDate		
        ...
        // txtsmallChickPrice		
        this.txtsmallChickPrice.setVisible(true);		
        this.txtsmallChickPrice.setHorizontalAlignment(2);		
        this.txtsmallChickPrice.setDataType(1);		
        this.txtsmallChickPrice.setSupportedEmpty(true);		
        this.txtsmallChickPrice.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtsmallChickPrice.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtsmallChickPrice.setPrecision(4);		
        this.txtsmallChickPrice.setRequired(true);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,pkeffectDate,pkunEffectDate,txtprice,txtaddPrice,txtsmallChickPrice}));
    ...
    public void initUIContentLayout()
    {
        ...
        contprice.setBounds(new Rectangle(20, 64, 270, 19));
        kDPanel1.add(contprice, null);
        contaddPrice.setBounds(new Rectangle(332, 61, 270, 19));
        kDPanel1.add(contaddPrice, null);
        contsmallChickPrice.setBounds(new Rectangle(20, 99, 270, 19));
        kDPanel1.add(contsmallChickPrice, null);
        //contunEffectDate
        ...
        //contsmallChickPrice
        contsmallChickPrice.setBoundEditor(txtsmallChickPrice);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("smallChickPrice", java.math.BigDecimal.class, this.txtsmallChickPrice, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.settle.app.ChickenDailyPriceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.taihe.settle.ChickenDailyPriceInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("smallChickPrice", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("smallChickPrice"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.settle.client", "ChickenDailyPriceEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.settle.client.ChickenDailyPriceEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.settle.ChickenDailyPriceFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.taihe.settle.ChickenDailyPriceInfo objectValue = new com.kingdee.eas.custom.taihe.settle.ChickenDailyPriceInfo();
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtprice.getValue())) {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtaddPrice.getValue())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"加价"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtsmallChickPrice.getValue())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"小鸡价格"});
		}

 ...
 * output class name
 */
public class SettleAwardPolicyListUI extends AbstractSettleAwardPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleAwardPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public SettleAwardPolicyListUI() throws Exception
    {
        super();
    }

...
public class SettleAwardPolicyAwardEntry extends CoreBillEntryBase implements ISettleAwardPolicyAwardEntry
{
    public SettleAwardPolicyAwardEntry()
    {
        super();
        registerInterface(ISettleAwardPolicyAwardEntry.class, this);
    }
    public SettleAwardPolicyAwardEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISettleAwardPolicyAwardEntry.class, this);
    }
    ...
    private SettleAwardPolicyAwardEntryController getController() throws BOSException
    {
        return (SettleAwardPolicyAwardEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleAwardPolicyAwardEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

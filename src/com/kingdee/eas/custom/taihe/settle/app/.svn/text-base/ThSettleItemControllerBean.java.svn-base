...
public class ThSettleItemControllerBean extends AbstractThSettleItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.settle.app.ThSettleItemControllerBean");
}
...
public class CarcassDisrateTreeControllerBean extends AbstractCarcassDisrateTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.settle.app.CarcassDisrateTreeControllerBean");
}
...
public class ChickenDailyPriceControllerBean extends AbstractChickenDailyPriceControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.settle.app.ChickenDailyPriceControllerBean");
}
...
public class SettleBillEntryControllerBean extends AbstractSettleBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.settle.app.SettleBillEntryControllerBean");
}
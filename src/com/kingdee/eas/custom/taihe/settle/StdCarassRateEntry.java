...
public class StdCarassRateEntry extends CoreBillEntryBase implements IStdCarassRateEntry
{
    public StdCarassRateEntry()
    {
        super();
        registerInterface(IStdCarassRateEntry.class, this);
    }
    public StdCarassRateEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStdCarassRateEntry.class, this);
    }
    ...
    private StdCarassRateEntryController getController() throws BOSException
    {
        return (StdCarassRateEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStdCarassRateEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStdCarassRateEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStdCarassRateEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStdCarassRateEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStdCarassRateEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStdCarassRateEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

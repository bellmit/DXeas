 ...
 * output class name
 */
public abstract class AbstractBatchContractListUIHandler extends com.kingdee.eas.custom.wlhllicensemanager.app.WlhlCoreBillListUIHandler

{
	...
	public void handleActionDistribution(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionDistribution(request,response,context);
	}
	protected void _handleActionDistribution(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	public void handleActionBackClose(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionBackClose(request,response,context);
	}
	protected void _handleActionBackClose(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

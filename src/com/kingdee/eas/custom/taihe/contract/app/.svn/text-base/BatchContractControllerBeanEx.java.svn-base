...
public class BatchContractControllerBeanEx extends com.kingdee.eas.custom.taihe.contract.app.BatchContractControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.contract.app.BatchContractControllerBeanEx");
    protected void _distribution(Context ctx, IObjectValue model)throws BOSException
    {
	     super._distribution(ctx, model);
    }
}				

...
public class BailAmountControllerBeanEx extends com.kingdee.eas.custom.taihe.contract.app.BailAmountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.contract.app.BailAmountControllerBeanEx");

...
import com.kingdee.eas.custom.taihe.contract.BatchContractEntryCollection;
import com.kingdee.eas.framework.CoreBillEntryBaseCollection;
import com.kingdee.bos.metadata.entity.EntityViewInfo;
import com.kingdee.eas.framework.app.CoreBillEntryBaseControllerBean;
import com.kingdee.eas.framework.CoreBaseCollection;
import com.kingdee.eas.framework.CoreBaseInfo;
import com.kingdee.eas.custom.taihe.contract.BatchContractEntryInfo;
...
public abstract class AbstractBatchContractEntryControllerBean extends CoreBillEntryBaseControllerBean implements BatchContractEntryController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c372b023-96d7-4e92-9878-df9a9a28b916"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("1f8f793d-27bf-488c-bb0b-db9c7131f827"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2f7ed8a8-8841-453a-9d0f-0d9e7e97a24c"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("b174ae73-3fa2-48a1-a8a3-260ef660e4f3"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("d98a9220-baa7-4b17-80d0-db723f53aa90"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("07cfc3b4-c366-482e-a935-2340577f10ae"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public IObjectPK addnew(Context ctx, BatchContractEntryInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("69adeb45-5e8d-402d-96da-113d6300bb5b"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public void addnew(Context ctx, IObjectPK pk, BatchContractEntryInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("5bc71960-483f-452b-8797-d4f16be10cc7"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void update(Context ctx, IObjectPK pk, BatchContractEntryInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("672b276c-3823-411f-8f75-e729e6732f48"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updatePartial(Context ctx, BatchContractEntryInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9f716f1f-6f92-4248-9e95-895ea81b870f"), new Object[]{ctx, model, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updateBigObject(Context ctx, IObjectPK pk, BatchContractEntryInfo model) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("60869f93-aeb3-4551-8f34-e5f4094fdb49"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2cefd58a-546b-4961-ae64-dee68c5ee1f7"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, pk);
            }
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0d0625c3-34ae-4480-aadc-0f8d80ffa0c3"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3709238f-edd1-4de7-8257-f0c87b5f06b8"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fbe442ca-32e8-465d-97df-ec7989549b83"), new Object[]{ctx, filter, sorter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("168572ab-020e-49d9-8fcc-1d455c54514e"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("436bb16d-655f-4f6b-8532-5a9e140a9bad"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("d79b08d4-7f63-45e4-b9cf-a1a039c3a99b"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3f001d05-cc2f-4d03-a48f-2ade16f25676"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("e23227f7-174b-4205-bd1a-570c453da292"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("06210226-c9c6-4e3a-bac8-f63956badacc"), new Object[]{ctx, arrayPK});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, arrayPK);
            }

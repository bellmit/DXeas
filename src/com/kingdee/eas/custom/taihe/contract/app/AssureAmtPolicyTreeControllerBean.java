...
public class AssureAmtPolicyTreeControllerBean extends AbstractAssureAmtPolicyTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.contract.app.AssureAmtPolicyTreeControllerBean");
}
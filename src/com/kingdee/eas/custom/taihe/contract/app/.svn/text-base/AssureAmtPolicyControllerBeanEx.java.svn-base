...
public class AssureAmtPolicyControllerBeanEx extends com.kingdee.eas.custom.taihe.contract.app.AssureAmtPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.contract.app.AssureAmtPolicyControllerBeanEx");

...
public interface IBatchContractEntry extends ICoreBillEntryBase
{
    ...
    public IObjectPK addnew(BatchContractEntryInfo model) throws BOSException, EASBizException;
    public void addnew(IObjectPK pk, BatchContractEntryInfo model) throws BOSException, EASBizException;
    public void update(IObjectPK pk, BatchContractEntryInfo model) throws BOSException, EASBizException;
    public void updatePartial(BatchContractEntryInfo model, SelectorItemCollection selector) throws BOSException, EASBizException;
    public void updateBigObject(IObjectPK pk, BatchContractEntryInfo model) throws BOSException;

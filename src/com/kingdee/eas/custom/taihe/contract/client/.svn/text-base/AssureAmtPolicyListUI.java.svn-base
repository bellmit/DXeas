 ...
 * output class name
 */
public class AssureAmtPolicyListUI extends AbstractAssureAmtPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AssureAmtPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public AssureAmtPolicyListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.contract.client.AssureAmtPolicyTreeEditUI.class.getName();
    }

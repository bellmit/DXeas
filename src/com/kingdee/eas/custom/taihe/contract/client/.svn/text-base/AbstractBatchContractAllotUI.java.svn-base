 ...
 * output class name
 */
public abstract class AbstractBatchContractAllotUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBatchContractAllotUI.class);
     ...
     */
    public AbstractBatchContractAllotUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBatchContractAllotUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnOK.setBounds(new Rectangle(43, 17, 73, 21));
        this.add(btnOK, null);
        btnCancel.setBounds(new Rectangle(181, 17, 73, 21));
        this.add(btnCancel, null);
        kDTable1.setBounds(new Rectangle(12, 79, 272, 208));
        this.add(kDTable1, null);
        btnAdd.setBounds(new Rectangle(190, 56, 45, 19));
        this.add(btnAdd, null);
        btnDel.setBounds(new Rectangle(241, 56, 39, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.contract.app.BatchContractAllotUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.contract.client", "BatchContractAllotUI");
    }

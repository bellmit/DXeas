 ...
 * output class name
 */
public class PreBillOfContractListUI extends AbstractPreBillOfContractListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PreBillOfContractListUI.class);
    
    /**
     * output class constructor
     */
    public PreBillOfContractListUI() throws Exception
    {
        super();
    }
    /* (non-Javadoc)

 ...
 * output class name
 */
public class BailAmountListUI extends AbstractBailAmountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BailAmountListUI.class);
    
    /**
     * output class constructor
     */
    public BailAmountListUI() throws Exception
    {
        super();
    }

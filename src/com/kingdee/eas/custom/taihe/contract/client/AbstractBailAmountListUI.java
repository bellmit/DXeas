 ...
 * output class name
 */
public abstract class AbstractBailAmountListUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBailAmountListUI.class);
     ...
     */
    public AbstractBailAmountListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBailAmountListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.taihe.contract.app", "BailAmountQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.contract.app.BailAmountListUIHandler";
	}
...
com.kingdee.eas.custom.taihe.contract.BailAmountInfo editData = (com.kingdee.eas.custom.taihe.contract.BailAmountInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.custom.taihe.contract.BailAmountFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBailAmountListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBailAmountListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.contract.client", "BailAmountListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","payTime","payAmount","partyB.name","auditTime","auditOpinion","billStatus","payType","beginMoney","moneyTypes","initialization","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","company.name"};
    }

 ...
 * output class name
 */
public class CheckRecordListUI extends AbstractCheckRecordListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CheckRecordListUI.class);
    
    /**
     * output class constructor
     */
    public CheckRecordListUI() throws Exception
    {
        super();
    }

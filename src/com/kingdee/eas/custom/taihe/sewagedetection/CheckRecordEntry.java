...
public class CheckRecordEntry extends CoreBillEntryBase implements ICheckRecordEntry
{
    public CheckRecordEntry()
    {
        super();
        registerInterface(ICheckRecordEntry.class, this);
    }
    public CheckRecordEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICheckRecordEntry.class, this);
    }
    ...
    private CheckRecordEntryController getController() throws BOSException
    {
        return (CheckRecordEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCheckRecordEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckRecordEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckRecordEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckRecordEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckRecordEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckRecordEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

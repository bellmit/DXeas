...
//
//public class CheckRecordControllerBeanEx extends com.kingdee.eas.custom.taihe.sewagedetection.app.CheckRecordControllerBean
//{
//    private static Logger logger =
//        Logger.getLogger("com.kingdee.eas.custom.taihe.sewagedetection.app.CheckRecordControllerBeanEx");
//    protected void _modileSee(Context ctx, IObjectValue model)throws BOSException
//    {
//	     super._modileSee(ctx, model);
//    }
//}				

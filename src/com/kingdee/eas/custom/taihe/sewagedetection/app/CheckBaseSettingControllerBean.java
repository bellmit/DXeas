...
public class CheckBaseSettingControllerBean extends AbstractCheckBaseSettingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.sewagedetection.app.CheckBaseSettingControllerBean");
}
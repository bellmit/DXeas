 ...
 * output class name
 */
public class TransportCoeListUI extends AbstractTransportCoeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransportCoeListUI.class);
    
    /**
     * output class constructor
     */
    public TransportCoeListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class WgtDisRateListUI extends AbstractWgtDisRateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WgtDisRateListUI.class);
    
    /**
     * output class constructor
     */
    public WgtDisRateListUI() throws Exception
    {
        super();
    }

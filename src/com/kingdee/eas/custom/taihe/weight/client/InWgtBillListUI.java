 ...
 * output class name
 */
public class InWgtBillListUI extends AbstractInWgtBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InWgtBillListUI.class);
    
    /**
     * output class constructor
     */
    public InWgtBillListUI() throws Exception
    {
        super();
    }

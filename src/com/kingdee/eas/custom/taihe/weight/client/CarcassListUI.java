 ...
 * output class name
 */
public class CarcassListUI extends AbstractCarcassListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarcassListUI.class);
    
    /**
     * output class constructor
     */
    public CarcassListUI() throws Exception
    {
        super();
    }

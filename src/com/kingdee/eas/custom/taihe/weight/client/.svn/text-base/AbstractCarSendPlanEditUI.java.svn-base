 ...
 * output class name
 */
public abstract class AbstractCarSendPlanEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCarSendPlanEditUI.class);
    protected com.kingdee.eas.custom.wlhllicensemanager.WlhlBillBaseInfo editData = null;
    protected com.kingdee.eas.custom.taihe.weight.CarSendPlanInfo entityWlhlTemplateBill = null;
    /**
     * output class constructor
     */
    public AbstractCarSendPlanEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCarSendPlanEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkauditTime,billStatus}));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.weight.app.CarSendPlanEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.weight.client", "CarSendPlanEditUI");
    }

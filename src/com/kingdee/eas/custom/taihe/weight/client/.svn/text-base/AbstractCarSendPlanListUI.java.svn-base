 ...
 * output class name
 */
public abstract class AbstractCarSendPlanListUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCarSendPlanListUI.class);
     ...
     */
    public AbstractCarSendPlanListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCarSendPlanListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.taihe.weight.app", "CarSendPlanQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.weight.app.CarSendPlanListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCarSendPlanListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCarSendPlanListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.weight.client", "CarSendPlanListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.taihe.weight.client.CarSendPlanEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.taihe.weight.CarSendPlanFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.taihe.weight.CarSendPlanInfo objectValue = new com.kingdee.eas.custom.taihe.weight.CarSendPlanInfo();		
        return objectValue;
    }
	...
	protected String getTDFileName() {
    	return "/bim/custom/taihe/weight/CarSendPlan";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.taihe.weight.app.CarSendPlanQuery");
	}

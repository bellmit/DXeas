 ...
 * output class name
 */
public class CarSendPlanListUI extends AbstractCarSendPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarSendPlanListUI.class);
    
    /**
     * output class constructor
     */
    public CarSendPlanListUI() throws Exception
    {
        super();
    }

...
public class WgtItemControllerBean extends AbstractWgtItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.WgtItemControllerBean");
}
...
public class WgtDisRateControllerBean extends AbstractWgtDisRateControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.WgtDisRateControllerBean");
}
...
public class CarTypeControllerBean extends AbstractCarTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.CarTypeControllerBean");
}
...
public class CarcassControllerBean extends AbstractCarcassControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.CarcassControllerBean");
}
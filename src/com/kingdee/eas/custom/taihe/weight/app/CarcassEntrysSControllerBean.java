...
public class CarcassEntrysSControllerBean extends AbstractCarcassEntrysSControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.CarcassEntrysSControllerBean");
}
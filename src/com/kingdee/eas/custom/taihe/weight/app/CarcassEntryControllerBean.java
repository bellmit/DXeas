...
public class CarcassEntryControllerBean extends AbstractCarcassEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.CarcassEntryControllerBean");
}
...
public class InWgtBillControllerBean extends AbstractInWgtBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.weight.app.InWgtBillControllerBean");
}
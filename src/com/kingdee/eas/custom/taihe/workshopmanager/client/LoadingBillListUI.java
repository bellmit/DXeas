 ...
 * output class name
 */
public class LoadingBillListUI extends AbstractLoadingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LoadingBillListUI.class);
    
    /**
     * output class constructor
     */
    public LoadingBillListUI() throws Exception
    {
        super();
    }
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "Entry.qty","Entry.price","Entry.amount","Entry.taxRate","Entry.taxAmount","Entry.taxPrice","Entry.allAmount","Entry.baseQty","Entry.assitQty","Entry.policyPrice","Entry.premiumPrice"};
    }
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("Entry.qty");
    	sumField.add("Entry.price");
    	sumField.add("Entry.amount");
    	sumField.add("Entry.taxRate");
    	sumField.add("Entry.taxAmount");
    	sumField.add("Entry.taxPrice");
    	sumField.add("Entry.allAmount");
    	sumField.add("Entry.baseQty");
    	sumField.add("Entry.assitQty");
    	sumField.add("Entry.policyPrice");
    	sumField.add("Entry.premiumPrice");

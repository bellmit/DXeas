 ...
 * output class name
 */
public class WorkshopDeafultSettingListUI extends AbstractWorkshopDeafultSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkshopDeafultSettingListUI.class);
    
    /**
     * output class constructor
     */
    public WorkshopDeafultSettingListUI() throws Exception
    {
        super();
    }

...
public class LoadingBillControllerBean extends AbstractLoadingBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.workshopmanager.app.LoadingBillControllerBean");

	@Override
	protected void _mobifyAddNew(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub
		
	}

	@Override
	protected void _mobileQuery(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub

...
public abstract class AbstractReturnBillControllerBean extends WlhlBillBaseControllerBean implements ReturnBillController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fddd4a18-40bd-4654-8f4f-bf40d524a010"), new Object[]{ctx});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("ef753771-c8dc-4fa2-8a69-c83905e89aa9"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("b7117390-0a81-46ff-b553-180c33da164b"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("498b9d23-559c-4207-af67-157eded7d248"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fedcb4a3-cbe6-4ccf-9454-df444423035b"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2ed0a7a3-8b14-48b5-8d0a-9fa1dea2af5d"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
    	return (WlhlBillBaseCollection)(getReturnBillCollection(ctx).cast(WlhlBillBaseCollection.class));
    }
    public WlhlBillBaseCollection getWlhlBillBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (WlhlBillBaseCollection)(getReturnBillCollection(ctx, view).cast(WlhlBillBaseCollection.class));
    }
    public WlhlBillBaseCollection getWlhlBillBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (WlhlBillBaseCollection)(getReturnBillCollection(ctx, oql).cast(WlhlBillBaseCollection.class));
    }

...
public class TaiheBaseSettingControllerBean extends AbstractTaiheBaseSettingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.taihe.basesetting.app.TaiheBaseSettingControllerBean");
}
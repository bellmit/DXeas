 ...
 * output class name
 */
public abstract class AbstractTaiheBaseSettingEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaiheBaseSettingEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcompany;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contstdOutDays;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfeedingType;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcompany;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtstdOutDays;
    protected com.kingdee.bos.ctrl.swing.KDComboBox feedingType;
    protected com.kingdee.eas.custom.taihe.basesetting.TaiheBaseSettingInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTaiheBaseSettingEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaiheBaseSettingEditUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        this.contcompany = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contstdOutDays = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contfeedingType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtcompany = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtstdOutDays = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.feedingType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.contcompany.setName("contcompany");
        this.contstdOutDays.setName("contstdOutDays");
        this.contfeedingType.setName("contfeedingType");
        this.prmtcompany.setName("prmtcompany");
        this.txtstdOutDays.setName("txtstdOutDays");
        ...
        // contstdOutDays		
        this.contstdOutDays.setBoundLabelText(resHelper.getString("contstdOutDays.boundLabelText"));		
        this.contstdOutDays.setBoundLabelLength(100);		
        this.contstdOutDays.setBoundLabelUnderline(true);		
        this.contstdOutDays.setVisible(true);
        // contfeedingType		
        ...
        // txtstdOutDays		
        this.txtstdOutDays.setVisible(true);		
        this.txtstdOutDays.setHorizontalAlignment(2);		
        this.txtstdOutDays.setDataType(0);		
        this.txtstdOutDays.setSupportedEmpty(true);		
        this.txtstdOutDays.setRequired(false);
        // feedingType		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,txtstdOutDays,feedingType}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 605, 313));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(748, 42, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(748, 79, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(748, 113, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(748, 147, 270, 19));
        this.add(kDLabelContainer4, null);
        contapprover.setBounds(new Rectangle(307, 223, 270, 19));
        this.add(contapprover, null);
        contapproveTime.setBounds(new Rectangle(307, 260, 270, 19));
        this.add(contapproveTime, null);
        contbaseStatus.setBounds(new Rectangle(310, 30, 270, 19));
        this.add(contbaseStatus, null);
        contcreator.setBounds(new Rectangle(16, 260, 270, 19));
        this.add(contcreator, null);
        contcreateTime.setBounds(new Rectangle(16, 223, 270, 19));
        this.add(contcreateTime, null);
        contcompany.setBounds(new Rectangle(16, 31, 270, 19));
        this.add(contcompany, null);
        contstdOutDays.setBounds(new Rectangle(16, 68, 270, 19));
        this.add(contstdOutDays, null);
        contfeedingType.setBounds(new Rectangle(310, 68, 270, 19));
        this.add(contfeedingType, null);
        //kDLabelContainer1
        ...
        //contstdOutDays
        contstdOutDays.setBoundEditor(txtstdOutDays);
        //contfeedingType
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("stdOutDays", int.class, this.txtstdOutDays, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.taihe.basesetting.app.TaiheBaseSettingEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.taihe.basesetting.TaiheBaseSettingInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("stdOutDays", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.taihe.basesetting.client", "TaiheBaseSettingEditUI");
    }

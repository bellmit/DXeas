 ...
 * output class name
 */
public class KanbanUserAuthorityListUI extends AbstractKanbanUserAuthorityListUI
{
    private static final Logger logger = CoreUIObject.getLogger(KanbanUserAuthorityListUI.class);
    
    /**
     * output class constructor
     */
    public KanbanUserAuthorityListUI() throws Exception
    {
        super();
    }

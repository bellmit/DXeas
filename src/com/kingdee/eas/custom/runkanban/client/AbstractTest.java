 ...
 * output class name
 */
public abstract class AbstractTest extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTest.class);
    protected ResourceBundleHelper resHelper = null;
    protected com.kingdee.bos.ctrl.swing.KDToolBar Test_toolbar;
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTest.class.getName());
        ...
        this.setName("Test");
        this.toolBar.setName("Test_toolbar");
        this.menuBar.setName("Test_menubar");
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDButton1.setBounds(new Rectangle(156, 74, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.runkanban.app.TestHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.runkanban.client", "Test");
    }

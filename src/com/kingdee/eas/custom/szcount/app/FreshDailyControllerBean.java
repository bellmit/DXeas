...
public class FreshDailyControllerBean extends AbstractFreshDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.FreshDailyControllerBean");

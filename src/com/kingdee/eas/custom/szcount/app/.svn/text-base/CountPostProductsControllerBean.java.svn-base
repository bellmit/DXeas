...
public class CountPostProductsControllerBean extends AbstractCountPostProductsControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.CountPostProductsControllerBean");
}
...
public class SzSemiProductControllerBeanEx extends com.kingdee.eas.custom.szcount.app.SzSemiProductControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.SzSemiProductControllerBeanEx");

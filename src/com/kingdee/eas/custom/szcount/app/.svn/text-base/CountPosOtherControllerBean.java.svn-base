...
public class CountPosOtherControllerBean extends AbstractCountPosOtherControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.CountPosOtherControllerBean");
}
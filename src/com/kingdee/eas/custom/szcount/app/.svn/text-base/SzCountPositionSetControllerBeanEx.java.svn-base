...
public class SzCountPositionSetControllerBeanEx extends com.kingdee.eas.custom.szcount.app.SzCountPositionSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.SzCountPositionSetControllerBeanEx");
    protected void _importforEx(Context ctx, IObjectValue model)throws BOSException
    {
	     super._importforEx(ctx, model);
    }
}				

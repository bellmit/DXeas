...
public class ChickenBasicDataControllerBean extends AbstractChickenBasicDataControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.ChickenBasicDataControllerBean");
}
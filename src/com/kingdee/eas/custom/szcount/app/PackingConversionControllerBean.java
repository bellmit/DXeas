...
public class PackingConversionControllerBean extends AbstractPackingConversionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.szcount.app.PackingConversionControllerBean");
}
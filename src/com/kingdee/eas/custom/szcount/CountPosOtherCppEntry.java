...
public class CountPosOtherCppEntry extends CoreBillEntryBase implements ICountPosOtherCppEntry
{
    public CountPosOtherCppEntry()
    {
        super();
        registerInterface(ICountPosOtherCppEntry.class, this);
    }
    public CountPosOtherCppEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICountPosOtherCppEntry.class, this);
    }
    ...
    private CountPosOtherCppEntryController getController() throws BOSException
    {
        return (CountPosOtherCppEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCountPosOtherCppEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

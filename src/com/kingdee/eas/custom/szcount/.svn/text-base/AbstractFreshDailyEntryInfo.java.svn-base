...
public class AbstractFreshDailyEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractFreshDailyEntryInfo()
    {
        this("id");
    }
    protected AbstractFreshDailyEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**

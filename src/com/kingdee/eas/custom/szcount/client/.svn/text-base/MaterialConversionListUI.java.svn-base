 ...
 * output class name
 */
public class MaterialConversionListUI extends AbstractMaterialConversionListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialConversionListUI.class);
    
    /**
     * output class constructor
     */
    public MaterialConversionListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.szcount.client.MaterialConversionTreeEditUI.class.getName();
    }

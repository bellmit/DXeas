 ...
 * output class name
 */
public class PackingConversionListUI extends AbstractPackingConversionListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PackingConversionListUI.class);
    
    /**
     * output class constructor
     */
    public PackingConversionListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractFreshBergamotCountMobileUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFreshBergamotCountMobileUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabel materialPackage;
    protected com.kingdee.bos.ctrl.swing.KDTextField materialsPackage;
     ...
     */
    public AbstractFreshBergamotCountMobileUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFreshBergamotCountMobileUI.class.getName());
        ...
        this.materialPackage = new com.kingdee.bos.ctrl.swing.KDLabel();
        this.materialsPackage = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.materialPackage.setName("materialPackage");
        this.materialsPackage.setName("materialsPackage");
        ...
        this.HouseName.setVisible(false);
        // strokeCounterName		
        ...
        // materialPackage		
        this.materialPackage.setText(resHelper.getString("materialPackage.text"));		
        this.materialPackage.setForeground(new java.awt.Color(255,128,128));		
        this.materialPackage.setFont(resHelper.getFont("materialPackage.font"));
        // materialsPackage		
        this.materialsPackage.setFont(resHelper.getFont("materialsPackage.font"));		
        this.materialsPackage.setEnabled(false);
        this.materialsPackage.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    materialsPackage_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
    ...
    public void initUIContentLayout()
    {
        ...
        HouseName.setBounds(new Rectangle(603, 38, 189, 20));
        this.add(HouseName, new KDLayout.Constraints(603, 38, 189, 20, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        strokeCounterName.setBounds(new Rectangle(536, 169, 68, 19));
        this.add(strokeCounterName, new KDLayout.Constraints(536, 169, 68, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        strokeCounters.setBounds(new Rectangle(604, 169, 140, 20));
        this.add(strokeCounters, new KDLayout.Constraints(604, 169, 140, 20, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabel4.setBounds(new Rectangle(554, 38, 49, 19));
        this.add(kDLabel4, new KDLayout.Constraints(554, 38, 49, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        weight.setBounds(new Rectangle(96, 56, 181, 30));
        kDPanel1.add(weight, new KDLayout.Constraints(96, 56, 181, 30, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        measureType.setBounds(new Rectangle(51, 121, 168, 41));
        kDPanel1.add(measureType, new KDLayout.Constraints(51, 121, 168, 41, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        materialPackage.setBounds(new Rectangle(293, 51, 58, 40));
        kDPanel1.add(materialPackage, new KDLayout.Constraints(293, 51, 58, 40, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        materialsPackage.setBounds(new Rectangle(339, 56, 74, 30));
        kDPanel1.add(materialsPackage, new KDLayout.Constraints(339, 56, 74, 30, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDTabbedPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.szcount.app.FreshBergamotCountMobileUIHandler";
	}
    ...
    /**
     * output materialsPackage_actionPerformed method
     */
    protected void materialsPackage_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionQY extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "ActionQY", "actionQY_actionPerformed", e);
        }
    }
    ...
    protected class ActionHY extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "ActionHY", "actionHY_actionPerformed", e);
        }
    }
    ...
    protected class ActionCheck extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "ActionCheck", "actionCheck_actionPerformed", e);
        }
    }
    ...
    protected class actionxlselect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "actionxlselect", "actionxlselect_actionPerformed", e);
        }
    }
    ...
    protected class actiontlselect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "actiontlselect", "actiontlselect_actionPerformed", e);
        }
    }
    ...
    protected class actionclselect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "actionclselect", "actionclselect_actionPerformed", e);
        }
    }
    ...
    protected class actionjjlselect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "actionjjlselect", "actionjjlselect_actionPerformed", e);
        }
    }
    ...
    protected class actionqtselect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreshBergamotCountMobileUI.this, "actionqtselect", "actionqtselect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.szcount.client", "FreshBergamotCountMobileUI");
    }

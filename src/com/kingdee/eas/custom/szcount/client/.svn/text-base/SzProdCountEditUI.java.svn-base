 ...
 * output class name
 */
public class SzProdCountEditUI extends AbstractSzProdCountEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SzProdCountEditUI.class);
    
    /**
     * output class constructor
     */
    public SzProdCountEditUI() throws Exception
    {
        super();
    }
    /**

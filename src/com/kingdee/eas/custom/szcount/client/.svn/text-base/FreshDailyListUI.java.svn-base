 ...
 * output class name
 */
public class FreshDailyListUI extends AbstractFreshDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FreshDailyListUI.class);
    
    /**
     * output class constructor
     */
    public FreshDailyListUI() throws Exception
    {
        super();
    }

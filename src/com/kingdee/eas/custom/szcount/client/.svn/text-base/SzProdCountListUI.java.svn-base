 ...
 * output class name
 */
public class SzProdCountListUI extends AbstractSzProdCountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SzProdCountListUI.class);
    
    /**
     * output class constructor
     */
    public SzProdCountListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class SzCountPositionSetListUI extends AbstractSzCountPositionSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SzCountPositionSetListUI.class);
    
    /**
     * output class constructor
     */
    public SzCountPositionSetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.szcount.client.SzCountPositionSetTreeEditUI.class.getName();
    }

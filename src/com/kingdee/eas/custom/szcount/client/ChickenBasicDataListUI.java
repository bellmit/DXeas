 ...
 * output class name
 */
public class ChickenBasicDataListUI extends AbstractChickenBasicDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChickenBasicDataListUI.class);
    
    /**
     * output class constructor
     */
    public ChickenBasicDataListUI() throws Exception
    {
        super();
    }

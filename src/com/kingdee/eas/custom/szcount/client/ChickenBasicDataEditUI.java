 ...
 * output class name
 */
public class ChickenBasicDataEditUI extends AbstractChickenBasicDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChickenBasicDataEditUI.class);
    
    /**
     * output class constructor
     */
    public ChickenBasicDataEditUI() throws Exception
    {
        super();
    }
    /**

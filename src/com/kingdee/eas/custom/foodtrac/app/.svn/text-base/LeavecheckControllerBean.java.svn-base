...
public class LeavecheckControllerBean extends AbstractLeavecheckControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.foodtrac.app.LeavecheckControllerBean");
}
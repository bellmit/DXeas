...
public class RawmaterialinfoPicentry extends CoreBillEntryBase implements IRawmaterialinfoPicentry
{
    public RawmaterialinfoPicentry()
    {
        super();
        registerInterface(IRawmaterialinfoPicentry.class, this);
    }
    public RawmaterialinfoPicentry(Context ctx)
    {
        super(ctx);
        registerInterface(IRawmaterialinfoPicentry.class, this);
    }
    ...
    private RawmaterialinfoPicentryController getController() throws BOSException
    {
        return (RawmaterialinfoPicentryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRawmaterialinfoPicentryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

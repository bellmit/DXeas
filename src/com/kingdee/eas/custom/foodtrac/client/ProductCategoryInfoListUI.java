 ...
 * output class name
 */
public class ProductCategoryInfoListUI extends AbstractProductCategoryInfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProductCategoryInfoListUI.class);
    
    /**
     * output class constructor
     */
    public ProductCategoryInfoListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class RawmaterialinfoListUI extends AbstractRawmaterialinfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RawmaterialinfoListUI.class);
    
    /**
     * output class constructor
     */
    public RawmaterialinfoListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractProductCategoryInfoListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProductCategoryInfoListUI.class);
     ...
     */
    public AbstractProductCategoryInfoListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProductCategoryInfoListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.foodtrac.app", "ProductCategoryInfoQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.foodtrac.app.ProductCategoryInfoListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("categorynumber"));
        sic.add(new SelectorItemInfo("categoryname"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProductCategoryInfoListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProductCategoryInfoListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.foodtrac.client", "ProductCategoryInfoListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.foodtrac.client.ProductCategoryInfoEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.foodtrac.ProductCategoryInfoFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.foodtrac.ProductCategoryInfoInfo objectValue = new com.kingdee.eas.custom.foodtrac.ProductCategoryInfoInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","entrys.materialnumber.number","description","number","categorynumber","categoryname","newdesc"};
    }



	protected String getTDFileName() {
    	return "/bim/custom/foodtrac/ProductCategoryInfo";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.foodtrac.app.ProductCategoryInfoQuery");
	}

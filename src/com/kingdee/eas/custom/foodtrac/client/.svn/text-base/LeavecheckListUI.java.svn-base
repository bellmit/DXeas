 ...
 * output class name
 */
public class LeavecheckListUI extends AbstractLeavecheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LeavecheckListUI.class);
    
    /**
     * output class constructor
     */
    public LeavecheckListUI() throws Exception
    {
        super();
    }

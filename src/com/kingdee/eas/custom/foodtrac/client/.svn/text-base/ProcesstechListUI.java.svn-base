 ...
 * output class name
 */
public class ProcesstechListUI extends AbstractProcesstechListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProcesstechListUI.class);
    
    /**
     * output class constructor
     */
    public ProcesstechListUI() throws Exception
    {
        super();
    }

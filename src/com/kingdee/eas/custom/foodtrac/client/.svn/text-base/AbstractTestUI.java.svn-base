...
public abstract class AbstractTestUI extends CoreUIObject
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDButton1.setBounds(new Rectangle(388, 129, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.foodtrac.app.TestUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.foodtrac.client", "TestUI");
    }

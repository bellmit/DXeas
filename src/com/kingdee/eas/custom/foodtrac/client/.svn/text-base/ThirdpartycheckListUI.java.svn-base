 ...
 * output class name
 */
public class ThirdpartycheckListUI extends AbstractThirdpartycheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ThirdpartycheckListUI.class);
    
    /**
     * output class constructor
     */
    public ThirdpartycheckListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class CountrycheckListUI extends AbstractCountrycheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CountrycheckListUI.class);
    
    /**
     * output class constructor
     */
    public CountrycheckListUI() throws Exception
    {
        super();
    }

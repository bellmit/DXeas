 ...
 * output class name
 */
public class CompanyinfoListUI extends AbstractCompanyinfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompanyinfoListUI.class);
    
    /**
     * output class constructor
     */
    public CompanyinfoListUI() throws Exception
    {
        super();
    }

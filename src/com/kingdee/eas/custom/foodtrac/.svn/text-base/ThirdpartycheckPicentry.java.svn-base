...
public class ThirdpartycheckPicentry extends CoreBillEntryBase implements IThirdpartycheckPicentry
{
    public ThirdpartycheckPicentry()
    {
        super();
        registerInterface(IThirdpartycheckPicentry.class, this);
    }
    public ThirdpartycheckPicentry(Context ctx)
    {
        super(ctx);
        registerInterface(IThirdpartycheckPicentry.class, this);
    }
    ...
    private ThirdpartycheckPicentryController getController() throws BOSException
    {
        return (ThirdpartycheckPicentryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getThirdpartycheckPicentryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

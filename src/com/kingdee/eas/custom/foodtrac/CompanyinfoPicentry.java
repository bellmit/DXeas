...
public class CompanyinfoPicentry extends CoreBillEntryBase implements ICompanyinfoPicentry
{
    public CompanyinfoPicentry()
    {
        super();
        registerInterface(ICompanyinfoPicentry.class, this);
    }
    public CompanyinfoPicentry(Context ctx)
    {
        super(ctx);
        registerInterface(ICompanyinfoPicentry.class, this);
    }
    ...
    private CompanyinfoPicentryController getController() throws BOSException
    {
        return (CompanyinfoPicentryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCompanyinfoPicentryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyinfoPicentryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyinfoPicentryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyinfoPicentryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyinfoPicentryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyinfoPicentryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

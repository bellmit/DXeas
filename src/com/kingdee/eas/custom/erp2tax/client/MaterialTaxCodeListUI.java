 ...
 * output class name
 */
public class MaterialTaxCodeListUI extends AbstractMaterialTaxCodeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialTaxCodeListUI.class);
    
    /**
     * output class constructor
     */
    public MaterialTaxCodeListUI() throws Exception
    {
        super();
    }

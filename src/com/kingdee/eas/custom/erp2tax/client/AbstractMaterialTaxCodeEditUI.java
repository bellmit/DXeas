 ...
 * output class name
 */
public abstract class AbstractMaterialTaxCodeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMaterialTaxCodeEditUI.class);
    ...
    protected com.kingdee.eas.custom.erp2tax.MaterialTaxCodeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMaterialTaxCodeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMaterialTaxCodeEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"seq","material","materialName","model"});
        ...
        // txtDescription
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,kdtEntry}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 625, 407));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(16, 32, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(329, 32, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(655, 66, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(655, 103, 270, 19));
        this.add(kDLabelContainer4, null);
        kdtEntry.setBounds(new Rectangle(16, 74, 585, 312));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.custom.erp2tax.MaterialTaxCodeEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.custom.erp2tax.MaterialTaxCodeEntryInfo.class, this.kdtEntry, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.erp2tax.app.MaterialTaxCodeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.erp2tax.MaterialTaxCodeInfo)ov;
    }
...
kdtEntry.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntry.getCell(rowIndex,"material").getValue(),"model")));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.erp2tax.client", "MaterialTaxCodeEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		for (int i=0,n=kdtEntry.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntry.getCell(i,"material").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"ÎïÁÏ±àÂë"});
			}
		}

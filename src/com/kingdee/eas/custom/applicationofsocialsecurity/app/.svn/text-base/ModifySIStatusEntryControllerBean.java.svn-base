...
public class ModifySIStatusEntryControllerBean extends AbstractModifySIStatusEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.applicationofsocialsecurity.app.ModifySIStatusEntryControllerBean");
}
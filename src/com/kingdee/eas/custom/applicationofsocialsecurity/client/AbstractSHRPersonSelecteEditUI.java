 ...
 * output class name
 */
public abstract class AbstractSHRPersonSelecteEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSHRPersonSelecteEditUI.class);
     ...
     */
    public AbstractSHRPersonSelecteEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSHRPersonSelecteEditUI.class.getName());
        ...
        // kDContainer1
        // kDTable1
		String kDTable1StrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"personNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"personName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"birthday\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"2\" /><t:Column t:key=\"gender\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"3\" /><t:Column t:key=\"position\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"4\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{personNum}</t:Cell><t:Cell>$Resource{personName}</t:Cell><t:Cell>$Resource{birthday}</t:Cell><t:Cell>$Resource{gender}</t:Cell><t:Cell>$Resource{position}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDContainer1.setBounds(new Rectangle(17, 20, 559, 207));
        this.add(kDContainer1, null);
        //kDContainer1
        kDContainer1.getContentPane().setLayout(null);        kDTable1.setBounds(new Rectangle(3, 6, 552, 172));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.applicationofsocialsecurity.app.SHRPersonSelecteEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.applicationofsocialsecurity.client", "SHRPersonSelecteEditUI");
    }

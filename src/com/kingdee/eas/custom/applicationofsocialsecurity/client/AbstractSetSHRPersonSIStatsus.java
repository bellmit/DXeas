 ...
 * output class name
 */
public abstract class AbstractSetSHRPersonSIStatsus extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSetSHRPersonSIStatsus.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox cBoxSIStatus;
    protected com.kingdee.eas.framework.CoreBillBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSetSHRPersonSIStatsus() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSetSHRPersonSIStatsus.class.getName());
        ...
        this.cBoxSIStatus = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.contSIStatus.setName("contSIStatus");
        this.btnConfirm.setName("btnConfirm");
        this.cBoxSIStatus.setName("cBoxSIStatus");
        // CoreUI		
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contSIStatus.setBounds(new Rectangle(13, 34, 270, 19));
        this.add(contSIStatus, null);
        btnConfirm.setBounds(new Rectangle(106, 113, 86, 29));
        this.add(btnConfirm, null);
        //contSIStatus
        contSIStatus.setBoundEditor(cBoxSIStatus);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.applicationofsocialsecurity.app.SetSHRPersonSIStatsusHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.applicationofsocialsecurity.client", "SetSHRPersonSIStatsus");
    }

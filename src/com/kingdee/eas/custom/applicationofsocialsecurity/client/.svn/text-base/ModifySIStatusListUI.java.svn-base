 ...
 * output class name
 */
public class ModifySIStatusListUI extends AbstractModifySIStatusListUI
{
	private static final Logger logger = CoreUIObject.getLogger(ModifySIStatusListUI.class);

	/**
	 * output class constructor
	 */
	public ModifySIStatusListUI() throws Exception
	{
		super();
	}
	...
	protected FilterInfo getDefaultFilterForQuery(){
		...
		if(this.getUIContext().get("srcBillID")!=null&&!this.getUIContext().get("srcBillID").equals("")){
			filterNew.getFilterItems().add(new FilterItemInfo("srcBillID",(String)this.getUIContext().get("srcBillID"),CompareType.EQUALS));
			filterNew.setMaskString("(#0 or #1) and #2");
		}
		return filterNew;

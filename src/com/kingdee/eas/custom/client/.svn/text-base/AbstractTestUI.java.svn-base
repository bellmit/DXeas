 ...
 * output class name
 */
public abstract class AbstractTestUI extends CoreUIObject
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDToolBar TestUI_toolbar;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setName("TestUI");
        this.toolBar.setName("TestUI_toolbar");
        this.menuBar.setName("TestUI_menubar");
        ...
        this.btnTest.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgList_taskundistribute"));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnTest.setBounds(new Rectangle(145, 146, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.app.TestUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.client", "TestUI");
    }

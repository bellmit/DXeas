...
public class ChangepackingEntry extends CoreBillEntryBase implements IChangepackingEntry
{
    public ChangepackingEntry()
    {
        super();
        registerInterface(IChangepackingEntry.class, this);
    }
    public ChangepackingEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChangepackingEntry.class, this);
    }
    ...
    private ChangepackingEntryController getController() throws BOSException
    {
        return (ChangepackingEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChangepackingEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangepackingEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangepackingEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangepackingEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangepackingEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangepackingEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

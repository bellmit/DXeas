 ...
 * output class name
 */
public class ChangepackingListUI extends AbstractChangepackingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChangepackingListUI.class);
    
    /**
     * output class constructor
     */
    public ChangepackingListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class FoodDailyListUI extends AbstractFoodDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FoodDailyListUI.class);
    
    /**
     * output class constructor
     */
    public FoodDailyListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractPackbasicEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPackbasicEditUI.class);
    ...
    protected com.kingdee.eas.custom.dx.baseset.PackbasicInfo editData = null;
    protected ActionGetData actionGetData = null;
    /**
     * output class constructor
     */
    public AbstractPackbasicEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPackbasicEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,pkauditTime,billStatus,kdtEntry,prmtcompany}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.custom.dx.baseset.PackbasicEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.custom.dx.baseset.PackbasicEntryInfo.class, this.kdtEntry, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.dx.baseset.app.PackbasicEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.dx.baseset.PackbasicInfo)ov;
    }
    ...
    protected class ActionGetData extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPackbasicEditUI.this, "ActionGetData", "actionGetData_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.dx.baseset.client", "PackbasicEditUI");
    }

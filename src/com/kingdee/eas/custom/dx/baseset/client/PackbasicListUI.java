 ...
 * output class name
 */
public class PackbasicListUI extends AbstractPackbasicListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PackbasicListUI.class);
    
    /**
     * output class constructor
     */
    public PackbasicListUI() throws Exception
    {
        super();
    }

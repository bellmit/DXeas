...
public class OtherGroupSetCppEntryGroupEntry extends CoreBillEntryBase implements IOtherGroupSetCppEntryGroupEntry
{
    public OtherGroupSetCppEntryGroupEntry()
    {
        super();
        registerInterface(IOtherGroupSetCppEntryGroupEntry.class, this);
    }
    public OtherGroupSetCppEntryGroupEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IOtherGroupSetCppEntryGroupEntry.class, this);
    }
    ...
    private OtherGroupSetCppEntryGroupEntryController getController() throws BOSException
    {
        return (OtherGroupSetCppEntryGroupEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryGroupEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class FoodDailyEntry extends CoreBillEntryBase implements IFoodDailyEntry
{
    public FoodDailyEntry()
    {
        super();
        registerInterface(IFoodDailyEntry.class, this);
    }
    public FoodDailyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IFoodDailyEntry.class, this);
    }
    ...
    private FoodDailyEntryController getController() throws BOSException
    {
        return (FoodDailyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFoodDailyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodDailyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodDailyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodDailyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodDailyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodDailyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class OtherGroupSetCppEntry extends CoreBillEntryBase implements IOtherGroupSetCppEntry
{
    public OtherGroupSetCppEntry()
    {
        super();
        registerInterface(IOtherGroupSetCppEntry.class, this);
    }
    public OtherGroupSetCppEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IOtherGroupSetCppEntry.class, this);
    }
    ...
    private OtherGroupSetCppEntryController getController() throws BOSException
    {
        return (OtherGroupSetCppEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOtherGroupSetCppEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

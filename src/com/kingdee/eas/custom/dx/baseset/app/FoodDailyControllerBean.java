...
public class FoodDailyControllerBean extends AbstractFoodDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.baseset.app.FoodDailyControllerBean");
}
...
public class OtherGroupSetControllerBean extends AbstractOtherGroupSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.baseset.app.OtherGroupSetControllerBean");
}
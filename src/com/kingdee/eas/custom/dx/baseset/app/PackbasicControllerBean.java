...
public class PackbasicControllerBean extends AbstractPackbasicControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.baseset.app.PackbasicControllerBean");
}
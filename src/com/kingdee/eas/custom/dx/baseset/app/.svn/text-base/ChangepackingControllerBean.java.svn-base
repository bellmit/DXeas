...
public class ChangepackingControllerBean extends AbstractChangepackingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.baseset.app.ChangepackingControllerBean");
}
...
public class SettlDetectionControllerBean extends AbstractSettlDetectionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.weight.app.SettlDetectionControllerBean");
}
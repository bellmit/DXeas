...
public class SettleBillControllerBeanEx extends com.kingdee.eas.custom.dx.weight.app.SettleBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.weight.app.SettleBillControllerBeanEx");

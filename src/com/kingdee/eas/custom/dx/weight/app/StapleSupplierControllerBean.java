...
public class StapleSupplierControllerBean extends AbstractStapleSupplierControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.weight.app.StapleSupplierControllerBean");
}
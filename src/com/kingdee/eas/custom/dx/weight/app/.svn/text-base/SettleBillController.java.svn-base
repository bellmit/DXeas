...
public interface SettleBillController extends CoreBillBaseController
{
    ...
    public void audit(Context ctx, SettleBillInfo model) throws BOSException, RemoteException;
    public void unAudit(Context ctx, SettleBillInfo model) throws BOSException, RemoteException;
}
...
public class SettleReControllerBeanEx extends com.kingdee.eas.custom.dx.weight.app.SettleReControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.dx.weight.app.SettleReControllerBeanEx");

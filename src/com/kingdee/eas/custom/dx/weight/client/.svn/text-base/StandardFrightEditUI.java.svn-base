 ...
 * output class name
 */
public class StandardFrightEditUI extends AbstractStandardFrightEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(StandardFrightEditUI.class);
    
    /**
     * output class constructor
     */
    public StandardFrightEditUI() throws Exception
    {
        super();
    }
    /**

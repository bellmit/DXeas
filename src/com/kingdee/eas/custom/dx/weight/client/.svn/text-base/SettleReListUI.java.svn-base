 ...
 * output class name
 */
public class SettleReListUI extends AbstractSettleReListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleReListUI.class);
    
    /**
     * output class constructor
     */
    public SettleReListUI() throws Exception
    {
        super();
    }
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "chickenSZWgt","chickenPYWgt","chickenZYWgt","ChickenSet","GrossQty","GrossWgt","SmChickenQty","SmChickenWgt","CriChickenQty","CriChickenWgt","QCQty","QCWgt","DeductionSZ","DeductionZY","DeductionPY","DeductionKF"};
    }
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("chickenSZWgt");
    	sumField.add("chickenPYWgt");
    	sumField.add("chickenZYWgt");
    	sumField.add("ChickenSet");
    	sumField.add("GrossQty");
    	sumField.add("GrossWgt");
    	sumField.add("SmChickenQty");
    	sumField.add("SmChickenWgt");
    	sumField.add("CriChickenQty");
    	sumField.add("CriChickenWgt");
    	sumField.add("QCQty");
    	sumField.add("QCWgt");
    	sumField.add("DeductionSZ");
    	sumField.add("DeductionZY");
    	sumField.add("DeductionPY");
    	sumField.add("DeductionKF");

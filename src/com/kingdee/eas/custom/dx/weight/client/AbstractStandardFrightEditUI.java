 ...
 * output class name
 */
public abstract class AbstractStandardFrightEditUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStandardFrightEditUI.class);
    ...
    protected com.kingdee.eas.custom.dx.weight.StandardFrightInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractStandardFrightEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStandardFrightEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,pkeffectDate,pkunEffectDate,txtprice}));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.dx.weight.app.StandardFrightEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.dx.weight.StandardFrightInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.dx.weight.client", "StandardFrightEditUI");
    }

 ...
 * output class name
 */
public class StapleSupplierEditUI extends AbstractStapleSupplierEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(StapleSupplierEditUI.class);
    
    /**
     * output class constructor
     */
    public StapleSupplierEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public class CarSendBillListUI extends AbstractCarSendBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarSendBillListUI.class);
    
    /**
     * output class constructor
     */
    public CarSendBillListUI() throws Exception
    {
        super();
    }
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "Entrys.wgt","Entrys.qty0"};
    }
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("Entrys.wgt");
    	sumField.add("Entrys.qty0");
        return sumField;
    }

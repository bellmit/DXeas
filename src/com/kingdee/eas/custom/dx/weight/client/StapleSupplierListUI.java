 ...
 * output class name
 */
public class StapleSupplierListUI extends AbstractStapleSupplierListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StapleSupplierListUI.class);
    
    /**
     * output class constructor
     */
    public StapleSupplierListUI() throws Exception
    {
        super();
    }

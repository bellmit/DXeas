...
public class SettleBillListUI extends AbstractSettleBillListUI
{
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "GrossQty","GrossWgt","SmChickenQty","SmChickenWgt","CriChickenQty","CriChickenWgt","DeductionSZ","DeductionZY","DeductionPY","DeductionKF","farmAmount","FrightAmount","SettleAmount","Amount","finlAmount","firghttwo","PyFarmAmount"};
    }
    ...
    public List<String> getFieldSumList()
    {
    	...
    	sumField.add("farmAmount");
    	sumField.add("FrightAmount");
    	sumField.add("SettleAmount");
    	
    	sumField.add("Amount");
    	sumField.add("finlAmount");
    	sumField.add("firghttwo");
    	sumField.add("PyFarmAmount");
    	
    	
    	sumField.add("OtherAmount");
    	sumField.add("reAmount");

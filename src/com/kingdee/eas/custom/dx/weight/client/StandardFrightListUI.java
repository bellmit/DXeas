 ...
 * output class name
 */
public class StandardFrightListUI extends AbstractStandardFrightListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StandardFrightListUI.class);
    
    /**
     * output class constructor
     */
    public StandardFrightListUI() throws Exception
    {
        super();
    }

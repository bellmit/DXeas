...
public class CarSendBillEntry extends CoreBillEntryBase implements ICarSendBillEntry
{
    public CarSendBillEntry()
    {
        super();
        registerInterface(ICarSendBillEntry.class, this);
    }
    public CarSendBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICarSendBillEntry.class, this);
    }
    ...
    private CarSendBillEntryController getController() throws BOSException
    {
        return (CarSendBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCarSendBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarSendBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarSendBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarSendBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarSendBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCarSendBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

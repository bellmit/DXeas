...
public class AbstractSignwasthetableEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
     ...
     */
    public com.kingdee.eas.custom.test.SignwasthetableInfo getParent()
    {
        return (com.kingdee.eas.custom.test.SignwasthetableInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.custom.test.SignwasthetableInfo item)
    {
        put("parent", item);
    }
    /**

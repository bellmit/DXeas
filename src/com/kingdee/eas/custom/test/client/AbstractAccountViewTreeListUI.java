 ...
 * output class name
 */
public abstract class AbstractAccountViewTreeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAccountViewTreeListUI.class);
    /**
     * output class constructor
     */
    public AbstractAccountViewTreeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAccountViewTreeListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.test.app.AccountViewTreeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.test.client", "AccountViewTreeListUI");
    }

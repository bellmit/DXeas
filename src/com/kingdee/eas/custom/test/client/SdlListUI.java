 ...
 * output class name
 */
public class SdlListUI extends AbstractSdlListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SdlListUI.class);
    
    /**
     * output class constructor
     */
    public SdlListUI() throws Exception
    {
        super();
    }

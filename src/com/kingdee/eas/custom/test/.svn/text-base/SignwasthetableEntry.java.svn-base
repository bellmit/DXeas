...
public class SignwasthetableEntry extends CoreBillEntryBase implements ISignwasthetableEntry
{
    public SignwasthetableEntry()
    {
        super();
        registerInterface(ISignwasthetableEntry.class, this);
    }
    public SignwasthetableEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISignwasthetableEntry.class, this);
    }
    ...
    {
        return new BOSObjectType("6F97AA9A");
    }
    private SignwasthetableEntryController getController() throws BOSException
    {
        return (SignwasthetableEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSignwasthetableEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignwasthetableEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignwasthetableEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignwasthetableEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignwasthetableEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignwasthetableEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

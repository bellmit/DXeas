...
public class EasLogs extends AbstractBizCtrl implements IEasLogs
{
    public EasLogs()
    {
        super();
        registerInterface(IEasLogs.class, this);
    }
    public EasLogs(Context ctx)
    {
        super(ctx);
        registerInterface(IEasLogs.class, this);
    }
    ...
    private EasLogsController getController() throws BOSException
    {
        return (EasLogsController)getBizController();
    }
    /**

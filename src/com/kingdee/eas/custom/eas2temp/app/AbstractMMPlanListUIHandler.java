 ...
 * output class name
 */
public abstract class AbstractMMPlanListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionMmPlanOPUI(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionMmPlanOPUI(request,response,context);
	}
	protected void _handleActionMmPlanOPUI(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
...
public class DataBaseSettingControllerBeanEx extends com.kingdee.eas.custom.eas2temp.app.DataBaseSettingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.eas2temp.app.DataBaseSettingControllerBeanEx");
    protected void _importMaterial(Context ctx, IObjectValue model)throws BOSException
    {
	     super._importMaterial(ctx, model);
    }
}				

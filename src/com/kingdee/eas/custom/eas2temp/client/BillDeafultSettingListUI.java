 ...
 * output class name
 */
public class BillDeafultSettingListUI extends AbstractBillDeafultSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BillDeafultSettingListUI.class);
    
    /**
     * output class constructor
     */
    public BillDeafultSettingListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.eas2temp.client.BillDeafultSettingTreeEditUI.class.getName();
    }

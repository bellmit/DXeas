 ...
 * output class name
 */
public class BarMaterialRelEditUI extends AbstractBarMaterialRelEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BarMaterialRelEditUI.class);
    
    /**
     * output class constructor
     */
    public BarMaterialRelEditUI() throws Exception
    {
        super();
        this.setUITitle("目标系统物料对于关系");
    }
    /**
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.custom.eas2temp.BarMaterialRelTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

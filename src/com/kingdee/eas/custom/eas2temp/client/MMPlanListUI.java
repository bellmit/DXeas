 ...
 * output class name
 */
public class MMPlanListUI extends AbstractMMPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MMPlanListUI.class);
    
    /**
     * output class constructor
     */
    public MMPlanListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractBianzhidaiFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBianzhidaiFilterUI.class);
     ...
     */
    public AbstractBianzhidaiFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBianzhidaiFilterUI.class.getName());
        ...
        this.kDLabelContainer2.setBoundLabelLength(40);
        // kDLabelContainer3		
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(28, 130, 198, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(290, 130, 176, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(28, 174, 198, 19));
        this.add(kDLabelContainer3, null);
        kDCheckBox1.setBounds(new Rectangle(290, 174, 140, 19));
        ...
        //kDLabelContainer3
        kDLabelContainer3.setBoundEditor(prmtstorageUnitOrg);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.eas2temp.app.BianzhidaiFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.eas2temp.client", "BianzhidaiFilterUI");
    }

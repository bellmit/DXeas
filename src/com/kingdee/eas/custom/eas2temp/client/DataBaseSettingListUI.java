...
public class DataBaseSettingListUI extends AbstractDataBaseSettingListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(DataBaseSettingListUI.class);
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.custom.eas2temp.DataBaseSettingFactory
				.getRemoteInstance();
	}
	...
	protected ITreeBase getTreeInterface() throws Exception {
		return com.kingdee.eas.custom.eas2temp.DataBaseSettingTreeFactory
				.getRemoteInstance();
	}
	...
	protected String getGroupEditUIName() {
		return com.kingdee.eas.custom.eas2temp.client.DataBaseSettingTreeEditUI.class
				.getName();
	}
	...
	protected FilterInfo getDefaultFilterForQuery() {
		...
		filter.getFilterItems().add(
				new FilterItemInfo("companyID.id", SysContext.getSysContext()
						.getCurrentStorageUnit().getString("id"),
						CompareType.EQUALS));
		return filter;
	}

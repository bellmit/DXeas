 ...
 * output class name
 */
public class BarMaterialRelListUI extends AbstractBarMaterialRelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BarMaterialRelListUI.class);
    
    /**
     * output class constructor
     */
    public BarMaterialRelListUI() throws Exception
    {
        super();
        this.setUITitle("目标系统物料对应关系");
    }
    ...
    {
        return com.kingdee.eas.custom.eas2temp.client.BarMaterialRelTreeEditUI.class.getName();
    }
...
//        return "BarMaterialRel";
	...
	protected FilterInfo getDefaultFilterForQuery() {
		...
		filter.getFilterItems().add(
				new FilterItemInfo("storageOrgUnit.id", SysContext
						.getSysContext().getCurrentStorageUnit()
						.getString("id"), CompareType.EQUALS));
		return filter;
	}

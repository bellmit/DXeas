 ...
 * output class name
 */
public class MMPlanOPUI extends AbstractMMPlanOPUI
{
    private static final Logger logger = CoreUIObject.getLogger(MMPlanOPUI.class);
    
    /**
     * output class constructor
     */
    public MMPlanOPUI() throws Exception
    {
        super();
    }
    ...
    {
        super.btnOpenBOM_actionPerformed(e);
    }
    ...
    {
        super.btnOPBill_actionPerformed(e);
    }
    ...
    {
        super.btnCreateToBill_actionPerformed(e);
    }

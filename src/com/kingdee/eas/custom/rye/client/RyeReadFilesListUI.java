 ...
 * output class name
 */
public class RyeReadFilesListUI extends AbstractRyeReadFilesListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RyeReadFilesListUI.class);
    
    /**
     * output class constructor
     */
    public RyeReadFilesListUI() throws Exception
    {
        super();
    }

...
public class AbstractPollingRecordBillInventoryEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractPollingRecordBillInventoryEntryInfo()
    {
        this("id");
    }
    protected AbstractPollingRecordBillInventoryEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**

...
public class JProcessBarDemo extends JFrame {
	...
	public JProcessBarDemo(){  
		...
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // 设置窗体退出的操作  
	...
	public void setProcessBarText(Object obj){
		if(obj instanceof Integer)
			processBar.setValue(UIRuleUtil.getIntValue(obj));
		else if(obj instanceof String)
			processBar.setString(UIRuleUtil.getString(obj));
	}
}

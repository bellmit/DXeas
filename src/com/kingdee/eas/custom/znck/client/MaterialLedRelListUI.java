 ...
 * output class name
 */
public class MaterialLedRelListUI extends AbstractMaterialLedRelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialLedRelListUI.class);
    
    /**
     * output class constructor
     */
    public MaterialLedRelListUI() throws Exception
    {
        super();
    }

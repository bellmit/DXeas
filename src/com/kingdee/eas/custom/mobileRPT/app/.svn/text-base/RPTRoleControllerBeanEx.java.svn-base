...
public class RPTRoleControllerBeanEx extends com.kingdee.eas.custom.mobileRPT.app.RPTRoleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.mobileRPT.app.RPTRoleControllerBeanEx");

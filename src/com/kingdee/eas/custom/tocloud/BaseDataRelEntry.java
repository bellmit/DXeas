...
public class BaseDataRelEntry extends CoreBillEntryBase implements IBaseDataRelEntry
{
    public BaseDataRelEntry()
    {
        super();
        registerInterface(IBaseDataRelEntry.class, this);
    }
    public BaseDataRelEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBaseDataRelEntry.class, this);
    }
    ...
    private BaseDataRelEntryController getController() throws BOSException
    {
        return (BaseDataRelEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBaseDataRelEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseDataRelEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseDataRelEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseDataRelEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseDataRelEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseDataRelEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

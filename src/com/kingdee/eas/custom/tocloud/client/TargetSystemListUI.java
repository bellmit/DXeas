 ...
 * output class name
 */
public class TargetSystemListUI extends AbstractTargetSystemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TargetSystemListUI.class);
    
    /**
     * output class constructor
     */
    public TargetSystemListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.tocloud.client.TargetSystemTreeEditUI.class.getName();
    }

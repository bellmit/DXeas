...
public abstract class AbstractTestUI extends com.kingdee.eas.framework.client.CoreUI
{
    ...
    protected test ActionTest = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        // CoreUI
        // kDButton1
        this.kDButton1.setAction((IItemAction)ActionProxyFactory.getProxy(ActionTest, new Class[] { IItemAction.class }, getServiceContext()));		
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDButton1.setBounds(new Rectangle(91, 42, 171, 21));
        this.add(kDButton1, null);
        kDTextArea1.setBounds(new Rectangle(49, 106, 427, 213));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.tocloud.app.TestUIHandler";
	}
    ...
    /**
     * output test_actionPerformed method
     */
    public void test_actionPerformed(ActionEvent e) throws Exception
    {
    }
	public RequestContext preparetest(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
     ...
     * output test class
     */     
    protected class test extends ItemAction {     
        ...
        public test(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("test.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("test.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("test.NAME");
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTestUI.this, "test", "test_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.tocloud.client", "TestUI");
    }

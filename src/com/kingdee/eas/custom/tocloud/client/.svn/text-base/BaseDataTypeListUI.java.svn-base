 ...
 * output class name
 */
public class BaseDataTypeListUI extends AbstractBaseDataTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BaseDataTypeListUI.class);
    
    /**
     * output class constructor
     */
    public BaseDataTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.tocloud.client.BaseDataTypeTreeEditUI.class.getName();
    }

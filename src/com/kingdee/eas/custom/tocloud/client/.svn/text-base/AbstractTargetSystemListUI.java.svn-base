 ...
 * output class name
 */
public abstract class AbstractTargetSystemListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTargetSystemListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractTargetSystemListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractTargetSystemListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.tocloud.app.TargetSystemListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.tocloud.client", "TargetSystemListUI");
    }

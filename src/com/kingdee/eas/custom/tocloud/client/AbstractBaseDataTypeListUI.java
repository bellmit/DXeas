 ...
 * output class name
 */
public abstract class AbstractBaseDataTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseDataTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractBaseDataTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractBaseDataTypeListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.tocloud.app.BaseDataTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.tocloud.client", "BaseDataTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.tocloud.client.BaseDataTypeEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.tocloud.BaseDataTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.tocloud.BaseDataTypeInfo objectValue = new com.kingdee.eas.custom.tocloud.BaseDataTypeInfo();		
        return objectValue;
    }

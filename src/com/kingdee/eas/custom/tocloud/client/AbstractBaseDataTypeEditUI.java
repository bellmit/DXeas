 ...
 * output class name
 */
public abstract class AbstractBaseDataTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseDataTypeEditUI.class);
    ...
    protected com.kingdee.eas.custom.tocloud.BaseDataTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBaseDataTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaseDataTypeEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,txtName,prmttargetSystem,txtDescription,txtSimpleName}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(62, 44, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(62, 85, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(62, 167, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(62, 211, 270, 19));
        this.add(kDLabelContainer4, null);
        conttargetSystem.setBounds(new Rectangle(62, 126, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.tocloud.app.BaseDataTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.tocloud.BaseDataTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.tocloud.client", "BaseDataTypeEditUI");
    }

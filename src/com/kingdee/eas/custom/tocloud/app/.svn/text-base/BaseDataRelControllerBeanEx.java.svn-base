...
public class BaseDataRelControllerBeanEx extends com.kingdee.eas.custom.tocloud.app.BaseDataRelControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.tocloud.app.BaseDataRelControllerBeanEx");

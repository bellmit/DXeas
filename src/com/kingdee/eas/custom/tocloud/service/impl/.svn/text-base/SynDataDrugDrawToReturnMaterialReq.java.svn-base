 ...
 *
 */
public class SynDataDrugDrawToReturnMaterialReq implements ISynData{
	...
	public String synData(Context ctx, String billId, String entryId,
		...
		//实例化
		DrugReceiveBillInfo fodderReceptionInfo = DrugReceiveBillFactory.getLocalInstance(ctx).getDrugReceiveBillInfo(new ObjectUuidPK(billId));
		...
		//备注
		String FDescription = "药品处方单同步生产退料单";
...
//
//		//总成本
//		String FAmount = String.valueOf(entryInfo.getCostAmount().multiply(new BigDecimal("-1")));
//		manReturnEntryInfo.setFAmount(FAmount);
//
//		//成本金额
//		String F_abc_Amount = String.valueOf(entryInfo.getCostAmount().multiply(new BigDecimal("-1")));
//		manReturnEntryInfo.setF_abc_Amount(F_abc_Amount);
...
//		//生产日期
//		String FProduceDate = null;
//		if(entryInfo.getBeginDate() != null){
//			FProduceDate = sdf.format(entryInfo.getBeginDate());
//		}else{
//			throw new Exception("请药品处方单分录的开始日期！");
//		}
//		manReturnEntryInfo.setFProduceDate(FProduceDate);
//
//		//有效期至
//		String FExpiryDate = null;
//		if(entryInfo.getEndDate() != null){
//			FExpiryDate = sdf.format(entryInfo.getEndDate());
//		}else{
//			throw new Exception("请药品处方单分录的结束日期！");
//		}

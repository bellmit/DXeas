 ...
 * output class name
 */
public class BSXBudgetOfFeedListUI extends AbstractBSXBudgetOfFeedListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BSXBudgetOfFeedListUI.class);
    
    /**
     * output class constructor
     */
    public BSXBudgetOfFeedListUI() throws Exception
    {
        super();
    }

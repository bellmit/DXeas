 ...
 * output class name
 */
public class BSXBudgetGroupListUI extends AbstractBSXBudgetGroupListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BSXBudgetGroupListUI.class);
    
    /**
     * output class constructor
     */
    public BSXBudgetGroupListUI() throws Exception
    {
        super();
    }

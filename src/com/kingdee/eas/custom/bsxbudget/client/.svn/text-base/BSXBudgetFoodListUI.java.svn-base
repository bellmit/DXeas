 ...
 * output class name
 */
public class BSXBudgetFoodListUI extends AbstractBSXBudgetFoodListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BSXBudgetFoodListUI.class);
    
    
    /**
     * output class constructor
     */
    public BSXBudgetFoodListUI() throws Exception
    {
        super();
    }

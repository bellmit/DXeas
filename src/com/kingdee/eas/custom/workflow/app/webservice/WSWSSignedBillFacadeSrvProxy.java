...
public class WSWSSignedBillFacadeSrvProxy { 
    ...
    public String getAddressesByName( String param ) throws WSInvokeException {
        try {
            return getController().getAddressesByName(
            param);
        }
        catch( Throwable e ) {
    ...
    public String deleteSignBillByFid( String fid ) throws WSInvokeException {
        try {
            return getController().deleteSignBillByFid(
            fid);
        }
        catch( Throwable e ) {
            throw new WSInvokeException( e ) ;

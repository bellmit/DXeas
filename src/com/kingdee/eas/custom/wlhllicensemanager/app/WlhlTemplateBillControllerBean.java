...
public class WlhlTemplateBillControllerBean extends AbstractWlhlTemplateBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.wlhllicensemanager.app.WlhlTemplateBillControllerBean");
}
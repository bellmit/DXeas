...
public abstract class AbstractWlhlTemplateBillListUI extends com.kingdee.eas.custom.wlhllicensemanager.client.WlhlCoreBillListUI
{
    ...
    {
        return new String[] {"id","number","bizDate","description","billStatus","createTime","lastUpdateTime","auditor.name","auditTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name"};
    }

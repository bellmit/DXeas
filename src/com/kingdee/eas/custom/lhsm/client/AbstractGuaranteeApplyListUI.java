 ...
 * output class name
 */
public abstract class AbstractGuaranteeApplyListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGuaranteeApplyListUI.class);
     ...
     */
    public AbstractGuaranteeApplyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGuaranteeApplyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.lhsm.app", "GuaranteeApplyQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.lhsm.app.GuaranteeApplyListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("applyLimit"));
        sic.add(new SelectorItemInfo("company.name"));
        sic.add(new SelectorItemInfo("useQuota"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractGuaranteeApplyListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractGuaranteeApplyListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.lhsm.client", "GuaranteeApplyListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.lhsm.client.GuaranteeApplyEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.lhsm.GuaranteeApplyFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.lhsm.GuaranteeApplyInfo objectValue = new com.kingdee.eas.custom.lhsm.GuaranteeApplyInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","applyLimit","company.name","useQuota","person.name","IDCardNo","billStatus"};
    }



	protected String getTDFileName() {
    	return "/bim/custom/lhsm/GuaranteeApply";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.lhsm.app.GuaranteeApplyQuery");
	}

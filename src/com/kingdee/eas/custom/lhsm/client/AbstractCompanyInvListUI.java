 ...
 * output class name
 */
public abstract class AbstractCompanyInvListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompanyInvListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCompanyInvListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCompanyInvListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.lhsm.app.CompanyInvListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("qty2"));
        sic.add(new SelectorItemInfo("qty1"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.lhsm.client", "CompanyInvListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.lhsm.client.CompanyInvEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.lhsm.CompanyInvFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.lhsm.CompanyInvInfo objectValue = new com.kingdee.eas.custom.lhsm.CompanyInvInfo();		
        return objectValue;
    }

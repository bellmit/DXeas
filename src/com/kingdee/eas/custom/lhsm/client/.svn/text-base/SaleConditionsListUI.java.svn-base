 ...
 * output class name
 */
public class SaleConditionsListUI extends AbstractSaleConditionsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleConditionsListUI.class);
    
    /**
     * output class constructor
     */
    public SaleConditionsListUI() throws Exception
    {
        super();
    }

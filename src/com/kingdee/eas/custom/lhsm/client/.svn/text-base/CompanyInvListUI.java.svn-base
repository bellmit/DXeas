 ...
 * output class name
 */
public class CompanyInvListUI extends AbstractCompanyInvListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompanyInvListUI.class);
    
    /**
     * output class constructor
     */
    public CompanyInvListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.lhsm.client.CompanyInvTreeEditUI.class.getName();
    }

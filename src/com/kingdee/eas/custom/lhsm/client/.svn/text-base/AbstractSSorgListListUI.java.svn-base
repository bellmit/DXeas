 ...
 * output class name
 */
public abstract class AbstractSSorgListListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSSorgListListUI.class);
    /**
     * output class constructor
     */
    public AbstractSSorgListListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.lhsm.app.SSorgListListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.lhsm.client", "SSorgListListUI");
    }

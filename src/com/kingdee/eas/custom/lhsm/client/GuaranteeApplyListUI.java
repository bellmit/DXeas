 ...
 * output class name
 */
public class GuaranteeApplyListUI extends AbstractGuaranteeApplyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(GuaranteeApplyListUI.class);
    
    /**
     * output class constructor
     */
    public GuaranteeApplyListUI() throws Exception
    {
        super();
    }

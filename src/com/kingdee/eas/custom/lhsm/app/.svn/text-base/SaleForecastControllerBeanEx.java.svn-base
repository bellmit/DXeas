...
public class SaleForecastControllerBeanEx extends com.kingdee.eas.custom.lhsm.app.SaleForecastControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.lhsm.app.SaleForecastControllerBeanEx");

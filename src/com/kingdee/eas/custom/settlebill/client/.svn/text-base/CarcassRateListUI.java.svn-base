 ...
 * output class name
 */
public class CarcassRateListUI extends AbstractCarcassRateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarcassRateListUI.class);
    
    /**
     * output class constructor
     */
    public CarcassRateListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.settlebill.client.CarcassRateTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public abstract class AbstractCarcassRateListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCarcassRateListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCarcassRateListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCarcassRateListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCarcassRateListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.settlebill.app", "CarcassRateQuery");
        // CoreUI
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","name","number","description","simpleName","createTime","creator.name","lastUpdateTime","lastUpdateUser.name","treeid.id","Entry.seq","effectDate","uneffectDate","company.name","billStatus","Entry.avgWgtCell","Entry.avgWgtFloor","Entry.rate","Entry.remark"});
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.settlebill.app.CarcassRateListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.settlebill.client", "CarcassRateListUI");
    }

...
public class SettleBillAssEntry extends CoreBillEntryBase implements ISettleBillAssEntry
{
    public SettleBillAssEntry()
    {
        super();
        registerInterface(ISettleBillAssEntry.class, this);
    }
    public SettleBillAssEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISettleBillAssEntry.class, this);
    }
    ...
    private SettleBillAssEntryController getController() throws BOSException
    {
        return (SettleBillAssEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSettleBillAssEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleBillAssEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleBillAssEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleBillAssEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleBillAssEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettleBillAssEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class SettleBillControllerBeanEx extends com.kingdee.eas.custom.settlebill.app.SettleBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.settlebill.app.SettleBillControllerBeanEx");
    protected void _getCostAmt(Context ctx, IObjectValue model)throws BOSException
    {
	     super._getCostAmt(ctx, model);
    }
}				

...
public abstract class AbstractSettleBillEntryControllerBean extends CoreBillEntryBaseControllerBean implements SettleBillEntryController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3dd7f039-1f9f-4595-b8ec-1173a019e2e5"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f791b67f-0fc3-4f6c-9429-650a0f0eb724"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("16255a3b-d052-4489-a873-e3f84004d99a"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("157cb171-683a-4156-8cec-0fee4e18843c"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("60768b0e-0288-43d8-bfea-6f955a2e0966"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3b48e7d1-87b0-475e-b428-9181d028306f"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {

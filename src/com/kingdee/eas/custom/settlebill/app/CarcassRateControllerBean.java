...
public class CarcassRateControllerBean extends AbstractCarcassRateControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.settlebill.app.CarcassRateControllerBean");
}
...
public class CreatePayRequestBillControllerBeanDepPlugin {
...
////				ContractManageInfo cmInfo = ContractManageFactory.getRemoteInstance().getContractManageInfo(new ObjectUuidPK(cmId));
////				ContractManagePaymentCollection cmEntry = cmInfo.getPayment();
//
//
...
//	}
	...
	{
		StringBuffer buffer=new StringBuffer();
		buffer.append("select t2.fid from T_SIG_ContractManagePayment t1 ");

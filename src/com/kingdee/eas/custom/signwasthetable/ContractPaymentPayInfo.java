...
public class ContractPaymentPayInfo extends CoreBillEntryBase implements IContractPaymentPayInfo
{
    public ContractPaymentPayInfo()
    {
        super();
        registerInterface(IContractPaymentPayInfo.class, this);
    }
    public ContractPaymentPayInfo(Context ctx)
    {
        super(ctx);
        registerInterface(IContractPaymentPayInfo.class, this);
    }
    ...
    private ContractPaymentPayInfoController getController() throws BOSException
    {
        return (ContractPaymentPayInfoController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractPaymentPayInfoInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPaymentPayInfoInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPaymentPayInfoInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPaymentPayInfoCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPaymentPayInfoCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractPaymentPayInfoCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

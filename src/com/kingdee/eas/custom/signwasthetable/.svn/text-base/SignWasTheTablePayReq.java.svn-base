...
public class SignWasTheTablePayReq extends CoreBillEntryBase implements ISignWasTheTablePayReq
{
    public SignWasTheTablePayReq()
    {
        super();
        registerInterface(ISignWasTheTablePayReq.class, this);
    }
    public SignWasTheTablePayReq(Context ctx)
    {
        super(ctx);
        registerInterface(ISignWasTheTablePayReq.class, this);
    }
    ...
    private SignWasTheTablePayReqController getController() throws BOSException
    {
        return (SignWasTheTablePayReqController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignWasTheTablePayReqCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

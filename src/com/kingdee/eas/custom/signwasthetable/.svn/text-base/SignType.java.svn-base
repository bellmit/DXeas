...
public class SignType extends DataBase implements ISignType
{
    public SignType()
    {
        super();
        registerInterface(ISignType.class, this);
    }
    public SignType(Context ctx)
    {
        super(ctx);
        registerInterface(ISignType.class, this);
    }
    ...
    private SignTypeController getController() throws BOSException
    {
        return (SignTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSignTypeInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getSignTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

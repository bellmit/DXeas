...
public class CmChangeControllerBean extends AbstractCmChangeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.CmChangeControllerBean");
}
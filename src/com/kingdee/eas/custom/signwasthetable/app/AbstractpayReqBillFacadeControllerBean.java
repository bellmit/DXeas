...
public abstract class AbstractpayReqBillFacadeControllerBean extends AbstractBizControllerBean implements payReqBillFacadeController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("ac56b5e0-1b93-44b2-914b-a23c076347b4"), new Object[]{ctx, payRequestBillID, new Boolean(closeStatus), closeUser, closeDate});

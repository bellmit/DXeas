...
public class ContractPaymentControllerBean extends AbstractContractPaymentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.ContractPaymentControllerBean");
}
...
public class SignWasTheTablePayReqControllerBean extends AbstractSignWasTheTablePayReqControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.SignWasTheTablePayReqControllerBean");
}
 ...
 * output class name
 */
public abstract class AbstractOverPayListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionViewSrcBill(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewSrcBill(request,response,context);
	}
	protected void _handleActionViewSrcBill(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

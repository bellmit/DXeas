...
public class CmChangeEntryControllerBean extends AbstractCmChangeEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.CmChangeEntryControllerBean");
}
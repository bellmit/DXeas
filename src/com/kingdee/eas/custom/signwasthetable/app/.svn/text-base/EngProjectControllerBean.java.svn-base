...
public class EngProjectControllerBean extends AbstractEngProjectControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.EngProjectControllerBean");
	...
	protected void _audit(Context ctx, IObjectValue model) throws BOSException {
		...
		EngProjectInfo engP = (EngProjectInfo) model;
		engP.setBillStatus(UsedStatus.auditValue);
		try {
			super._save(ctx, engP);
	...
	protected void _unAudit(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub
		EngProjectInfo engP = (EngProjectInfo) model;
		engP.setBillStatus(UsedStatus.saveValue);
		try {
			super._save(ctx, engP);
		} catch (EASBizException e) {
			// TODO Auto-generated catch block

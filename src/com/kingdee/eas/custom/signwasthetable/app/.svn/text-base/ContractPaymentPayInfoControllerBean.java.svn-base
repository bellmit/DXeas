...
public class ContractPaymentPayInfoControllerBean extends AbstractContractPaymentPayInfoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.ContractPaymentPayInfoControllerBean");
}
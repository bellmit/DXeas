...
public class EngProjectTreeControllerBean extends AbstractEngProjectTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.EngProjectTreeControllerBean");
}
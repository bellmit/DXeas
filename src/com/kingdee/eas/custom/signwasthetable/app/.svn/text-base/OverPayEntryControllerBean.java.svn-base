...
public class OverPayEntryControllerBean extends AbstractOverPayEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.OverPayEntryControllerBean");
}
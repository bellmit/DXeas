...
public class ContractEntryControllerBean extends AbstractContractEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.signwasthetable.app.ContractEntryControllerBean");
}
...
import com.kingdee.bos.ctrl.reportone.r1.form.designer.actions.operate.data.EditDataParamOperate;
...
import com.kingdee.eas.custom.signwasthetable.OverPayFactory;
 ...
 * output class name
 */
public class OverPayListUI extends AbstractOverPayListUI
{
	private static final Logger logger = CoreUIObject.getLogger(OverPayListUI.class);

	/**
	 * output class constructor
	 */
	public OverPayListUI() throws Exception
	{
		super();
	}
	/*
	...
	protected FilterInfo getDefaultFilterForQuery() {
		...
		String srcBillID=(String) this.getUIContext().get("srcBillIDList");
		String ms = filterInfo.getMaskString();
		ms="("+ms+")";
		if(srcBillID!=null)
		{
			filterInfo.getFilterItems().add(new FilterItemInfo("ContractSrcId",srcBillID,CompareType.EQUALS));
	...
	public void actionEdit_actionPerformed(ActionEvent e) throws Exception
	{
		...
		OverPayInfo info = OverPayFactory.getRemoteInstance().getOverPayInfo(new ObjectUuidPK(id));

 ...
 * output class name
 */
public class EngProjectEditUI extends AbstractEngProjectEditUI
{
	/**
	 *审核
	 */
	...
	public void onLoad() throws Exception {
		...
		//修改图标
		this.eProjectAudit.setIcon(EASResource.getIcon("imgTbtn_auditing"));
		this.eProjectUnAudit.setIcon(EASResource.getIcon("imgTbtn_fauditing"));
		//隐藏文字
		this.eProjectAudit.setHideActionText(true);
		this.eProjectUnAudit.setHideActionText(true);
	...
	private static final Logger logger = CoreUIObject.getLogger(EngProjectEditUI.class);

	/**
	 * output class constructor
	 */
	public EngProjectEditUI() throws Exception
	{
		super();
	}
	/**
	...
	public void actionCancel_actionPerformed(ActionEvent e) throws Exception
	{
		...
		{
			//调用facade保存
			com.kingdee.eas.custom.signwasthetable.signTableSysFacadeFactory.getRemoteInstance().engProjectCancel(editData.getId().toString());
	...
	public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception
	{
		...
		{
			//调用facade保存
			com.kingdee.eas.custom.signwasthetable.signTableSysFacadeFactory.getRemoteInstance().engProjectCancelCancel(editData.getId().toString());
	...
	public void setDataObject(IObjectValue dataObject) 
	{
		...
		if(STATUS_ADDNEW.equals(getOprtState())) {
			editData.put("treeid",(com.kingdee.eas.custom.signwasthetable.EngProjectTreeInfo)getUIContext().get(UIContext.PARENTNODE));
		}
	}

 ...
 * output class name
 */
public class CmChangeListUI extends AbstractCmChangeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CmChangeListUI.class);
    
    /**
     * output class constructor
     */
    public CmChangeListUI() throws Exception
    {
        super();
    }

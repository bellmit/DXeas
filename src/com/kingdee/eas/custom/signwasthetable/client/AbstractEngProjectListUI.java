 ...
 * output class name
 */
public abstract class AbstractEngProjectListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEngProjectListUI.class);
    ...
    protected ActionUnAudit actionUnAudit = null;
		...
		public AbstractEngProjectListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractEngProjectListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEngProjectListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.signwasthetable.app", "EngProjectQuery");
        //actionAudit
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.signwasthetable.app.EngProjectListUIHandler";
	}
...
com.kingdee.eas.custom.signwasthetable.EngProjectInfo editData = (com.kingdee.eas.custom.signwasthetable.EngProjectInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
com.kingdee.eas.custom.signwasthetable.EngProjectFactory.getRemoteInstance().audit(editData);
    }
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
        if (getSelectedKeyValue() == null) return;
com.kingdee.eas.custom.signwasthetable.EngProjectInfo editData = (com.kingdee.eas.custom.signwasthetable.EngProjectInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
com.kingdee.eas.custom.signwasthetable.EngProjectFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractEngProjectListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEngProjectListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.signwasthetable.client", "EngProjectListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.signwasthetable.client.EngProjectEditUI.class.getName();
    }

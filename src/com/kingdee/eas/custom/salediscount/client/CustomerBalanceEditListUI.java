 ...
 * output class name
 */
public class CustomerBalanceEditListUI extends AbstractCustomerBalanceEditListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerBalanceEditListUI.class);
    
    /**
     * output class constructor
     */
    public CustomerBalanceEditListUI() throws Exception
    {
        super();
    }

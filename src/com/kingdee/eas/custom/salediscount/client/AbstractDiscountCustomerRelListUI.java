 ...
 * output class name
 */
public abstract class AbstractDiscountCustomerRelListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDiscountCustomerRelListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractDiscountCustomerRelListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractDiscountCustomerRelListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salediscount.app.DiscountCustomerRelListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salediscount.client", "DiscountCustomerRelListUI");
    }

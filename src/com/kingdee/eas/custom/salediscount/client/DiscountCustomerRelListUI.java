 ...
 * output class name
 */
public class DiscountCustomerRelListUI extends AbstractDiscountCustomerRelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DiscountCustomerRelListUI.class);
    
    /**
     * output class constructor
     */
    public DiscountCustomerRelListUI() throws Exception
    {
        super();
    }
...
//    }
    ...
    {
        return com.kingdee.eas.custom.salediscount.client.DiscountCustomerRelTreeEditUI.class.getName();
    }

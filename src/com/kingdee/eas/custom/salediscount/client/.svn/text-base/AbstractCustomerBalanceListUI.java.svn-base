 ...
 * output class name
 */
public abstract class AbstractCustomerBalanceListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCustomerBalanceListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCustomerBalanceListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCustomerBalanceListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salediscount.app.CustomerBalanceListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("initBalance"));
        sic.add(new SelectorItemInfo("nowBalance"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salediscount.client", "CustomerBalanceListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.salediscount.client.CustomerBalanceEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.salediscount.CustomerBalanceFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.salediscount.CustomerBalanceInfo objectValue = new com.kingdee.eas.custom.salediscount.CustomerBalanceInfo();		
        return objectValue;
    }

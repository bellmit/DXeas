 ...
 * output class name
 */
public class DiscountGridLogListUI extends AbstractDiscountGridLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DiscountGridLogListUI.class);
    
    /**
     * output class constructor
     */
    public DiscountGridLogListUI() throws Exception
    {
        super();
    }

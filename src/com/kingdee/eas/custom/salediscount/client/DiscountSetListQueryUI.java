 ...
 * output class name
 */
public class DiscountSetListQueryUI extends AbstractDiscountSetListQueryUI
{
    private static final Logger logger = CoreUIObject.getLogger(DiscountSetListQueryUI.class);
    
    /**
     * output class constructor
     */
    public DiscountSetListQueryUI() throws Exception
    {
        super();
    }

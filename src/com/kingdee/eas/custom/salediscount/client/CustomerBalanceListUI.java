 ...
 * output class name
 */
public class CustomerBalanceListUI extends AbstractCustomerBalanceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerBalanceListUI.class);
    
    /**
     * output class constructor
     */
    public CustomerBalanceListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.salediscount.client.CustomerBalanceTreeEditUI.class.getName();
    }

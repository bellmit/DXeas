...
public class CustomerBalanceControllerBean extends AbstractCustomerBalanceControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salediscount.app.CustomerBalanceControllerBean");
}
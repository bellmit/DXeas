...
public class DiscountRecordBillControllerBeanEx extends com.kingdee.eas.custom.salediscount.app.DiscountRecordBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salediscount.app.DiscountRecordBillControllerBeanEx");

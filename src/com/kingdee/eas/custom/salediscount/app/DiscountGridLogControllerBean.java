...
public class DiscountGridLogControllerBean extends AbstractDiscountGridLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salediscount.app.DiscountGridLogControllerBean");
}
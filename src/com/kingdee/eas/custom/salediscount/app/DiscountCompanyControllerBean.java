...
public class DiscountCompanyControllerBean extends AbstractDiscountCompanyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salediscount.app.DiscountCompanyControllerBean");
}
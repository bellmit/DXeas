...
public class DiscountSetEntryControllerBean extends AbstractDiscountSetEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salediscount.app.DiscountSetEntryControllerBean");
}
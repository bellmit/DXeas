 ...
 * output class name
 */
public abstract class AbstractProductSaleDayFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProductSaleDayFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisMaterialGroup;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisMaterial;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer8;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer9;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisCustomer;
    ...
    protected com.kingdee.bos.ctrl.swing.KDDatePicker dpDate;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker dpLastBeginDate;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker dpLastEndDate;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker dpBeginDate;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker dpProxBeginDate;
     ...
     */
    public AbstractProductSaleDayFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProductSaleDayFilterUI.class.getName());
        ...
        this.chkisMaterialGroup = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.chkisMaterial = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.kDLabelContainer8 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.kDLabelContainer9 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.chkisCustomer = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.dpDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.dpLastBeginDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.dpLastEndDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.dpBeginDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.dpProxBeginDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        ...
        this.chkisMaterialGroup.setName("chkisMaterialGroup");
        this.chkisMaterial.setName("chkisMaterial");
        this.kDLabelContainer8.setName("kDLabelContainer8");
        this.kDLabelContainer9.setName("kDLabelContainer9");
        this.chkisCustomer.setName("chkisCustomer");
        ...
        this.dpDate.setName("dpDate");
        this.dpLastBeginDate.setName("dpLastBeginDate");
        this.dpLastEndDate.setName("dpLastEndDate");
        this.dpBeginDate.setName("dpBeginDate");
        this.dpProxBeginDate.setName("dpProxBeginDate");
        ...
        // chkisMaterialGroup		
        this.chkisMaterialGroup.setText(resHelper.getString("chkisMaterialGroup.text"));
        // chkisMaterial		
        this.chkisMaterial.setText(resHelper.getString("chkisMaterial.text"));
        // kDLabelContainer8		
        ...
        // chkisCustomer		
        this.chkisCustomer.setText(resHelper.getString("chkisCustomer.text"));
        // kDLabelContainer10		
        ...
        // prmtBeginEmp
        // dpDate		
        this.dpDate.setFocusCycleRoot(true);
        this.dpDate.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    dpDate_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        // dpLastBeginDate
        this.dpLastBeginDate.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    dpLastBeginDate_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer3.setBounds(new Rectangle(30, 270, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(30, 300, 270, 19));
        this.add(kDLabelContainer4, null);
        kDLabelContainer5.setBounds(new Rectangle(340, 300, 270, 19));
        this.add(kDLabelContainer5, null);
        kDLabelContainer6.setBounds(new Rectangle(30, 330, 270, 19));
        this.add(kDLabelContainer6, null);
        kDLabelContainer7.setBounds(new Rectangle(340, 330, 270, 19));
        this.add(kDLabelContainer7, null);
        chkisArea.setBounds(new Rectangle(30, 150, 140, 19));
        this.add(chkisArea, null);
        chkisEmp.setBounds(new Rectangle(340, 150, 140, 19));
        this.add(chkisEmp, null);
        chkisMaterialGroup.setBounds(new Rectangle(30, 210, 140, 19));
        this.add(chkisMaterialGroup, null);
        chkisMaterial.setBounds(new Rectangle(340, 180, 140, 19));
        this.add(chkisMaterial, null);
        kDLabelContainer8.setBounds(new Rectangle(30, 30, 270, 19));
        this.add(kDLabelContainer8, null);
        kDLabelContainer9.setBounds(new Rectangle(340, 120, 270, 19));
        this.add(kDLabelContainer9, null);
        chkisCustomer.setBounds(new Rectangle(30, 180, 126, 23));
        this.add(chkisCustomer, null);
        kDLabelContainer10.setBounds(new Rectangle(30, 90, 270, 19));
        this.add(kDLabelContainer10, null);
        kDLabelContainer11.setBounds(new Rectangle(340, 30, 270, 19));
        this.add(kDLabelContainer11, null);
        kDLabelContainer12.setBounds(new Rectangle(340, 60, 270, 19));
        this.add(kDLabelContainer12, null);
        kDLabelContainer13.setBounds(new Rectangle(340, 90, 270, 19));
        this.add(kDLabelContainer13, null);
        kDLabelContainer14.setBounds(new Rectangle(30, 120, 270, 19));
        this.add(kDLabelContainer14, null);
        rbtnSaleOrder.setBounds(new Rectangle(30, 240, 140, 19));
        this.add(rbtnSaleOrder, null);
        rbtnSaleIssue.setBounds(new Rectangle(230, 240, 140, 19));
        this.add(rbtnSaleIssue, null);
        rbtnOtherBill.setBounds(new Rectangle(430, 240, 140, 19));
        this.add(rbtnOtherBill, null);
        chkisyhl.setBounds(new Rectangle(30, 360, 140, 19));
        ...
        //kDLabelContainer3
        kDLabelContainer3.setBoundEditor(dpDate);
        //kDLabelContainer4
        kDLabelContainer4.setBoundEditor(dpLastBeginDate);
        //kDLabelContainer5
        kDLabelContainer5.setBoundEditor(dpLastEndDate);
        //kDLabelContainer6
        kDLabelContainer6.setBoundEditor(dpBeginDate);
        //kDLabelContainer7
        kDLabelContainer7.setBoundEditor(dpProxBeginDate);
        //kDLabelContainer8
        kDLabelContainer8.setBoundEditor(prmtBeginArea);
        //kDLabelContainer9
        kDLabelContainer9.setBoundEditor(cmbLevel);
        //kDLabelContainer10
        kDLabelContainer10.setBoundEditor(prmtBeginCustomer);
        //kDLabelContainer11
        kDLabelContainer11.setBoundEditor(prmtEndArea);
        //kDLabelContainer12
        kDLabelContainer12.setBoundEditor(prmtEndEmp);
        //kDLabelContainer13
        kDLabelContainer13.setBoundEditor(prmtEndCustomer);
        //kDLabelContainer14
        kDLabelContainer14.setBoundEditor(cmbLevelA);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salediscount.rpt.app.ProductSaleDayFilterUIHandler";
	}
    ...
    /**
     * output dpLastBeginDate_dataChanged method
     */
    protected void dpLastBeginDate_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salediscount.rpt.client", "ProductSaleDayFilterUI");
    }

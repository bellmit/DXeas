 ...
 * output class name
 */
public class SaleDiscountAnalyzeRptUI extends AbstractSaleDiscountAnalyzeRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleDiscountAnalyzeRptUI.class);
    
    /**
     * output class constructor
     */
    public SaleDiscountAnalyzeRptUI() throws Exception
    {
        super();

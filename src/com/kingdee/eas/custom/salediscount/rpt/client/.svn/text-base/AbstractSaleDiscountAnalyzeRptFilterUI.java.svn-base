 ...
 * output class name
 */
public abstract class AbstractSaleDiscountAnalyzeRptFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleDiscountAnalyzeRptFilterUI.class);
     ...
     */
    public AbstractSaleDiscountAnalyzeRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleDiscountAnalyzeRptFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(57, 78, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(57, 133, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(57, 167, 270, 19));
        this.add(kDLabelContainer4, null);
        cbByMaterial.setBounds(new Rectangle(57, 210, 140, 19));
        this.add(cbByMaterial, null);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salediscount.rpt.app.SaleDiscountAnalyzeRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salediscount.rpt.client", "SaleDiscountAnalyzeRptFilterUI");
    }

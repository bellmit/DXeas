 ...
 * output class name
 */
public class ReqTheoryAndFactureRptUI extends AbstractReqTheoryAndFactureRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReqTheoryAndFactureRptUI.class);
    
    /**
     * output class constructor
     */
    public ReqTheoryAndFactureRptUI() throws Exception
    {

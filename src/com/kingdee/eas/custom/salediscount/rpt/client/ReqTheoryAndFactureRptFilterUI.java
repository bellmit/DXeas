 ...
 * output class name
 */
public class ReqTheoryAndFactureRptFilterUI extends AbstractReqTheoryAndFactureRptFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReqTheoryAndFactureRptFilterUI.class);
    
    /**
     * output class constructor
     */
    public ReqTheoryAndFactureRptFilterUI() throws Exception
    {
    	super();
    }

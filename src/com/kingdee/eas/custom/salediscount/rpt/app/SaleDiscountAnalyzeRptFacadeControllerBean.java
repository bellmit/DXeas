...
//    	sb.append(" sum(CFDiscountAmount) adjustAmount,0,0,0 ");
    	...
    	sb.append(" where t.fDescription like '%调整生成%'  and t.cfstatus='4'  and t.CFCompanyID ='");
    	sb.append(CompanyID);
    	sb.append("' and t.FBizDate >=to_date('");
    	sb.append(beginDate);
    	sb.append("','yyyy-MM-dd') and t.fbizDate <=to_date('");
...
//    	//7
    	...
    	header.setLabels(new Object[][]{
			{"产品编码","产品名称",
				"销量(吨)","单价","含税单价","价税合计","厂价金额","基本折扣(立折)","实物折扣额","月度折扣","分销折扣","年度折扣","调整生成","折扣合计","销售净额"}});
    	return header;
    }
...
//    	//7
    	...
    	header.setLabels(new Object[][]{
			{"业务员编码","业务员","	客户编码","客户","产品编码","产品名称",
				"销量(吨)","单价","含税单价","价税合计","厂价金额","基本折扣(立折)","实物折扣","月度折扣","分销折扣","年度折扣","调整生成","折扣合计","销售净额"}});
    	return header;
    }

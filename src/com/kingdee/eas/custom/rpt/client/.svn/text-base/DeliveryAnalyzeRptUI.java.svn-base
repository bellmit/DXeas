...
import com.kingdee.eas.custom.rpt.DeliveryAnalyzeFacadeFactory;
 ...
 * output class name
 */
public class DeliveryAnalyzeRptUI extends AbstractDeliveryAnalyzeRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliveryAnalyzeRptUI.class);
    
    /**
     * output class constructor
     */
    public DeliveryAnalyzeRptUI() throws Exception
    {
        super();this.setUITitle("发运路线优选查询");
	...
	protected CommRptBaseConditionUI getQueryDialogUserPanel() throws Exception {
		return new DeliverySummaryQueryUI();
	}

	@Override
	protected ICommRptBase getRemoteInstance() throws BOSException {
		return DeliveryAnalyzeFacadeFactory.getRemoteInstance();
	}

...
import com.kingdee.eas.custom.rpt.DeliverySummaryFacadeFactory;
 ...
 * output class name
 */
public class DeliverySummaryRptUI extends AbstractDeliverySummaryRptUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliverySummaryRptUI.class);
    
    /**
     * output class constructor
     */
    public DeliverySummaryRptUI() throws Exception
    {
        super();
	...
	protected ICommRptBase getRemoteInstance() throws BOSException {
		return DeliverySummaryFacadeFactory.getRemoteInstance();
	}

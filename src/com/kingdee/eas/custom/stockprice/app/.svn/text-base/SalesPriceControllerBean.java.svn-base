...
public class SalesPriceControllerBean extends AbstractSalesPriceControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.stockprice.app.SalesPriceControllerBean");
}
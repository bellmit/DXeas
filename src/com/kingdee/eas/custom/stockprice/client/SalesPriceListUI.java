 ...
 * output class name
 */
public class SalesPriceListUI extends AbstractSalesPriceListUI
{
	private static final Logger logger = CoreUIObject.getLogger(SalesPriceListUI.class);

	/**
	 * output class constructor
	 */
	public SalesPriceListUI() throws Exception
	{
		super();
	}
	protected FilterInfo getDefaultFilterForQuery(){
		FilterInfo filterNew = new FilterInfo();
		filterNew.getFilterItems().add(new FilterItemInfo("company.id",SysContext.getSysContext().getCurrentCtrlUnit().getString("id")));

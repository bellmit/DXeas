 ...
 * output class name
 */
public abstract class AbstractBasePriceOfOtherCompanyListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBasePriceOfOtherCompanyListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnImportData;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnExportModel;
     ...
     */
    public AbstractBasePriceOfOtherCompanyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBasePriceOfOtherCompanyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.stockprice.app", "BasePriceOfOtherCompanyQuery");
        //actionRemove
        ...
        this.actionImportData.setExtendProperty("userDefined", "false");
        this.actionImportData.setExtendProperty("isObjectUpdateLock", "false");
        ...
        this.actionExportData.setExtendProperty("userDefined", "false");
        this.actionExportData.setExtendProperty("isObjectUpdateLock", "false");
        ...
        // btnExportModel
        this.btnExportModel.setAction((IItemAction)ActionProxyFactory.getProxy(actionExportData, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnExportModel.setText(resHelper.getString("btnExportModel.text"));
        // btnAudit
    ...
    public void initUIToolBarLayout()
    {
        ...
        this.toolBar.add(btnExportModel);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.stockprice.app.BasePriceOfOtherCompanyListUIHandler";
	}
...
com.kingdee.eas.custom.stockprice.BasePriceOfOtherCompanyInfo editData = (com.kingdee.eas.custom.stockprice.BasePriceOfOtherCompanyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.custom.stockprice.BasePriceOfOtherCompanyFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionGetAllMaterial extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionGetAllMaterial", "actionGetAllMaterial_actionPerformed", e);
        }
    }
    ...
    protected class ActionImpExcel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionImpExcel", "actionImpExcel_actionPerformed", e);
        }
    }
    ...
    protected class ActionExpModel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionExpModel", "actionExpModel_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBasePriceOfOtherCompanyListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.stockprice.client", "BasePriceOfOtherCompanyListUI");
    }
    /**
    ...
    {
        return new String[] {"number","bizDate","company","id","createTime","lastUpdateTime","auditor.number","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","entrys.material.name","entrys.unit.name","entrys.currency.name","auditDate","description","auditor.name","creator.name","billStatus","effectDate"};
    }

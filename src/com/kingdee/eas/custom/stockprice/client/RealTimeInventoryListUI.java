 ...
 * output class name
 */
public class RealTimeInventoryListUI extends AbstractRealTimeInventoryListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RealTimeInventoryListUI.class);
     ...
     */
    public RealTimeInventoryListUI() throws Exception
    {
        super();
    }

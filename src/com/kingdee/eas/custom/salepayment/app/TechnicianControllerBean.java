...
public class TechnicianControllerBean extends AbstractTechnicianControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.TechnicianControllerBean");
}
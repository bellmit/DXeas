...
public class MonthFeeControllerBean extends AbstractMonthFeeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.MonthFeeControllerBean");
}
...
public class SalePaymentSetControllerBean extends AbstractSalePaymentSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.SalePaymentSetControllerBean");
}
...
public class AreaTargetControllerBeanEx extends com.kingdee.eas.custom.salepayment.app.AreaTargetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.AreaTargetControllerBeanEx");

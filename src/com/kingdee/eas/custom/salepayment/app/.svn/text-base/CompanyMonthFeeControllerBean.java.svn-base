...
public class CompanyMonthFeeControllerBean extends AbstractCompanyMonthFeeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.CompanyMonthFeeControllerBean");
}
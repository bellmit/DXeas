...
public class LongTimeArAmountControllerBean extends AbstractLongTimeArAmountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.LongTimeArAmountControllerBean");
}
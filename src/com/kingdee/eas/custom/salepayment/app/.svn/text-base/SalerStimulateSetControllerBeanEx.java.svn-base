...
public class SalerStimulateSetControllerBeanEx extends com.kingdee.eas.custom.salepayment.app.SalerStimulateSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.SalerStimulateSetControllerBeanEx");

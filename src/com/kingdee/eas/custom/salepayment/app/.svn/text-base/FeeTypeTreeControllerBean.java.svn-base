...
public class FeeTypeTreeControllerBean extends AbstractFeeTypeTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.FeeTypeTreeControllerBean");
}
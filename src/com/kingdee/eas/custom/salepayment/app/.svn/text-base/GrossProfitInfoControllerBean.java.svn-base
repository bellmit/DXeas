...
public class GrossProfitInfoControllerBean extends AbstractGrossProfitInfoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.GrossProfitInfoControllerBean");
}
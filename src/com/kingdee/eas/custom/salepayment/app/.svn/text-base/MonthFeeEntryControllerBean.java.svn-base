...
public class MonthFeeEntryControllerBean extends AbstractMonthFeeEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.MonthFeeEntryControllerBean");
}
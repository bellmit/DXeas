...
public class CompanyTargetControllerBeanEx extends com.kingdee.eas.custom.salepayment.app.CompanyTargetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.CompanyTargetControllerBeanEx");

...
public class CustomerSaleTargetControllerBeanEx extends com.kingdee.eas.custom.salepayment.app.CustomerSaleTargetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.CustomerSaleTargetControllerBeanEx");

...
public class AreaTargetTreeControllerBean extends AbstractAreaTargetTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.AreaTargetTreeControllerBean");
}
...
public class SaleFeeInputControllerBean extends AbstractSaleFeeInputControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.salepayment.app.SaleFeeInputControllerBean");
}
...
public class CompanyTargetAreaEntry extends CoreBillEntryBase implements ICompanyTargetAreaEntry
{
    public CompanyTargetAreaEntry()
    {
        super();
        registerInterface(ICompanyTargetAreaEntry.class, this);
    }
    public CompanyTargetAreaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICompanyTargetAreaEntry.class, this);
    }
    ...
    private CompanyTargetAreaEntryController getController() throws BOSException
    {
        return (CompanyTargetAreaEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompanyTargetAreaEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

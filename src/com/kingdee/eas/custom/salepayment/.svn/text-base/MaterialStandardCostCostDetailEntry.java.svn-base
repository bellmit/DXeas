...
public class MaterialStandardCostCostDetailEntry extends CoreBillEntryBase implements IMaterialStandardCostCostDetailEntry
{
    public MaterialStandardCostCostDetailEntry()
    {
        super();
        registerInterface(IMaterialStandardCostCostDetailEntry.class, this);
    }
    public MaterialStandardCostCostDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMaterialStandardCostCostDetailEntry.class, this);
    }
    ...
    private MaterialStandardCostCostDetailEntryController getController() throws BOSException
    {
        return (MaterialStandardCostCostDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialStandardCostCostDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

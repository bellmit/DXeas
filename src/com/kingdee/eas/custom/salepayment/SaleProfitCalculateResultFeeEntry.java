...
public class SaleProfitCalculateResultFeeEntry extends CoreBillEntryBase implements ISaleProfitCalculateResultFeeEntry
{
    public SaleProfitCalculateResultFeeEntry()
    {
        super();
        registerInterface(ISaleProfitCalculateResultFeeEntry.class, this);
    }
    public SaleProfitCalculateResultFeeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISaleProfitCalculateResultFeeEntry.class, this);
    }
    ...
    private SaleProfitCalculateResultFeeEntryController getController() throws BOSException
    {
        return (SaleProfitCalculateResultFeeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSaleProfitCalculateResultFeeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

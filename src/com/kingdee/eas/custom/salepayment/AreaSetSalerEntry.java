...
public class AreaSetSalerEntry extends CoreBillEntryBase implements IAreaSetSalerEntry
{
    public AreaSetSalerEntry()
    {
        super();
        registerInterface(IAreaSetSalerEntry.class, this);
    }
    public AreaSetSalerEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAreaSetSalerEntry.class, this);
    }
    ...
    private AreaSetSalerEntryController getController() throws BOSException
    {
        return (AreaSetSalerEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAreaSetSalerEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAreaSetSalerEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAreaSetSalerEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAreaSetSalerEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAreaSetSalerEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAreaSetSalerEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

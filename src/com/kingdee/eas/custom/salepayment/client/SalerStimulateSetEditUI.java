 ...
 * output class name
 */
public class SalerStimulateSetEditUI extends AbstractSalerStimulateSetEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SalerStimulateSetEditUI.class);
    
    /**
     * output class constructor
     */
    public SalerStimulateSetEditUI() throws Exception
    {
        super();
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.custom.salepayment.SalerStimulateSetTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

 ...
 * output class name
 */
public abstract class AbstractCustomerSaleTargetEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCustomerSaleTargetEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conttargetAmount;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txttargetAmount;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcompany;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.eas.custom.salepayment.CustomerSaleTargetInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractCustomerSaleTargetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCustomerSaleTargetEditUI.class.getName());
        ...
        this.conttargetAmount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txttargetAmount = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.conttargetAmount.setName("conttargetAmount");
        ...
        this.txttargetAmount.setName("txttargetAmount");
        ...
        // conttargetAmount		
        this.conttargetAmount.setBoundLabelText(resHelper.getString("conttargetAmount.boundLabelText"));		
        this.conttargetAmount.setBoundLabelLength(100);		
        this.conttargetAmount.setBoundLabelUnderline(true);		
        this.conttargetAmount.setVisible(true);
        // contcompany		
        ...
        // txttargetAmount		
        this.txttargetAmount.setVisible(true);		
        this.txttargetAmount.setHorizontalAlignment(2);		
        this.txttargetAmount.setDataType(1);		
        this.txttargetAmount.setSupportedEmpty(true);		
        this.txttargetAmount.setMinimumValue( new java.math.BigDecimal("-1.0E26"));		
        this.txttargetAmount.setMaximumValue( new java.math.BigDecimal("1.0E26"));		
        this.txttargetAmount.setPrecision(2);		
        this.txttargetAmount.setRequired(true);
        // prmtcompany		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcustomer,baseStatus,indexType,txtyear,quarter,txttargetAmount,prmtcompany}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(108, 51, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(455, 51, 270, 19));
        ...
        contcustomer.setBounds(new Rectangle(455, 96, 270, 19));
        this.add(contcustomer, null);
        contbaseStatus.setBounds(new Rectangle(455, 141, 270, 19));
        this.add(contbaseStatus, null);
        contindexType.setBounds(new Rectangle(108, 141, 270, 19));
        this.add(contindexType, null);
        contyear.setBounds(new Rectangle(108, 186, 270, 19));
        this.add(contyear, null);
        contquarter.setBounds(new Rectangle(455, 186, 270, 19));
        this.add(contquarter, null);
        conttargetAmount.setBounds(new Rectangle(108, 233, 270, 19));
        this.add(conttargetAmount, null);
        contcompany.setBounds(new Rectangle(108, 96, 270, 19));
        ...
        //conttargetAmount
        conttargetAmount.setBoundEditor(txttargetAmount);
        //contcompany
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("targetAmount", java.math.BigDecimal.class, this.txttargetAmount, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.CustomerSaleTargetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.salepayment.CustomerSaleTargetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("targetAmount", ValidateHelper.ON_SAVE);    
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCustomerSaleTargetEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCustomerSaleTargetEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "CustomerSaleTargetEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txttargetAmount.getValue())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"目标不含税销售额"});
		}

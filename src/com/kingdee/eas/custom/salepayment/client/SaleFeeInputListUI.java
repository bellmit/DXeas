 ...
 * output class name
 */
public class SaleFeeInputListUI extends AbstractSaleFeeInputListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleFeeInputListUI.class);
    
    /**
     * output class constructor
     */
    public SaleFeeInputListUI() throws Exception
    {
        super();
    }

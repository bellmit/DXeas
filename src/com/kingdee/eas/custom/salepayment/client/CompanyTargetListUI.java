 ...
 * output class name
 */
public class CompanyTargetListUI extends AbstractCompanyTargetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompanyTargetListUI.class);
    
    /**
     * output class constructor
     */
    public CompanyTargetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.CompanyTargetTreeEditUI.class.getName();
    }

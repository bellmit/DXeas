 ...
 * output class name
 */
public abstract class AbstractSaleProfitCalculateUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleProfitCalculateUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDProgressBar pbProgress;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtCompanyTarget;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtCompany;
    /**
     * output class constructor
     */
    public AbstractSaleProfitCalculateUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleProfitCalculateUI.class.getName());
        ...
        this.pbProgress = new com.kingdee.bos.ctrl.swing.KDProgressBar();
        ...
        this.pbProgress.setName("pbProgress");
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(71, 67, 257, 19));
        this.add(kDLabelContainer1, null);
        kDSeparator2.setBounds(new Rectangle(34, 114, 330, 10));
        this.add(kDSeparator2, null);
        kDLabelContainer2.setBounds(new Rectangle(71, 39, 257, 19));
        this.add(kDLabelContainer2, null);
        btnExecute.setBounds(new Rectangle(133, 241, 100, 21));
        this.add(btnExecute, null);
        pbProgress.setBounds(new Rectangle(17, 140, 372, 21));
        this.add(pbProgress, null);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(prmtCompanyTarget);
        //kDLabelContainer2
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.SaleProfitCalculateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "SaleProfitCalculateUI");
    }

 ...
 * output class name
 */
public abstract class AbstractFeeTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeeTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractFeeTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractFeeTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeeTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.salepayment.app", "FeeTypeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.FeeTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "FeeTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.FeeTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.salepayment.FeeTypeInfo objectValue = new com.kingdee.eas.custom.salepayment.FeeTypeInfo();		
        return objectValue;
    }

 ...
 * output class name
 */
public class LongTimeArAmountListUI extends AbstractLongTimeArAmountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LongTimeArAmountListUI.class);
    
    /**
     * output class constructor
     */
    public LongTimeArAmountListUI() throws Exception
    {
        super();
    }

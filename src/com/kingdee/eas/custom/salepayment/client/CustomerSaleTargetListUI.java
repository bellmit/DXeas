 ...
 * output class name
 */
public class CustomerSaleTargetListUI extends AbstractCustomerSaleTargetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerSaleTargetListUI.class);
    
    /**
     * output class constructor
     */
    public CustomerSaleTargetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.CustomerSaleTargetTreeEditUI.class.getName();
    }

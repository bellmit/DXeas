 ...
 * output class name
 */
public class MaterialStandardCostListUI extends AbstractMaterialStandardCostListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialStandardCostListUI.class);
    
    /**
     * output class constructor
     */
    public MaterialStandardCostListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.MaterialStandardCostTreeEditUI.class.getName();
    }

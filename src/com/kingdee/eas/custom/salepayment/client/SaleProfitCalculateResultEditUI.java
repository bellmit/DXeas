 ...
 * output class name
 */
public class SaleProfitCalculateResultEditUI extends AbstractSaleProfitCalculateResultEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleProfitCalculateResultEditUI.class);
    
    /**
     * output class constructor
     */
    public SaleProfitCalculateResultEditUI() throws Exception
    {
        super();
    }
    /**

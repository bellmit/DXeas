...
public abstract class AbstractAreaSetEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtarea;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcompany;
    protected com.kingdee.eas.custom.salepayment.AreaSetInfo editData = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.txtarea = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        // kdtSalerEntry
		String kdtSalerEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"saler\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"area\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{saler}</t:Cell><t:Cell>$Resource{area}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtSalerEntry.setFormatXml(resHelper.translateString("kdtSalerEntry",kdtSalerEntryStrXML));

                this.kdtSalerEntry.putBindContents("editData",new String[] {"seq","saler","area"});
        ...
        kdtSalerEntry_saler_OVR.setFormat(new BizDataFormat("$number$-$name$"));
        this.kdtSalerEntry.getColumn("saler").setRenderer(kdtSalerEntry_saler_OVR);
        KDTextField kdtSalerEntry_area_TextField = new KDTextField();
        kdtSalerEntry_area_TextField.setName("kdtSalerEntry_area_TextField");
        kdtSalerEntry_area_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtSalerEntry_area_CellEditor = new KDTDefaultCellEditor(kdtSalerEntry_area_TextField);
        this.kdtSalerEntry.getColumn("area").setEditor(kdtSalerEntry_area_CellEditor);
        // contcompany		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtSimpleName,txtDescription,txtNumber,txtName,prmtperson,txtarea,kdtSalerEntry,prmtcompany}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer1.setBounds(new Rectangle(28, 18, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(28, 18, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(373, 18, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(373, 18, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contperson.setBounds(new Rectangle(28, 52, 270, 19));
        this.add(contperson, new KDLayout.Constraints(28, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contarea.setBounds(new Rectangle(373, 52, 270, 19));
        this.add(contarea, new KDLayout.Constraints(373, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtSalerEntry.setBounds(new Rectangle(17, 84, 984, 506));
        kdtSalerEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtSalerEntry,new com.kingdee.eas.custom.salepayment.AreaSetSalerEntryInfo(),null,false);
        this.add(kdtSalerEntry_detailPanel, new KDLayout.Constraints(17, 84, 984, 506, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contcompany.setBounds(new Rectangle(718, 18, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(718, 18, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("SalerEntry", com.kingdee.eas.custom.salepayment.AreaSetSalerEntryInfo.class, this.kdtSalerEntry, "userObject");
		dataBinder.registerBinding("SalerEntry.saler", java.lang.Object.class, this.kdtSalerEntry, "saler.text");
		dataBinder.registerBinding("SalerEntry.area", String.class, this.kdtSalerEntry, "area.text");
		dataBinder.registerBinding("number", String.class, this.txtNumber, "text");
		dataBinder.registerBinding("name", String.class, this.txtName, "_multiLangItem");
		dataBinder.registerBinding("simpleName", String.class, this.txtSimpleName, "text");
		dataBinder.registerBinding("description", String.class, this.txtDescription, "_multiLangItem");
		dataBinder.registerBinding("person", com.kingdee.eas.basedata.person.PersonInfo.class, this.prmtperson, "data");
		dataBinder.registerBinding("area", String.class, this.txtarea, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.AreaSetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.salepayment.AreaSetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("SalerEntry.area", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("SalerEntry.area"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "AreaSetEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.AreaSetEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtperson.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"大区经理"});
		}

 ...
 * output class name
 */
public class SaleProfitCalculateResultListUI extends AbstractSaleProfitCalculateResultListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SaleProfitCalculateResultListUI.class);
    
    /**
     * output class constructor
     */
    public SaleProfitCalculateResultListUI() throws Exception
    {
        super();
    }

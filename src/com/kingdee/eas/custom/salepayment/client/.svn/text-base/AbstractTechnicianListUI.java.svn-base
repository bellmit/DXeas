 ...
 * output class name
 */
public abstract class AbstractTechnicianListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTechnicianListUI.class);
    /**
     * output class constructor
     */
    public AbstractTechnicianListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.TechnicianListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "TechnicianListUI");
    }

 ...
 * output class name
 */
public abstract class AbstractSalerStimulateSetListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSalerStimulateSetListUI.class);
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractSalerStimulateSetListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractSalerStimulateSetListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSalerStimulateSetListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.custom.salepayment.app", "SalerStimulateSetQuery");
        //actionAudit
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.SalerStimulateSetListUIHandler";
	}
...
com.kingdee.eas.custom.salepayment.SalerStimulateSetInfo editData = (com.kingdee.eas.custom.salepayment.SalerStimulateSetInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.custom.salepayment.SalerStimulateSetFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSalerStimulateSetListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSalerStimulateSetListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "SalerStimulateSetListUI");
    }

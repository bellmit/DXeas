 ...
 * output class name
 */
public class MonthFeeListUI extends AbstractMonthFeeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthFeeListUI.class);
    
    /**
     * output class constructor
     */
    public MonthFeeListUI() throws Exception
    {
        super();
    }

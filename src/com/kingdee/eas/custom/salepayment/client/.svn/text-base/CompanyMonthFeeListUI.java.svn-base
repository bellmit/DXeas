 ...
 * output class name
 */
public class CompanyMonthFeeListUI extends AbstractCompanyMonthFeeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompanyMonthFeeListUI.class);
    
    /**
     * output class constructor
     */
    public CompanyMonthFeeListUI() throws Exception
    {
        super();
    }

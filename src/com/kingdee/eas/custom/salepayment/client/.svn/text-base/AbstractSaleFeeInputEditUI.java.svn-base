 ...
 * output class name
 */
public abstract class AbstractSaleFeeInputEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleFeeInputEditUI.class);
    ...
    protected com.kingdee.eas.custom.salepayment.SaleFeeInputInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSaleFeeInputEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleFeeInputEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtyear,txtmonth,pkauditTime,prmtcompany,baseStatus,prmtsaler}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.custom.salepayment.SaleFeeInputEntryInfo(),null,false);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.custom.salepayment.SaleFeeInputEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.SaleFeeInputEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.salepayment.SaleFeeInputInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "SaleFeeInputEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.SaleFeeInputEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.SaleFeeInputFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.custom.salepayment.SaleFeeInputInfo objectValue = new com.kingdee.eas.custom.salepayment.SaleFeeInputInfo();
    	...
    	return "/bim/custom/salepayment/SaleFeeInput";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.custom.salepayment.app.SaleFeeInputQuery");
	}
    
        
					protected void beforeStoreFields(ActionEvent arg0) throws Exception {
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"feeType").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"费用类型"});
			}
		}
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {

 ...
 * output class name
 */
public abstract class AbstractSalePaymentSetEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSalePaymentSetEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contmanageFeeShareType;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox manageFeeShareType;
    protected com.kingdee.bos.ctrl.swing.KDComboBox profitExeType;
    protected com.kingdee.eas.custom.salepayment.SalePaymentSetInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSalePaymentSetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSalePaymentSetEditUI.class.getName());
        ...
        this.contmanageFeeShareType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.manageFeeShareType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contmanageFeeShareType.setName("contmanageFeeShareType");
        ...
        this.manageFeeShareType.setName("manageFeeShareType");
        ...
        // contmanageFeeShareType		
        this.contmanageFeeShareType.setBoundLabelText(resHelper.getString("contmanageFeeShareType.boundLabelText"));		
        this.contmanageFeeShareType.setBoundLabelLength(100);		
        this.contmanageFeeShareType.setBoundLabelUnderline(true);		
        this.contmanageFeeShareType.setVisible(true);
        // contprofitExeType		
        ...
        // recDataSource		
        this.recDataSource.setVisible(true);		
        ...
        // manageFeeShareType		
        this.manageFeeShareType.setVisible(true);		
        this.manageFeeShareType.addItems(EnumUtils.getEnumList("com.kingdee.eas.custom.salepayment.ManageFeeShareType").toArray());		
        this.manageFeeShareType.setRequired(false);
        // profitExeType		
        this.profitExeType.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,recDataSource,manageFeeShareType,profitExeType}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(34, 45, 270, 19));
        ...
        contcompany.setBounds(new Rectangle(361, 45, 270, 19));
        this.add(contcompany, null);
        kDSeparator5.setBounds(new Rectangle(34, 88, 960, 10));
        this.add(kDSeparator5, null);
        contrecDataSource.setBounds(new Rectangle(34, 121, 270, 19));
        this.add(contrecDataSource, null);
        contmanageFeeShareType.setBounds(new Rectangle(358, 121, 270, 19));
        this.add(contmanageFeeShareType, null);
        contprofitExeType.setBounds(new Rectangle(34, 162, 270, 19));
        this.add(contprofitExeType, null);
        //kDLabelContainer1
        ...
        //contmanageFeeShareType
        contmanageFeeShareType.setBoundEditor(manageFeeShareType);
        //contprofitExeType
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("manageFeeShareType", com.kingdee.eas.custom.salepayment.ManageFeeShareType.class, this.manageFeeShareType, "selectedItem");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.custom.salepayment.app.SalePaymentSetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.custom.salepayment.SalePaymentSetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("manageFeeShareType", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("manageFeeShareType"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.custom.salepayment.client", "SalePaymentSetEditUI");
    }
    ...
    {
        return com.kingdee.eas.custom.salepayment.client.SalePaymentSetEditUI.class.getName();
    }

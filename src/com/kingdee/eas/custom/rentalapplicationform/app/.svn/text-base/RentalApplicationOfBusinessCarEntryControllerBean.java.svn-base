...
public class RentalApplicationOfBusinessCarEntryControllerBean extends AbstractRentalApplicationOfBusinessCarEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.rentalapplicationform.app.RentalApplicationOfBusinessCarEntryControllerBean");
}
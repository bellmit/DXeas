...
public class PurBudgetEntryControllerBean extends AbstractPurBudgetEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.purchasebudget.app.PurBudgetEntryControllerBean");
}
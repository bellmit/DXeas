 ...
 * output class name
 */
public abstract class AbstractSupplierReqListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionSupplierAudit(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionSupplierAudit(request,response,context);
	}
	protected void _handleActionSupplierAudit(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

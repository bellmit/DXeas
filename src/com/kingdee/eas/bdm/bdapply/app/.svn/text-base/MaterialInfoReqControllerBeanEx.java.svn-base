...
public class MaterialInfoReqControllerBeanEx extends com.kingdee.eas.bdm.bdapply.app.MaterialInfoReqControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.bdm.bdapply.app.MaterialInfoReqControllerBeanEx");
    protected void _materialInfoAudit(Context ctx, IObjectValue model)throws BOSException
    {
	     super._materialInfoAudit(ctx, model);
    }

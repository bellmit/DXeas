...
public class UserReqControllerBeanEx extends com.kingdee.eas.bdm.bdapply.app.UserReqControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.bdm.bdapply.app.UserReqControllerBeanEx");

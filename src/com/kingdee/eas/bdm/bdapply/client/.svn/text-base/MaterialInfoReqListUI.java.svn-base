...
import com.kingdee.eas.bdm.bdapply.IMaterialInfoReq;
 ...
 * output class name
 */
public class MaterialInfoReqListUI extends AbstractMaterialInfoReqListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MaterialInfoReqListUI.class);
    private static final Color APPROVEColor = new Color(252, 255, 206);
    /**
     * output class constructor
     */
    public MaterialInfoReqListUI() throws Exception
    {
        super();
    ...
    {
        return MaterialInfoReqFactory.getRemoteInstance();
    }
    ...
    {
    	MaterialInfoReqInfo objectValue = new MaterialInfoReqInfo();
        return objectValue;
    }
    public void actionAllAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		String number = "";
		MaterialInfoReqInfo info;
		IMaterialInfoReq is = MaterialInfoReqFactory.getRemoteInstance();
		for (int i = 0; i < ids.size(); ++i) {
			if (ids.get(i) == null)
				continue;
			info = is.getMaterialInfoReqInfo(new ObjectUuidPK(ids.get(i).toString()));
    ...
    public void actionBasenotby_actionPerformed(ActionEvent e) throws Exception
    {
		...
		MaterialInfoReqInfo info = MaterialInfoReqFactory.getRemoteInstance().getMaterialInfoReqInfo(pk);

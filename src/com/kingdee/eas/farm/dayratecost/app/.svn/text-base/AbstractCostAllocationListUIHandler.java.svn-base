 ...
 * output class name
 */
public abstract class AbstractCostAllocationListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionExeAllocation(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionExeAllocation(request,response,context);
	}
	protected void _handleActionExeAllocation(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
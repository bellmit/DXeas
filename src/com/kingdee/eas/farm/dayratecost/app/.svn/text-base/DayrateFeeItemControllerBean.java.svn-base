...
import com.kingdee.eas.farm.dayratecost.DayrateFeeItemFactory;
import com.kingdee.eas.farm.dayratecost.DayrateFeeItemInfo;
import com.kingdee.eas.farm.stocking.basedata.FarmBaseStatusEnum;
import com.kingdee.util.NumericExceptionSubItem;

public class DayrateFeeItemControllerBean extends AbstractDayrateFeeItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.dayratecost.app.DayrateFeeItemControllerBean");
    @Override
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		 DayrateFeeItemInfo info = ( DayrateFeeItemInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		 DayrateFeeItemInfo info =  DayrateFeeItemFactory.getLocalInstance(ctx).getDayrateFeeItemInfo(pk);
		if (info.getBaseStatus().equals(FarmBaseStatusEnum.approve) || info.getBaseStatus().equals(FarmBaseStatusEnum.enable)) {
			throw new EASBizException(new NumericExceptionSubItem("001","资料已经核准或启用！"));
		}

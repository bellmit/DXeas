...
public class DayRateCostDetailArOffSetDetail extends CoreBillEntryBase implements IDayRateCostDetailArOffSetDetail
{
    public DayRateCostDetailArOffSetDetail()
    {
        super();
        registerInterface(IDayRateCostDetailArOffSetDetail.class, this);
    }
    public DayRateCostDetailArOffSetDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IDayRateCostDetailArOffSetDetail.class, this);
    }
    ...
    private DayRateCostDetailArOffSetDetailController getController() throws BOSException
    {
        return (DayRateCostDetailArOffSetDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailArOffSetDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

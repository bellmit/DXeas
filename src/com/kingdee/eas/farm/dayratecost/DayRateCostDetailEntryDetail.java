...
public class DayRateCostDetailEntryDetail extends CoreBillEntryBase implements IDayRateCostDetailEntryDetail
{
    public DayRateCostDetailEntryDetail()
    {
        super();
        registerInterface(IDayRateCostDetailEntryDetail.class, this);
    }
    public DayRateCostDetailEntryDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IDayRateCostDetailEntryDetail.class, this);
    }
    ...
    private DayRateCostDetailEntryDetailController getController() throws BOSException
    {
        return (DayRateCostDetailEntryDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDayRateCostDetailEntryDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

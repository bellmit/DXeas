 ...
 * output class name
 */
public class DayrateFeeItemEditUI extends AbstractDayrateFeeItemEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DayrateFeeItemEditUI.class);
    
    /**
     * output class constructor
     */
    public DayrateFeeItemEditUI() throws Exception
    {
        super();
    }
    @Override
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.dayratecost.DayrateFeeItemTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

 ...
 * output class name
 */
public class DayRateBaseSettingListUI extends AbstractDayRateBaseSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DayRateBaseSettingListUI.class);
    
    /**
     * output class constructor
     */
    public DayRateBaseSettingListUI() throws Exception
    {
        super();
    }

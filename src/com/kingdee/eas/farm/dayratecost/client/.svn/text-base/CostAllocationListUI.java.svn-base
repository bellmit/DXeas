 ...
 * output class name
 */
public class CostAllocationListUI extends AbstractCostAllocationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CostAllocationListUI.class);
    
    /**
     * output class constructor
     */
    public CostAllocationListUI() throws Exception
    {
        super();
    }

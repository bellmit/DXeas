 ...
 * output class name
 */
public class DayRateInitBillListUI extends AbstractDayRateInitBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DayRateInitBillListUI.class);
    
    /**
     * output class constructor
     */
    public DayRateInitBillListUI() throws Exception
    {
        super();
    }
	...
	public void actionInitialize_actionPerformed(ActionEvent e)
			throws Exception {
		if(MsgBox.showConfirm2("是否进行初始化操作？")==MsgBox.OK) {
			super.actionInitialize_actionPerformed(e);
			MsgBox.showInfo("初始化完成！");
		}
	}

	public void actionUnInitialize_actionPerformed(ActionEvent e)
			throws Exception {
		// TODO Auto-generated method stub
		if(MsgBox.showConfirm2("是否进行反初始化操作？")==MsgBox.OK) {
			super.actionUnInitialize_actionPerformed(e);
			MsgBox.showInfo("反初始化完成！");
		}
	}

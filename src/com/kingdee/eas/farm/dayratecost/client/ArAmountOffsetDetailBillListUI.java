 ...
 * output class name
 */
public class ArAmountOffsetDetailBillListUI extends AbstractArAmountOffsetDetailBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ArAmountOffsetDetailBillListUI.class);
    
    /**
     * output class constructor
     */
    public ArAmountOffsetDetailBillListUI() throws Exception
    {
        super();
    }

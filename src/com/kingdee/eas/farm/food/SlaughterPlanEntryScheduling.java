...
public class SlaughterPlanEntryScheduling extends CoreBillEntryBase implements ISlaughterPlanEntryScheduling
{
    public SlaughterPlanEntryScheduling()
    {
        super();
        registerInterface(ISlaughterPlanEntryScheduling.class, this);
    }
    public SlaughterPlanEntryScheduling(Context ctx)
    {
        super(ctx);
        registerInterface(ISlaughterPlanEntryScheduling.class, this);
    }
    ...
    private SlaughterPlanEntrySchedulingController getController() throws BOSException
    {
        return (SlaughterPlanEntrySchedulingController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSlaughterPlanEntrySchedulingCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class ChickenDailyCarCassEntry extends CoreBillEntryBase implements IChickenDailyCarCassEntry
{
    public ChickenDailyCarCassEntry()
    {
        super();
        registerInterface(IChickenDailyCarCassEntry.class, this);
    }
    public ChickenDailyCarCassEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChickenDailyCarCassEntry.class, this);
    }
    ...
    private ChickenDailyCarCassEntryController getController() throws BOSException
    {
        return (ChickenDailyCarCassEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenDailyCarCassEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
import com.kingdee.eas.farm.food.FuleDaliyFactory;
...
public class FuleDaliyControllerBean extends AbstractFuleDaliyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.FuleDaliyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FuleDaliyInfo info = (FuleDaliyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FuleDaliyInfo info = FuleDaliyFactory.getLocalInstance(ctx).getFuleDaliyInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED)) {

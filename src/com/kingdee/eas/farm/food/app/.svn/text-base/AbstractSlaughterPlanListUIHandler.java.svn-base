 ...
 * output class name
 */
public abstract class AbstractSlaughterPlanListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionGetSlaughterPlan(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionGetSlaughterPlan(request,response,context);
	}
	protected void _handleActionGetSlaughterPlan(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

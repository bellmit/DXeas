...
public class CManufactureBillEntryControllerBean extends AbstractCManufactureBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.CManufactureBillEntryControllerBean");
}
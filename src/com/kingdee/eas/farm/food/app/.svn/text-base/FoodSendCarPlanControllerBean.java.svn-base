...
import com.kingdee.eas.farm.food.FoodSendCarPlanFactory;
...
public class FoodSendCarPlanControllerBean extends AbstractFoodSendCarPlanControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.FoodSendCarPlanControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FoodSendCarPlanInfo info = (FoodSendCarPlanInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FoodSendCarPlanInfo info = FoodSendCarPlanFactory.getLocalInstance(ctx).getFoodSendCarPlanInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED)) {

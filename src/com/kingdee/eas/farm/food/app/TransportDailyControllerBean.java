...
import com.kingdee.eas.farm.food.TransportDailyFactory;
...
public class TransportDailyControllerBean extends AbstractTransportDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.TransportDailyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		TransportDailyInfo info = (TransportDailyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		TransportDailyInfo info = TransportDailyFactory.getLocalInstance(ctx).getTransportDailyInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED)) {

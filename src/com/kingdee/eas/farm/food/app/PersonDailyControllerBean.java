...
import com.kingdee.eas.farm.food.PersonDailyFactory;
...
public class PersonDailyControllerBean extends AbstractPersonDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.PersonDailyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		PersonDailyInfo info = (PersonDailyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		PersonDailyInfo info = PersonDailyFactory.getLocalInstance(ctx).getPersonDailyInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED)) {

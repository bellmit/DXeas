...
import com.kingdee.eas.farm.food.ChickenDailyFactory;
...
public class ChickenDailyControllerBean extends AbstractChickenDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.app.ChickenDailyControllerBean");
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		ChickenDailyInfo info = (ChickenDailyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		ChickenDailyInfo info = ChickenDailyFactory.getLocalInstance(ctx).getChickenDailyInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED)) {

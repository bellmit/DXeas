...
public class FoodBaseData extends DataBase implements IFoodBaseData
{
    public FoodBaseData()
    {
        super();
        registerInterface(IFoodBaseData.class, this);
    }
    public FoodBaseData(Context ctx)
    {
        super(ctx);
        registerInterface(IFoodBaseData.class, this);
    }
    ...
    private FoodBaseDataController getController() throws BOSException
    {
        return (FoodBaseDataController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFoodBaseDataInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getFoodBaseDataInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodBaseDataInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodBaseDataCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodBaseDataCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFoodBaseDataCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

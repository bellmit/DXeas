...
public class ProdCountControllerBean extends AbstractProdCountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.stocount.app.ProdCountControllerBean");
    
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		ProdCountInfo info = (ProdCountInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		ProdCountInfo info = ProdCountFactory.getLocalInstance(ctx).getProdCountInfo(pk);
		if (info.getStatus().equals(BillBaseStatusEnum.AUDITED)) {

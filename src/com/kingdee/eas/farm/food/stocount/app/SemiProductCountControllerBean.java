...
public class SemiProductCountControllerBean extends AbstractSemiProductCountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.stocount.app.SemiProductCountControllerBean");
}
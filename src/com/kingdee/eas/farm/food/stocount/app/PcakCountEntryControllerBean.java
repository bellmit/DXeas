...
public class PcakCountEntryControllerBean extends AbstractPcakCountEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.stocount.app.PcakCountEntryControllerBean");
}
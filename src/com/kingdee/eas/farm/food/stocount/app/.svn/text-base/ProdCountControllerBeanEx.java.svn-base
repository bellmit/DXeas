...
public class ProdCountControllerBeanEx extends com.kingdee.eas.farm.food.stocount.app.ProdCountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.stocount.app.ProdCountControllerBeanEx");

...
public class ProdCountEntryControllerBean extends AbstractProdCountEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.food.stocount.app.ProdCountEntryControllerBean");
}
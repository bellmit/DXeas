 ...
 * output class name
 */
public class SemiProductCountListUI extends AbstractSemiProductCountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SemiProductCountListUI.class);
    
    /**
     * output class constructor
     */
    public SemiProductCountListUI() throws Exception
    {
        super();
    }
    /* (non-Javadoc)
...
//       filterNew.getFilterItems().add(new FilterItemInfo("person.name",SysContext.getSysContext().getCurrentUserInfo().getPerson().getName(),CompareType.EQUALS));
//        return filterNew;
//       
//   }

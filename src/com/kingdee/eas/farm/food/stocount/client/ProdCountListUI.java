 ...
 * output class name
 */
public class ProdCountListUI extends AbstractProdCountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProdCountListUI.class);
    
    /**
     * output class constructor
     */
    public ProdCountListUI() throws Exception
    {
        super();
    }

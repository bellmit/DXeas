 ...
 * output class name
 */
public class PcakCountListUI extends AbstractPcakCountListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PcakCountListUI.class);
    
    /**
     * output class constructor
     */
    public PcakCountListUI() throws Exception
    {
        super();
    }
    @Override
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.farm.food.stocount.client.AbstractPcakCountListUI#actionAudit_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.farm.food.stocount.client.AbstractPcakCountListUI#actionUnaudit_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override
    ...
    protected String[] getSumColNames()
    {
        ...
        return new String[] { "entrys.mnumber0"};
    }

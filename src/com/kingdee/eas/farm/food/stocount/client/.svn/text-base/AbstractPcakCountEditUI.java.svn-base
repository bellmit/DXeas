 ...
 * output class name
 */
public abstract class AbstractPcakCountEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPcakCountEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contmbaseunit;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contmnumber;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtmaterialtype;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtmbaseunit;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtmnumber;
    protected com.kingdee.bos.ctrl.swing.KDDatePicker pkproductDate;
    protected com.kingdee.bos.ctrl.swing.KDComboBox classes;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtbatch;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton audit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton unaudit;
    protected com.kingdee.eas.farm.food.stocount.PcakCountInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnaudit actionUnaudit = null;
    /**
     * output class constructor
     */
    public AbstractPcakCountEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPcakCountEditUI.class.getName());
        ...
        this.contmbaseunit = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contmnumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtmaterialtype = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtmbaseunit = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtmnumber = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.pkproductDate = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.classes = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.txtbatch = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contmbaseunit.setName("contmbaseunit");
        this.contmnumber.setName("contmnumber");
        ...
        this.txtmaterialtype.setName("txtmaterialtype");
        this.txtmbaseunit.setName("txtmbaseunit");
        this.txtmnumber.setName("txtmnumber");
        this.pkproductDate.setName("pkproductDate");
        this.classes.setName("classes");
        this.txtbatch.setName("txtbatch");
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","batch","materialnumber","materialtype","mbaseunit","productDate","mnumber"});
        ...
        this.contmaterialtype.setVisible(true);
        // contmbaseunit		
        this.contmbaseunit.setBoundLabelText(resHelper.getString("contmbaseunit.boundLabelText"));		
        this.contmbaseunit.setBoundLabelLength(100);		
        this.contmbaseunit.setBoundLabelUnderline(true);		
        this.contmbaseunit.setVisible(true);
        // contmnumber		
        this.contmnumber.setBoundLabelText(resHelper.getString("contmnumber.boundLabelText"));		
        this.contmnumber.setBoundLabelLength(100);		
        this.contmnumber.setBoundLabelUnderline(true);		
        this.contmnumber.setVisible(true);
        // contproductDate		
        ...
        this.chkIsPackAcceptance.setEnabled(false);
        // prmtCreator		
        ...
        // txtmaterialtype		
        this.txtmaterialtype.setHorizontalAlignment(2);		
        this.txtmaterialtype.setMaxLength(80);		
        this.txtmaterialtype.setRequired(false);		
        this.txtmaterialtype.setVisible(false);
        // txtmbaseunit		
        this.txtmbaseunit.setHorizontalAlignment(2);		
        this.txtmbaseunit.setMaxLength(80);		
        this.txtmbaseunit.setRequired(false);		
        this.txtmbaseunit.setVisible(false);
        // txtmnumber		
        this.txtmnumber.setHorizontalAlignment(2);		
        this.txtmnumber.setDataType(1);		
        this.txtmnumber.setSupportedEmpty(true);		
        this.txtmnumber.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtmnumber.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtmnumber.setPrecision(4);		
        this.txtmnumber.setRequired(false);		
        this.txtmnumber.setVisible(false);
        // pkproductDate		
        this.pkproductDate.setRequired(false);		
        this.pkproductDate.setVisible(false);
        // classes		
        ...
        // txtbatch		
        this.txtbatch.setHorizontalAlignment(2);		
        this.txtbatch.setMaxLength(100);		
        this.txtbatch.setRequired(false);		
        this.txtbatch.setVisible(false);
        // audit
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.food.stocount.PcakCountEntryInfo(),null,false);
        ...
        contperson.setBounds(new Rectangle(20, 133, 270, 19));
        this.add(contperson, new KDLayout.Constraints(20, 133, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsemcount.setBounds(new Rectangle(366, 134, 270, 19));
        this.add(contsemcount, new KDLayout.Constraints(366, 134, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contmaterial.setBounds(new Rectangle(25, -217, 270, 19));
        this.add(contmaterial, new KDLayout.Constraints(25, -217, 270, 19, 0));
        contmaterialtype.setBounds(new Rectangle(367, -215, 270, 19));
        this.add(contmaterialtype, new KDLayout.Constraints(367, -215, 270, 19, 0));
        contmbaseunit.setBounds(new Rectangle(715, -212, 270, 19));
        this.add(contmbaseunit, new KDLayout.Constraints(715, -212, 270, 19, 0));
        contmnumber.setBounds(new Rectangle(365, -299, 270, 19));
        this.add(contmnumber, new KDLayout.Constraints(365, -299, 270, 19, 0));
        contproductDate.setBounds(new Rectangle(22, -299, 270, 19));
        this.add(contproductDate, new KDLayout.Constraints(22, -299, 270, 19, 0));
        contclasses.setBounds(new Rectangle(709, 132, 270, 19));
        this.add(contclasses, new KDLayout.Constraints(709, 132, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbatch.setBounds(new Rectangle(19, -205, 270, 19));
        this.add(contbatch, new KDLayout.Constraints(19, -205, 270, 19, 0));
        ...
        //contmaterialtype
        contmaterialtype.setBoundEditor(txtmaterialtype);
        //contmbaseunit
        contmbaseunit.setBoundEditor(txtmbaseunit);
        //contmnumber
        contmnumber.setBoundEditor(txtmnumber);
        //contproductDate
        contproductDate.setBoundEditor(pkproductDate);
        //contclasses
        contclasses.setBoundEditor(classes);
        //contbatch
        contbatch.setBoundEditor(txtbatch);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.food.stocount.PcakCountEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("materialtype", String.class, this.txtmaterialtype, "text");
		dataBinder.registerBinding("mbaseunit", String.class, this.txtmbaseunit, "text");
		dataBinder.registerBinding("mnumber", java.math.BigDecimal.class, this.txtmnumber, "value");
		...
		dataBinder.registerBinding("batch", String.class, this.txtbatch, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.stocount.app.PcakCountEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.food.stocount.PcakCountInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("mbaseunit", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("mnumber", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"materialnumber").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"number")));
    ...
    public void prmtmaterial_Changed() throws Exception
    {
        System.out.println("prmtmaterial_Changed() Function is executed!");
            txtmaterialtype.setText(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)prmtmaterial.getData(),"model")));

    txtmbaseunit.setText(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)prmtmaterial.getData(),"baseUnit.name")));
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("mbaseunit"));
        sic.add(new SelectorItemInfo("mnumber"));
    ...
    {
        com.kingdee.eas.farm.food.stocount.PcakCountFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.food.stocount.PcakCountFactory.getRemoteInstance().unaudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPcakCountEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPcakCountEditUI.this, "ActionUnaudit", "actionUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.stocount.client", "PcakCountEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.food.stocount.client.PcakCountEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.food.stocount.PcakCountFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.food.stocount.PcakCountInfo objectValue = new com.kingdee.eas.farm.food.stocount.PcakCountInfo();
    	...
    	return "/bim/farm/food/stocount/PcakCount";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.food.stocount.app.PcakCountQuery");
	}

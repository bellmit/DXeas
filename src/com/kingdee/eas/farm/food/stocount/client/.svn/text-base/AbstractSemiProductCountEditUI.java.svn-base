 ...
 * output class name
 */
public abstract class AbstractSemiProductCountEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSemiProductCountEditUI.class);
    ...
    protected com.kingdee.eas.farm.food.stocount.SemiProductCountInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSemiProductCountEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSemiProductCountEditUI.class.getName());
        ...
        this.prmtsemcount.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {status,prmtperson,prmtsemcount,classes}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(12, 242, 991, 48));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.food.stocount.SemiProductCountEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, null);
        contstatus.setBounds(new Rectangle(712, 53, 270, 19));
        ...
        this.add(contsemcount, null);
        contclasses.setBounds(new Rectangle(712, 131, 270, 19));
        this.add(contclasses, null);
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.food.stocount.SemiProductCountEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.stocount.app.SemiProductCountEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.food.stocount.SemiProductCountInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.stocount.client", "SemiProductCountEditUI");
    }
    /**

 ...
 * output class name
 */
public class PcakCountEditUI extends AbstractPcakCountEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PcakCountEditUI.class);
    
    /**
     * output class constructor
     */
    public PcakCountEditUI() throws Exception
    {
        super();
    }
    @Override
	...
	/* (non-Javadoc)
	 * @see com.kingdee.eas.farm.food.stocount.client.AbstractPcakCountEditUI#actionUnaudit_actionPerformed(java.awt.event.ActionEvent)
	 */
	@Override

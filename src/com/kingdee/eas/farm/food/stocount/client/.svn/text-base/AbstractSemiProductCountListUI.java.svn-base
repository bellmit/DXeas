 ...
 * output class name
 */
public abstract class AbstractSemiProductCountListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSemiProductCountListUI.class);
     ...
     */
    public AbstractSemiProductCountListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSemiProductCountListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.food.stocount.app", "SemiProductCountQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.stocount.app.SemiProductCountListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSemiProductCountListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSemiProductCountListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.stocount.client", "SemiProductCountListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.food.stocount.client.SemiProductCountEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.food.stocount.SemiProductCountFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.food.stocount.SemiProductCountInfo objectValue = new com.kingdee.eas.farm.food.stocount.SemiProductCountInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","status","person.name","semcount.name","classes"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/food/stocount/SemiProductCount";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.food.stocount.app.SemiProductCountQuery");
	}

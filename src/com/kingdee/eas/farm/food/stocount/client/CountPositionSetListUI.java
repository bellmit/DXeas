...
import com.kingdee.eas.farm.food.stocount.canorcancel;
 ...
 * output class name
 */
public class CountPositionSetListUI extends AbstractCountPositionSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CountPositionSetListUI.class);
    
    /**
     * output class constructor
     */
    public CountPositionSetListUI() throws Exception
    {
        super();
    }
    ...
    public void actionCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	//获得info
    	CountPositionSetInfo info = CountPositionSetFactory.getRemoteInstance().getCountPositionSetInfo("where id = '"+id+"'");

    		info.setBaseStatus(canorcancel.abel);//修改状态为启用
    		
			CountPositionSetFactory.getRemoteInstance().save(info);//保存
    ...
    {
        return com.kingdee.eas.farm.food.stocount.client.CountPositionSetTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public abstract class AbstractCountPositionSetListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCountPositionSetListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCountPositionSetListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCountPositionSetListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.stocount.app.CountPositionSetListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.stocount.client", "CountPositionSetListUI");
    }

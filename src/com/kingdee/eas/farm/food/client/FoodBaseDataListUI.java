 ...
 * output class name
 */
public class FoodBaseDataListUI extends AbstractFoodBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FoodBaseDataListUI.class);
    
    /**
     * output class constructor
     */
    public FoodBaseDataListUI() throws Exception
    {
        super();
    }
    ...
    protected FilterInfo getDefaultFilterForQuery() {
		...
		String orgID="filterOrgNumber";//¿â´æ×éÖ¯

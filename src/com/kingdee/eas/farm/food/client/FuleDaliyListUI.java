 ...
 * output class name
 */
public class FuleDaliyListUI extends AbstractFuleDaliyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FuleDaliyListUI.class);
    
    /**
     * output class constructor
     */
    public FuleDaliyListUI() throws Exception
    {
        super();
        initControl();
    }

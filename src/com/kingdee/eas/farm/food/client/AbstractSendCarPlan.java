 ...
 * output class name
 */
public abstract class AbstractSendCarPlan extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSendCarPlan.class);
    protected ResourceBundleHelper resHelper = null;
    protected com.kingdee.bos.ctrl.swing.KDToolBar SendCarPlan_toolbar;
     ...
     */
    public AbstractSendCarPlan() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSendCarPlan.class.getName());
        ...
        this.setName("SendCarPlan");
        this.toolBar.setName("SendCarPlan_toolbar");
        this.menuBar.setName("SendCarPlan_menubar");
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(51, 40, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(380, 41, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(42, 90, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.app.SendCarPlanHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.client", "SendCarPlan");
    }

 ...
 * output class name
 */
public class TransportDailyListUI extends AbstractTransportDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransportDailyListUI.class);
    
    /**
     * output class constructor
     */
    public TransportDailyListUI() throws Exception
    {
        super();
        initControl();
    }
   ...
   public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
   {
	...
	private void initControl() throws Exception{
		...
		/*this.tblMain.getLayoutManager().setHorizonScrollBar(new JScrollBar(JScrollBar.HORIZONTAL));
		this.tblMain.setScrollStateHorizon(KDTStyleConstants.SCROLL_STATE_SHOW);

 ...
 * output class name
 */
public class CoutBillSettingListUI extends AbstractCoutBillSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CoutBillSettingListUI.class);
    
    /**
     * output class constructor
     */
    public CoutBillSettingListUI() throws Exception
    {
        super();
    }

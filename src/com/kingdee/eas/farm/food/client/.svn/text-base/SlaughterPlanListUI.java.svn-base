 ...
 * output class name
 */
public class SlaughterPlanListUI extends AbstractSlaughterPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SlaughterPlanListUI.class);
    
    /**
     * output class constructor
     */
    public SlaughterPlanListUI() throws Exception
    {
        super();
    }
    ...
    public void actionRemove_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	SlaughterPlanInfo info = SlaughterPlanFactory.getRemoteInstance().getSlaughterPlanInfo(new ObjectUuidPK(id));
    	if(!info.getBillStatus().equals(BillBaseStatusEnum.TEMPORARILYSAVED)&&!info.getBillStatus().equals(BillBaseStatusEnum.SUBMITED))
    	{
    		MsgBox.showInfo("当前状态下不能删除");
    		SysUtil.abort();
    	}

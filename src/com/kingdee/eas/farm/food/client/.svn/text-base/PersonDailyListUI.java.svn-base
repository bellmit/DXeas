 ...
 * output class name
 */
public class PersonDailyListUI extends AbstractPersonDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonDailyListUI.class);
    
    /**
     * output class constructor
     */
    public PersonDailyListUI() throws Exception
    {
        super();
        initControl();
    }

 ...
 * output class name
 */
public class FoodSendCarPlanListUI extends AbstractFoodSendCarPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FoodSendCarPlanListUI.class);
    
    /**
     * output class constructor
     */
    public FoodSendCarPlanListUI() throws Exception
    {
        super();
    }

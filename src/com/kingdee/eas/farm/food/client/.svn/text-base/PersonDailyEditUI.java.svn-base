 ...
 * output class name
 */
public class PersonDailyEditUI extends AbstractPersonDailyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonDailyEditUI.class);
    
    /**
     * output class constructor
     */
    public PersonDailyEditUI() throws Exception
    {
        super();
        initControl();
    }
    ...
    private void initControl() throws Exception{
		...
		this.txtallPersonQty.setPrecision(0);
		this.txtdeceiveTodayQty.setPrecision(0);
		this.txtdevicePersonQty.setPrecision(0);
		this.txtFIPersonQty.setPrecision(0);
		this.txtFITodayQty.setPrecision(0);
		this.txtlogisticsPersonQty.setPrecision(0);
		this.txtlogisticsTodayQty.setPrecision(0);
		this.txtmanuPersonQty.setPrecision(0);
		this.txtmanuTodayQty.setPrecision(0);
		this.txtsalePersonQty.setPrecision(0);
		this.txtsaleTodayQty.setPrecision(0);
		this.txtsynthesisPersonQty.setPrecision(0);
		this.txtsynthesisTodayQty.setPrecision(0);
    }
    @Override

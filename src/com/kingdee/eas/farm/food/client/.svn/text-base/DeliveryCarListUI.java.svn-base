 ...
 * output class name
 */
public class DeliveryCarListUI extends AbstractDeliveryCarListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliveryCarListUI.class);
    
    /**
     * output class constructor
     */
    public DeliveryCarListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.food.client.DeliveryCarTreeEditUI.class.getName();
    }

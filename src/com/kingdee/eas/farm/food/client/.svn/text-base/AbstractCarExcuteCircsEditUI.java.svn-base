 ...
 * output class name
 */
public abstract class AbstractCarExcuteCircsEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCarExcuteCircsEditUI.class);
    ...
    protected com.kingdee.eas.farm.food.CarExcuteCircsInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractCarExcuteCircsEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCarExcuteCircsEditUI.class.getName());
        ...
        KDFormattedTextField kdtEntrys_lateTime_TextField = new KDFormattedTextField();
        kdtEntrys_lateTime_TextField.setName("kdtEntrys_lateTime_TextField");
        kdtEntrys_lateTime_TextField.setVisible(true);
        kdtEntrys_lateTime_TextField.setEditable(true);
        kdtEntrys_lateTime_TextField.setHorizontalAlignment(2);
        kdtEntrys_lateTime_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntrys_lateTime_CellEditor = new KDTDefaultCellEditor(kdtEntrys_lateTime_TextField);
        this.kdtEntrys.getColumn("lateTime").setEditor(kdtEntrys_lateTime_CellEditor);
        // contcarCount		
        ...
        this.txtcarCount.setEnabled(false);
        // pkauditTime		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,txtcarCount,pkauditTime,prmtstorageOrgUnit,billStatus,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(368, 42, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(368, 42, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(15, 98, 980, 414));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.food.CarExcuteCircsEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(15, 98, 980, 414, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDSeparator8.setBounds(new Rectangle(12, 77, 986, 16));
        this.add(kDSeparator8, new KDLayout.Constraints(12, 77, 986, 16, 0));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.food.CarExcuteCircsEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.lateTime", int.class, this.kdtEntrys, "lateTime.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.app.CarExcuteCircsEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.food.CarExcuteCircsInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.lateTime", ValidateHelper.ON_SAVE);    
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCarExcuteCircsEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCarExcuteCircsEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.client", "CarExcuteCircsEditUI");
    }
    /**

 ...
 * output class name
 */
public abstract class AbstractDeliveryCarEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDeliveryCarEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtcarType;
    protected com.kingdee.eas.farm.food.DeliveryCarInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDeliveryCarEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDeliveryCarEditUI.class.getName());
        ...
        this.txtcarType = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.txtcarType.setName("txtcarType");
        // CoreUI		
        ...
        this.txtdriverTel.setMaxLength(20);		
        this.txtdriverTel.setRequired(false);
        // txtcarType		
        this.txtcarType.setVisible(true);		
        this.txtcarType.setHorizontalAlignment(2);		
        this.txtcarType.setMaxLength(10);		
        this.txtcarType.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtdriverName,txtdriverTel,txtcarType}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(65, -116, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(64, -118, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(64, 335, 270, 19));
        this.add(kDLabelContainer4, null);
        contdriverName.setBounds(new Rectangle(66, 121, 270, 19));
        this.add(contdriverName, null);
        contdriverTel.setBounds(new Rectangle(66, 160, 270, 19));
        this.add(contdriverTel, null);
        contcarType.setBounds(new Rectangle(66, 82, 270, 19));
        ...
        //contcarType
        contcarType.setBoundEditor(txtcarType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("carType", String.class, this.txtcarType, "text");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.food.app.DeliveryCarEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.food.DeliveryCarInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.food.client", "DeliveryCarEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.food.client.DeliveryCarEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.food.DeliveryCarFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.food.DeliveryCarInfo objectValue = new com.kingdee.eas.farm.food.DeliveryCarInfo();

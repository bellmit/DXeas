 ...
 * output class name
 */
public class ChickenDailyListUI extends AbstractChickenDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChickenDailyListUI.class);
    
    /**
     * output class constructor
     */
    public ChickenDailyListUI() throws Exception
    {
        super();
        initControl();
    }
...
//					fliterInfo.getFilterItems().add(new FilterItemInfo("BodyEntry.seq",1,CompareType.EQUALS));
...
//			fliterInfo.getFilterItems().add(new FilterItemInfo("BodyEntry.seq",1,CompareType.EQUALS));
//			fliterInfo.setMaskString("#0 and #1");
		}
...
//		try{
//			if(fliterInfo != null){
//				fliterInfo.mergeFilter(filterNew, "and");
//			}else{
//				fliterInfo = filterNew;
//			}
//			
//		}catch(BOSException e){
//			e.printStackTrace();

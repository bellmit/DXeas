 ...
 * output class name
 */
public class CoutBillSettingEditUI extends AbstractCoutBillSettingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CoutBillSettingEditUI.class);
    
    /**
     * output class constructor
     */
    public CoutBillSettingEditUI() throws Exception
    {
        super();
    }
    /**

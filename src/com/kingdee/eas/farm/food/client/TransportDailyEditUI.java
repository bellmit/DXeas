 ...
 * output class name
 */
public class TransportDailyEditUI extends AbstractTransportDailyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransportDailyEditUI.class);
    
    /**
     * output class constructor
     */
    public TransportDailyEditUI() throws Exception
    {
        super();
        initControl();
    }

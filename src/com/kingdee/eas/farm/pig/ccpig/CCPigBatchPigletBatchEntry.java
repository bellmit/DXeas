...
public class CCPigBatchPigletBatchEntry extends CoreBillEntryBase implements ICCPigBatchPigletBatchEntry
{
    public CCPigBatchPigletBatchEntry()
    {
        super();
        registerInterface(ICCPigBatchPigletBatchEntry.class, this);
    }
    public CCPigBatchPigletBatchEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigBatchPigletBatchEntry.class, this);
    }
    ...
    private CCPigBatchPigletBatchEntryController getController() throws BOSException
    {
        return (CCPigBatchPigletBatchEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigletBatchEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

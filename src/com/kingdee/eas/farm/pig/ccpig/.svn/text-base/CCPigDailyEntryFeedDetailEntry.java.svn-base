...
public class CCPigDailyEntryFeedDetailEntry extends CoreBillEntryBase implements ICCPigDailyEntryFeedDetailEntry
{
    public CCPigDailyEntryFeedDetailEntry()
    {
        super();
        registerInterface(ICCPigDailyEntryFeedDetailEntry.class, this);
    }
    public CCPigDailyEntryFeedDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigDailyEntryFeedDetailEntry.class, this);
    }
    ...
    private CCPigDailyEntryFeedDetailEntryController getController() throws BOSException
    {
        return (CCPigDailyEntryFeedDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyEntryFeedDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

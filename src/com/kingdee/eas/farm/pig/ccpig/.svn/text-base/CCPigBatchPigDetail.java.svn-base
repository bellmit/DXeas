...
public class CCPigBatchPigDetail extends CoreBillEntryBase implements ICCPigBatchPigDetail
{
    public CCPigBatchPigDetail()
    {
        super();
        registerInterface(ICCPigBatchPigDetail.class, this);
    }
    public CCPigBatchPigDetail(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigBatchPigDetail.class, this);
    }
    ...
    private CCPigBatchPigDetailController getController() throws BOSException
    {
        return (CCPigBatchPigDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBatchPigDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

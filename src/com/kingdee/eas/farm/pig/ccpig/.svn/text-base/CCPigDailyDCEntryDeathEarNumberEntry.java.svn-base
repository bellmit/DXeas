...
public class CCPigDailyDCEntryDeathEarNumberEntry extends CoreBillEntryBase implements ICCPigDailyDCEntryDeathEarNumberEntry
{
    public CCPigDailyDCEntryDeathEarNumberEntry()
    {
        super();
        registerInterface(ICCPigDailyDCEntryDeathEarNumberEntry.class, this);
    }
    public CCPigDailyDCEntryDeathEarNumberEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigDailyDCEntryDeathEarNumberEntry.class, this);
    }
    ...
    private CCPigDailyDCEntryDeathEarNumberEntryController getController() throws BOSException
    {
        return (CCPigDailyDCEntryDeathEarNumberEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyDCEntryDeathEarNumberEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

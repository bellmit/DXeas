...
public class CCPigBreedModelFarmEntry extends CoreBillEntryBase implements ICCPigBreedModelFarmEntry
{
    public CCPigBreedModelFarmEntry()
    {
        super();
        registerInterface(ICCPigBreedModelFarmEntry.class, this);
    }
    public CCPigBreedModelFarmEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigBreedModelFarmEntry.class, this);
    }
    ...
    private CCPigBreedModelFarmEntryController getController() throws BOSException
    {
        return (CCPigBreedModelFarmEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigBreedModelFarmEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

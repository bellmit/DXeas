...
public class CCPigBatchPigDetailControllerBean extends AbstractCCPigBatchPigDetailControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.ccpig.app.CCPigBatchPigDetailControllerBean");

...
public class CCPigDailyControllerBeanEx extends com.kingdee.eas.farm.pig.ccpig.app.CCPigDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.ccpig.app.CCPigDailyControllerBeanEx");

...
public class CCPigDailyCullEntry extends CoreBillEntryBase implements ICCPigDailyCullEntry
{
    public CCPigDailyCullEntry()
    {
        super();
        registerInterface(ICCPigDailyCullEntry.class, this);
    }
    public CCPigDailyCullEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigDailyCullEntry.class, this);
    }
    ...
    private CCPigDailyCullEntryController getController() throws BOSException
    {
        return (CCPigDailyCullEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyCullEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

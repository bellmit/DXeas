...
public class CCPigDailyOutEntryOutEarNumberEntry extends CoreBillEntryBase implements ICCPigDailyOutEntryOutEarNumberEntry
{
    public CCPigDailyOutEntryOutEarNumberEntry()
    {
        super();
        registerInterface(ICCPigDailyOutEntryOutEarNumberEntry.class, this);
    }
    public CCPigDailyOutEntryOutEarNumberEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCPigDailyOutEntryOutEarNumberEntry.class, this);
    }
    ...
    private CCPigDailyOutEntryOutEarNumberEntryController getController() throws BOSException
    {
        return (CCPigDailyOutEntryOutEarNumberEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCPigDailyOutEntryOutEarNumberEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

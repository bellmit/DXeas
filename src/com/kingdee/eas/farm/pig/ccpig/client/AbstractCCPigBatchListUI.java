 ...
 * output class name
 */
public abstract class AbstractCCPigBatchListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCCPigBatchListUI.class);
     ...
     */
    public AbstractCCPigBatchListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCCPigBatchListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.pig.ccpig.app", "CCPigBatchQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.ccpig.app.CCPigBatchListUIHandler";
	}
...
com.kingdee.eas.farm.pig.ccpig.CCPigBatchInfo editData = (com.kingdee.eas.farm.pig.ccpig.CCPigBatchInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.pig.ccpig.CCPigBatchFactory.getRemoteInstance().updateBatchMarket(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCCPigBatchListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCCPigBatchListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCCPigBatchListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCCPigBatchListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUpdateBatchMarket extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCCPigBatchListUI.this, "ActionUpdateBatchMarket", "actionUpdateBatchMarket_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.ccpig.client", "CCPigBatchListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","costObject.name","baseStatus","bizDate","days","aveWeight","description","pigLevel.name","initAllQty","pigFarm.name","entrys.pigHouse.name","creator.number","creator.name","createTime","auditor.name","auditTime","lastUpdateTime","auditor.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name"};
    }

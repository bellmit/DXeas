 ...
 * output class name
 */
public class PigBatchTypeListUI extends AbstractPigBatchTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PigBatchTypeListUI.class);
    
    /**
     * output class constructor
     */
    public PigBatchTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigBatchTypeTreeEditUI.class.getName();
    }

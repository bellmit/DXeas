 ...
 * output class name
 */
public class PigFarmListUI extends AbstractPigFarmListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PigFarmListUI.class);
    
    /**
     * output class constructor
     */
    public PigFarmListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigFarmTreeEditUI.class.getName();
    }

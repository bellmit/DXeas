 ...
 * output class name
 */
public class DailyImmunePlanListUI extends AbstractDailyImmunePlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DailyImmunePlanListUI.class);
    
    /**
     * output class constructor
     */
    public DailyImmunePlanListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.DailyImmunePlanTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class PigBatchListUI extends AbstractPigBatchListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PigBatchListUI.class);
    
    /**
     * output class constructor
     */
    public PigBatchListUI() throws Exception
    {
        super();
    }

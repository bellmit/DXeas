 ...
 * output class name
 */
public class PigFieldListUI extends AbstractPigFieldListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PigFieldListUI.class);
    
    /**
     * output class constructor
     */
    public PigFieldListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigFieldTreeEditUI.class.getName();
    }

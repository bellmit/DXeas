 ...
 * output class name
 */
public class PigTypeListUI extends AbstractPigTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PigTypeListUI.class);
    
    /**
     * output class constructor
     */
    public PigTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigTypeTreeEditUI.class.getName();
    }

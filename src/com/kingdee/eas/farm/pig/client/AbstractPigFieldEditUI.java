 ...
 * output class name
 */
public abstract class AbstractPigFieldEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPigFieldEditUI.class);
    ...
    protected com.kingdee.eas.farm.pig.PigFieldInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPigFieldEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPigFieldEditUI.class.getName());
        ...
        this.prmtpigHouse.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtpigHouse,prmtpigFarm}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(36, 35, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(354, 35, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(36, 65, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(354, 65, 270, 19));
        this.add(kDLabelContainer4, null);
        contpigHouse.setBounds(new Rectangle(354, 95, 270, 19));
        this.add(contpigHouse, null);
        contpigFarm.setBounds(new Rectangle(36, 95, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.app.PigFieldEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.prmtpigHouse.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.pig.PigFieldInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.client", "PigFieldEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigFieldEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.PigFieldFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.PigFieldInfo objectValue = new com.kingdee.eas.farm.pig.PigFieldInfo();

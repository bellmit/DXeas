 ...
 * output class name
 */
public abstract class AbstractPigBatchTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPigBatchTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractPigBatchTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractPigBatchTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPigBatchTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.pig.app", "PigBatchTypeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.app.PigBatchTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.client", "PigBatchTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.PigBatchTypeEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.PigBatchTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.PigBatchTypeInfo objectValue = new com.kingdee.eas.farm.pig.PigBatchTypeInfo();		
        return objectValue;
    }

 ...
 * output class name
 */
public class StrainListUI extends AbstractStrainListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StrainListUI.class);
    
    /**
     * output class constructor
     */
    public StrainListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.client.StrainTreeEditUI.class.getName();
    }

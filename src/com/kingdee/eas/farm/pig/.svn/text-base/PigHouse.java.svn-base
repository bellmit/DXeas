...
public class PigHouse extends DataBase implements IPigHouse
{
    public PigHouse()
    {
        super();
        registerInterface(IPigHouse.class, this);
    }
    public PigHouse(Context ctx)
    {
        super(ctx);
        registerInterface(IPigHouse.class, this);
    }
    ...
    private PigHouseController getController() throws BOSException
    {
        return (PigHouseController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPigHouseInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getPigHouseInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigHouseInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigHouseCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigHouseCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigHouseCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

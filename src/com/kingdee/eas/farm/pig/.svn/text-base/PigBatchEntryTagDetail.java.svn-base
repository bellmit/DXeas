...
public class PigBatchEntryTagDetail extends CoreBillEntryBase implements IPigBatchEntryTagDetail
{
    public PigBatchEntryTagDetail()
    {
        super();
        registerInterface(IPigBatchEntryTagDetail.class, this);
    }
    public PigBatchEntryTagDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IPigBatchEntryTagDetail.class, this);
    }
    ...
    private PigBatchEntryTagDetailController getController() throws BOSException
    {
        return (PigBatchEntryTagDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPigBatchEntryTagDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

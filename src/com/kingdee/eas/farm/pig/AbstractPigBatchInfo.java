...
public class AbstractPigBatchInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractPigBatchInfo()
    {
        this("id");
    }
    protected AbstractPigBatchInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.farm.pig.PigBatchEntryCollection());
    }
    /**
     * Object: 猪养殖批次 's 分录 property 
     */
    public com.kingdee.eas.farm.pig.PigBatchEntryCollection getEntrys()
    {
        return (com.kingdee.eas.farm.pig.PigBatchEntryCollection)get("entrys");
    }
    /**
     * Object:猪养殖批次's 是否生成凭证property 
     */
    ...
    /**
     * Object: 猪养殖批次 's 批次（成本对象） property 
     */

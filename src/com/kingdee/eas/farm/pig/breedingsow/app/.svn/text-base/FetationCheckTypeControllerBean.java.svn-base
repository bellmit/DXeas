...
public class FetationCheckTypeControllerBean extends AbstractFetationCheckTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.FetationCheckTypeControllerBean");
}
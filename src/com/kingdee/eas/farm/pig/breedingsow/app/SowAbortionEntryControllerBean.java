...
public class SowAbortionEntryControllerBean extends AbstractSowAbortionEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowAbortionEntryControllerBean");
}
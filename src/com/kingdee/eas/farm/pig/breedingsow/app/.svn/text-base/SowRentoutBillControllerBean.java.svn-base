...
public class SowRentoutBillControllerBean extends AbstractSowRentoutBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowRentoutBillControllerBean");
}
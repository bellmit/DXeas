...
public class GestationCheckEntryControllerBean extends AbstractGestationCheckEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.GestationCheckEntryControllerBean");
}
...
public class SowTreeControllerBean extends AbstractSowTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowTreeControllerBean");
}
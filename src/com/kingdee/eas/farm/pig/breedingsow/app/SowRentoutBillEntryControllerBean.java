...
public class SowRentoutBillEntryControllerBean extends AbstractSowRentoutBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowRentoutBillEntryControllerBean");
}
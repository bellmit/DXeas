...
public class CheckHeatBillEntryControllerBean extends AbstractCheckHeatBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.CheckHeatBillEntryControllerBean");
}
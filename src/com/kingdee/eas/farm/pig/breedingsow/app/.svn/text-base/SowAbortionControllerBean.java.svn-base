...
public class SowAbortionControllerBean extends AbstractSowAbortionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowAbortionControllerBean");
}
...
public class ReserveSowControllerBean extends AbstractReserveSowControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.ReserveSowControllerBean");
}
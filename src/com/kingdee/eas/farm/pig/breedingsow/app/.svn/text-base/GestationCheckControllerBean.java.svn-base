...
public class GestationCheckControllerBean extends AbstractGestationCheckControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.GestationCheckControllerBean");
}
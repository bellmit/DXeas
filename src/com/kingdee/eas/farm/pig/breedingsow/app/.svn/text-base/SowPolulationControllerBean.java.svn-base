...
public class SowPolulationControllerBean extends AbstractSowPolulationControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.SowPolulationControllerBean");
}
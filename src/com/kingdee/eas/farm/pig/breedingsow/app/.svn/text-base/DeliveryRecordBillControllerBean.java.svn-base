...
public class DeliveryRecordBillControllerBean extends AbstractDeliveryRecordBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingsow.app.DeliveryRecordBillControllerBean");
}
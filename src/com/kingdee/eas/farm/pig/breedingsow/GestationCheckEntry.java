...
public class GestationCheckEntry extends CoreBillEntryBase implements IGestationCheckEntry
{
    public GestationCheckEntry()
    {
        super();
        registerInterface(IGestationCheckEntry.class, this);
    }
    public GestationCheckEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IGestationCheckEntry.class, this);
    }
    ...
    private GestationCheckEntryController getController() throws BOSException
    {
        return (GestationCheckEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getGestationCheckEntryInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getGestationCheckEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGestationCheckEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGestationCheckEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGestationCheckEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getGestationCheckEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

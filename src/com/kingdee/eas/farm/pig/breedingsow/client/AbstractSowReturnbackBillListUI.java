 ...
 * output class name
 */
public abstract class AbstractSowReturnbackBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSowReturnbackBillListUI.class);
     ...
     */
    public AbstractSowReturnbackBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSowReturnbackBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.app", "SowReturnbackBillQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.breedingsow.app.SowReturnbackBillListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSowReturnbackBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSowReturnbackBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.client", "SowReturnbackBillListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.client.SowReturnbackBillEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.SowReturnbackBillFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.breedingsow.SowReturnbackBillInfo objectValue = new com.kingdee.eas.farm.pig.breedingsow.SowReturnbackBillInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","auditTime","baseStatus","farm.name","customer.name","entrys.sow.number","operator.name"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/pig/breedingsow/SowReturnbackBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.app.SowReturnbackBillQuery");
	}

 ...
 * output class name
 */
public class GestationCheckListUI extends AbstractGestationCheckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(GestationCheckListUI.class);
    
    /**
     * output class constructor
     */
    public GestationCheckListUI() throws Exception
    {
        super();
    }

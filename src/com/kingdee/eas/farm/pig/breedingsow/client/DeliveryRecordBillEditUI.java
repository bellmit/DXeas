 ...
 * output class name
 */
public class DeliveryRecordBillEditUI extends AbstractDeliveryRecordBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliveryRecordBillEditUI.class);
    
    /**
     * output class constructor
     */
    public DeliveryRecordBillEditUI() throws Exception
    {
        super();
    }
    /**

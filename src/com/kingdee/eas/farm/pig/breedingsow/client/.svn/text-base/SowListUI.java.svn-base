 ...
 * output class name
 */
public class SowListUI extends AbstractSowListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SowListUI.class);
    
    /**
     * output class constructor
     */
    public SowListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.client.SowTreeEditUI.class.getName();
    }

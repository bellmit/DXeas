 ...
 * output class name
 */
public class FetationCheckTypeListUI extends AbstractFetationCheckTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FetationCheckTypeListUI.class);
    
    /**
     * output class constructor
     */
    public FetationCheckTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.client.FetationCheckTypeTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class DeliveryRecordBillListUI extends AbstractDeliveryRecordBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeliveryRecordBillListUI.class);
    
    /**
     * output class constructor
     */
    public DeliveryRecordBillListUI() throws Exception
    {
        super();
    }

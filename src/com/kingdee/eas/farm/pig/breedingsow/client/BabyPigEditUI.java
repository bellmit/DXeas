 ...
 * output class name
 */
public class BabyPigEditUI extends AbstractBabyPigEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BabyPigEditUI.class);
    
    /**
     * output class constructor
     */
    public BabyPigEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public class SowRentoutBillListUI extends AbstractSowRentoutBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SowRentoutBillListUI.class);
    
    /**
     * output class constructor
     */
    public SowRentoutBillListUI() throws Exception
    {
        super();
    }

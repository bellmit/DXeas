 ...
 * output class name
 */
public class SowReturnbackBillListUI extends AbstractSowReturnbackBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SowReturnbackBillListUI.class);
    
    /**
     * output class constructor
     */
    public SowReturnbackBillListUI() throws Exception
    {
        super();
    }

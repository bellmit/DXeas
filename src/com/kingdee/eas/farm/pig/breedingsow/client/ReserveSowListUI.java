 ...
 * output class name
 */
public class ReserveSowListUI extends AbstractReserveSowListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReserveSowListUI.class);
    
    /**
     * output class constructor
     */
    public ReserveSowListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class BabyPigListUI extends AbstractBabyPigListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BabyPigListUI.class);
    
    /**
     * output class constructor
     */
    public BabyPigListUI() throws Exception
    {
        super();
    }

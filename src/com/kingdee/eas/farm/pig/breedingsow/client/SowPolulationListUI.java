 ...
 * output class name
 */
public class SowPolulationListUI extends AbstractSowPolulationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SowPolulationListUI.class);
    
    /**
     * output class constructor
     */
    public SowPolulationListUI() throws Exception
    {
        super();
    }

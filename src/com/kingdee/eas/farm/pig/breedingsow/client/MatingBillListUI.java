 ...
 * output class name
 */
public class MatingBillListUI extends AbstractMatingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MatingBillListUI.class);
    
    /**
     * output class constructor
     */
    public MatingBillListUI() throws Exception
    {
        super();
    }

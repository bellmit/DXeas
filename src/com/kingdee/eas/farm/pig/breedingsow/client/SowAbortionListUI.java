 ...
 * output class name
 */
public class SowAbortionListUI extends AbstractSowAbortionListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SowAbortionListUI.class);
    
    /**
     * output class constructor
     */
    public SowAbortionListUI() throws Exception
    {
        super();
    }

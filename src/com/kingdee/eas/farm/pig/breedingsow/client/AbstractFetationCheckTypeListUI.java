 ...
 * output class name
 */
public abstract class AbstractFetationCheckTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFetationCheckTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractFetationCheckTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractFetationCheckTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFetationCheckTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.app", "FetationCheckTypeQuery");
        // CoreUI
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.breedingsow.app.FetationCheckTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.client", "FetationCheckTypeListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.FetationCheckTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.breedingsow.FetationCheckTypeInfo objectValue = new com.kingdee.eas.farm.pig.breedingsow.FetationCheckTypeInfo();		
        return objectValue;
    }

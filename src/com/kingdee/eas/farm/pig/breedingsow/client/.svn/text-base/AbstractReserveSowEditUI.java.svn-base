 ...
 * output class name
 */
public abstract class AbstractReserveSowEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReserveSowEditUI.class);
    ...
    protected com.kingdee.eas.farm.pig.breedingsow.ReserveSowInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractReserveSowEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractReserveSowEditUI.class.getName());
        ...
        final KDBizPromptBox kdtEntrys_pigType_PromptBox = new KDBizPromptBox();
        kdtEntrys_pigType_PromptBox.setQueryInfo("com.kingdee.eas.farm.pig.app.PigTypeQuery");
        kdtEntrys_pigType_PromptBox.setVisible(true);
        kdtEntrys_pigType_PromptBox.setEditable(true);
        kdtEntrys_pigType_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_pigType_PromptBox.setEditFormat("$number$");
        kdtEntrys_pigType_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_pigType_CellEditor = new KDTDefaultCellEditor(kdtEntrys_pigType_PromptBox);
        this.kdtEntrys.getColumn("pigType").setEditor(kdtEntrys_pigType_CellEditor);
        ObjectValueRender kdtEntrys_pigType_OVR = new ObjectValueRender();
        kdtEntrys_pigType_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("pigType").setRenderer(kdtEntrys_pigType_OVR);
        			kdtEntrys_pigType_PromptBox.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.farm.pig.client.PigTypeListUI kdtEntrys_pigType_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtEntrys_pigType_PromptBox_F7ListUI == null) {
					try {
						kdtEntrys_pigType_PromptBox_F7ListUI = new com.kingdee.eas.farm.pig.client.PigTypeListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(kdtEntrys_pigType_PromptBox_F7ListUI));
					kdtEntrys_pigType_PromptBox_F7ListUI.setF7Use(true,ctx);
					kdtEntrys_pigType_PromptBox.setSelector(kdtEntrys_pigType_PromptBox_F7ListUI);
				}
			}
		});
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkauditTime,baseStatus,prmtfarm,kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,prmtoperator,prmtpighouse,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contBizDate.setBounds(new Rectangle(724, 47, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(728, -73, 270, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(16, 570, 270, 19));
        this.add(contAuditor, null);
        kdtEntrys.setBounds(new Rectangle(12, 76, 991, 484));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.pig.breedingsow.ReserveSowEntryInfo(),null,false);
        ...
        contoperator.setBounds(new Rectangle(376, 45, 270, 19));
        this.add(contoperator, null);
        contpighouse.setBounds(new Rectangle(13, 41, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.pig.breedingsow.ReserveSowEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.pigType", java.lang.Object.class, this.kdtEntrys, "pigType.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.breedingsow.app.ReserveSowEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.pig.breedingsow.ReserveSowInfo)ov;
    }
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
	    	...
	    	sic.add(new SelectorItemInfo("entrys.pigType.id"));
			sic.add(new SelectorItemInfo("entrys.pigType.name"));
        	sic.add(new SelectorItemInfo("entrys.pigType.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.client", "ReserveSowEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.client.ReserveSowEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingsow.ReserveSowFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.breedingsow.ReserveSowInfo objectValue = new com.kingdee.eas.farm.pig.breedingsow.ReserveSowInfo();
    	...
    	return "/bim/farm/pig/breedingsow/ReserveSow";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.pig.breedingsow.app.ReserveSowQuery");
	}

 ...
 * output class name
 */
public class CheckHeatBillListUI extends AbstractCheckHeatBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CheckHeatBillListUI.class);
    
    /**
     * output class constructor
     */
    public CheckHeatBillListUI() throws Exception
    {
        super();
    }

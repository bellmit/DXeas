...
public class BoarDailyCullEntryCullEarNumberEntry extends CoreBillEntryBase implements IBoarDailyCullEntryCullEarNumberEntry
{
    public BoarDailyCullEntryCullEarNumberEntry()
    {
        super();
        registerInterface(IBoarDailyCullEntryCullEarNumberEntry.class, this);
    }
    public BoarDailyCullEntryCullEarNumberEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBoarDailyCullEntryCullEarNumberEntry.class, this);
    }
    ...
    private BoarDailyCullEntryCullEarNumberEntryController getController() throws BOSException
    {
        return (BoarDailyCullEntryCullEarNumberEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCullEarNumberEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

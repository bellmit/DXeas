...
public class SpermCheckBillEntryControllerBean extends AbstractSpermCheckBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingboar.app.SpermCheckBillEntryControllerBean");
}
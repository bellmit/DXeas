...
public class BreedingBoarBreedModelControllerBean extends AbstractBreedingBoarBreedModelControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingboar.app.BreedingBoarBreedModelControllerBean");
}
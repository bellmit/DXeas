...
public class CollectSpermBIllEntryControllerBean extends AbstractCollectSpermBIllEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingboar.app.CollectSpermBIllEntryControllerBean");
}
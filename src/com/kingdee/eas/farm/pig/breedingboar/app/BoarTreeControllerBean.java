...
public class BoarTreeControllerBean extends AbstractBoarTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingboar.app.BoarTreeControllerBean");
}
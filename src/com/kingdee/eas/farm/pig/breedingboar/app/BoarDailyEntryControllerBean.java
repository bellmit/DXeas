...
public class BoarDailyEntryControllerBean extends AbstractBoarDailyEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.pig.breedingboar.app.BoarDailyEntryControllerBean");
}
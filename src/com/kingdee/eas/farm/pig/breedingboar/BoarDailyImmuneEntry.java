...
public class BoarDailyImmuneEntry extends CoreBillEntryBase implements IBoarDailyImmuneEntry
{
    public BoarDailyImmuneEntry()
    {
        super();
        registerInterface(IBoarDailyImmuneEntry.class, this);
    }
    public BoarDailyImmuneEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBoarDailyImmuneEntry.class, this);
    }
    ...
    {
        return new BOSObjectType("ED782EF0");
    }
    private BoarDailyImmuneEntryController getController() throws BOSException
    {
        return (BoarDailyImmuneEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyImmuneEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

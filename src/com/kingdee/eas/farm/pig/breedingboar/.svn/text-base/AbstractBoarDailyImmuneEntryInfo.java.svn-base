...
public class AbstractBoarDailyImmuneEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractBoarDailyImmuneEntryInfo()
    {
        this("id");
    }
    protected AbstractBoarDailyImmuneEntryInfo(String pkField)
    {
        super(pkField);
        put("ImmuneDetailEntry", new com.kingdee.eas.farm.pig.breedingboar.BoarDailyImmuneEntryImmuneDetailEntryCollection());
    }
    /**
     ...
     */
    public com.kingdee.eas.farm.pig.breedingboar.BoarDailyImmuneEntryImmuneDetailEntryCollection getImmuneDetailEntry()
    {
        return (com.kingdee.eas.farm.pig.breedingboar.BoarDailyImmuneEntryImmuneDetailEntryCollection)get("ImmuneDetailEntry");
    }

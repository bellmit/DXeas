...
public class BoarDailyEntryFeedDetailEntry extends CoreBillEntryBase implements IBoarDailyEntryFeedDetailEntry
{
    public BoarDailyEntryFeedDetailEntry()
    {
        super();
        registerInterface(IBoarDailyEntryFeedDetailEntry.class, this);
    }
    public BoarDailyEntryFeedDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBoarDailyEntryFeedDetailEntry.class, this);
    }
    ...
    {
        return new BOSObjectType("DEC7AB30");
    }
    private BoarDailyEntryFeedDetailEntryController getController() throws BOSException
    {
        return (BoarDailyEntryFeedDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyEntryFeedDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

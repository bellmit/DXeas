 ...
 * output class name
 */
public class BoarDailyListUI extends AbstractBoarDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BoarDailyListUI.class);
    
    /**
     * output class constructor
     */
    public BoarDailyListUI() throws Exception
    {
        super();
    }

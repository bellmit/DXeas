 ...
 * output class name
 */
public class CollectSpermBIllListUI extends AbstractCollectSpermBIllListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CollectSpermBIllListUI.class);
    
    /**
     * output class constructor
     */
    public CollectSpermBIllListUI() throws Exception
    {
        super();
    }

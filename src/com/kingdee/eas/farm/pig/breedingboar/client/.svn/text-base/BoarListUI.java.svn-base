 ...
 * output class name
 */
public class BoarListUI extends AbstractBoarListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BoarListUI.class);
    
    /**
     * output class constructor
     */
    public BoarListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingboar.client.BoarTreeEditUI.class.getName();
    }

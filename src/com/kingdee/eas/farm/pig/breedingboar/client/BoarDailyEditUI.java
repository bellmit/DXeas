 ...
 * output class name
 */
public class BoarDailyEditUI extends AbstractBoarDailyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BoarDailyEditUI.class);
    
    /**
     * output class constructor
     */
    public BoarDailyEditUI() throws Exception
    {
        super();
    }
    /**

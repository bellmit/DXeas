 ...
 * output class name
 */
public abstract class AbstractCollectSpermBIllEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCollectSpermBIllEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcollectPerson;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcollectPerson;
    protected com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCollectSpermBIllEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCollectSpermBIllEditUI.class.getName());
        ...
        this.contcollectPerson = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtcollectPerson = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contcollectPerson.setName("contcollectPerson");
        ...
        this.prmtcollectPerson.setName("prmtcollectPerson");
        // CoreUI		
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","boar","earGap","earTag","boarName","collectTime","labelNumber","batchNumber","indoorTemp","spermColor","spermSmell","qty"});
        ...
        KDFormattedTextField kdtEntrys_indoorTemp_TextField = new KDFormattedTextField();
        kdtEntrys_indoorTemp_TextField.setName("kdtEntrys_indoorTemp_TextField");
        kdtEntrys_indoorTemp_TextField.setVisible(true);
        kdtEntrys_indoorTemp_TextField.setEditable(true);
        kdtEntrys_indoorTemp_TextField.setHorizontalAlignment(2);
        kdtEntrys_indoorTemp_TextField.setDataType(1);
        	kdtEntrys_indoorTemp_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E26"));
        	kdtEntrys_indoorTemp_TextField.setMaximumValue(new java.math.BigDecimal("1.0E26"));
        kdtEntrys_indoorTemp_TextField.setPrecision(2);
        KDTDefaultCellEditor kdtEntrys_indoorTemp_CellEditor = new KDTDefaultCellEditor(kdtEntrys_indoorTemp_TextField);
        this.kdtEntrys.getColumn("indoorTemp").setEditor(kdtEntrys_indoorTemp_CellEditor);
        KDComboBox kdtEntrys_spermColor_ComboBox = new KDComboBox();
        kdtEntrys_spermColor_ComboBox.setName("kdtEntrys_spermColor_ComboBox");
        kdtEntrys_spermColor_ComboBox.setVisible(true);
        kdtEntrys_spermColor_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.farm.pig.SpermColor").toArray());
        KDTDefaultCellEditor kdtEntrys_spermColor_CellEditor = new KDTDefaultCellEditor(kdtEntrys_spermColor_ComboBox);
        this.kdtEntrys.getColumn("spermColor").setEditor(kdtEntrys_spermColor_CellEditor);
        KDComboBox kdtEntrys_spermSmell_ComboBox = new KDComboBox();
        kdtEntrys_spermSmell_ComboBox.setName("kdtEntrys_spermSmell_ComboBox");
        kdtEntrys_spermSmell_ComboBox.setVisible(true);
        kdtEntrys_spermSmell_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.farm.pig.SpermSmell").toArray());
        KDTDefaultCellEditor kdtEntrys_spermSmell_CellEditor = new KDTDefaultCellEditor(kdtEntrys_spermSmell_ComboBox);
        this.kdtEntrys.getColumn("spermSmell").setEditor(kdtEntrys_spermSmell_CellEditor);
        ...
        // contcollectPerson		
        this.contcollectPerson.setBoundLabelText(resHelper.getString("contcollectPerson.boundLabelText"));		
        this.contcollectPerson.setBoundLabelLength(100);		
        this.contcollectPerson.setBoundLabelUnderline(true);		
        this.contcollectPerson.setVisible(true);
        // prmtCreator		
        ...
        // prmtcollectPerson		
        this.prmtcollectPerson.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonQuery");		
        this.prmtcollectPerson.setVisible(true);		
        this.prmtcollectPerson.setEditable(true);		
        this.prmtcollectPerson.setDisplayFormat("$name$");		
        this.prmtcollectPerson.setEditFormat("$number$");		
        this.prmtcollectPerson.setCommitFormat("$number$");		
        this.prmtcollectPerson.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkauditTime,prmtfarm,baseStatus,prmtcollectPerson}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(12, 73, 991, 488));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllEntryInfo(),null,false);
...
vo.put("spermSmell","1");
        ...
        contcollectPerson.setBounds(new Rectangle(23, 43, 270, 19));
        this.add(contcollectPerson, null);
        //contCreator
        ...
        //contcollectPerson
        contcollectPerson.setBoundEditor(prmtcollectPerson);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.indoorTemp", java.math.BigDecimal.class, this.kdtEntrys, "indoorTemp.text");
		dataBinder.registerBinding("entrys.spermColor", com.kingdee.util.enums.Enum.class, this.kdtEntrys, "spermColor.text");
		dataBinder.registerBinding("entrys.spermSmell", com.kingdee.util.enums.Enum.class, this.kdtEntrys, "spermSmell.text");
		...
		dataBinder.registerBinding("collectPerson", com.kingdee.eas.basedata.person.PersonInfo.class, this.prmtcollectPerson, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.breedingboar.app.CollectSpermBIllEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.indoorTemp", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.spermColor", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.spermSmell", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("collectPerson", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntrys.getCell(rowIndex,"boarName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"boar").getValue(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.indoorTemp"));
    	sic.add(new SelectorItemInfo("entrys.spermColor"));
    	sic.add(new SelectorItemInfo("entrys.spermSmell"));
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("collectPerson.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("collectPerson.id"));
        	sic.add(new SelectorItemInfo("collectPerson.number"));
        	sic.add(new SelectorItemInfo("collectPerson.name"));
		}
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.breedingboar.client", "CollectSpermBIllEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.pig.breedingboar.client.CollectSpermBIllEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllInfo objectValue = new com.kingdee.eas.farm.pig.breedingboar.CollectSpermBIllInfo();
    	...
    	return "/bim/farm/pig/breedingboar/CollectSpermBIll";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.pig.breedingboar.app.CollectSpermBIllQuery");
	}

 ...
 * output class name
 */
public class SpermCheckBillEditUI extends AbstractSpermCheckBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpermCheckBillEditUI.class);
    
    /**
     * output class constructor
     */
    public SpermCheckBillEditUI() throws Exception
    {
        super();
    }
    /**

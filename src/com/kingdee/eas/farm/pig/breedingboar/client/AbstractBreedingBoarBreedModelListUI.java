 ...
 * output class name
 */
public abstract class AbstractBreedingBoarBreedModelListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBreedingBoarBreedModelListUI.class);
     ...
     */
    public AbstractBreedingBoarBreedModelListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBreedingBoarBreedModelListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.pig.breedingboar.app", "BreedingBoarBreedModelQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.pig.breedingboar.app.BreedingBoarBreedModelListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBreedingBoarBreedModelListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBreedingBoarBreedModelListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.pig.breedingboar.client", "BreedingBoarBreedModelListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.pig.breedingboar.client.BreedingBoarBreedModelEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.pig.breedingboar.BreedingBoarBreedModelFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.pig.breedingboar.BreedingBoarBreedModelInfo objectValue = new com.kingdee.eas.farm.pig.breedingboar.BreedingBoarBreedModelInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","pigFarm.name"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/pig/breedingboar/BreedingBoarBreedModel";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.pig.breedingboar.app.BreedingBoarBreedModelQuery");
	}

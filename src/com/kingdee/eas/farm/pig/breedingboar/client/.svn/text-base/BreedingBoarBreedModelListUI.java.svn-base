 ...
 * output class name
 */
public class BreedingBoarBreedModelListUI extends AbstractBreedingBoarBreedModelListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedingBoarBreedModelListUI.class);
    
    /**
     * output class constructor
     */
    public BreedingBoarBreedModelListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class SpermCheckBillListUI extends AbstractSpermCheckBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SpermCheckBillListUI.class);
    
    /**
     * output class constructor
     */
    public SpermCheckBillListUI() throws Exception
    {
        super();
    }

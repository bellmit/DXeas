...
public class BoarDailyCullEntry extends CoreBillEntryBase implements IBoarDailyCullEntry
{
    public BoarDailyCullEntry()
    {
        super();
        registerInterface(IBoarDailyCullEntry.class, this);
    }
    public BoarDailyCullEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBoarDailyCullEntry.class, this);
    }
    ...
    private BoarDailyCullEntryController getController() throws BOSException
    {
        return (BoarDailyCullEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBoarDailyCullEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBoarDailyCullEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

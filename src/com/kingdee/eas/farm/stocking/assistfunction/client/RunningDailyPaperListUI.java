 ...
 * output class name
 */
public class RunningDailyPaperListUI extends AbstractRunningDailyPaperListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RunningDailyPaperListUI.class);
    
    /**
     * output class constructor
     */
    public RunningDailyPaperListUI() throws Exception
    {
        super();
    }

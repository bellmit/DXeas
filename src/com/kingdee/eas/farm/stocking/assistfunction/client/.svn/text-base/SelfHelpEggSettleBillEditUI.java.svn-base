 ...
 * output class name
 */
public class SelfHelpEggSettleBillEditUI extends AbstractSelfHelpEggSettleBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SelfHelpEggSettleBillEditUI.class);
    
    /**
     * output class constructor
     */
    public SelfHelpEggSettleBillEditUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionShowPriceCol_actionPerformed
     */
    public void actionShowPriceCol_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionShowPriceCol_actionPerformed(e);
    }

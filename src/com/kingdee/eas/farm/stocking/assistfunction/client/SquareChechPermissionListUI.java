 ...
 * output class name
 */
public class SquareChechPermissionListUI extends AbstractSquareChechPermissionListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SquareChechPermissionListUI.class);
    
    /**
     * output class constructor
     */
    public SquareChechPermissionListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class EggReceiveBillColorSettingEditUI extends AbstractEggReceiveBillColorSettingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggReceiveBillColorSettingEditUI.class);
    
    /**
     * output class constructor
     */
    public EggReceiveBillColorSettingEditUI() throws Exception
    {
        super();
    }
    /**

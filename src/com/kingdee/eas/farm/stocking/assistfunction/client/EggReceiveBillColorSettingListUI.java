 ...
 * output class name
 */
public class EggReceiveBillColorSettingListUI extends AbstractEggReceiveBillColorSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggReceiveBillColorSettingListUI.class);
    
    /**
     * output class constructor
     */
    public EggReceiveBillColorSettingListUI() throws Exception
    {
        super();
    }

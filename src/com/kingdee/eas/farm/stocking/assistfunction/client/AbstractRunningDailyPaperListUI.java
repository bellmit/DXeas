 ...
 * output class name
 */
public abstract class AbstractRunningDailyPaperListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRunningDailyPaperListUI.class);
     ...
     */
    public AbstractRunningDailyPaperListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRunningDailyPaperListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.assistfunction.app", "RunningDailyPaperQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.assistfunction.app.RunningDailyPaperListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.ccEggCost"));
        sic.add(new SelectorItemInfo("entrys.parentEggCost"));
        sic.add(new SelectorItemInfo("entrys.hatchFee"));
        sic.add(new SelectorItemInfo("entrys.hatchAgentFee"));
        sic.add(new SelectorItemInfo("entrys.bizDate0"));
        sic.add(new SelectorItemInfo("unitFee"));
        return sic;
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRunningDailyPaperListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRunningDailyPaperListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.assistfunction.client", "RunningDailyPaperListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.assistfunction.client.RunningDailyPaperEditUI.class.getName();
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","period.number","company.name","billStatus","unitFee"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/stocking/assistfunction/RunningDailyPaper";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.assistfunction.app.RunningDailyPaperQuery");
	}

...
public abstract class AbstractPwdVerifyUI extends com.kingdee.eas.framework.client.CoreUI
{
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.assistfunction.app.PwdVerifyUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.assistfunction.client", "PwdVerifyUI");
    }

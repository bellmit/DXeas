 ...
 * output class name
 */
public class SettleBillPrintCountEditUI extends AbstractSettleBillPrintCountEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleBillPrintCountEditUI.class);
    
    /**
     * output class constructor
     */
    public SettleBillPrintCountEditUI() throws Exception
    {
        super();
    }
    /**

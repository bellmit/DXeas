...
public class RunningDailyPaperControllerBean extends AbstractRunningDailyPaperControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.assistfunction.app.RunningDailyPaperControllerBean");
}
...
public class SquareChechPermissionControllerBean extends AbstractSquareChechPermissionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.assistfunction.app.SquareChechPermissionControllerBean");
}
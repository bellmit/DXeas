...
public class EggSettlePolicyRangeEntry extends CoreBillEntryBase implements IEggSettlePolicyRangeEntry
{
    public EggSettlePolicyRangeEntry()
    {
        super();
        registerInterface(IEggSettlePolicyRangeEntry.class, this);
    }
    public EggSettlePolicyRangeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEggSettlePolicyRangeEntry.class, this);
    }
    ...
    private EggSettlePolicyRangeEntryController getController() throws BOSException
    {
        return (EggSettlePolicyRangeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettlePolicyRangeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

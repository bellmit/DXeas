...
public class EggSettleBillEntryPriceEntry extends CoreBillEntryBase implements IEggSettleBillEntryPriceEntry
{
    public EggSettleBillEntryPriceEntry()
    {
        super();
        registerInterface(IEggSettleBillEntryPriceEntry.class, this);
    }
    public EggSettleBillEntryPriceEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEggSettleBillEntryPriceEntry.class, this);
    }
    ...
    private EggSettleBillEntryPriceEntryController getController() throws BOSException
    {
        return (EggSettleBillEntryPriceEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggSettleBillEntryPriceEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

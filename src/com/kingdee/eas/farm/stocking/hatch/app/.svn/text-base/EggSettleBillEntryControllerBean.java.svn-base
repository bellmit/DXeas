...
public class EggSettleBillEntryControllerBean extends AbstractEggSettleBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.hatch.app.EggSettleBillEntryControllerBean");
}
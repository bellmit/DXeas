...
public class InventoryControllerBean extends AbstractInventoryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.hatch.app.InventoryControllerBean");
}
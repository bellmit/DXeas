...
public class SecondAllotControllerBean extends AbstractSecondAllotControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.hatch.app.SecondAllotControllerBean");
}
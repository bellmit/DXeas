...
public class EggSettlePolicyControllerBean extends AbstractEggSettlePolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.hatch.app.EggSettlePolicyControllerBean");
    @Override
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		EggSettlePolicyInfo info = (EggSettlePolicyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		EggSettlePolicyInfo info = EggSettlePolicyFactory.getLocalInstance(ctx).getEggSettlePolicyInfo(pk);
		if (info.getBaseStatus().equals(FarmBaseStatusEnum.approve) || info.equals(FarmBaseStatusEnum.enable)) {
			throw new EASBizException(new NumericExceptionSubItem("001","资料已经核准或启用！"));
		}

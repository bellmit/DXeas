 ...
 * output class name
 */
public abstract class AbstractFormalBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFormalBillEditUI.class);
    ...
    protected com.kingdee.eas.farm.stocking.hatch.FormalBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFormalBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFormalBillEditUI.class.getName());
        ...
        // kDSeparator9
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol5\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol6\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style><c:Style id=\"sCol7\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol8\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol9\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"farmer\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"farm\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"house\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"stockingBatch\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"nowWeekAge\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol5\" /><t:Column t:key=\"nowDayAge\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol6\" /><t:Column t:key=\"applyDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:styleID=\"sCol7\" /><t:Column t:key=\"applyWeekAge\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol8\" /><t:Column t:key=\"applyDayAge\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol9\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{farmer}</t:Cell><t:Cell>$Resource{farm}</t:Cell><t:Cell>$Resource{house}</t:Cell><t:Cell>$Resource{stockingBatch}</t:Cell><t:Cell>$Resource{nowWeekAge}</t:Cell><t:Cell>$Resource{nowDayAge}</t:Cell><t:Cell>$Resource{applyDate}</t:Cell><t:Cell>$Resource{applyWeekAge}</t:Cell><t:Cell>$Resource{applyDayAge}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntrys.setFormatXml(resHelper.translateString("kdtEntrys",kdtEntrysStrXML));

                this.kdtEntrys.putBindContents("editData",new String[] {"id","farmer","farm","house","stockingBatch","nowWeekAge","nowDayAge","applyDate","applyWeekAge","applyDayAge"});
        ...
        KDTextField kdtEntrys_nowWeekAge_TextField = new KDTextField();
        kdtEntrys_nowWeekAge_TextField.setName("kdtEntrys_nowWeekAge_TextField");
        kdtEntrys_nowWeekAge_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_nowWeekAge_CellEditor = new KDTDefaultCellEditor(kdtEntrys_nowWeekAge_TextField);
        this.kdtEntrys.getColumn("nowWeekAge").setEditor(kdtEntrys_nowWeekAge_CellEditor);
        KDFormattedTextField kdtEntrys_nowDayAge_TextField = new KDFormattedTextField();
        kdtEntrys_nowDayAge_TextField.setName("kdtEntrys_nowDayAge_TextField");
        kdtEntrys_nowDayAge_TextField.setVisible(true);
        kdtEntrys_nowDayAge_TextField.setEditable(true);
        kdtEntrys_nowDayAge_TextField.setHorizontalAlignment(2);
        kdtEntrys_nowDayAge_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntrys_nowDayAge_CellEditor = new KDTDefaultCellEditor(kdtEntrys_nowDayAge_TextField);
        this.kdtEntrys.getColumn("nowDayAge").setEditor(kdtEntrys_nowDayAge_CellEditor);
        ...
        KDTextField kdtEntrys_applyWeekAge_TextField = new KDTextField();
        kdtEntrys_applyWeekAge_TextField.setName("kdtEntrys_applyWeekAge_TextField");
        kdtEntrys_applyWeekAge_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_applyWeekAge_CellEditor = new KDTDefaultCellEditor(kdtEntrys_applyWeekAge_TextField);
        this.kdtEntrys.getColumn("applyWeekAge").setEditor(kdtEntrys_applyWeekAge_CellEditor);
        KDFormattedTextField kdtEntrys_applyDayAge_TextField = new KDFormattedTextField();
        kdtEntrys_applyDayAge_TextField.setName("kdtEntrys_applyDayAge_TextField");
        kdtEntrys_applyDayAge_TextField.setVisible(true);
        kdtEntrys_applyDayAge_TextField.setEditable(true);
        kdtEntrys_applyDayAge_TextField.setHorizontalAlignment(2);
        kdtEntrys_applyDayAge_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntrys_applyDayAge_CellEditor = new KDTDefaultCellEditor(kdtEntrys_applyDayAge_TextField);
        this.kdtEntrys.getColumn("applyDayAge").setEditor(kdtEntrys_applyDayAge_CellEditor);
        // prmtCreator		
    ...
    public void initUIContentLayout()
    {
        ...
        contCreateTime.setBounds(new Rectangle(695, 549, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(695, 549, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contLastUpdateTime.setBounds(new Rectangle(695, 582, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(695, 582, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contbillStatus.setBounds(new Rectangle(694, 13, 270, 19));
        this.add(contbillStatus, new KDLayout.Constraints(694, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDSeparator9.setBounds(new Rectangle(6, 83, 986, 8));
        this.add(kDSeparator9, new KDLayout.Constraints(6, 83, 986, 8, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(20, 102, 945, 418));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.hatch.FormalBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(20, 102, 945, 418, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.hatch.FormalBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.nowWeekAge", String.class, this.kdtEntrys, "nowWeekAge.text");
		dataBinder.registerBinding("entrys.nowDayAge", int.class, this.kdtEntrys, "nowDayAge.text");
		dataBinder.registerBinding("entrys.applyDate", java.util.Date.class, this.kdtEntrys, "applyDate.text");
		dataBinder.registerBinding("entrys.applyWeekAge", String.class, this.kdtEntrys, "applyWeekAge.text");
		dataBinder.registerBinding("entrys.applyDayAge", int.class, this.kdtEntrys, "applyDayAge.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.hatch.app.FormalBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.hatch.FormalBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.nowWeekAge", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.nowDayAge", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.applyDate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.applyWeekAge", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.applyDayAge", ValidateHelper.ON_SAVE);    
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFormalBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFormalBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.client", "FormalBillEditUI");
    }
    /**
    ...
    protected IMetaDataPK getTDQueryPK() {
		...
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"applyDate").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"申请转正日期"});
			}
		}

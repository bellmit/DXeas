 ...
 * output class name
 */
public class SecondAllotListUI extends AbstractSecondAllotListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SecondAllotListUI.class);
    
    /**
     * output class constructor
     */
    public SecondAllotListUI() throws Exception
    {
        super();
    }

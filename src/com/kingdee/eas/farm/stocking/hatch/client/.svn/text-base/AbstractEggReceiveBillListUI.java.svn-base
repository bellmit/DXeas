 ...
 * output class name
 */
public abstract class AbstractEggReceiveBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEggReceiveBillListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnDelDown;
     ...
     */
    public AbstractEggReceiveBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEggReceiveBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.app", "EggReceiveBillQuery");
        //actionRemove
        ...
        // btnDelDown
        this.btnDelDown.setAction((IItemAction)ActionProxyFactory.getProxy(actionDeleteDownBill, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnDelDown.setText(resHelper.getString("btnDelDown.text"));
        // mBtnAudit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.hatch.app.EggReceiveBillListUIHandler";
	}
...
com.kingdee.eas.farm.stocking.hatch.EggReceiveBillInfo editData = (com.kingdee.eas.farm.stocking.hatch.EggReceiveBillInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.stocking.hatch.EggReceiveBillFactory.getRemoteInstance().setColor(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionShowPriceCol extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionShowPriceCol", "actionShowPriceCol_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewAllBill extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionViewAllBill", "actionViewAllBill_actionPerformed", e);
        }
    }
    ...
    protected class ActionDeleteDownBill extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionDeleteDownBill", "actionDeleteDownBill_actionPerformed", e);
        }
    }
    ...
    protected class ActionSetColor extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggReceiveBillListUI.this, "ActionSetColor", "actionSetColor_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.client", "EggReceiveBillListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","company.name","storageOrgUnit.name","description","isInit","billStatus","lastUpdateTime","creator.name","createTime","auditor.number","auditor.name","auditTime","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","eggSource","BIMUDF0129","hasTakeAway","incubation.name","farm","batch","house","isManuMin","isOtherIn","isBatchTrans"};
    }

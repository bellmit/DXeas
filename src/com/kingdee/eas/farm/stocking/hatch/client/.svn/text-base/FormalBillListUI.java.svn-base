 ...
 * output class name
 */
public class FormalBillListUI extends AbstractFormalBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FormalBillListUI.class);
    
    /**
     * output class constructor
     */
    public FormalBillListUI() throws Exception
    {
        super();
    }

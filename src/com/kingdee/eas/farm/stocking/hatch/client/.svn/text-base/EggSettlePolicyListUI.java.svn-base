 ...
 * output class name
 */
public class EggSettlePolicyListUI extends AbstractEggSettlePolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggSettlePolicyListUI.class);
    
    /**
     * output class constructor
     */
    public EggSettlePolicyListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.hatch.client.EggSettlePolicyTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class InventoryListUI extends AbstractInventoryListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InventoryListUI.class);
    
    /**
     * output class constructor
     */
    public InventoryListUI() throws Exception
    {
        super();
    }

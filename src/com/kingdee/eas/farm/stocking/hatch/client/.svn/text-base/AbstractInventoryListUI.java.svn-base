 ...
 * output class name
 */
public abstract class AbstractInventoryListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.app", "InventoryQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","entrys.id","handler.number","handler.name","entrys.seq","company.name"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.hatch.app.InventoryListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInventoryListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInventoryListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.client", "InventoryListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.hatch.client.InventoryEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.hatch.InventoryFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.hatch.InventoryInfo objectValue = new com.kingdee.eas.farm.stocking.hatch.InventoryInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","company.name"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/stocking/hatch/Inventory";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.hatch.app.InventoryQuery");
	}

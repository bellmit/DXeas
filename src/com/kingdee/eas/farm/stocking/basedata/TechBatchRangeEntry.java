...
public class TechBatchRangeEntry extends CoreBillEntryBase implements ITechBatchRangeEntry
{
    public TechBatchRangeEntry()
    {
        super();
        registerInterface(ITechBatchRangeEntry.class, this);
    }
    public TechBatchRangeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITechBatchRangeEntry.class, this);
    }
    ...
    private TechBatchRangeEntryController getController() throws BOSException
    {
        return (TechBatchRangeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTechBatchRangeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTechBatchRangeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTechBatchRangeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTechBatchRangeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTechBatchRangeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTechBatchRangeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

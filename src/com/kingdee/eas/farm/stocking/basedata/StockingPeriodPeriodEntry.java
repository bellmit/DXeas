...
public class StockingPeriodPeriodEntry extends CoreBillEntryBase implements IStockingPeriodPeriodEntry
{
    public StockingPeriodPeriodEntry()
    {
        super();
        registerInterface(IStockingPeriodPeriodEntry.class, this);
    }
    public StockingPeriodPeriodEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStockingPeriodPeriodEntry.class, this);
    }
    ...
    private StockingPeriodPeriodEntryController getController() throws BOSException
    {
        return (StockingPeriodPeriodEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingPeriodPeriodEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

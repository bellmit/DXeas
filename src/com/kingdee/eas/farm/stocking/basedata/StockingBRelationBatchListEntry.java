...
public class StockingBRelationBatchListEntry extends CoreBillEntryBase implements IStockingBRelationBatchListEntry
{
    public StockingBRelationBatchListEntry()
    {
        super();
        registerInterface(IStockingBRelationBatchListEntry.class, this);
    }
    public StockingBRelationBatchListEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStockingBRelationBatchListEntry.class, this);
    }
    ...
    private StockingBRelationBatchListEntryController getController() throws BOSException
    {
        return (StockingBRelationBatchListEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBRelationBatchListEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

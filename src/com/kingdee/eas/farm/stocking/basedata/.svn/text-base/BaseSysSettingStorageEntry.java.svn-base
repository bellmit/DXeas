...
public class BaseSysSettingStorageEntry extends CoreBillEntryBase implements IBaseSysSettingStorageEntry
{
    public BaseSysSettingStorageEntry()
    {
        super();
        registerInterface(IBaseSysSettingStorageEntry.class, this);
    }
    public BaseSysSettingStorageEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBaseSysSettingStorageEntry.class, this);
    }
    ...
    private BaseSysSettingStorageEntryController getController() throws BOSException
    {
        return (BaseSysSettingStorageEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingStorageEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

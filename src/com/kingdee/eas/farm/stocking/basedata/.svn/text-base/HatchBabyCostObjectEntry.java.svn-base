...
public class HatchBabyCostObjectEntry extends CoreBillEntryBase implements IHatchBabyCostObjectEntry
{
    public HatchBabyCostObjectEntry()
    {
        super();
        registerInterface(IHatchBabyCostObjectEntry.class, this);
    }
    public HatchBabyCostObjectEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IHatchBabyCostObjectEntry.class, this);
    }
    ...
    private HatchBabyCostObjectEntryController getController() throws BOSException
    {
        return (HatchBabyCostObjectEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBabyCostObjectEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

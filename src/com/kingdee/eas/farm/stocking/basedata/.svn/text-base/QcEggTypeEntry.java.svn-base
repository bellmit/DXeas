...
public class QcEggTypeEntry extends CoreBillEntryBase implements IQcEggTypeEntry
{
    public QcEggTypeEntry()
    {
        super();
        registerInterface(IQcEggTypeEntry.class, this);
    }
    public QcEggTypeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IQcEggTypeEntry.class, this);
    }
    ...
    private QcEggTypeEntryController getController() throws BOSException
    {
        return (QcEggTypeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getQcEggTypeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQcEggTypeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQcEggTypeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQcEggTypeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQcEggTypeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getQcEggTypeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

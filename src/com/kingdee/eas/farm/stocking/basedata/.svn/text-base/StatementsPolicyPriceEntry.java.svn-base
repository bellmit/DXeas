...
public class StatementsPolicyPriceEntry extends CoreBillEntryBase implements IStatementsPolicyPriceEntry
{
    public StatementsPolicyPriceEntry()
    {
        super();
        registerInterface(IStatementsPolicyPriceEntry.class, this);
    }
    public StatementsPolicyPriceEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStatementsPolicyPriceEntry.class, this);
    }
    ...
    private StatementsPolicyPriceEntryController getController() throws BOSException
    {
        return (StatementsPolicyPriceEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsPolicyPriceEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

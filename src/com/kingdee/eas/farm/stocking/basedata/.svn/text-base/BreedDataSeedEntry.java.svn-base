...
public class BreedDataSeedEntry extends CoreBillEntryBase implements IBreedDataSeedEntry
{
    public BreedDataSeedEntry()
    {
        super();
        registerInterface(IBreedDataSeedEntry.class, this);
    }
    public BreedDataSeedEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBreedDataSeedEntry.class, this);
    }
    ...
    private BreedDataSeedEntryController getController() throws BOSException
    {
        return (BreedDataSeedEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBreedDataSeedEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedDataSeedEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedDataSeedEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedDataSeedEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedDataSeedEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedDataSeedEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
import com.kingdee.eas.farm.stocking.basedata.SubsidyFactory;
import com.kingdee.eas.farm.stocking.basedata.SubsidyInfo;
import com.kingdee.util.NumericExceptionSubItem;

public class SubsidyControllerBean extends AbstractSubsidyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.basedata.app.SubsidyControllerBean");
    @Override
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		SubsidyInfo info = (SubsidyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		SubsidyInfo info = SubsidyFactory.getLocalInstance(ctx).getSubsidyInfo(pk);
		if (info.getBaseStatus().equals(FarmBaseStatusEnum.approve) || info.equals(FarmBaseStatusEnum.enable)) {
			throw new EASBizException(new NumericExceptionSubItem("001","资料已经核准或启用！"));
		}

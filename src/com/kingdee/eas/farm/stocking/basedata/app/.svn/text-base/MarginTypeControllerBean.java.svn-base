...
import com.kingdee.eas.farm.stocking.basedata.MarginTypeFactory;
import com.kingdee.eas.farm.stocking.basedata.MarginTypeInfo;
import com.kingdee.util.NumericExceptionSubItem;

public class MarginTypeControllerBean extends AbstractMarginTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.basedata.app.MarginTypeControllerBean");
    @Override
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		MarginTypeInfo info = (MarginTypeInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		MarginTypeInfo info = MarginTypeFactory.getLocalInstance(ctx).getMarginTypeInfo(pk);
		if (info.getBaseStatus().equals(FarmBaseStatusEnum.approve) || info.getBaseStatus().equals(FarmBaseStatusEnum.enable)) {
			throw new EASBizException(new NumericExceptionSubItem("001","资料已经核准或启用！"));
		}

...
import com.kingdee.eas.farm.stocking.basedata.SellSeedlingSettlePolicyFactory;
...
public class SellSeedlingSettlePolicyControllerBean extends AbstractSellSeedlingSettlePolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.basedata.app.SellSeedlingSettlePolicyControllerBean");
    
	@Override
	protected void _cancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		SellSeedlingSettlePolicyInfo info = (SellSeedlingSettlePolicyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		SellSeedlingSettlePolicyInfo info = SellSeedlingSettlePolicyFactory.getLocalInstance(ctx).getSellSeedlingSettlePolicyInfo(pk);
		if (info.getBaseStatus().equals(FarmBaseStatusEnum.approve) || info.getBaseStatus().equals(FarmBaseStatusEnum.enable)) {
			throw new EASBizException(new NumericExceptionSubItem("001","资料已经核准或启用！"));
		}

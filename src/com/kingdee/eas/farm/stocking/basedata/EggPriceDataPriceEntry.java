...
public class EggPriceDataPriceEntry extends CoreBillEntryBase implements IEggPriceDataPriceEntry
{
    public EggPriceDataPriceEntry()
    {
        super();
        registerInterface(IEggPriceDataPriceEntry.class, this);
    }
    public EggPriceDataPriceEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEggPriceDataPriceEntry.class, this);
    }
    ...
    private EggPriceDataPriceEntryController getController() throws BOSException
    {
        return (EggPriceDataPriceEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggPriceDataPriceEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

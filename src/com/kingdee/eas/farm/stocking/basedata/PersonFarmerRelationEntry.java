...
public class PersonFarmerRelationEntry extends CoreBillEntryBase implements IPersonFarmerRelationEntry
{
    public PersonFarmerRelationEntry()
    {
        super();
        registerInterface(IPersonFarmerRelationEntry.class, this);
    }
    public PersonFarmerRelationEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPersonFarmerRelationEntry.class, this);
    }
    ...
    private PersonFarmerRelationEntryController getController() throws BOSException
    {
        return (PersonFarmerRelationEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPersonFarmerRelationEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

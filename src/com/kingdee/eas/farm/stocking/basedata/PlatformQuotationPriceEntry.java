...
public class PlatformQuotationPriceEntry extends CoreBillEntryBase implements IPlatformQuotationPriceEntry
{
    public PlatformQuotationPriceEntry()
    {
        super();
        registerInterface(IPlatformQuotationPriceEntry.class, this);
    }
    public PlatformQuotationPriceEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPlatformQuotationPriceEntry.class, this);
    }
    ...
    private PlatformQuotationPriceEntryController getController() throws BOSException
    {
        return (PlatformQuotationPriceEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlatformQuotationPriceEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

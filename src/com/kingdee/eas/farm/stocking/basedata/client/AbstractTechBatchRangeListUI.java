 ...
 * output class name
 */
public abstract class AbstractTechBatchRangeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTechBatchRangeListUI.class);
    /**
     * output class constructor
     */
    public AbstractTechBatchRangeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.TechBatchRangeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "TechBatchRangeListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.TechBatchRangeEditUI.class.getName();
    }

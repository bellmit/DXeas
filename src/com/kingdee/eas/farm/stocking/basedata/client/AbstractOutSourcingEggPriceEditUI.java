 ...
 * output class name
 */
public abstract class AbstractOutSourcingEggPriceEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOutSourcingEggPriceEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer1;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer2;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contFICompany;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsettleCostPrice;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtsettleCostPrice;
    ...
    protected com.kingdee.eas.farm.stocking.basedata.OutSourcingEggPriceInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractOutSourcingEggPriceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOutSourcingEggPriceEditUI.class.getName());
        ...
        this.contsettleCostPrice = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtsettleCostPrice = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contsettleCostPrice.setName("contsettleCostPrice");
        ...
        this.txtsettleCostPrice.setName("txtsettleCostPrice");
        ...
        // contsettleCostPrice		
        this.contsettleCostPrice.setBoundLabelText(resHelper.getString("contsettleCostPrice.boundLabelText"));		
        this.contsettleCostPrice.setBoundLabelLength(100);		
        this.contsettleCostPrice.setBoundLabelUnderline(true);		
        this.contsettleCostPrice.setVisible(true);
        // conthatchBeginDate		
        ...
        // txtsettleCostPrice		
        this.txtsettleCostPrice.setVisible(true);		
        this.txtsettleCostPrice.setHorizontalAlignment(2);		
        this.txtsettleCostPrice.setDataType(1);		
        this.txtsettleCostPrice.setSupportedEmpty(true);		
        this.txtsettleCostPrice.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtsettleCostPrice.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtsettleCostPrice.setPrecision(4);		
        this.txtsettleCostPrice.setRequired(false);
        // pkhatchBeginDate		
        this.pkhatchBeginDate.setVisible(true);		
        this.pkhatchBeginDate.setRequired(false);
        // pkhatchEndDate		
        this.pkhatchEndDate.setVisible(true);		
        this.pkhatchEndDate.setRequired(false);
        // baseStatus		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkhatchBeginDate,pkhatchEndDate,txtsettleCostPrice,txtNumber,txtName,prmtFICompany,baseStatus}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 390, 382));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(58, 38, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(58, 120, 270, 19));
        this.add(kDLabelContainer2, null);
        contFICompany.setBounds(new Rectangle(58, 161, 270, 19));
        this.add(contFICompany, null);
        contsettleCostPrice.setBounds(new Rectangle(58, 288, 270, 19));
        this.add(contsettleCostPrice, null);
        conthatchBeginDate.setBounds(new Rectangle(58, 202, 270, 19));
        this.add(conthatchBeginDate, null);
        conthatchEndDate.setBounds(new Rectangle(58, 243, 270, 19));
        this.add(conthatchEndDate, null);
        contbaseStatus.setBounds(new Rectangle(58, 79, 270, 19));
        ...
        //contsettleCostPrice
        contsettleCostPrice.setBoundEditor(txtsettleCostPrice);
        //conthatchBeginDate
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("settleCostPrice", java.math.BigDecimal.class, this.txtsettleCostPrice, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.OutSourcingEggPriceEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.pkhatchBeginDate.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.basedata.OutSourcingEggPriceInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("settleCostPrice", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("settleCostPrice"));
    ...
    {
        com.kingdee.eas.farm.stocking.basedata.OutSourcingEggPriceFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.basedata.OutSourcingEggPriceFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOutSourcingEggPriceEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOutSourcingEggPriceEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "OutSourcingEggPriceEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.OutSourcingEggPriceEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.OutSourcingEggPriceFactory.getRemoteInstance();
    }

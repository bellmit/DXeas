 ...
 * output class name
 */
public abstract class AbstractFarmersEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFarmersEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfarmerActName;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtfarmerActName;
     ...
     */
    public AbstractFarmersEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFarmersEditUI.class.getName());
        ...
        this.contfarmerActName = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtfarmerActName = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contfarmerActName.setName("contfarmerActName");
        ...
        this.txtfarmerActName.setName("txtfarmerActName");
        ...
        // contfarmerActName		
        this.contfarmerActName.setBoundLabelText(resHelper.getString("contfarmerActName.boundLabelText"));		
        this.contfarmerActName.setBoundLabelLength(100);		
        this.contfarmerActName.setBoundLabelUnderline(true);		
        this.contfarmerActName.setVisible(true);
        // txtidentity		
        ...
        // txtfarmerActName		
        this.txtfarmerActName.setVisible(true);		
        this.txtfarmerActName.setHorizontalAlignment(2);		
        this.txtfarmerActName.setMaxLength(100);		
        this.txtfarmerActName.setRequired(false);
        // kdtFarmEntry
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,prmtcreator,pkcreateTime,txtaddress,txtidentity,txttel,txtmobileTel,prmtauditor,pkauditTime,sex,baseStatus,prmtcustomer,txtbank,txtbankNo,prmtsupplier,prmtcostCenter,kdtFarmEntry,prmtcompany,txtage,txtnation,eduLvl,txtfamilyPersonCount,prmtBEBank,txtfarmerActName,prmtgeneralAsstActType}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 661, 449));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(29, 10, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(349, 10, 270, 19));
        ...
        contcreator.setBounds(new Rectangle(33, 417, 270, 19));
        this.add(contcreator, null);
        contcreateTime.setBounds(new Rectangle(349, 417, 270, 19));
        this.add(contcreateTime, null);
        contauditor.setBounds(new Rectangle(33, 386, 270, 19));
        this.add(contauditor, null);
        contauditTime.setBounds(new Rectangle(349, 386, 270, 19));
        this.add(contauditTime, null);
        kDTabbedPane1.setBounds(new Rectangle(23, 139, 597, 235));
        this.add(kDTabbedPane1, null);
        contbaseStatus.setBounds(new Rectangle(349, 40, 270, 19));
        this.add(contbaseStatus, null);
        contcustomer.setBounds(new Rectangle(349, 69, 270, 19));
        this.add(contcustomer, null);
        kDSeparator5.setBounds(new Rectangle(13, 376, 624, 1));
        this.add(kDSeparator5, null);
        kDSeparator6.setBounds(new Rectangle(13, 128, 622, 10));
        this.add(kDSeparator6, null);
        contsupplier.setBounds(new Rectangle(29, 69, 270, 19));
        this.add(contsupplier, null);
        contcostCenter.setBounds(new Rectangle(29, 69, 270, 19));
        this.add(contcostCenter, null);
        contcompany.setBounds(new Rectangle(29, 40, 270, 19));
        this.add(contcompany, null);
        contgeneralAsstActType.setBounds(new Rectangle(29, 100, 270, 19));
        ...
        conttel.setBounds(new Rectangle(306, 35, 270, 19));
        ...
        contbankNo.setBounds(new Rectangle(306, 146, 266, 19));
        kDPanel1.add(contbankNo, null);
        contage.setBounds(new Rectangle(18, 62, 270, 19));
        kDPanel1.add(contage, null);
        contnation.setBounds(new Rectangle(306, 62, 270, 19));
        kDPanel1.add(contnation, null);
        conteduLvl.setBounds(new Rectangle(18, 89, 270, 19));
        kDPanel1.add(conteduLvl, null);
        contfamilyPersonCount.setBounds(new Rectangle(306, 89, 270, 19));
        kDPanel1.add(contfamilyPersonCount, null);
        contBEBank.setBounds(new Rectangle(18, 146, 270, 19));
        kDPanel1.add(contBEBank, null);
        contbank.setBounds(new Rectangle(18, 173, 270, 19));
        kDPanel1.add(contbank, null);
        contfarmerActName.setBounds(new Rectangle(306, 173, 270, 19));
        kDPanel1.add(contfarmerActName, null);
        //contidentity
        ...
        //contfarmerActName
        contfarmerActName.setBoundEditor(txtfarmerActName);
        //kDPanel2
        kDPanel2.setLayout(null);        kdtFarmEntry.setBounds(new Rectangle(0, 0, 586, 203));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("farmerActName", String.class, this.txtfarmerActName, "text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.FarmersEditUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("farmerActName", ValidateHelper.ON_SAVE);    
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFarmersEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmersEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "FarmersEditUI");
    }

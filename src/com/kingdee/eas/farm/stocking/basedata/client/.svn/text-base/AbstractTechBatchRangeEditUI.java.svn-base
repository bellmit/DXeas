 ...
 * output class name
 */
public abstract class AbstractTechBatchRangeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTechBatchRangeEditUI.class);
    ...
    protected com.kingdee.eas.farm.stocking.basedata.TechBatchRangeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTechBatchRangeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTechBatchRangeEditUI.class.getName());
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntry.putBindContents("editData",new String[] {"seq","batch","farm"});
        ...
        this.kdtEntry.getColumn("batch").setRenderer(kdtEntry_batch_OVR);
			...
			com.kingdee.eas.farm.stocking.basedata.client.StockingBatchListUI kdtEntry_batch_PromptBox_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (kdtEntry_batch_PromptBox_F7ListUI == null) {
					try {
						kdtEntry_batch_PromptBox_F7ListUI = new com.kingdee.eas.farm.stocking.basedata.client.StockingBatchListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
        ...
        KDTextField kdtEntry_farm_TextField = new KDTextField();
        kdtEntry_farm_TextField.setName("kdtEntry_farm_TextField");
        kdtEntry_farm_TextField.setMaxLength(80);
        KDTDefaultCellEditor kdtEntry_farm_CellEditor = new KDTDefaultCellEditor(kdtEntry_farm_TextField);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtcompany,prmtuser}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 306, 375));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(17, 12, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(17, 48, 270, 19));
        this.add(kDLabelContainer2, null);
        kdtEntry.setBounds(new Rectangle(17, 159, 270, 198));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.farm.stocking.basedata.TechBatchRangeEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, null);
        contcompany.setBounds(new Rectangle(17, 84, 270, 19));
        this.add(contcompany, null);
        contuser.setBounds(new Rectangle(17, 120, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.farm.stocking.basedata.TechBatchRangeEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("Entry.batch", java.lang.Object.class, this.kdtEntry, "batch.text");
		dataBinder.registerBinding("Entry.farm", String.class, this.kdtEntry, "farm.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.TechBatchRangeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.basedata.TechBatchRangeInfo)ov;
    }
    ...
    {
            if ("batch".equalsIgnoreCase(kdtEntry.getColumn(colIndex).getKey())) {
kdtEntry.getCell(rowIndex,"farm").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntry.getCell(rowIndex,"batch").getValue(),"farm.name")));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "TechBatchRangeEditUI");
    }

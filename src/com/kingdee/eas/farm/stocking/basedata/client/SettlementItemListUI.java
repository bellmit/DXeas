 ...
 * output class name
 */
public class SettlementItemListUI extends AbstractSettlementItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettlementItemListUI.class);
    
    /**
     * output class constructor
     */
    public SettlementItemListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.SettlementItemTreeEditUI.class.getName();
    }

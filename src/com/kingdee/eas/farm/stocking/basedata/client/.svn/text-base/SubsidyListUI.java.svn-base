 ...
 * output class name
 */
public class SubsidyListUI extends AbstractSubsidyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SubsidyListUI.class);
    
    /**
     * output class constructor
     */
    public SubsidyListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.SubsidyTreeEditUI.class.getName();
    }

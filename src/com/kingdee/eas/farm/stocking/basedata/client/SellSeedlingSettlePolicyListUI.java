 ...
 * output class name
 */
public class SellSeedlingSettlePolicyListUI extends AbstractSellSeedlingSettlePolicyListUI
{
	private static final Logger logger = CoreUIObject.getLogger(SellSeedlingSettlePolicyListUI.class);

	/**
	 * output class constructor
	 */
	public SellSeedlingSettlePolicyListUI() throws Exception
	{
		super();
	}
	@Override

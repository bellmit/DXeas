 ...
 * output class name
 */
public class CheckItemListUI extends AbstractCheckItemListUI
{
     ...
     */
    public CheckItemListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.CheckItemTreeEditUI.class.getName();
    }

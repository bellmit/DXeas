 ...
 * output class name
 */
public class BreedDataListUI extends AbstractBreedDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedDataListUI.class);
    
    /**
     * output class constructor
     */
    public BreedDataListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.BreedDataTreeEditUI.class.getName();
    }

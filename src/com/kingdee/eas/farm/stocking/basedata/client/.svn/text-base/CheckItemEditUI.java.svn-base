 ...
 * output class name
 */
public class CheckItemEditUI extends AbstractCheckItemEditUI
{
     ...
     */
    public CheckItemEditUI() throws Exception
    {
        super();
    }
    @Override
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.stocking.basedata.CheckItemTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

 ...
 * output class name
 */
public class RewardsPolicyListUI extends AbstractRewardsPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RewardsPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public RewardsPolicyListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.RewardsPolicyTreeEditUI.class.getName();
    }

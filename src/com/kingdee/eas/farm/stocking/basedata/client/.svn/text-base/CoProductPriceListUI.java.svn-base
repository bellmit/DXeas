 ...
 * output class name
 */
public class CoProductPriceListUI extends AbstractCoProductPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CoProductPriceListUI.class);
    
    /**
     * output class constructor
     */
    public CoProductPriceListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.CoProductPriceTreeEditUI.class.getName();
    }

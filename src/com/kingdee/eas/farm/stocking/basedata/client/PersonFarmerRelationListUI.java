 ...
 * output class name
 */
public class PersonFarmerRelationListUI extends AbstractPersonFarmerRelationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonFarmerRelationListUI.class);
    
    /**
     * output class constructor
     */
    public PersonFarmerRelationListUI() throws Exception
    {
        super();
    }
...
//		super.actionCancelCancel_actionPerformed(e);
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.PersonFarmerRelationTreeEditUI.class.getName();
    }

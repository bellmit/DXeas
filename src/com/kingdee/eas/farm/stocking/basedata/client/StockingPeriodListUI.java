 ...
 * output class name
 */
public class StockingPeriodListUI extends AbstractStockingPeriodListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StockingPeriodListUI.class);
    
    /**
     * output class constructor
     */
    public StockingPeriodListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractFeeSendPersonListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeeSendPersonListUI.class);
    /**
     * output class constructor
     */
    public AbstractFeeSendPersonListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeeSendPersonListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.app", "FeeSendPersonQuery");
        // CoreUI
        ...
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","simpleName","description","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","id","person.name","billStatus"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.FeeSendPersonListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "FeeSendPersonListUI");
    }

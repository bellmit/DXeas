 ...
 * output class name
 */
public abstract class AbstractQcEggTypeListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQcEggTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractQcEggTypeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.QcEggTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "QcEggTypeListUI");
    }

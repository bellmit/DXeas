 ...
 * output class name
 */
public class SettleStandardListUI extends AbstractSettleStandardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleStandardListUI.class);
    
    /**
     * output class constructor
     */
    public SettleStandardListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.SettleStandardTreeEditUI.class.getName();
    }

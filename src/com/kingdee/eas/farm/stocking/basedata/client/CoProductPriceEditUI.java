 ...
 * output class name
 */
public class CoProductPriceEditUI extends AbstractCoProductPriceEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CoProductPriceEditUI.class);
    
    /**
     * output class constructor
     */
    public CoProductPriceEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.stocking.basedata.CoProductPriceTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
		...
		try {
			 MeasureUnitCollection unitCol = MeasureUnitFactory.getRemoteInstance().getMeasureUnitCollection("where number='KG'");
			 if(unitCol!=null&&unitCol.size()>0) {
				 objectValue.setUnit(unitCol.get(0)); 
			 }
		}catch(Exception err){
			err.printStackTrace();
		}

 ...
 * output class name
 */
public class MarginTypeListUI extends AbstractMarginTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginTypeListUI.class);
    
    /**
     * output class constructor
     */
    public MarginTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.MarginTypeTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public abstract class AbstractBaseSysSettingEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseSysSettingEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfarmerAsstActGroup;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtfarmerAsstActGroup;
    protected com.kingdee.eas.farm.stocking.basedata.BaseSysSettingInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBaseSysSettingEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaseSysSettingEditUI.class.getName());
        ...
        this.contfarmerAsstActGroup = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtfarmerAsstActGroup = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contfarmerAsstActGroup.setName("contfarmerAsstActGroup");
        this.prmtfarmerAsstActGroup.setName("prmtfarmerAsstActGroup");
        // CoreUI		
        ...
        this.contparentCostCenter.setVisible(true);
        ...
        this.prmtparentCostCenter.setRequired(true);
        ...
        // contfarmerAsstActGroup		
        this.contfarmerAsstActGroup.setBoundLabelText(resHelper.getString("contfarmerAsstActGroup.boundLabelText"));		
        this.contfarmerAsstActGroup.setBoundLabelLength(100);		
        this.contfarmerAsstActGroup.setBoundLabelUnderline(true);		
        this.contfarmerAsstActGroup.setVisible(true);
        // prmtfarmerAsstActGroup		
        this.prmtfarmerAsstActGroup.setQueryInfo("com.kingdee.eas.farm.stocking.basedata.app.F7GeneralAsstActTypeGroupQuery");		
        this.prmtfarmerAsstActGroup.setVisible(true);		
        this.prmtfarmerAsstActGroup.setEditable(true);		
        this.prmtfarmerAsstActGroup.setDisplayFormat("$name$");		
        this.prmtfarmerAsstActGroup.setEditFormat("$number$");		
        this.prmtfarmerAsstActGroup.setCommitFormat("$number$");		
        this.prmtfarmerAsstActGroup.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,prmtcompany,chkisInner,prmtcostGroup,accountType,chkisHouseManager,prmtparentCostCenter,prmtdefaultStorageOrgUnit,kdtStorageEntry,kdtMarginTypeEntry,chkisAutoSCM,chkisCreateFarmerAsst,prmtfarmerAsstActGroup}));
    ...
    public void initUIContentLayout()
    {
        ...
        kdtStorageEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtStorageEntry,new com.kingdee.eas.farm.stocking.basedata.BaseSysSettingStorageEntryInfo(),null,false);
...
vo.put("outOrgType",new Integer(1));
        ...
        contparentCostCenter.setBounds(new Rectangle(308, 16, 270, 19));
        ...
        kdtMarginTypeEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtMarginTypeEntry,new com.kingdee.eas.farm.stocking.basedata.BaseSysSettingMarginTypeEntryInfo(),null,false);
        ...
        chkisCreateFarmerAsst.setBounds(new Rectangle(22, 70, 152, 19));
        kDPanel3.add(chkisCreateFarmerAsst, null);
        contfarmerAsstActGroup.setBounds(new Rectangle(249, 70, 270, 19));
        kDPanel3.add(contfarmerAsstActGroup, null);
        //contfarmerAsstActGroup
        contfarmerAsstActGroup.setBoundEditor(prmtfarmerAsstActGroup);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("StorageEntry", com.kingdee.eas.farm.stocking.basedata.BaseSysSettingStorageEntryInfo.class, this.kdtStorageEntry, "userObject");
		...
		dataBinder.registerBinding("MarginTypeEntry", com.kingdee.eas.farm.stocking.basedata.BaseSysSettingMarginTypeEntryInfo.class, this.kdtMarginTypeEntry, "userObject");
		...
		dataBinder.registerBinding("farmerAsstActGroup", com.kingdee.eas.basedata.master.auxacct.AsstAccountInfo.class, this.prmtfarmerAsstActGroup, "data");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.BaseSysSettingEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.basedata.BaseSysSettingInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("farmerAsstActGroup", ValidateHelper.ON_SAVE);    		
	}
...
kdtStorageEntry.getCell(rowIndex,"storageOrgUnitName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtStorageEntry.getCell(rowIndex,"storageOrgUnit").getValue(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("farmerAsstActGroup.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("farmerAsstActGroup.id"));
        	sic.add(new SelectorItemInfo("farmerAsstActGroup.number"));
        	sic.add(new SelectorItemInfo("farmerAsstActGroup.name"));
		}
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "BaseSysSettingEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.BaseSysSettingEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.BaseSysSettingFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.basedata.BaseSysSettingInfo objectValue = new com.kingdee.eas.farm.stocking.basedata.BaseSysSettingInfo();
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtparentCostCenter.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"养户父成本中心"});
		}

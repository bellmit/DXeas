 ...
 * output class name
 */
public class BaseSysSettingEditUI extends AbstractBaseSysSettingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BaseSysSettingEditUI.class);
    
    /**
     * output class constructor
     */
    public BaseSysSettingEditUI() throws Exception
    {
        super();
    }
    /**

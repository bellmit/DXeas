 ...
 * output class name
 */
public abstract class AbstractHatchBabyCostObjectEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHatchBabyCostObjectEditUI.class);
    ...
    protected com.kingdee.eas.farm.stocking.basedata.HatchBabyCostObjectInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHatchBabyCostObjectEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHatchBabyCostObjectEditUI.class.getName());
        ...
        // kdtEntry
		String kdtEntryStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:NumberFormat>&amp;int</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"farmerTree\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"childDuck\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"material\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"costObject\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{farmerTree}</t:Cell><t:Cell>$Resource{childDuck}</t:Cell><t:Cell>$Resource{material}</t:Cell><t:Cell>$Resource{costObject}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntry.setFormatXml(resHelper.translateString("kdtEntry",kdtEntryStrXML));

                this.kdtEntry.putBindContents("editData",new String[] {"seq","farmerTree","childDuck","material","costObject"});
        ...
        final KDBizPromptBox kdtEntry_farmerTree_PromptBox = new KDBizPromptBox();
        kdtEntry_farmerTree_PromptBox.setQueryInfo("com.kingdee.eas.farm.stocking.basedata.app.F7FarmerGroupQuery");
        kdtEntry_farmerTree_PromptBox.setVisible(true);
        kdtEntry_farmerTree_PromptBox.setEditable(true);
        kdtEntry_farmerTree_PromptBox.setDisplayFormat("$number$");
        kdtEntry_farmerTree_PromptBox.setEditFormat("$number$");
        kdtEntry_farmerTree_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntry_farmerTree_CellEditor = new KDTDefaultCellEditor(kdtEntry_farmerTree_PromptBox);
        this.kdtEntry.getColumn("farmerTree").setEditor(kdtEntry_farmerTree_CellEditor);
        ObjectValueRender kdtEntry_farmerTree_OVR = new ObjectValueRender();
        kdtEntry_farmerTree_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntry.getColumn("farmerTree").setRenderer(kdtEntry_farmerTree_OVR);
        KDTextField kdtEntry_childDuck_TextField = new KDTextField();
        kdtEntry_childDuck_TextField.setName("kdtEntry_childDuck_TextField");
        kdtEntry_childDuck_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntry_childDuck_CellEditor = new KDTDefaultCellEditor(kdtEntry_childDuck_TextField);
        this.kdtEntry.getColumn("childDuck").setEditor(kdtEntry_childDuck_CellEditor);
        ...
        // prmtfarmersTree		
        this.prmtfarmersTree.setQueryInfo("com.kingdee.eas.custom.signwasthetable.app.SignBDQuery");		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,prmtfarmersTree}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 567, 298));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(18, 18, 242, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(297, 21, 242, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(565, 44, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(566, 12, 270, 19));
        this.add(kDLabelContainer4, null);
        kdtEntry.setBounds(new Rectangle(18, 91, 521, 200));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.farm.stocking.basedata.HatchBabyCostObjectEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, null);
        contfarmersTree.setBounds(new Rectangle(18, 55, 242, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.farm.stocking.basedata.HatchBabyCostObjectEntryInfo.class, this.kdtEntry, "userObject");
		dataBinder.registerBinding("Entry.farmerTree", java.lang.Object.class, this.kdtEntry, "farmerTree.text");
		dataBinder.registerBinding("Entry.childDuck", String.class, this.kdtEntry, "childDuck.text");
		dataBinder.registerBinding("Entry.material", java.lang.Object.class, this.kdtEntry, "material.text");
		dataBinder.registerBinding("Entry.costObject", java.lang.Object.class, this.kdtEntry, "costObject.text");
		dataBinder.registerBinding("number", String.class, this.txtNumber, "text");
		dataBinder.registerBinding("name", String.class, this.txtName, "_multiLangItem");
		dataBinder.registerBinding("simpleName", String.class, this.txtSimpleName, "text");
		dataBinder.registerBinding("description", String.class, this.txtDescription, "_multiLangItem");
		dataBinder.registerBinding("farmersTree", com.kingdee.eas.custom.signwasthetable.SignBDInfo.class, this.prmtfarmersTree, "data");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.HatchBabyCostObjectEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.basedata.HatchBabyCostObjectInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entry.farmerTree", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("Entry.childDuck", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("Entry.farmerTree.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("Entry.farmerTree.id"));
			sic.add(new SelectorItemInfo("Entry.farmerTree.name"));
        	sic.add(new SelectorItemInfo("Entry.farmerTree.number"));
		}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "HatchBabyCostObjectEditUI");
    }

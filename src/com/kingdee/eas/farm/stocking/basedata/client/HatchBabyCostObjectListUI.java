 ...
 * output class name
 */
public class HatchBabyCostObjectListUI extends AbstractHatchBabyCostObjectListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchBabyCostObjectListUI.class);
    
    /**
     * output class constructor
     */
    public HatchBabyCostObjectListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class FarmerInterestListUI extends AbstractFarmerInterestListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerInterestListUI.class);
    
    /**
     * output class constructor
     */
    public FarmerInterestListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractStatementsPolicyListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStatementsPolicyListUI.class);
    ...
    protected ActionUnAudit actionUnAudit = null;
		...
		public AbstractStatementsPolicyListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractStatementsPolicyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStatementsPolicyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.app", "StatementsPolicyQuery");
        //actionIsTemplate
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.StatementsPolicyListUIHandler";
	}
...
com.kingdee.eas.farm.stocking.basedata.StatementsPolicyInfo editData = (com.kingdee.eas.farm.stocking.basedata.StatementsPolicyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.stocking.basedata.StatementsPolicyFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionIsTemplate extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractStatementsPolicyListUI.this, "ActionIsTemplate", "actionIsTemplate_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStatementsPolicyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStatementsPolicyListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "StatementsPolicyListUI");
    }

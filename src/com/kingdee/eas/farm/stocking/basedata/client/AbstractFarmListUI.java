...
public abstract class AbstractFarmListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    ...
    private void jbInit() throws Exception
    {
        ...
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.app", "FarmQuery");
        //actionAudit
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basedata.app.FarmListUIHandler";
	}
...
com.kingdee.eas.farm.stocking.basedata.FarmInfo editData = (com.kingdee.eas.farm.stocking.basedata.FarmInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.stocking.basedata.FarmFactory.getRemoteInstance().unAudit(editData);
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basedata.client", "FarmListUI");
    }

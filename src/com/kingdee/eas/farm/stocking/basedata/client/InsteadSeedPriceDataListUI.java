 ...
 * output class name
 */
public class InsteadSeedPriceDataListUI extends AbstractInsteadSeedPriceDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InsteadSeedPriceDataListUI.class);
    
    /**
     * output class constructor
     */
    public InsteadSeedPriceDataListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.InsteadSeedPriceDataTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class SettleStandardEditUI extends AbstractSettleStandardEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleStandardEditUI.class);
    
    /**
     * output class constructor
     */
    public SettleStandardEditUI() throws Exception
    {
        super();
    }
    @Override
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.stocking.basedata.SettleStandardTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

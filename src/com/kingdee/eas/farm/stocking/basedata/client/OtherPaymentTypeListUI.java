 ...
 * output class name
 */
public class OtherPaymentTypeListUI extends AbstractOtherPaymentTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherPaymentTypeListUI.class);
    
    /**
     * output class constructor
     */
    public OtherPaymentTypeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.basedata.client.OtherPaymentTypeTreeEditUI.class.getName();
    }

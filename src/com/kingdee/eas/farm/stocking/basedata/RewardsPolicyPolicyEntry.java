...
public class RewardsPolicyPolicyEntry extends CoreBillEntryBase implements IRewardsPolicyPolicyEntry
{
    public RewardsPolicyPolicyEntry()
    {
        super();
        registerInterface(IRewardsPolicyPolicyEntry.class, this);
    }
    public RewardsPolicyPolicyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRewardsPolicyPolicyEntry.class, this);
    }
    ...
    private RewardsPolicyPolicyEntryController getController() throws BOSException
    {
        return (RewardsPolicyPolicyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRewardsPolicyPolicyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

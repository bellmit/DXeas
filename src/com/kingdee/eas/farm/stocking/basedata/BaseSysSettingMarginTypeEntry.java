...
public class BaseSysSettingMarginTypeEntry extends CoreBillEntryBase implements IBaseSysSettingMarginTypeEntry
{
    public BaseSysSettingMarginTypeEntry()
    {
        super();
        registerInterface(IBaseSysSettingMarginTypeEntry.class, this);
    }
    public BaseSysSettingMarginTypeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBaseSysSettingMarginTypeEntry.class, this);
    }
    ...
    private BaseSysSettingMarginTypeEntryController getController() throws BOSException
    {
        return (BaseSysSettingMarginTypeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBaseSysSettingMarginTypeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class MarginBillEntryControllerBean extends AbstractMarginBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.basebizbill.app.MarginBillEntryControllerBean");
}
 ...
 * output class name
 */
public class FarmerApplyBillListUI extends AbstractFarmerApplyBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerApplyBillListUI.class);
    
    /**
     * output class constructor
     */
    public FarmerApplyBillListUI() throws Exception
    {
        super();
    }

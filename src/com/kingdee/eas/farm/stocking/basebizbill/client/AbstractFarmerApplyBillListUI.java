 ...
 * output class name
 */
public abstract class AbstractFarmerApplyBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFarmerApplyBillListUI.class);
     ...
     */
    public AbstractFarmerApplyBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFarmerApplyBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.basebizbill.app", "FarmerApplyBillQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.basebizbill.app.FarmerApplyBillListUIHandler";
	}
...
com.kingdee.eas.farm.stocking.basebizbill.FarmerApplyBillInfo editData = (com.kingdee.eas.farm.stocking.basebizbill.FarmerApplyBillInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.stocking.basebizbill.FarmerApplyBillFactory.getRemoteInstance().isCheckItemEntry(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionIsTemplate extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionIsTemplate", "actionIsTemplate_actionPerformed", e);
        }
    }
    ...
    protected class ActionIsCheckItemEntry extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerApplyBillListUI.this, "ActionIsCheckItemEntry", "actionIsCheckItemEntry_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.basebizbill.client", "FarmerApplyBillListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","billStatus","company.name","name","sex","identity","mobileTel","tel","address","bankNo","bankName","experience","breedLvl","score","ssessmentPerson.name","isTemplate","WoM","checkResult","farmer.name","farmerGroup.name","createTime","lastUpdateTime","auditor.number","auditor.name","auditTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","age","nation","eduLvl","familyPeronCount","bankAccountNo","BEBank.name","actualName"};
    }

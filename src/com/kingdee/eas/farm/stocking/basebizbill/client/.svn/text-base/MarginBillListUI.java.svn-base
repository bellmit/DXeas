 ...
 * output class name
 */
public class MarginBillListUI extends AbstractMarginBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginBillListUI.class);
    
    /**
     * output class constructor
     */
    public MarginBillListUI() throws Exception
    {
        super();
    }

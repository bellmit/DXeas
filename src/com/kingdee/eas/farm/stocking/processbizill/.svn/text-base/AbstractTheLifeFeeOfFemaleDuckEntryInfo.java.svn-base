...
public class AbstractTheLifeFeeOfFemaleDuckEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractTheLifeFeeOfFemaleDuckEntryInfo()
    {
        this("id");
    }
    protected AbstractTheLifeFeeOfFemaleDuckEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.farm.stocking.processbizill.TheLifeFeeOfFemaleDuckInfo getParent()
    {
        return (com.kingdee.eas.farm.stocking.processbizill.TheLifeFeeOfFemaleDuckInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.farm.stocking.processbizill.TheLifeFeeOfFemaleDuckInfo item)
    {
        put("parent", item);
    }
    /**

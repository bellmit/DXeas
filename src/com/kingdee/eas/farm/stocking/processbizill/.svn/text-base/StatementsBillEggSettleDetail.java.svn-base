...
public class StatementsBillEggSettleDetail extends CoreBillEntryBase implements IStatementsBillEggSettleDetail
{
    public StatementsBillEggSettleDetail()
    {
        super();
        registerInterface(IStatementsBillEggSettleDetail.class, this);
    }
    public StatementsBillEggSettleDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IStatementsBillEggSettleDetail.class, this);
    }
    ...
    private StatementsBillEggSettleDetailController getController() throws BOSException
    {
        return (StatementsBillEggSettleDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillEggSettleDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class StatementOfAccountFeedsnew extends CoreBillEntryBase implements IStatementOfAccountFeedsnew
{
    public StatementOfAccountFeedsnew()
    {
        super();
        registerInterface(IStatementOfAccountFeedsnew.class, this);
    }
    public StatementOfAccountFeedsnew(Context ctx)
    {
        super(ctx);
        registerInterface(IStatementOfAccountFeedsnew.class, this);
    }
    ...
    private StatementOfAccountFeedsnewController getController() throws BOSException
    {
        return (StatementOfAccountFeedsnewController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementOfAccountFeedsnewCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

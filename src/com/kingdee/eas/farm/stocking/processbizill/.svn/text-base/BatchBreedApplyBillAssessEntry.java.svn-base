...
public class BatchBreedApplyBillAssessEntry extends CoreBillEntryBase implements IBatchBreedApplyBillAssessEntry
{
    public BatchBreedApplyBillAssessEntry()
    {
        super();
        registerInterface(IBatchBreedApplyBillAssessEntry.class, this);
    }
    public BatchBreedApplyBillAssessEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBatchBreedApplyBillAssessEntry.class, this);
    }
    ...
    private BatchBreedApplyBillAssessEntryController getController() throws BOSException
    {
        return (BatchBreedApplyBillAssessEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchBreedApplyBillAssessEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class StockingBreedDailyMatUserEntry extends CoreBillEntryBase implements IStockingBreedDailyMatUserEntry
{
    public StockingBreedDailyMatUserEntry()
    {
        super();
        registerInterface(IStockingBreedDailyMatUserEntry.class, this);
    }
    public StockingBreedDailyMatUserEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStockingBreedDailyMatUserEntry.class, this);
    }
    ...
    private StockingBreedDailyMatUserEntryController getController() throws BOSException
    {
        return (StockingBreedDailyMatUserEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailyMatUserEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

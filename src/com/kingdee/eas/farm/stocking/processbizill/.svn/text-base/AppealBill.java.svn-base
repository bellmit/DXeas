...
public class AppealBill extends CoreBillBase implements IAppealBill
{
    public AppealBill()
    {
        super();
        registerInterface(IAppealBill.class, this);
    }
    public AppealBill(Context ctx)
    {
        super(ctx);
        registerInterface(IAppealBill.class, this);
    }
    ...
    private AppealBillController getController() throws BOSException
    {
        return (AppealBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAppealBillCollection(getContext());
        }
    ...
    {
        try {
            return getController().getAppealBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppealBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppealBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppealBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppealBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class TranOut extends CoreBillBase implements ITranOut
{
    public TranOut()
    {
        super();
        registerInterface(ITranOut.class, this);
    }
    public TranOut(Context ctx)
    {
        super(ctx);
        registerInterface(ITranOut.class, this);
    }
    ...
    private TranOutController getController() throws BOSException
    {
        return (TranOutController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTranOutCollection(getContext());
        }
    ...
    {
        try {
            return getController().getTranOutCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranOutCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranOutInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranOutInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranOutInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class StockingBreedDailySendEggEntry extends CoreBillEntryBase implements IStockingBreedDailySendEggEntry
{
    public StockingBreedDailySendEggEntry()
    {
        super();
        registerInterface(IStockingBreedDailySendEggEntry.class, this);
    }
    public StockingBreedDailySendEggEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStockingBreedDailySendEggEntry.class, this);
    }
    ...
    private StockingBreedDailySendEggEntryController getController() throws BOSException
    {
        return (StockingBreedDailySendEggEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStockingBreedDailySendEggEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

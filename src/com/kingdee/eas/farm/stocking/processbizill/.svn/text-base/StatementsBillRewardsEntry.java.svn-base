...
public class StatementsBillRewardsEntry extends CoreBillEntryBase implements IStatementsBillRewardsEntry
{
    public StatementsBillRewardsEntry()
    {
        super();
        registerInterface(IStatementsBillRewardsEntry.class, this);
    }
    public StatementsBillRewardsEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStatementsBillRewardsEntry.class, this);
    }
    ...
    private StatementsBillRewardsEntryController getController() throws BOSException
    {
        return (StatementsBillRewardsEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillRewardsEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

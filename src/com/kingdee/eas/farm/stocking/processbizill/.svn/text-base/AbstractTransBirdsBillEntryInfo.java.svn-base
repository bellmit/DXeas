...
public class AbstractTransBirdsBillEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractTransBirdsBillEntryInfo()
    {
        this("id");
    }
    protected AbstractTransBirdsBillEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.farm.stocking.processbizill.TransBirdsBillInfo getParent()
    {
        return (com.kingdee.eas.farm.stocking.processbizill.TransBirdsBillInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.farm.stocking.processbizill.TransBirdsBillInfo item)
    {
        put("parent", item);
    }
    /**

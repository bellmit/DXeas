...
import com.kingdee.eas.farm.stocking.processbizill.TransBirdsBillFactory;
import com.kingdee.eas.farm.stocking.processbizill.TransBirdsBillInfo;
import com.kingdee.eas.scm.common.BillBaseStatusEnum;
import com.kingdee.eas.util.app.ContextUtil;
import com.kingdee.util.NumericExceptionSubItem;

public class TransBirdsBillControllerBean extends AbstractTransBirdsBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.TransBirdsBillControllerBean");
    protected void _audit(Context ctx, IObjectValue model)throws BOSException
    {
    	try {
    		 TransBirdsBillInfo info = ( TransBirdsBillInfo) model;
...
//    		createToSCMBill(ctx, info);
     ...
     * @param info
     */
    private void createToSCMBill(Context ctx, TransBirdsBillInfo info) throws BOSException {
    	try {
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		 TransBirdsBillInfo info =  TransBirdsBillFactory.getLocalInstance(ctx).getTransBirdsBillInfo(pk);

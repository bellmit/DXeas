...
public class TranInControllerBean extends AbstractTranInControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.TranInControllerBean");

	@Override
	protected void _audit(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub
		
		TranInInfo info = (TranInInfo)model;

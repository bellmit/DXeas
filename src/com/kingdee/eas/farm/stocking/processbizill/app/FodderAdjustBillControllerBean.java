...
import com.kingdee.eas.farm.stocking.processbizill.FodderAdjustBillFactory;
...
public class FodderAdjustBillControllerBean extends AbstractFodderAdjustBillControllerBean
{
	private static Logger logger =
		Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.FodderAdjustBillControllerBean");

	protected void _audit(Context ctx, IObjectValue model)throws BOSException, EASBizException {
		FodderAdjustBillInfo info = getFodderAdjustBillInfo(ctx,new ObjectUuidPK(((FodderAdjustBillInfo) model).getId()));
	...
	protected IObjectPK _save(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		...
		FodderAdjustBillInfo info = (FodderAdjustBillInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		FodderAdjustBillInfo info = FodderAdjustBillFactory.getLocalInstance(ctx).getFodderAdjustBillInfo(pk);

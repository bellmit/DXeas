...

{
	...
	public void handleActionCalFemalAmount(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionCalFemalAmount(request,response,context);
	}
	protected void _handleActionCalFemalAmount(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
...
public class TheLifeFeeOfFemaleDuckControllerBean extends AbstractTheLifeFeeOfFemaleDuckControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.TheLifeFeeOfFemaleDuckControllerBean");
    /**
     * 审核
     */
	@Override
	protected void _audit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		...
		TheLifeFeeOfFemaleDuckInfo info=(TheLifeFeeOfFemaleDuckInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException,
			EASBizException {
		// TODO Auto-generated method stub
		TheLifeFeeOfFemaleDuckInfo info = TheLifeFeeOfFemaleDuckFactory.getLocalInstance(ctx).getTheLifeFeeOfFemaleDuckInfo(pk);
		if(info.getBillStatus().equals(BillStatus.audit))

...
import com.kingdee.eas.farm.stocking.processbizill.QeggAndDuckSeedEarlyFactory;
...
public class QeggAndDuckSeedEarlyControllerBean extends AbstractQeggAndDuckSeedEarlyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.QeggAndDuckSeedEarlyControllerBean");

	protected void _audit(Context ctx, IObjectValue model)throws BOSException
	{    		
		QeggAndDuckSeedEarlyInfo info = (QeggAndDuckSeedEarlyInfo) model;
	...
	protected void _unAudit(Context ctx, IObjectValue model)throws BOSException
	{
	   ...
	   @Override
		...
		protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
			// TODO Auto-generated method stub
			QeggAndDuckSeedEarlyInfo info = QeggAndDuckSeedEarlyFactory.getLocalInstance(ctx).getQeggAndDuckSeedEarlyInfo(pk);

 ...
 * output class name
 */
public abstract class AbstractStockingBreedDailyListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionReShareCoalAndDiesel(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionReShareCoalAndDiesel(request,response,context);
	}
	protected void _handleActionReShareCoalAndDiesel(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
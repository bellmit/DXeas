...
public class FodderReceiveBillControllerBean extends AbstractFodderReceiveBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.stocking.processbizill.app.FodderReceiveBillControllerBean");
     ...
     * @param info
     */
    private void createToSCMBill(Context ctx,FodderReceiveBillInfo info) throws BOSException {
    	try {
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FodderReceiveBillInfo info = FodderReceiveBillFactory.getLocalInstance(ctx).getFodderReceiveBillInfo(pk);

 ...
 * output class name
 */
public class BreedPlanBillListUI extends AbstractBreedPlanBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedPlanBillListUI.class);
    
    /**
     * output class constructor
     */
    public BreedPlanBillListUI() throws Exception
    {
        super();
    }

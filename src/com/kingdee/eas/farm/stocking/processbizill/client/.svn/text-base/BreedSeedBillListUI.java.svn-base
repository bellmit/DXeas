 ...
 * output class name
 */
public class BreedSeedBillListUI extends AbstractBreedSeedBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedSeedBillListUI.class);
    
    /**
     * output class constructor
     */
    public BreedSeedBillListUI() throws Exception
    {
        super();
    }
	...
	protected void refresh(ActionEvent e) throws Exception {
		// TODO Auto-generated method stub
		super.refresh(e);
//		UITools.apendFootRow(this.tblMain, new String[]{"entrys.receiveQty","entrys.supplementQty","entrys.lossQty","entrys.allReceiveQty"});
	}

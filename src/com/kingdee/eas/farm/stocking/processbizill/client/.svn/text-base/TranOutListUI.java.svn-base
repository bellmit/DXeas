 ...
 * output class name
 */
public class TranOutListUI extends AbstractTranOutListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TranOutListUI.class);
    
    /**
     * output class constructor
     */
    public TranOutListUI() throws Exception
    {
        super();
    }

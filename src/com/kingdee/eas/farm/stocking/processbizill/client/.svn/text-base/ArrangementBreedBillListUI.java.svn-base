 ...
 * output class name
 */
public class ArrangementBreedBillListUI extends AbstractArrangementBreedBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ArrangementBreedBillListUI.class);
    
    /**
     * output class constructor
     */
    public ArrangementBreedBillListUI() throws Exception
    {
        super();
    }

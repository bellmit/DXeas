 ...
 * output class name
 */
public abstract class AbstractTranInEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTranInEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conttranOutNum;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txttranOutNum;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.eas.farm.stocking.processbizill.TranInInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractTranInEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTranInEditUI.class.getName());
        ...
        this.conttranOutNum = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txttranOutNum = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.conttranOutNum.setName("conttranOutNum");
        ...
        this.txttranOutNum.setName("txttranOutNum");
        ...
        // conttranOutNum		
        this.conttranOutNum.setBoundLabelText(resHelper.getString("conttranOutNum.boundLabelText"));		
        this.conttranOutNum.setBoundLabelLength(100);		
        this.conttranOutNum.setBoundLabelUnderline(true);		
        this.conttranOutNum.setVisible(false);
        // prmtCreator		
        ...
        // txttranOutNum		
        this.txttranOutNum.setVisible(true);		
        this.txttranOutNum.setHorizontalAlignment(2);		
        this.txttranOutNum.setMaxLength(100);		
        this.txttranOutNum.setRequired(false);		
        this.txttranOutNum.setEnabled(false);
        // btnAudit
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,outTime,txttranCar,pkauditTime,kdtEntrys,baseStatus,txttranOutNum}));
    ...
    public void initUIContentLayout()
    {
        ...
        contBizDate.setBounds(new Rectangle(345, 17, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(345, 17, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(345, 41, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(345, 41, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(19, 83, 982, 388));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.processbizill.TranInEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(19, 83, 982, 388, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contoutTime.setBounds(new Rectangle(672, 17, 270, 19));
        this.add(contoutTime, new KDLayout.Constraints(672, 17, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttranCar.setBounds(new Rectangle(21, 41, 270, 19));
        this.add(conttranCar, new KDLayout.Constraints(21, 41, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contbaseStatus.setBounds(new Rectangle(672, 41, 270, 19));
        this.add(contbaseStatus, new KDLayout.Constraints(672, 41, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttranOutNum.setBounds(new Rectangle(344, 39, 270, 19));
        this.add(conttranOutNum, new KDLayout.Constraints(344, 39, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        //conttranOutNum
        conttranOutNum.setBoundEditor(txttranOutNum);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.processbizill.TranInEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("tranOutNum", String.class, this.txttranOutNum, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.TranInEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.TranInInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("tranOutNum", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("tranOutNum"));
        return sic;
    }        
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.TranInFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.TranInFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTranInEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTranInEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "TranInEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.TranInEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/farm/stocking/processbizill/TranIn";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.TranInQuery");
	}

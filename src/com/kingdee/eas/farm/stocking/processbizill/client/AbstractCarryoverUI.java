 ...
 * output class name
 */
public abstract class AbstractCarryoverUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCarryoverUI.class);
     ...
     */
    public AbstractCarryoverUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCarryoverUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contPeriod.setBounds(new Rectangle(21, 44, 270, 19));
        this.add(contPeriod, null);
        btnConfirm.setBounds(new Rectangle(104, 121, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.CarryoverUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "CarryoverUI");
    }

 ...
 * output class name
 */
public class BatchBreedApplyBillListUI extends AbstractBatchBreedApplyBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BatchBreedApplyBillListUI.class);
    
    /**
     * output class constructor
     */
    public BatchBreedApplyBillListUI() throws Exception
    {
        super();
    }

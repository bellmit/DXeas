 ...
 * output class name
 */
public abstract class AbstractTtfiledEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTtfiledEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox BIMUDF0005;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtBIMUDF0006;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtBIMUDF0009;
    ...
    protected com.kingdee.eas.farm.stocking.processbizill.TtfiledInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractTtfiledEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTtfiledEditUI.class.getName());
        ...
        this.BIMUDF0005 = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.prmtBIMUDF0006 = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.txtBIMUDF0009 = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.BIMUDF0005.setName("BIMUDF0005");
        this.prmtBIMUDF0006.setName("prmtBIMUDF0006");
        ...
        // prmtBIMUDF0003		
        this.prmtBIMUDF0003.setQueryInfo("com.kingdee.eas.farm.carnivorous.basedata.app.FarmerQuery");		
        this.prmtBIMUDF0003.setVisible(true);		
        this.prmtBIMUDF0003.setEditable(true);		
        this.prmtBIMUDF0003.setDisplayFormat("$address$");		
        ...
        this.prmtBIMUDF0003.setRequired(false);
			...
			com.kingdee.eas.farm.carnivorous.basedata.client.FarmerListUI prmtBIMUDF0003_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmtBIMUDF0003_F7ListUI == null) {
					try {
						prmtBIMUDF0003_F7ListUI = new com.kingdee.eas.farm.carnivorous.basedata.client.FarmerListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
        ...
        // prmtBIMUDF0002		
        this.prmtBIMUDF0002.setQueryInfo("com.kingdee.eas.farm.carnivorous.basedata.app.FarmQuery");		
        ...
        this.prmtBIMUDF0002.setRequired(false);
			...
			com.kingdee.eas.farm.carnivorous.basedata.client.FarmListUI prmtBIMUDF0002_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmtBIMUDF0002_F7ListUI == null) {
					try {
						prmtBIMUDF0002_F7ListUI = new com.kingdee.eas.farm.carnivorous.basedata.client.FarmListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
        ...
        // BIMUDF0005		
        this.BIMUDF0005.setVisible(true);		
        this.BIMUDF0005.addItems(EnumUtils.getEnumList("com.kingdee.eas.farm.stocking.processbizill.PurType").toArray());		
        this.BIMUDF0005.setRequired(true);		
        this.BIMUDF0005.setEnabled(false);
        // prmtBIMUDF0006		
        this.prmtBIMUDF0006.setQueryInfo("com.kingdee.eas.farm.carnivorous.basedata.app.BatchQuery");		
        this.prmtBIMUDF0006.setVisible(true);		
        this.prmtBIMUDF0006.setEditable(true);		
        this.prmtBIMUDF0006.setDisplayFormat("$name$");		
        this.prmtBIMUDF0006.setEditFormat("$number$");		
        this.prmtBIMUDF0006.setCommitFormat("$number$");		
        this.prmtBIMUDF0006.setRequired(false);
        		prmtBIMUDF0006.addSelectorListener(new SelectorListener() {
			com.kingdee.eas.farm.carnivorous.basedata.client.BatchListUI prmtBIMUDF0006_F7ListUI = null;
			public void willShow(SelectorEvent e) {
				if (prmtBIMUDF0006_F7ListUI == null) {
					try {
						prmtBIMUDF0006_F7ListUI = new com.kingdee.eas.farm.carnivorous.basedata.client.BatchListUI();
					} catch (Exception e1) {
						e1.printStackTrace();
					}
					HashMap ctx = new HashMap();
					ctx.put("bizUIOwner",javax.swing.SwingUtilities.getWindowAncestor(prmtBIMUDF0006_F7ListUI));
					prmtBIMUDF0006_F7ListUI.setF7Use(true,ctx);
					prmtBIMUDF0006.setSelector(prmtBIMUDF0006_F7ListUI);
				}
			}
		});
        ...
        this.txtBIMUDF0009.setDataType(1);		
        this.txtBIMUDF0009.setSupportedEmpty(true);		
        this.txtBIMUDF0009.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtBIMUDF0009.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtBIMUDF0009.setPrecision(4);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtBIMUDF0001,prmtBIMUDF0003,prmtBIMUDF0002,prmtBIMUDF0004,BIMUDF0005,prmtBIMUDF0006,txtBIMUDF0007,txtBIMUDF0008,txtBIMUDF0009,txtBIMUDF0010,txtBIMUDF0011,txtBIMUDF0012,txtBIMUDF0013}));
    ...
    {
        this.setBounds(new Rectangle(19, 4, 1059, 636));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(359, 437, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(704, 435, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(27, 499, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(359, 494, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(23, 19, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(345, 20, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(347, 118, 275, 25));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(24, 438, 270, 19));
        this.add(contAuditor, null);
        contBIMUDF0001.setBounds(new Rectangle(20, 67, 270, 19));
        this.add(contBIMUDF0001, null);
        contBIMUDF0003.setBounds(new Rectangle(351, 66, 270, 19));
        this.add(contBIMUDF0003, null);
        contBIMUDF0002.setBounds(new Rectangle(697, 65, 270, 19));
        this.add(contBIMUDF0002, null);
        contBIMUDF0004.setBounds(new Rectangle(22, 121, 270, 19));
        this.add(contBIMUDF0004, null);
        contBIMUDF0005.setBounds(new Rectangle(697, 16, 270, 19));
        this.add(contBIMUDF0005, null);
        kDSeparator8.setBounds(new Rectangle(7, 181, 960, 10));
        this.add(kDSeparator8, null);
        kDLabel1.setBounds(new Rectangle(18, 191, 100, 19));
        this.add(kDLabel1, null);
        contBIMUDF0006.setBounds(new Rectangle(20, 227, 270, 19));
        this.add(contBIMUDF0006, null);
        contBIMUDF0008.setBounds(new Rectangle(696, 221, 270, 19));
        this.add(contBIMUDF0008, null);
        contBIMUDF0013.setBounds(new Rectangle(356, 338, 270, 19));
        this.add(contBIMUDF0013, null);
        contBIMUDF0012.setBounds(new Rectangle(22, 340, 270, 19));
        this.add(contBIMUDF0012, null);
        contBIMUDF0009.setBounds(new Rectangle(23, 276, 270, 19));
        this.add(contBIMUDF0009, null);
        contBIMUDF0010.setBounds(new Rectangle(356, 282, 270, 19));
        this.add(contBIMUDF0010, null);
        contBIMUDF0011.setBounds(new Rectangle(698, 281, 270, 19));
        this.add(contBIMUDF0011, null);
        contBIMUDF0007.setBounds(new Rectangle(357, 224, 270, 19));
        this.add(contBIMUDF0007, null);
        kDSeparator9.setBounds(new Rectangle(16, 396, 958, 10));
        this.add(kDSeparator9, null);
        kDButton1.setBounds(new Rectangle(420, 583, 73, 21));
        this.add(kDButton1, null);
        kDSeparator10.setBounds(new Rectangle(18, 540, 938, 10));
        ...
        //contBIMUDF0005
        contBIMUDF0005.setBoundEditor(BIMUDF0005);
        //contBIMUDF0006
        contBIMUDF0006.setBoundEditor(prmtBIMUDF0006);
        //contBIMUDF0008
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("BIMUDF0003", com.kingdee.eas.farm.carnivorous.basedata.FarmerInfo.class, this.prmtBIMUDF0003, "data");
		dataBinder.registerBinding("BIMUDF0002", com.kingdee.eas.farm.carnivorous.basedata.FarmInfo.class, this.prmtBIMUDF0002, "data");
		dataBinder.registerBinding("BIMUDF0004", com.kingdee.eas.custom.salepayment.TechnicianInfo.class, this.prmtBIMUDF0004, "data");
		dataBinder.registerBinding("BIMUDF0005", com.kingdee.eas.farm.stocking.processbizill.PurType.class, this.BIMUDF0005, "selectedItem");
		dataBinder.registerBinding("BIMUDF0006", com.kingdee.eas.farm.carnivorous.basedata.BatchInfo.class, this.prmtBIMUDF0006, "data");
		...
		dataBinder.registerBinding("BIMUDF0009", java.math.BigDecimal.class, this.txtBIMUDF0009, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.TtfiledEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.TtfiledInfo)ov;
    }
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
        	...
        	sic.add(new SelectorItemInfo("BIMUDF0003.address"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
        	...
        	sic.add(new SelectorItemInfo("BIMUDF0006.id"));
        	sic.add(new SelectorItemInfo("BIMUDF0006.number"));
        	sic.add(new SelectorItemInfo("BIMUDF0006.name"));
		}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "TtfiledEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.TtfiledEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.TtfiledFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.TtfiledInfo objectValue = new com.kingdee.eas.farm.stocking.processbizill.TtfiledInfo();
    	...
    	return "/bim/farm/stocking/processbizill/Ttfiled";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.TtfiledQuery");
	}
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(BIMUDF0005.getSelectedItem())) {

 ...
 * output class name
 */
public class BirdsRecycleBillListUI extends AbstractBirdsRecycleBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BirdsRecycleBillListUI.class);
    
    /**
     * output class constructor
     */
    public BirdsRecycleBillListUI() throws Exception
    {
        super();
    }

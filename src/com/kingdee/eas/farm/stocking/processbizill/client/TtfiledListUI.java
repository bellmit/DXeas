 ...
 * output class name
 */
public class TtfiledListUI extends AbstractTtfiledListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TtfiledListUI.class);
    
    /**
     * output class constructor
     */
    public TtfiledListUI() throws Exception
    {
        super();
    }

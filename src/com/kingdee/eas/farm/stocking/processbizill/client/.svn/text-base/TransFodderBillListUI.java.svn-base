 ...
 * output class name
 */
public class TransFodderBillListUI extends AbstractTransFodderBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransFodderBillListUI.class);
    
    /**
     * output class constructor
     */
    public TransFodderBillListUI() throws Exception
    {
        super();
    }

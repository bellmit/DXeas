 ...
 * output class name
 */
public class OtherReceptionBillListUI extends AbstractOtherReceptionBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherReceptionBillListUI.class);
    
    /**
     * output class constructor
     */
    public OtherReceptionBillListUI() throws Exception
    {
        super();
    }

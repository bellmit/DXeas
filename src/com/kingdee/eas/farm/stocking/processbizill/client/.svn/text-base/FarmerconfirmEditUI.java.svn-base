 ...
 * output class name
 */
public class FarmerconfirmEditUI extends AbstractFarmerconfirmEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerconfirmEditUI.class);
    
    /**
     * output class constructor
     */
    public FarmerconfirmEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public abstract class AbstractStateOfAcaountImportListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStateOfAcaountImportListUI.class);
     ...
     */
    public AbstractStateOfAcaountImportListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStateOfAcaountImportListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app", "StateOfAcaountImportQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.StateOfAcaountImportListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.depositInterest"));
        sic.add(new SelectorItemInfo("entrys.deposit"));
        sic.add(new SelectorItemInfo("entrys.interestPaid"));
        sic.add(new SelectorItemInfo("entrys.loanInterest"));
        sic.add(new SelectorItemInfo("entrys.others"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractStateOfAcaountImportListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStateOfAcaountImportListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "StateOfAcaountImportListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.StateOfAcaountImportEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.StateOfAcaountImportFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.StateOfAcaountImportInfo objectValue = new com.kingdee.eas.farm.stocking.processbizill.StateOfAcaountImportInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","billStatus","period.number","company.name","entrys.farmer.name","auditTime"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/stocking/processbizill/StateOfAcaountImport";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.StateOfAcaountImportQuery");
	}

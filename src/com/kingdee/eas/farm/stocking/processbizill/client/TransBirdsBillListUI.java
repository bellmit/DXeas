 ...
 * output class name
 */
public class TransBirdsBillListUI extends AbstractTransBirdsBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransBirdsBillListUI.class);
    
    /**
     * output class constructor
     */
    public TransBirdsBillListUI() throws Exception
    {
        super();
    }

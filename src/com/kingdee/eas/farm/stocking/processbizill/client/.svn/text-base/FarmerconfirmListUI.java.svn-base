 ...
 * output class name
 */
public class FarmerconfirmListUI extends AbstractFarmerconfirmListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerconfirmListUI.class);
    
    /**
     * output class constructor
     */
    public FarmerconfirmListUI() throws Exception
    {
        super();
    }

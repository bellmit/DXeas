 ...
 * output class name
 */
public abstract class AbstractFodderApplyBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFodderApplyBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conttechnician;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmttechnician;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDSeparator newSeparator3;
    protected com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFodderApplyBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFodderApplyBillEditUI.class.getName());
        ...
        this.conttechnician = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmttechnician = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.conttechnician.setName("conttechnician");
        ...
        this.prmttechnician.setName("prmttechnician");
        ...
        // kDSeparator9
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol6\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol8\"><c:NumberFormat>&amp;int</c:NumberFormat></c:Style><c:Style id=\"sCol9\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol11\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol12\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol13\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol14\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol15\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol18\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol19\"><c:Protection locked=\"true\" hidden=\"true\" /></c:Style><c:Style id=\"sCol20\"><c:Protection locked=\"true\" hidden=\"true\" /></c:Style><c:Style id=\"sCol21\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol22\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style><c:Style id=\"sCol23\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol24\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol26\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"farmer\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"farm\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"house\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"stockingBatch\" t:width=\"120\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"batchContract\" t:width=\"120\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"hatchDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol6\" /><t:Column t:key=\"weekAge\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"currentQty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol8\" /><t:Column t:key=\"feedStdDaily\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol9\" /><t:Column t:key=\"feedNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"num1Feed\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol11\" /><t:Column t:key=\"num2Feed\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol12\" /><t:Column t:key=\"num3Feed\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol13\" /><t:Column t:key=\"num4Feed\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol14\" /><t:Column t:key=\"sendDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:styleID=\"sCol15\" /><t:Column t:key=\"sendPerson\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"sendCompany\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"material\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol18\" /><t:Column t:key=\"materialName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol19\" /><t:Column t:key=\"model\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol20\" /><t:Column t:key=\"unitQty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol21\" /><t:Column t:key=\"bagQty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol22\" /><t:Column t:key=\"unit\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol23\" /><t:Column t:key=\"qty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol24\" /><t:Column t:key=\"remark\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"spareStocking\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol26\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{farmer}</t:Cell><t:Cell>$Resource{farm}</t:Cell><t:Cell>$Resource{house}</t:Cell><t:Cell>$Resource{stockingBatch}</t:Cell><t:Cell>$Resource{batchContract}</t:Cell><t:Cell>$Resource{hatchDate}</t:Cell><t:Cell>$Resource{weekAge}</t:Cell><t:Cell>$Resource{currentQty}</t:Cell><t:Cell>$Resource{feedStdDaily}</t:Cell><t:Cell>$Resource{feedNum}</t:Cell><t:Cell>$Resource{num1Feed}</t:Cell><t:Cell>$Resource{num2Feed}</t:Cell><t:Cell>$Resource{num3Feed}</t:Cell><t:Cell>$Resource{num4Feed}</t:Cell><t:Cell>$Resource{sendDate}</t:Cell><t:Cell>$Resource{sendPerson}</t:Cell><t:Cell>$Resource{sendCompany}</t:Cell><t:Cell>$Resource{material}</t:Cell><t:Cell>$Resource{materialName}</t:Cell><t:Cell>$Resource{model}</t:Cell><t:Cell>$Resource{unitQty}</t:Cell><t:Cell>$Resource{bagQty}</t:Cell><t:Cell>$Resource{unit}</t:Cell><t:Cell>$Resource{qty}</t:Cell><t:Cell>$Resource{remark}</t:Cell><t:Cell>$Resource{spareStocking}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","farmer","farm","house","stockingBatch","batchContract","hatchDate","weekAge","currentQty","feedStdDaily","feedNum","num1Feed","num2Feed","num3Feed","num4Feed","sendDate","sendPerson","sendCompany","material","materialName","model","unitQty","bagQty","unit","qty","remark","spareStocking"});
        ...
        kdtEntrys_batchContract_PromptBox.setQueryInfo("com.kingdee.eas.farm.stocking.processbizill.app.BatchContractQuery");
        ...
        KDDatePicker kdtEntrys_hatchDate_DatePicker = new KDDatePicker();
        kdtEntrys_hatchDate_DatePicker.setName("kdtEntrys_hatchDate_DatePicker");
        kdtEntrys_hatchDate_DatePicker.setVisible(true);
        kdtEntrys_hatchDate_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_hatchDate_CellEditor = new KDTDefaultCellEditor(kdtEntrys_hatchDate_DatePicker);
        this.kdtEntrys.getColumn("hatchDate").setEditor(kdtEntrys_hatchDate_CellEditor);
        ...
        KDFormattedTextField kdtEntrys_currentQty_TextField = new KDFormattedTextField();
        kdtEntrys_currentQty_TextField.setName("kdtEntrys_currentQty_TextField");
        kdtEntrys_currentQty_TextField.setVisible(true);
        kdtEntrys_currentQty_TextField.setEditable(true);
        kdtEntrys_currentQty_TextField.setHorizontalAlignment(2);
        kdtEntrys_currentQty_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntrys_currentQty_CellEditor = new KDTDefaultCellEditor(kdtEntrys_currentQty_TextField);
        this.kdtEntrys.getColumn("currentQty").setEditor(kdtEntrys_currentQty_CellEditor);
        KDFormattedTextField kdtEntrys_feedStdDaily_TextField = new KDFormattedTextField();
        kdtEntrys_feedStdDaily_TextField.setName("kdtEntrys_feedStdDaily_TextField");
        kdtEntrys_feedStdDaily_TextField.setVisible(true);
        kdtEntrys_feedStdDaily_TextField.setEditable(true);
        kdtEntrys_feedStdDaily_TextField.setHorizontalAlignment(2);
        kdtEntrys_feedStdDaily_TextField.setDataType(1);
        	kdtEntrys_feedStdDaily_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_feedStdDaily_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_feedStdDaily_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_feedStdDaily_CellEditor = new KDTDefaultCellEditor(kdtEntrys_feedStdDaily_TextField);
        this.kdtEntrys.getColumn("feedStdDaily").setEditor(kdtEntrys_feedStdDaily_CellEditor);
        final KDBizPromptBox kdtEntrys_feedNum_PromptBox = new KDBizPromptBox();
        kdtEntrys_feedNum_PromptBox.setQueryInfo("com.kingdee.eas.farm.stocking.basedata.app.FeedWithHisNumberQuery");
        kdtEntrys_feedNum_PromptBox.setVisible(true);
        kdtEntrys_feedNum_PromptBox.setEditable(true);
        kdtEntrys_feedNum_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_feedNum_PromptBox.setEditFormat("$number$");
        kdtEntrys_feedNum_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_feedNum_CellEditor = new KDTDefaultCellEditor(kdtEntrys_feedNum_PromptBox);
        this.kdtEntrys.getColumn("feedNum").setEditor(kdtEntrys_feedNum_CellEditor);
        ObjectValueRender kdtEntrys_feedNum_OVR = new ObjectValueRender();
        kdtEntrys_feedNum_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("feedNum").setRenderer(kdtEntrys_feedNum_OVR);
        KDFormattedTextField kdtEntrys_num1Feed_TextField = new KDFormattedTextField();
        kdtEntrys_num1Feed_TextField.setName("kdtEntrys_num1Feed_TextField");
        kdtEntrys_num1Feed_TextField.setVisible(true);
        kdtEntrys_num1Feed_TextField.setEditable(true);
        kdtEntrys_num1Feed_TextField.setHorizontalAlignment(2);
        kdtEntrys_num1Feed_TextField.setDataType(1);
        	kdtEntrys_num1Feed_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_num1Feed_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_num1Feed_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_num1Feed_CellEditor = new KDTDefaultCellEditor(kdtEntrys_num1Feed_TextField);
        this.kdtEntrys.getColumn("num1Feed").setEditor(kdtEntrys_num1Feed_CellEditor);
        KDFormattedTextField kdtEntrys_num2Feed_TextField = new KDFormattedTextField();
        kdtEntrys_num2Feed_TextField.setName("kdtEntrys_num2Feed_TextField");
        kdtEntrys_num2Feed_TextField.setVisible(true);
        kdtEntrys_num2Feed_TextField.setEditable(true);
        kdtEntrys_num2Feed_TextField.setHorizontalAlignment(2);
        kdtEntrys_num2Feed_TextField.setDataType(1);
        	kdtEntrys_num2Feed_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_num2Feed_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_num2Feed_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_num2Feed_CellEditor = new KDTDefaultCellEditor(kdtEntrys_num2Feed_TextField);
        this.kdtEntrys.getColumn("num2Feed").setEditor(kdtEntrys_num2Feed_CellEditor);
        KDFormattedTextField kdtEntrys_num3Feed_TextField = new KDFormattedTextField();
        kdtEntrys_num3Feed_TextField.setName("kdtEntrys_num3Feed_TextField");
        kdtEntrys_num3Feed_TextField.setVisible(true);
        kdtEntrys_num3Feed_TextField.setEditable(true);
        kdtEntrys_num3Feed_TextField.setHorizontalAlignment(2);
        kdtEntrys_num3Feed_TextField.setDataType(1);
        	kdtEntrys_num3Feed_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_num3Feed_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_num3Feed_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_num3Feed_CellEditor = new KDTDefaultCellEditor(kdtEntrys_num3Feed_TextField);
        this.kdtEntrys.getColumn("num3Feed").setEditor(kdtEntrys_num3Feed_CellEditor);
        KDFormattedTextField kdtEntrys_num4Feed_TextField = new KDFormattedTextField();
        kdtEntrys_num4Feed_TextField.setName("kdtEntrys_num4Feed_TextField");
        kdtEntrys_num4Feed_TextField.setVisible(true);
        kdtEntrys_num4Feed_TextField.setEditable(true);
        kdtEntrys_num4Feed_TextField.setHorizontalAlignment(2);
        kdtEntrys_num4Feed_TextField.setDataType(1);
        	kdtEntrys_num4Feed_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_num4Feed_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_num4Feed_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_num4Feed_CellEditor = new KDTDefaultCellEditor(kdtEntrys_num4Feed_TextField);
        this.kdtEntrys.getColumn("num4Feed").setEditor(kdtEntrys_num4Feed_CellEditor);
        ...
        final KDBizPromptBox kdtEntrys_sendPerson_PromptBox = new KDBizPromptBox();
        kdtEntrys_sendPerson_PromptBox.setQueryInfo("com.kingdee.eas.farm.stocking.basedata.app.FeeSendPersonQuery");
        kdtEntrys_sendPerson_PromptBox.setVisible(true);
        kdtEntrys_sendPerson_PromptBox.setEditable(true);
        kdtEntrys_sendPerson_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_sendPerson_PromptBox.setEditFormat("$number$");
        kdtEntrys_sendPerson_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_sendPerson_CellEditor = new KDTDefaultCellEditor(kdtEntrys_sendPerson_PromptBox);
        this.kdtEntrys.getColumn("sendPerson").setEditor(kdtEntrys_sendPerson_CellEditor);
        ObjectValueRender kdtEntrys_sendPerson_OVR = new ObjectValueRender();
        kdtEntrys_sendPerson_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("sendPerson").setRenderer(kdtEntrys_sendPerson_OVR);
        final KDBizPromptBox kdtEntrys_sendCompany_PromptBox = new KDBizPromptBox();
        kdtEntrys_sendCompany_PromptBox.setQueryInfo("com.kingdee.eas.basedata.org.app.CompanyOrgUnitQuery4AsstAcct");
        ...
        ObjectValueRender kdtEntrys_sendCompany_OVR = new ObjectValueRender();
        kdtEntrys_sendCompany_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("sendCompany").setRenderer(kdtEntrys_sendCompany_OVR);
        ...
        kdtEntrys_bagQty_TextField.setDataType(0);
        ...
        KDFormattedTextField kdtEntrys_spareStocking_TextField = new KDFormattedTextField();
        kdtEntrys_spareStocking_TextField.setName("kdtEntrys_spareStocking_TextField");
        kdtEntrys_spareStocking_TextField.setVisible(true);
        kdtEntrys_spareStocking_TextField.setEditable(true);
        kdtEntrys_spareStocking_TextField.setHorizontalAlignment(2);
        kdtEntrys_spareStocking_TextField.setDataType(1);
        	kdtEntrys_spareStocking_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_spareStocking_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_spareStocking_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_spareStocking_CellEditor = new KDTDefaultCellEditor(kdtEntrys_spareStocking_TextField);
        this.kdtEntrys.getColumn("spareStocking").setEditor(kdtEntrys_spareStocking_CellEditor);
        // contstorageOrgUnit		
        ...
        // conttechnician		
        this.conttechnician.setBoundLabelText(resHelper.getString("conttechnician.boundLabelText"));		
        this.conttechnician.setBoundLabelLength(100);		
        this.conttechnician.setBoundLabelUnderline(true);		
        this.conttechnician.setVisible(true);
        // prmtCreator		
        ...
        // prmttechnician		
        this.prmttechnician.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonFilterQuery");		
        this.prmttechnician.setEditable(true);		
        this.prmttechnician.setDisplayFormat("$name$");		
        this.prmttechnician.setEditFormat("$number$");		
        this.prmttechnician.setCommitFormat("$number$");		
        this.prmttechnician.setRequired(false);
        // tBtnAudit
        ...
        // newSeparator3
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkendDate,txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,billStatus,prmtcompany,pkauditTime,prmtstorageOrgUnit,prmtperiod,pkbeginDate,prmttechnician,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(371, 554, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(371, 554, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(690, 554, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(690, 554, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(371, 582, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(371, 582, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(690, 582, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(690, 582, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDescription.setBounds(new Rectangle(690, 54, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(690, 54, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contcompany.setBounds(new Rectangle(20, 54, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(20, 54, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDSeparator8.setBounds(new Rectangle(18, 537, 961, 10));
        this.add(kDSeparator8, new KDLayout.Constraints(18, 537, 961, 10, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDSeparator9.setBounds(new Rectangle(6, 157, 986, 8));
        this.add(kDSeparator9, new KDLayout.Constraints(6, 157, 986, 8, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(22, 179, 943, 346));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(22, 179, 943, 346, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contstorageOrgUnit.setBounds(new Rectangle(371, 54, 270, 19));
        this.add(contstorageOrgUnit, new KDLayout.Constraints(371, 54, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contperiod.setBounds(new Rectangle(20, 95, 270, 19));
        this.add(contperiod, new KDLayout.Constraints(20, 95, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbeginDate.setBounds(new Rectangle(371, 95, 270, 19));
        this.add(contbeginDate, new KDLayout.Constraints(371, 95, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contendDate.setBounds(new Rectangle(690, 95, 270, 19));
        this.add(contendDate, new KDLayout.Constraints(690, 95, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conttechnician.setBounds(new Rectangle(20, 126, 270, 19));
        this.add(conttechnician, new KDLayout.Constraints(20, 126, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        //conttechnician
        conttechnician.setBoundEditor(prmttechnician);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.bagQty", int.class, this.kdtEntrys, "bagQty.text");
		dataBinder.registerBinding("entrys.hatchDate", java.util.Date.class, this.kdtEntrys, "hatchDate.text");
		dataBinder.registerBinding("entrys.weekAge", String.class, this.kdtEntrys, "weekAge.text");
		dataBinder.registerBinding("entrys.currentQty", int.class, this.kdtEntrys, "currentQty.text");
		dataBinder.registerBinding("entrys.feedStdDaily", java.math.BigDecimal.class, this.kdtEntrys, "feedStdDaily.text");
		dataBinder.registerBinding("entrys.sendDate", java.util.Date.class, this.kdtEntrys, "sendDate.text");
		dataBinder.registerBinding("entrys.sendCompany", java.lang.Object.class, this.kdtEntrys, "sendCompany.text");
		dataBinder.registerBinding("entrys.sendPerson", java.lang.Object.class, this.kdtEntrys, "sendPerson.text");
		dataBinder.registerBinding("entrys.num1Feed", java.math.BigDecimal.class, this.kdtEntrys, "num1Feed.text");
		dataBinder.registerBinding("entrys.num2Feed", java.math.BigDecimal.class, this.kdtEntrys, "num2Feed.text");
		dataBinder.registerBinding("entrys.num3Feed", java.math.BigDecimal.class, this.kdtEntrys, "num3Feed.text");
		dataBinder.registerBinding("entrys.num4Feed", java.math.BigDecimal.class, this.kdtEntrys, "num4Feed.text");
		dataBinder.registerBinding("entrys.remark", String.class, this.kdtEntrys, "remark.text");
		dataBinder.registerBinding("entrys.house", java.lang.Object.class, this.kdtEntrys, "house.text");
		dataBinder.registerBinding("entrys.feedNum", java.lang.Object.class, this.kdtEntrys, "feedNum.text");
		dataBinder.registerBinding("entrys.spareStocking", java.math.BigDecimal.class, this.kdtEntrys, "spareStocking.text");
		...
		dataBinder.registerBinding("technician", com.kingdee.eas.basedata.person.PersonInfo.class, this.prmttechnician, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.FodderApplyBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.hatchDate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.weekAge", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.currentQty", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.feedStdDaily", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.sendDate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.sendCompany", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.sendPerson", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.num1Feed", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.num2Feed", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.num3Feed", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.num4Feed", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.remark", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.house", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.feedNum", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.spareStocking", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("technician", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntrys.getCell(rowIndex,"qty").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"unitQty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getIntValue(kdtEntrys.getCell(rowIndex,"bagQty").getValue())));
...
kdtEntrys.getCell(rowIndex,"qty").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"unitQty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getIntValue(kdtEntrys.getCell(rowIndex,"bagQty").getValue())));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.hatchDate"));
    	sic.add(new SelectorItemInfo("entrys.weekAge"));
    	sic.add(new SelectorItemInfo("entrys.currentQty"));
    	sic.add(new SelectorItemInfo("entrys.feedStdDaily"));
    	sic.add(new SelectorItemInfo("entrys.sendDate"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.sendCompany.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.sendCompany.id"));
			sic.add(new SelectorItemInfo("entrys.sendCompany.name"));
        	sic.add(new SelectorItemInfo("entrys.sendCompany.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.sendPerson.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.sendPerson.id"));
			sic.add(new SelectorItemInfo("entrys.sendPerson.name"));
        	sic.add(new SelectorItemInfo("entrys.sendPerson.number"));
		}
    	sic.add(new SelectorItemInfo("entrys.num1Feed"));
    	sic.add(new SelectorItemInfo("entrys.num2Feed"));
    	sic.add(new SelectorItemInfo("entrys.num3Feed"));
    	sic.add(new SelectorItemInfo("entrys.num4Feed"));
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.feedNum.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.feedNum.id"));
			sic.add(new SelectorItemInfo("entrys.feedNum.name"));
        	sic.add(new SelectorItemInfo("entrys.feedNum.number"));
		}
    	sic.add(new SelectorItemInfo("entrys.spareStocking"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("technician.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("technician.id"));
        	sic.add(new SelectorItemInfo("technician.number"));
        	sic.add(new SelectorItemInfo("technician.name"));
		}
        return sic;
    }        
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.FodderApplyBillFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFodderApplyBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFodderApplyBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "FodderApplyBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.FodderApplyBillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/farm/stocking/processbizill/FodderApplyBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.FodderApplyBillQuery");
	}
		...
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"feedNum").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"物料"});
			}
		}
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"sendDate").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"送料日期"});
			}
		}

...
public abstract class AbstractFiltrationUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contCompany.setBounds(new Rectangle(54, 41, 270, 19));
        this.add(contCompany, null);
        contPeriod.setBounds(new Rectangle(54, 89, 270, 19));
        this.add(contPeriod, null);
        contFarmers.setBounds(new Rectangle(54, 137, 270, 19));
        this.add(contFarmers, null);
        btnDetermine.setBounds(new Rectangle(174, 195, 73, 21));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "FiltrationUI");
    }

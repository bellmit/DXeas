 ...
 * output class name
 */
public class SeedBillListUI extends AbstractSeedBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SeedBillListUI.class);
    
    /**
     * output class constructor
     */
    public SeedBillListUI() throws Exception
    {
        super();
    }

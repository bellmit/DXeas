 ...
 * output class name
 */
public class FodderApplyBillListUI extends AbstractFodderApplyBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FodderApplyBillListUI.class);
    
    /**
     * output class constructor
     */
    public FodderApplyBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class TransFodderBillEditUI extends AbstractTransFodderBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TransFodderBillEditUI.class);
     ...
     */
    public TransFodderBillEditUI() throws Exception
    {
        super();
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        objectValue.getEntrys().add(new TransFodderBillEntryInfo());
        return objectValue;
    }
    @Override
...
//		StockingClientComm.makeApplierF7(this.prmtperson, companyID, this, false);
		...
		/*//养殖场过滤
		StockingClientComm.setFarmFilter((KDBizPromptBox) this.kdtEntrys.getColumn("orderFarm").getEditor().getComponent(), curCompanyID, null);*/
	}
	@Override

 ...
 * output class name
 */
public abstract class AbstractBirdsRecycleBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBirdsRecycleBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisWeightSettle;
    ...
    protected com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractBirdsRecycleBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBirdsRecycleBillEditUI.class.getName());
        ...
        this.chkisWeightSettle = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkisWeightSettle.setName("chkisWeightSettle");
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol2\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol3\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol4\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol5\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol6\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol7\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol8\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol9\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol10\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol11\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol12\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol13\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol14\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"material\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"materialName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol2\" /><t:Column t:key=\"model\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol3\" /><t:Column t:key=\"unit\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:styleID=\"sCol4\" /><t:Column t:key=\"qty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol5\" /><t:Column t:key=\"weight\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol6\" /><t:Column t:key=\"basePrice\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol7\" /><t:Column t:key=\"receivePrice\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol8\" /><t:Column t:key=\"amount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol9\" /><t:Column t:key=\"femaleQty\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol10\" /><t:Column t:key=\"femaleWeight\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol11\" /><t:Column t:key=\"femalePrice\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol12\" /><t:Column t:key=\"femaleAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol13\" /><t:Column t:key=\"allAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol14\" /><t:Column t:key=\"warehouse\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{material}</t:Cell><t:Cell>$Resource{materialName}</t:Cell><t:Cell>$Resource{model}</t:Cell><t:Cell>$Resource{unit}</t:Cell><t:Cell>$Resource{qty}</t:Cell><t:Cell>$Resource{weight}</t:Cell><t:Cell>$Resource{basePrice}</t:Cell><t:Cell>$Resource{receivePrice}</t:Cell><t:Cell>$Resource{amount}</t:Cell><t:Cell>$Resource{femaleQty}</t:Cell><t:Cell>$Resource{femaleWeight}</t:Cell><t:Cell>$Resource{femalePrice}</t:Cell><t:Cell>$Resource{femaleAmount}</t:Cell><t:Cell>$Resource{allAmount}</t:Cell><t:Cell>$Resource{warehouse}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","materialName","model","unit","qty","weight","basePrice","receivePrice","amount","femaleQty","femaleWeight","femalePrice","femaleAmount","allAmount","warehouse"});
        ...
        kdtEntrys_femaleQty_TextField.setDataType(1);
        	kdtEntrys_femaleQty_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_femaleQty_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_femaleQty_TextField.setPrecision(10);
        ...
        KDFormattedTextField kdtEntrys_femaleWeight_TextField = new KDFormattedTextField();
        kdtEntrys_femaleWeight_TextField.setName("kdtEntrys_femaleWeight_TextField");
        kdtEntrys_femaleWeight_TextField.setVisible(true);
        kdtEntrys_femaleWeight_TextField.setEditable(true);
        kdtEntrys_femaleWeight_TextField.setHorizontalAlignment(2);
        kdtEntrys_femaleWeight_TextField.setDataType(1);
        	kdtEntrys_femaleWeight_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_femaleWeight_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_femaleWeight_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_femaleWeight_CellEditor = new KDTDefaultCellEditor(kdtEntrys_femaleWeight_TextField);
        this.kdtEntrys.getColumn("femaleWeight").setEditor(kdtEntrys_femaleWeight_CellEditor);
        KDFormattedTextField kdtEntrys_femalePrice_TextField = new KDFormattedTextField();
        kdtEntrys_femalePrice_TextField.setName("kdtEntrys_femalePrice_TextField");
        kdtEntrys_femalePrice_TextField.setVisible(true);
        kdtEntrys_femalePrice_TextField.setEditable(true);
        kdtEntrys_femalePrice_TextField.setHorizontalAlignment(2);
        kdtEntrys_femalePrice_TextField.setDataType(1);
        	kdtEntrys_femalePrice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_femalePrice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_femalePrice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_femalePrice_CellEditor = new KDTDefaultCellEditor(kdtEntrys_femalePrice_TextField);
        this.kdtEntrys.getColumn("femalePrice").setEditor(kdtEntrys_femalePrice_CellEditor);
        KDFormattedTextField kdtEntrys_femaleAmount_TextField = new KDFormattedTextField();
        kdtEntrys_femaleAmount_TextField.setName("kdtEntrys_femaleAmount_TextField");
        kdtEntrys_femaleAmount_TextField.setVisible(true);
        kdtEntrys_femaleAmount_TextField.setEditable(true);
        kdtEntrys_femaleAmount_TextField.setHorizontalAlignment(2);
        kdtEntrys_femaleAmount_TextField.setDataType(1);
        	kdtEntrys_femaleAmount_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_femaleAmount_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_femaleAmount_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_femaleAmount_CellEditor = new KDTDefaultCellEditor(kdtEntrys_femaleAmount_TextField);
        this.kdtEntrys.getColumn("femaleAmount").setEditor(kdtEntrys_femaleAmount_CellEditor);
        ...
        // chkisWeightSettle		
        this.chkisWeightSettle.setText(resHelper.getString("chkisWeightSettle.text"));		
        this.chkisWeightSettle.setHorizontalAlignment(2);		
        this.chkisWeightSettle.setRolloverEnabled(true);		
        this.chkisWeightSettle.setSelected(true);		
        this.chkisWeightSettle.setEnabled(false);
        // chkisInit		
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(379, 553, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(379, 553, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(730, 553, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(730, 553, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDescription.setBounds(new Rectangle(20, 111, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(20, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(29, 553, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(29, 553, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contcompany.setBounds(new Rectangle(689, 45, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(689, 45, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kDSeparator8.setBounds(new Rectangle(18, 542, 980, 10));
        this.add(kDSeparator8, new KDLayout.Constraints(18, 542, 980, 10, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDSeparator9.setBounds(new Rectangle(6, 141, 986, 8));
        this.add(kDSeparator9, new KDLayout.Constraints(6, 141, 986, 8, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contfarmer.setBounds(new Rectangle(20, 45, 270, 19));
        this.add(contfarmer, new KDLayout.Constraints(20, 45, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(22, 159, 943, 373));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(22, 159, 943, 373, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contstorageOrgUnit.setBounds(new Rectangle(690, 77, 270, 19));
        this.add(contstorageOrgUnit, new KDLayout.Constraints(690, 77, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contstockingBatch.setBounds(new Rectangle(371, 45, 270, 19));
        this.add(contstockingBatch, new KDLayout.Constraints(371, 45, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contfarm.setBounds(new Rectangle(20, 77, 270, 19));
        this.add(contfarm, new KDLayout.Constraints(20, 77, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contperson.setBounds(new Rectangle(371, 77, 270, 19));
        this.add(contperson, new KDLayout.Constraints(371, 77, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkisWeightSettle.setBounds(new Rectangle(370, 111, 270, 19));
        this.add(chkisWeightSettle, new KDLayout.Constraints(370, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkisInit.setBounds(new Rectangle(690, 111, 270, 19));
        this.add(chkisInit, new KDLayout.Constraints(690, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.femaleQty", java.math.BigDecimal.class, this.kdtEntrys, "femaleQty.text");
		dataBinder.registerBinding("entrys.femaleWeight", java.math.BigDecimal.class, this.kdtEntrys, "femaleWeight.text");
		dataBinder.registerBinding("entrys.femalePrice", java.math.BigDecimal.class, this.kdtEntrys, "femalePrice.text");
		dataBinder.registerBinding("entrys.femaleAmount", java.math.BigDecimal.class, this.kdtEntrys, "femaleAmount.text");
		dataBinder.registerBinding("entrys.allAmount", java.math.BigDecimal.class, this.kdtEntrys, "allAmount.text");
		dataBinder.registerBinding("isWeightSettle", boolean.class, this.chkisWeightSettle, "selected");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.BirdsRecycleBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.femaleWeight", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.femalePrice", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.femaleAmount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.allAmount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("isWeightSettle", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"unit").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"baseUnit"));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.femaleWeight"));
    	sic.add(new SelectorItemInfo("entrys.femalePrice"));
    	sic.add(new SelectorItemInfo("entrys.femaleAmount"));
    	sic.add(new SelectorItemInfo("entrys.allAmount"));
        sic.add(new SelectorItemInfo("isWeightSettle"));
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.BirdsRecycleBillFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBirdsRecycleBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBirdsRecycleBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "BirdsRecycleBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.BirdsRecycleBillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/farm/stocking/processbizill/BirdsRecycleBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.BirdsRecycleBillQuery");
	}

 ...
 * output class name
 */
public abstract class AbstractFiltration extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFiltration.class);
     ...
     */
    public AbstractFiltration() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFiltration.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.FiltrationHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "Filtration");
    }

 ...
 * output class name
 */
public class StockingBatchChangeBillListUI extends AbstractStockingBatchChangeBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StockingBatchChangeBillListUI.class);
    
    /**
     * output class constructor
     */
    public StockingBatchChangeBillListUI() throws Exception
    {
        super();
    }

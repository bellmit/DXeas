 ...
 * output class name
 */
public abstract class AbstractEggRecycleEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEggRecycleEditUI.class);
    ...
    protected com.kingdee.eas.farm.stocking.processbizill.EggRecycleInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractEggRecycleEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEggRecycleEditUI.class.getName());
        ...
        this.contLastUpdateUser.setOpaque(true);
        // contLastUpdateTime		
        this.contLastUpdateTime.setBoundLabelText(resHelper.getString("contLastUpdateTime.boundLabelText"));		
        this.contLastUpdateTime.setBoundLabelLength(100);		
        this.contLastUpdateTime.setBoundLabelUnderline(true);		
        this.contLastUpdateTime.setEnabled(false);		
        this.contLastUpdateTime.setOpaque(true);
        // contNumber		
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","materialName","model","unit","qty","number","weight","ertilityRate","ertilityQty","basePrice","receivePrice","receiveAmout","warehouse"});
        ...
        KDFormattedTextField kdtEntrys_number_TextField = new KDFormattedTextField();
        kdtEntrys_number_TextField.setName("kdtEntrys_number_TextField");
        kdtEntrys_number_TextField.setVisible(true);
        kdtEntrys_number_TextField.setEditable(true);
        kdtEntrys_number_TextField.setHorizontalAlignment(2);
        kdtEntrys_number_TextField.setDataType(1);
        	kdtEntrys_number_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_number_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_number_TextField.setPrecision(10);
        ...
        KDFormattedTextField kdtEntrys_ertilityRate_TextField = new KDFormattedTextField();
        kdtEntrys_ertilityRate_TextField.setName("kdtEntrys_ertilityRate_TextField");
        kdtEntrys_ertilityRate_TextField.setVisible(true);
        kdtEntrys_ertilityRate_TextField.setEditable(true);
        kdtEntrys_ertilityRate_TextField.setHorizontalAlignment(2);
        kdtEntrys_ertilityRate_TextField.setDataType(1);
        	kdtEntrys_ertilityRate_TextField.setMinimumValue(new java.math.BigDecimal("-999.99"));
        	kdtEntrys_ertilityRate_TextField.setMaximumValue(new java.math.BigDecimal("999.99"));
        kdtEntrys_ertilityRate_TextField.setPrecision(2);
        KDTDefaultCellEditor kdtEntrys_ertilityRate_CellEditor = new KDTDefaultCellEditor(kdtEntrys_ertilityRate_TextField);
        this.kdtEntrys.getColumn("ertilityRate").setEditor(kdtEntrys_ertilityRate_CellEditor);
        KDFormattedTextField kdtEntrys_ertilityQty_TextField = new KDFormattedTextField();
        kdtEntrys_ertilityQty_TextField.setName("kdtEntrys_ertilityQty_TextField");
        kdtEntrys_ertilityQty_TextField.setVisible(true);
        kdtEntrys_ertilityQty_TextField.setEditable(true);
        kdtEntrys_ertilityQty_TextField.setHorizontalAlignment(2);
        kdtEntrys_ertilityQty_TextField.setDataType(1);
        	kdtEntrys_ertilityQty_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_ertilityQty_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_ertilityQty_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_ertilityQty_CellEditor = new KDTDefaultCellEditor(kdtEntrys_ertilityQty_TextField);
        this.kdtEntrys.getColumn("ertilityQty").setEditor(kdtEntrys_ertilityQty_CellEditor);
        ...
        KDFormattedTextField kdtEntrys_receiveAmout_TextField = new KDFormattedTextField();
        kdtEntrys_receiveAmout_TextField.setName("kdtEntrys_receiveAmout_TextField");
        kdtEntrys_receiveAmout_TextField.setVisible(true);
        kdtEntrys_receiveAmout_TextField.setEditable(true);
        kdtEntrys_receiveAmout_TextField.setHorizontalAlignment(2);
        kdtEntrys_receiveAmout_TextField.setDataType(1);
        	kdtEntrys_receiveAmout_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_receiveAmout_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_receiveAmout_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_receiveAmout_CellEditor = new KDTDefaultCellEditor(kdtEntrys_receiveAmout_TextField);
        this.kdtEntrys.getColumn("receiveAmout").setEditor(kdtEntrys_receiveAmout_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        contCreateTime.setBounds(new Rectangle(730, 549, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(730, 549, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(379, 578, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(379, 578, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(730, 578, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(730, 578, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDescription.setBounds(new Rectangle(371, 84, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(371, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contcompany.setBounds(new Rectangle(690, 52, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(690, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contauditTime.setBounds(new Rectangle(29, 578, 270, 19));
        this.add(contauditTime, new KDLayout.Constraints(29, 578, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDSeparator8.setBounds(new Rectangle(18, 537, 980, 10));
        this.add(kDSeparator8, new KDLayout.Constraints(18, 537, 980, 10, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        kDSeparator9.setBounds(new Rectangle(6, 113, 986, 8));
        this.add(kDSeparator9, new KDLayout.Constraints(6, 113, 986, 8, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contfarmer.setBounds(new Rectangle(20, 52, 270, 19));
        this.add(contfarmer, new KDLayout.Constraints(20, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(22, 130, 943, 399));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.processbizill.EggRecycleEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(22, 130, 943, 399, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contstockingBatch.setBounds(new Rectangle(371, 52, 270, 19));
        this.add(contstockingBatch, new KDLayout.Constraints(371, 52, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contfarm.setBounds(new Rectangle(20, 84, 270, 19));
        this.add(contfarm, new KDLayout.Constraints(20, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contstorageOrgUnit.setBounds(new Rectangle(690, 84, 270, 19));
        this.add(contstorageOrgUnit, new KDLayout.Constraints(690, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        chkisInit.setBounds(new Rectangle(688, 3, 270, 19));
        this.add(chkisInit, new KDLayout.Constraints(688, 3, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.processbizill.EggRecycleEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.ertilityRate", java.math.BigDecimal.class, this.kdtEntrys, "ertilityRate.text");
		...
		dataBinder.registerBinding("entrys.receiveAmout", java.math.BigDecimal.class, this.kdtEntrys, "receiveAmout.text");
		...
		dataBinder.registerBinding("entrys.number", java.math.BigDecimal.class, this.kdtEntrys, "number.text");
		dataBinder.registerBinding("entrys.ertilityQty", java.math.BigDecimal.class, this.kdtEntrys, "ertilityQty.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.EggRecycleEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.EggRecycleInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.ertilityRate", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.receiveAmout", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.ertilityQty", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"receiveAmout").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"qty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"receivePrice").getValue())));
...
kdtEntrys.getCell(rowIndex,"receiveAmout").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimal(com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"qty").getValue())* com.kingdee.bos.ui.face.UIRuleUtil.getBigDecimalValue(kdtEntrys.getCell(rowIndex,"receivePrice").getValue())));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.ertilityRate"));
    	sic.add(new SelectorItemInfo("entrys.basePrice"));
    	sic.add(new SelectorItemInfo("entrys.receivePrice"));
    	sic.add(new SelectorItemInfo("entrys.receiveAmout"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    	...
    	sic.add(new SelectorItemInfo("entrys.ertilityQty"));
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.EggRecycleFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.EggRecycleFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractEggRecycleEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractEggRecycleEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "EggRecycleEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.EggRecycleEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/farm/stocking/processbizill/EggRecycle";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.EggRecycleQuery");
	}
		...
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"material").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"蛋品编码"});
			}
		}
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtstockingBatch.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"种苗批次"});
		}

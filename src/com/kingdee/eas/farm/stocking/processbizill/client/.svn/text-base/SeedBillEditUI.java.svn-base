 ...
 * output class name
 */
public class SeedBillEditUI extends AbstractSeedBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SeedBillEditUI.class);
    
    /**
     * output class constructor
     */
    public SeedBillEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    /**
     * output actionChkVoucherAll_actionPerformed
     */
    ...
    /**
     * output actionChkVoucherFlag_actionPerformed
     */

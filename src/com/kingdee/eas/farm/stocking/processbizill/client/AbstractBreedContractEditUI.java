 ...
 * output class name
 */
public abstract class AbstractBreedContractEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBreedContractEditUI.class);
    ...
    protected com.kingdee.eas.farm.stocking.processbizill.BreedContractInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractBreedContractEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBreedContractEditUI.class.getName());
        ...
        KDDatePicker kdtEntrys_endData_DatePicker = new KDDatePicker();
        kdtEntrys_endData_DatePicker.setName("kdtEntrys_endData_DatePicker");
        kdtEntrys_endData_DatePicker.setVisible(true);
        kdtEntrys_endData_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_endData_CellEditor = new KDTDefaultCellEditor(kdtEntrys_endData_DatePicker);
        this.kdtEntrys.getColumn("endData").setEditor(kdtEntrys_endData_CellEditor);
        ...
        // newSeparator3
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,billStatus,prmtcompany,pkauditTime,chkisTemplate,prmtfarmer,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(367, 52, 270, 19));
        ...
        chkisTemplate.setBounds(new Rectangle(676, 51, 270, 19));
        this.add(chkisTemplate, null);
        kDTabbedPane1.setBounds(new Rectangle(29, 97, 969, 396));
        ...
        //kDPanel1
        kDPanel1.setLayout(null);        contfarmer.setBounds(new Rectangle(19, 29, 270, 19));
        kDPanel1.add(contfarmer, null);
        //contfarmer
        contfarmer.setBoundEditor(prmtfarmer);
        //kDPanel2
        kDPanel2.setLayout(null);        kdtEntrys.setBounds(new Rectangle(11, 4, 943, 356));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.stocking.processbizill.BreedContractEntryInfo(),null,false);
        kDPanel2.add(kdtEntrys_detailPanel, null);
        kDPanel3.setLayout(null);        kDPanel4.setLayout(null);
    }
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.stocking.processbizill.BreedContractEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.endData", java.util.Date.class, this.kdtEntrys, "endData.text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.BreedContractEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.stocking.processbizill.BreedContractInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.endData", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.endData"));
        return sic;
    }        
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.BreedContractFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.BreedContractFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBreedContractEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBreedContractEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "BreedContractEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.BreedContractEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.BreedContractFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.BreedContractInfo objectValue = new com.kingdee.eas.farm.stocking.processbizill.BreedContractInfo();
    	...
    	return "/bim/farm/stocking/processbizill/BreedContract";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.BreedContractQuery");
	}

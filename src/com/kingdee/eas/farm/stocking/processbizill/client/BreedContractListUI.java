 ...
 * output class name
 */
public class BreedContractListUI extends AbstractBreedContractListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedContractListUI.class);
    
    /**
     * output class constructor
     */
    public BreedContractListUI() throws Exception
    {
        super();
    }

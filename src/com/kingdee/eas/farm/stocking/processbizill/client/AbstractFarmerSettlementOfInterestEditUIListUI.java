 ...
 * output class name
 */
public abstract class AbstractFarmerSettlementOfInterestEditUIListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFarmerSettlementOfInterestEditUIListUI.class);
     ...
     */
    public AbstractFarmerSettlementOfInterestEditUIListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFarmerSettlementOfInterestEditUIListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app", "FarmerSettlementOfInterestEditUIQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.stocking.processbizill.app.FarmerSettlementOfInterestEditUIListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.FarmerName.name"));
        sic.add(new SelectorItemInfo("entrys.IntersetRate"));
        sic.add(new SelectorItemInfo("entrys.LocaInterest"));
        return sic;
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFarmerSettlementOfInterestEditUIListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerSettlementOfInterestEditUIListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.client", "FarmerSettlementOfInterestEditUIListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.client.FarmerSettlementOfInterestEditUIEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.stocking.processbizill.FarmerSettlementOfInterestEditUIFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.stocking.processbizill.FarmerSettlementOfInterestEditUIInfo objectValue = new com.kingdee.eas.farm.stocking.processbizill.FarmerSettlementOfInterestEditUIInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","Company.name","Period.periodNumber","entrys.FarmerName.name"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/stocking/processbizill/FarmerSettlementOfInterestEditUI";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.stocking.processbizill.app.FarmerSettlementOfInterestEditUIQuery");
	}

 ...
 * output class name
 */
public class StateOfAcaountImportListUI extends AbstractStateOfAcaountImportListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StateOfAcaountImportListUI.class);
    
    /**
     * output class constructor
     */
    public StateOfAcaountImportListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class FodderAdjustBillListUI extends AbstractFodderAdjustBillListUI
{
	private static final Logger logger = CoreUIObject.getLogger(FodderAdjustBillListUI.class);

	/**
	 * output class constructor
	 */
	public FodderAdjustBillListUI() throws Exception
	{
		super();
	}

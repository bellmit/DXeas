 ...
 * output class name
 */
public class QCEggScrapBillListUI extends AbstractQCEggScrapBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(QCEggScrapBillListUI.class);
    
    /**
     * output class constructor
     */
    public QCEggScrapBillListUI() throws Exception
    {
        super();
    }

...
public abstract class AbstractStockingBreedDailyEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEggEntry.putBindContents("editData",new String[] {"seq","px","house","material","materialName","model","unit","allQty","runQty","qcEggQty","unQCEgg","mutnatQty","zd","brokenQty","fxd","doubleQty","firstQty","rd","smallEggQty","totalLossQty","dz","eggRate","description","BBQty"});
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanelFeed.putClientProperty("OriginalBounds", new Rectangle(0, 0, 992, 330));        kdtEntrys.setBounds(new Rectangle(1, 1, 982, 328));
        ...
        kDPanelFeed.add(kdtEntrys_detailPanel, new KDLayout.Constraints(1, 1, 982, 328, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDPanelBreed
        ...
        kDPanelEgg.putClientProperty("OriginalBounds", new Rectangle(0, 0, 992, 330));        kdtEggEntry.setBounds(new Rectangle(1, 1, 989, 324));
        ...
        kDPanelEgg.add(kdtEggEntry_detailPanel, new KDLayout.Constraints(1, 1, 989, 324, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDPanelSendEgg

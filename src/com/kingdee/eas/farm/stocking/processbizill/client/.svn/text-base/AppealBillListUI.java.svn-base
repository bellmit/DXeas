 ...
 * output class name
 */
public class AppealBillListUI extends AbstractAppealBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AppealBillListUI.class);
    
    /**
     * output class constructor
     */
    public AppealBillListUI() throws Exception
    {
        super();
    }

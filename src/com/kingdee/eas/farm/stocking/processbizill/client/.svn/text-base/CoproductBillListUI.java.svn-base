 ...
 * output class name
 */
public class CoproductBillListUI extends AbstractCoproductBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CoproductBillListUI.class);
    
    /**
     * output class constructor
     */
    public CoproductBillListUI() throws Exception
    {
        super();
    }

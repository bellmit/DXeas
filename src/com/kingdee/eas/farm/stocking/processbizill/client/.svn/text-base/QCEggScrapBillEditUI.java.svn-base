 ...
 * output class name
 */
public class QCEggScrapBillEditUI extends AbstractQCEggScrapBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(QCEggScrapBillEditUI.class);
     ...
     */
    public QCEggScrapBillEditUI() throws Exception
    {
        super();
    }
    @Override

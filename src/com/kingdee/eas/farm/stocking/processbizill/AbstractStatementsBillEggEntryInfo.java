...
public class AbstractStatementsBillEggEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractStatementsBillEggEntryInfo()
    {
        this("id");
    }
    protected AbstractStatementsBillEggEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object: 回收分录 's null property 
     */

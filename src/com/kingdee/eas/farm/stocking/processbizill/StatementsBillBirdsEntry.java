...
public class StatementsBillBirdsEntry extends CoreBillEntryBase implements IStatementsBillBirdsEntry
{
    public StatementsBillBirdsEntry()
    {
        super();
        registerInterface(IStatementsBillBirdsEntry.class, this);
    }
    public StatementsBillBirdsEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStatementsBillBirdsEntry.class, this);
    }
    ...
    private StatementsBillBirdsEntryController getController() throws BOSException
    {
        return (StatementsBillBirdsEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStatementsBillBirdsEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

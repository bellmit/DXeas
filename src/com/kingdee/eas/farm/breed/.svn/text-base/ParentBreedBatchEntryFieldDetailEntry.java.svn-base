...
public class ParentBreedBatchEntryFieldDetailEntry extends CoreBillEntryBase implements IParentBreedBatchEntryFieldDetailEntry
{
    public ParentBreedBatchEntryFieldDetailEntry()
    {
        super();
        registerInterface(IParentBreedBatchEntryFieldDetailEntry.class, this);
    }
    public ParentBreedBatchEntryFieldDetailEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IParentBreedBatchEntryFieldDetailEntry.class, this);
    }
    ...
    private ParentBreedBatchEntryFieldDetailEntryController getController() throws BOSException
    {
        return (ParentBreedBatchEntryFieldDetailEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentBreedBatchEntryFieldDetailEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

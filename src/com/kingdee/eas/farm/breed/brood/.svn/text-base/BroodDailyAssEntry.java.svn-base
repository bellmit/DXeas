...
public class BroodDailyAssEntry extends CoreBillEntryBase implements IBroodDailyAssEntry
{
    public BroodDailyAssEntry()
    {
        super();
        registerInterface(IBroodDailyAssEntry.class, this);
    }
    public BroodDailyAssEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBroodDailyAssEntry.class, this);
    }
    ...
    private BroodDailyAssEntryController getController() throws BOSException
    {
        return (BroodDailyAssEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBroodDailyAssEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyAssEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyAssEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyAssEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyAssEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyAssEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

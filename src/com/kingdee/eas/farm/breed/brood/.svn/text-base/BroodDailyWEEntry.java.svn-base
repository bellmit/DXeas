...
public class BroodDailyWEEntry extends CoreBillEntryBase implements IBroodDailyWEEntry
{
    public BroodDailyWEEntry()
    {
        super();
        registerInterface(IBroodDailyWEEntry.class, this);
    }
    public BroodDailyWEEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBroodDailyWEEntry.class, this);
    }
    ...
    private BroodDailyWEEntryController getController() throws BOSException
    {
        return (BroodDailyWEEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBroodDailyWEEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyWEEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyWEEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyWEEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyWEEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBroodDailyWEEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class AbstractBroodDailyFodderEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractBroodDailyFodderEntryInfo()
    {
        this("id");
    }
    protected AbstractBroodDailyFodderEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**

...
public class BroodCoopSetControllerBean extends AbstractBroodCoopSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.brood.app.BroodCoopSetControllerBean");
}
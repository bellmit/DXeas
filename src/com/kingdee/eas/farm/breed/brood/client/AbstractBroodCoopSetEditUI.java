 ...
 * output class name
 */
public abstract class AbstractBroodCoopSetEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBroodCoopSetEditUI.class);
    ...
    protected com.kingdee.eas.farm.breed.brood.BroodCoopSetInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBroodCoopSetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBroodCoopSetEditUI.class.getName());
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol2\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol3\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"material\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" /><t:Column t:key=\"materialName\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol2\" /><t:Column t:key=\"defaultQuantity\" t:width=\"120\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol3\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{material}</t:Cell><t:Cell>$Resource{materialName}</t:Cell><t:Cell>$Resource{defaultQuantity}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","materialName","defaultQuantity"});
        ...
        KDFormattedTextField kdtEntrys_defaultQuantity_TextField = new KDFormattedTextField();
        kdtEntrys_defaultQuantity_TextField.setName("kdtEntrys_defaultQuantity_TextField");
        kdtEntrys_defaultQuantity_TextField.setVisible(true);
        kdtEntrys_defaultQuantity_TextField.setEditable(true);
        kdtEntrys_defaultQuantity_TextField.setHorizontalAlignment(2);
        kdtEntrys_defaultQuantity_TextField.setDataType(1);
        	kdtEntrys_defaultQuantity_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E26"));
        	kdtEntrys_defaultQuantity_TextField.setMaximumValue(new java.math.BigDecimal("1.0E26"));
        kdtEntrys_defaultQuantity_TextField.setPrecision(2);
        KDTDefaultCellEditor kdtEntrys_defaultQuantity_CellEditor = new KDTDefaultCellEditor(kdtEntrys_defaultQuantity_TextField);
        this.kdtEntrys.getColumn("defaultQuantity").setEditor(kdtEntrys_defaultQuantity_CellEditor);
        // contauditTime		
        ...
        this.prmthenhouse.setVisible(true);		
        ...
        // txtwarehouse		
        this.txtwarehouse.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,kdtEntrys,pkauditTime,prmthenhouse,txtwarehouse,prmtstoOrg}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contCreator, new KDLayout.Constraints(15, 564, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(15, 591, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(15, 591, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(contLastUpdateTime, new KDLayout.Constraints(370, 591, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(13, 10, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(13, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(719, 10, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(719, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contDescription.setBounds(new Rectangle(719, 37, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(719, 37, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(725, 564, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(725, 564, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(12, 71, 991, 486));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.breed.brood.BroodCoopSetEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 71, 991, 486, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contauditTime.setBounds(new Rectangle(725, 591, 270, 19));
        this.add(contauditTime, new KDLayout.Constraints(725, 591, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        conthenhouse.setBounds(new Rectangle(13, 37, 270, 19));
        this.add(conthenhouse, new KDLayout.Constraints(13, 37, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contwarehouse.setBounds(new Rectangle(363, 37, 270, 19));
        this.add(contwarehouse, new KDLayout.Constraints(363, 37, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contstoOrg.setBounds(new Rectangle(363, 10, 270, 19));
        this.add(contstoOrg, new KDLayout.Constraints(363, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.farm.breed.brood.BroodCoopSetEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.defaultQuantity", java.math.BigDecimal.class, this.kdtEntrys, "defaultQuantity.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.brood.app.BroodCoopSetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.breed.brood.BroodCoopSetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.defaultQuantity", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"materialName").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"name")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.defaultQuantity"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.brood.client", "BroodCoopSetEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.breed.brood.client.BroodCoopSetEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/farm/breed/brood/BroodCoopSet";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.breed.brood.app.BroodCoopSetQuery");
	}
		...
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"material").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"ËÇÎ¹ËÇÁÏ"});
			}
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmthenhouse.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"¼¦Éá"});
		}

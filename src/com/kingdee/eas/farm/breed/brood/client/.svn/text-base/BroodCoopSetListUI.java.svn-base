 ...
 * output class name
 */
public class BroodCoopSetListUI extends AbstractBroodCoopSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BroodCoopSetListUI.class);
    
    /**
     * output class constructor
     */
    public BroodCoopSetListUI() throws Exception
    {
        super();
    }

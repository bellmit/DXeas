...
public class LayEggDailyLayEggEntry extends CoreBillEntryBase implements ILayEggDailyLayEggEntry
{
    public LayEggDailyLayEggEntry()
    {
        super();
        registerInterface(ILayEggDailyLayEggEntry.class, this);
    }
    public LayEggDailyLayEggEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ILayEggDailyLayEggEntry.class, this);
    }
    ...
    private LayEggDailyLayEggEntryController getController() throws BOSException
    {
        return (LayEggDailyLayEggEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyLayEggEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

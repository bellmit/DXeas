...
public class LayEggDailyCullDeathEntry extends CoreBillEntryBase implements ILayEggDailyCullDeathEntry
{
    public LayEggDailyCullDeathEntry()
    {
        super();
        registerInterface(ILayEggDailyCullDeathEntry.class, this);
    }
    public LayEggDailyCullDeathEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ILayEggDailyCullDeathEntry.class, this);
    }
    ...
    private LayEggDailyCullDeathEntryController getController() throws BOSException
    {
        return (LayEggDailyCullDeathEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyCullDeathEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class ParentEggDailyTransEntry extends CoreBillEntryBase implements IParentEggDailyTransEntry
{
    public ParentEggDailyTransEntry()
    {
        super();
        registerInterface(IParentEggDailyTransEntry.class, this);
    }
    public ParentEggDailyTransEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IParentEggDailyTransEntry.class, this);
    }
    ...
    private ParentEggDailyTransEntryController getController() throws BOSException
    {
        return (ParentEggDailyTransEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyTransEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

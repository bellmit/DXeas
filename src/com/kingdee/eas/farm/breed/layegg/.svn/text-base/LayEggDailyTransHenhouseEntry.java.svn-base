...
public class LayEggDailyTransHenhouseEntry extends CoreBillEntryBase implements ILayEggDailyTransHenhouseEntry
{
    public LayEggDailyTransHenhouseEntry()
    {
        super();
        registerInterface(ILayEggDailyTransHenhouseEntry.class, this);
    }
    public LayEggDailyTransHenhouseEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ILayEggDailyTransHenhouseEntry.class, this);
    }
    ...
    private LayEggDailyTransHenhouseEntryController getController() throws BOSException
    {
        return (LayEggDailyTransHenhouseEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyTransHenhouseEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

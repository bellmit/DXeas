...
public class AbstractParentEggDailyFodderEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractParentEggDailyFodderEntryInfo()
    {
        this("id");
    }
    protected AbstractParentEggDailyFodderEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**

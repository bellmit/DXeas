...
public class LifeFeeEntryControllerBean extends AbstractLifeFeeEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.layegg.app.LifeFeeEntryControllerBean");
}
...
public class EggConveyorControllerBean extends AbstractEggConveyorControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.layegg.app.EggConveyorControllerBean");
}
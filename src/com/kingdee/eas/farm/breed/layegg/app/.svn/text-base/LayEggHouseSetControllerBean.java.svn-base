...
public class LayEggHouseSetControllerBean extends AbstractLayEggHouseSetControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.layegg.app.LayEggHouseSetControllerBean");
}
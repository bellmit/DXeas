...
public class ParentEggDailyControllerBean extends AbstractParentEggDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.layegg.app.ParentEggDailyControllerBean");
}
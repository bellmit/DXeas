...
public class LayEggDailyFodderEntry extends CoreBillEntryBase implements ILayEggDailyFodderEntry
{
    public LayEggDailyFodderEntry()
    {
        super();
        registerInterface(ILayEggDailyFodderEntry.class, this);
    }
    public LayEggDailyFodderEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ILayEggDailyFodderEntry.class, this);
    }
    ...
    private LayEggDailyFodderEntryController getController() throws BOSException
    {
        return (LayEggDailyFodderEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyFodderEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

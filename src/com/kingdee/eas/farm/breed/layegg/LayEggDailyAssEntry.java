...
public class LayEggDailyAssEntry extends CoreBillEntryBase implements ILayEggDailyAssEntry
{
    public LayEggDailyAssEntry()
    {
        super();
        registerInterface(ILayEggDailyAssEntry.class, this);
    }
    public LayEggDailyAssEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ILayEggDailyAssEntry.class, this);
    }
    ...
    private LayEggDailyAssEntryController getController() throws BOSException
    {
        return (LayEggDailyAssEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLayEggDailyAssEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

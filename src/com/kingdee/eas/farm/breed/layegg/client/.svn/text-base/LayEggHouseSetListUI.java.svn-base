 ...
 * output class name
 */
public class LayEggHouseSetListUI extends AbstractLayEggHouseSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LayEggHouseSetListUI.class);
    
    /**
     * output class constructor
     */
    public LayEggHouseSetListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class ParentEggDailyEditUI extends AbstractParentEggDailyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ParentEggDailyEditUI.class);
    
    /**
     * output class constructor
     */
    public ParentEggDailyEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    /**
     * output actionReShareInfos_actionPerformed
     */
    ...
    /**
     * output actionRefreshInventory_actionPerformed
     */
    public void actionRefreshInventory_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionRefreshInventory_actionPerformed(e);
    }

 ...
 * output class name
 */
public abstract class AbstractEggConveyorListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEggConveyorListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractEggConveyorListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractEggConveyorListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.layegg.app.EggConveyorListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("henhouseDesc"));
        sic.add(new SelectorItemInfo("eggWarehouse.name"));
        return sic;
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.layegg.client", "EggConveyorListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.breed.layegg.client.EggConveyorEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.breed.layegg.EggConveyorFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.breed.layegg.EggConveyorInfo objectValue = new com.kingdee.eas.farm.breed.layegg.EggConveyorInfo();		
        return objectValue;
    }

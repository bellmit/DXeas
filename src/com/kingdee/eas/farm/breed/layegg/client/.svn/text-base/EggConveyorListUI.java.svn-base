 ...
 * output class name
 */
public class EggConveyorListUI extends AbstractEggConveyorListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggConveyorListUI.class);
    
    /**
     * output class constructor
     */
    public EggConveyorListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.breed.layegg.client.EggConveyorTreeEditUI.class.getName();
    }

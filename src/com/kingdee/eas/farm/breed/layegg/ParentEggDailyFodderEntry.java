...
public class ParentEggDailyFodderEntry extends CoreBillEntryBase implements IParentEggDailyFodderEntry
{
    public ParentEggDailyFodderEntry()
    {
        super();
        registerInterface(IParentEggDailyFodderEntry.class, this);
    }
    public ParentEggDailyFodderEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IParentEggDailyFodderEntry.class, this);
    }
    ...
    {
        return new BOSObjectType("264C99F1");
    }
    private ParentEggDailyFodderEntryController getController() throws BOSException
    {
        return (ParentEggDailyFodderEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getParentEggDailyFodderEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

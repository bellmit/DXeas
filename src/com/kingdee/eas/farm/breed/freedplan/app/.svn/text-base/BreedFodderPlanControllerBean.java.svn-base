...
public class BreedFodderPlanControllerBean extends AbstractBreedFodderPlanControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.freedplan.app.BreedFodderPlanControllerBean");
}
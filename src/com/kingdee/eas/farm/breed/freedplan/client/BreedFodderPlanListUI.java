 ...
 * output class name
 */
public class BreedFodderPlanListUI extends AbstractBreedFodderPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedFodderPlanListUI.class);
    
    /**
     * output class constructor
     */
    public BreedFodderPlanListUI() throws Exception
    {
        super();
    }

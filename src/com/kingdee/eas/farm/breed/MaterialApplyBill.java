...
public class MaterialApplyBill extends CoreBillBase implements IMaterialApplyBill
{
    public MaterialApplyBill()
    {
        super();
        registerInterface(IMaterialApplyBill.class, this);
    }
    public MaterialApplyBill(Context ctx)
    {
        super(ctx);
        registerInterface(IMaterialApplyBill.class, this);
    }
    ...
    private MaterialApplyBillController getController() throws BOSException
    {
        return (MaterialApplyBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMaterialApplyBillCollection(getContext());
        }
    ...
    {
        try {
            return getController().getMaterialApplyBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialApplyBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialApplyBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialApplyBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMaterialApplyBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

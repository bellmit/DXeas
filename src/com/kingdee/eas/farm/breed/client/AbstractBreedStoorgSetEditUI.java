 ...
 * output class name
 */
public abstract class AbstractBreedStoorgSetEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBreedStoorgSetEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfarmLeader;
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisEnableAutoApplyFodder;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtfarmLeader;
    ...
    protected com.kingdee.eas.farm.breed.BreedStoorgSetInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBreedStoorgSetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBreedStoorgSetEditUI.class.getName());
        ...
        this.contfarmLeader = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.chkisEnableAutoApplyFodder = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.prmtfarmLeader = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contfarmLeader.setName("contfarmLeader");
        this.contstatus.setName("contstatus");
        this.conthenhouseType.setName("conthenhouseType");
        this.conttel.setName("conttel");
        this.contcompany.setName("contcompany");
        this.chkisEnableAutoApplyFodder.setName("chkisEnableAutoApplyFodder");
        ...
        this.prmtfarmLeader.setName("prmtfarmLeader");
        ...
        // contfarmLeader		
        this.contfarmLeader.setBoundLabelText(resHelper.getString("contfarmLeader.boundLabelText"));		
        this.contfarmLeader.setBoundLabelLength(100);		
        this.contfarmLeader.setBoundLabelUnderline(true);		
        this.contfarmLeader.setVisible(true);
        // contstatus		
        ...
        // chkisEnableAutoApplyFodder		
        this.chkisEnableAutoApplyFodder.setText(resHelper.getString("chkisEnableAutoApplyFodder.text"));		
        this.chkisEnableAutoApplyFodder.setVisible(true);		
        this.chkisEnableAutoApplyFodder.setHorizontalAlignment(2);
        // prmtCreator		
        ...
        // prmtfarmLeader		
        this.prmtfarmLeader.setQueryInfo("com.kingdee.eas.basedata.person.app.PersonFilterQuery");		
        this.prmtfarmLeader.setEditable(true);		
        this.prmtfarmLeader.setDisplayFormat("$name$");		
        this.prmtfarmLeader.setEditFormat("$number$");		
        this.prmtfarmLeader.setCommitFormat("$number$");		
        this.prmtfarmLeader.setRequired(false);
        // status		
        this.status.addItems(EnumUtils.getEnumList("com.kingdee.eas.farm.breed.DisableState").toArray());		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,txtname,henhouseType,prmtstoOrg,prmtcompany,pkBizDate,pkbuildDate,txtaddress,prmtfarmLeader,txttel,txtDescription,status,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,chkisEnableAutoApplyFodder}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 623, 606));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(23, 482, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(316, 482, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(23, 521, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(316, 521, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(23, 42, 270, 19));
        this.add(contNumber, null);
        contBizDate.setBounds(new Rectangle(38, -175, 270, 19));
        this.add(contBizDate, null);
        contDescription.setBounds(new Rectangle(22, 273, 564, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(17, 568, 270, 19));
        this.add(contAuditor, null);
        contname.setBounds(new Rectangle(316, 42, 270, 19));
        this.add(contname, null);
        contstoOrg.setBounds(new Rectangle(23, 75, 270, 19));
        this.add(contstoOrg, null);
        contbuildDate.setBounds(new Rectangle(23, 173, 270, 19));
        this.add(contbuildDate, null);
        contaddress.setBounds(new Rectangle(23, 244, 563, 19));
        this.add(contaddress, null);
        contfarmLeader.setBounds(new Rectangle(23, 109, 270, 19));
        this.add(contfarmLeader, null);
        contstatus.setBounds(new Rectangle(315, 206, 270, 19));
        this.add(contstatus, null);
        conthenhouseType.setBounds(new Rectangle(23, 206, 270, 19));
        this.add(conthenhouseType, null);
        conttel.setBounds(new Rectangle(316, 108, 270, 19));
        this.add(conttel, null);
        contcompany.setBounds(new Rectangle(316, 75, 270, 19));
        this.add(contcompany, null);
        chkisEnableAutoApplyFodder.setBounds(new Rectangle(328, 147, 270, 19));
        this.add(chkisEnableAutoApplyFodder, null);
        //contCreator
        ...
        //contfarmLeader
        contfarmLeader.setBoundEditor(prmtfarmLeader);
        //contstatus
	...
	private void registerBindings(){
		dataBinder.registerBinding("isEnableAutoApplyFodder", boolean.class, this.chkisEnableAutoApplyFodder, "selected");
		...
		dataBinder.registerBinding("farmLeader", com.kingdee.eas.basedata.person.PersonInfo.class, this.prmtfarmLeader, "data");
		dataBinder.registerBinding("status", com.kingdee.eas.farm.breed.DisableState.class, this.status, "selectedItem");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.BreedStoorgSetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.breed.BreedStoorgSetInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isEnableAutoApplyFodder", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("farmLeader", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("farmLeader.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("farmLeader.id"));
        	sic.add(new SelectorItemInfo("farmLeader.number"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "BreedStoorgSetEditUI");
    }
    /**
    ...
    protected IMetaDataPK getTDQueryPK() {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtname.getText())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"养殖场名称"});
		}
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtstoOrg.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"库存组织（养殖场）"});
		}

 ...
 * output class name
 */
public class CenterControlDeviceListUI extends AbstractCenterControlDeviceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CenterControlDeviceListUI.class);
    
    /**
     * output class constructor
     */
    public CenterControlDeviceListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.breed.client.CenterControlDeviceTreeEditUI.class.getName();
    }

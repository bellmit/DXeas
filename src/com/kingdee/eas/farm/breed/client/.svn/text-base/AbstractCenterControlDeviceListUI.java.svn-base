 ...
 * output class name
 */
public abstract class AbstractCenterControlDeviceListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCenterControlDeviceListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractCenterControlDeviceListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractCenterControlDeviceListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.CenterControlDeviceListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "CenterControlDeviceListUI");
    }

 ...
 * output class name
 */
public class ResidueSetListUI extends AbstractResidueSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ResidueSetListUI.class);
    
    /**
     * output class constructor
     */
    public ResidueSetListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.breed.client.ResidueSetTreeEditUI.class.getName();
    }

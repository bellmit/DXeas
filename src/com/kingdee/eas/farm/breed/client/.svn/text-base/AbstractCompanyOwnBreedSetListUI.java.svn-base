 ...
 * output class name
 */
public abstract class AbstractCompanyOwnBreedSetListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCompanyOwnBreedSetListUI.class);
    /**
     * output class constructor
     */
    public AbstractCompanyOwnBreedSetListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCompanyOwnBreedSetListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.breed.app", "CompanyOwnBreedSetQuery");
        // CoreUI
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.CompanyOwnBreedSetListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "CompanyOwnBreedSetListUI");
    }

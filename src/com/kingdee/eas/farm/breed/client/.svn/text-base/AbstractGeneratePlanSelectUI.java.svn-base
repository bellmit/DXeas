 ...
 * output class name
 */
public abstract class AbstractGeneratePlanSelectUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGeneratePlanSelectUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer chkplan;
     ...
     */
    public AbstractGeneratePlanSelectUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGeneratePlanSelectUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        this.chkplan = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.btnConfirm = new com.kingdee.bos.ctrl.swing.KDButton();
        this.kDComboBox1 = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.chkplan.setName("chkplan");
        ...
        // chkplan		
        this.chkplan.setBoundLabelText(resHelper.getString("chkplan.boundLabelText"));		
        this.chkplan.setBoundLabelLength(100);		
        this.chkplan.setBoundLabelUnderline(true);
        // btnConfirm		
        ...
        // kDComboBox1		
        this.kDComboBox1.setActionCommand("cboxBusList");
    ...
    {
        this.setBounds(new Rectangle(10, 10, 320, 200));
        this.setLayout(null);
        chkplan.setBounds(new Rectangle(25, 46, 270, 19));
        this.add(chkplan, null);
        btnConfirm.setBounds(new Rectangle(73, 118, 174, 30));
        this.add(btnConfirm, null);
        //chkplan
        chkplan.setBoundEditor(kDComboBox1);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.GeneratePlanSelectUIHandler";
	}
    ...
    /**
     * output btnConfirm_actionPerforme method
     */
    protected void btnConfirm_actionPerforme(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "GeneratePlanSelectUI");
    }

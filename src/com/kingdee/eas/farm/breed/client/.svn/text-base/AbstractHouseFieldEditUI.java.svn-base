 ...
 * output class name
 */
public abstract class AbstractHouseFieldEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHouseFieldEditUI.class);
    ...
    protected com.kingdee.eas.farm.breed.HouseFieldInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHouseFieldEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHouseFieldEditUI.class.getName());
        ...
        this.prmthenhouse.setDisplayFormat("$name$");		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,prmthenhouse,prmtfarm,txtDescription,txtSimpleName}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(62, 81, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(62, 180, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(62, 217, 270, 19));
        this.add(kDLabelContainer4, null);
        conthenhouse.setBounds(new Rectangle(62, 114, 270, 19));
        this.add(conthenhouse, null);
        contfarm.setBounds(new Rectangle(62, 148, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.HouseFieldEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.breed.HouseFieldInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "HouseFieldEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmthenhouse.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"À˘ Ù«›…·"});
		}

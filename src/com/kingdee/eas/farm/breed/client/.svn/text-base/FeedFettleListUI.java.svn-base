 ...
 * output class name
 */
public class FeedFettleListUI extends AbstractFeedFettleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeedFettleListUI.class);
    // 当前养殖场
    private BreedStoorgSetInfo currFarm;
    /**
     * output class constructor
     */
    public FeedFettleListUI() throws Exception
    {
        super();
        // 当前 养殖场

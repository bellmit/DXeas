 ...
 * output class name
 */
public abstract class AbstractUpdateCostObjectUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractUpdateCostObjectUI.class);
     ...
     */
    public AbstractUpdateCostObjectUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractUpdateCostObjectUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(42, 48, 313, 19));
        this.add(kDLabelContainer1, null);
        btnConfirm.setBounds(new Rectangle(65, 112, 92, 21));
        this.add(btnConfirm, null);
        btnCancel.setBounds(new Rectangle(237, 112, 92, 21));
        this.add(btnCancel, null);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(prmtCostObject);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.app.UpdateCostObjectUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.client", "UpdateCostObjectUI");
    }

 ...
 * output class name
 */
public class FeedFettleEditUI extends AbstractFeedFettleEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeedFettleEditUI.class);
    
    /**
     * output class constructor
     */
    public FeedFettleEditUI() throws Exception
    {
        super();
    }
    /**

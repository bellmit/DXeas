 ...
 * output class name
 */
public class BreedStoorgSetListUI extends AbstractBreedStoorgSetListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BreedStoorgSetListUI.class);
 // 当前养殖场
    private BreedStoorgSetInfo currFarm;
    /**
     * output class constructor
     */
    public BreedStoorgSetListUI() throws Exception
    {
        super();
        // 当前 养殖场
...
//    	// 如果当前在养殖场，则过滤 养殖场
//    	if(currFarm != null){
//    		filterInfo.getFilterItems().add(new FilterItemInfo("id",currFarm.getId().toString(),CompareType.EQUALS));
//    	}

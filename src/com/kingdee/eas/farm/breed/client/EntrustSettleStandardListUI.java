 ...
 * output class name
 */
public class EntrustSettleStandardListUI extends AbstractEntrustSettleStandardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EntrustSettleStandardListUI.class);
    
    /**
     * output class constructor
     */
    public EntrustSettleStandardListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.breed.client.EntrustSettleStandardTreeEditUI.class.getName();
    }

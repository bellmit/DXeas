...
public class BreedBatchEditEntry extends CoreBillEntryBase implements IBreedBatchEditEntry
{
    public BreedBatchEditEntry()
    {
        super();
        registerInterface(IBreedBatchEditEntry.class, this);
    }
    public BreedBatchEditEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBreedBatchEditEntry.class, this);
    }
    ...
    private BreedBatchEditEntryController getController() throws BOSException
    {
        return (BreedBatchEditEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBreedBatchEditEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedBatchEditEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedBatchEditEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedBatchEditEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedBatchEditEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBreedBatchEditEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class CCSendFodderStandardEntry extends CoreBillEntryBase implements ICCSendFodderStandardEntry
{
    public CCSendFodderStandardEntry()
    {
        super();
        registerInterface(ICCSendFodderStandardEntry.class, this);
    }
    public CCSendFodderStandardEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICCSendFodderStandardEntry.class, this);
    }
    ...
    private CCSendFodderStandardEntryController getController() throws BOSException
    {
        return (CCSendFodderStandardEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCCSendFodderStandardEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

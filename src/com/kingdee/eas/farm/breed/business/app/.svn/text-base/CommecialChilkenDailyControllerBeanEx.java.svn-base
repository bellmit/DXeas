...
public class CommecialChilkenDailyControllerBeanEx extends com.kingdee.eas.farm.breed.business.app.CommecialChilkenDailyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.business.app.CommecialChilkenDailyControllerBeanEx");

...
public class CommecialChikenApplyFodderControllerBeanEx extends com.kingdee.eas.farm.breed.business.app.CommecialChikenApplyFodderControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.business.app.CommecialChikenApplyFodderControllerBeanEx");

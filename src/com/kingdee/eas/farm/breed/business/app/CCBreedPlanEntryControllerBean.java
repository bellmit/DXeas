...
public class CCBreedPlanEntryControllerBean extends AbstractCCBreedPlanEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.breed.business.app.CCBreedPlanEntryControllerBean");
}
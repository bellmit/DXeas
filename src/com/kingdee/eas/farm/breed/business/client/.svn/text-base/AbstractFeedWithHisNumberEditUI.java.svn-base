...
public abstract class AbstractFeedWithHisNumberEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    protected com.kingdee.eas.farm.breed.business.FeedWithHisNumberInfo editData = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtnum1,pkbeginDate,pkendDate,chkisCancelCancel,prmtnum5}));
    ...
    public void initUIContentLayout()
    {
        ...
        contnum1.setBounds(new Rectangle(25, 86, 270, 19));
        this.add(contnum1, null);
        contnum2.setBounds(new Rectangle(25, 112, 270, 19));
        this.add(contnum2, null);
        contnum3.setBounds(new Rectangle(25, 142, 270, 19));
        this.add(contnum3, null);
        contnum4.setBounds(new Rectangle(25, 168, 270, 19));
        this.add(contnum4, null);
        contbeginDate.setBounds(new Rectangle(25, 222, 270, 19));
        this.add(contbeginDate, null);
        contendDate.setBounds(new Rectangle(25, 261, 270, 19));
        this.add(contendDate, null);
        chkisCancelCancel.setBounds(new Rectangle(24, 291, 270, 19));
        this.add(chkisCancelCancel, null);
        contnum5.setBounds(new Rectangle(25, 195, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.breed.business.app.FeedWithHisNumberEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.breed.business.FeedWithHisNumberInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.breed.business.client", "FeedWithHisNumberEditUI");
    }

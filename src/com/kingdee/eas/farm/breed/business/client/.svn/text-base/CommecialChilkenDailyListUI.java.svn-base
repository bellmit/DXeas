 ...
 * output class name
 */
public class CommecialChilkenDailyListUI extends AbstractCommecialChilkenDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CommecialChilkenDailyListUI.class);
    
    /**
     * output class constructor
     */
    public CommecialChilkenDailyListUI() throws Exception
    {
        super();

 ...
 * output class name
 */
public class CarviousFeedPlanListUI extends AbstractCarviousFeedPlanListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarviousFeedPlanListUI.class);
    
    /**
     * output class constructor
     */
    public CarviousFeedPlanListUI() throws Exception
    {
        super();
    }

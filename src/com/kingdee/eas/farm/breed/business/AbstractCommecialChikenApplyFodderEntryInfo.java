...
public class AbstractCommecialChikenApplyFodderEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCommecialChikenApplyFodderEntryInfo()
    {
        this("id");
    }
    protected AbstractCommecialChikenApplyFodderEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
    ...
    /**
     * Object:饲喂信息分录's 标准饲喂量（kg）property 
     */

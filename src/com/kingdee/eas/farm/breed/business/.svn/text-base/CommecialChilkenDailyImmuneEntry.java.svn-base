...
public class CommecialChilkenDailyImmuneEntry extends CoreBillEntryBase implements ICommecialChilkenDailyImmuneEntry
{
    public CommecialChilkenDailyImmuneEntry()
    {
        super();
        registerInterface(ICommecialChilkenDailyImmuneEntry.class, this);
    }
    public CommecialChilkenDailyImmuneEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICommecialChilkenDailyImmuneEntry.class, this);
    }
    ...
    private CommecialChilkenDailyImmuneEntryController getController() throws BOSException
    {
        return (CommecialChilkenDailyImmuneEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommecialChilkenDailyImmuneEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

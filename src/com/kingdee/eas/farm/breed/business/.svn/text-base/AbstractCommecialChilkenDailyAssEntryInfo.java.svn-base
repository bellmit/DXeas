...
public class AbstractCommecialChilkenDailyAssEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCommecialChilkenDailyAssEntryInfo()
    {
        this("id");
    }
    protected AbstractCommecialChilkenDailyAssEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
    ...
    /**
     * Object:其他信息分录's 当日死淘property 
     */
    public int getCullAndDeath()
    {
        return getInt("cullAndDeath");
    }
    public void setCullAndDeath(int item)
    {
        setInt("cullAndDeath", item);
    }
    /**
     ...
     */
    public int getBreedingStock()
    {
        return getInt("breedingStock");
    }
    public void setBreedingStock(int item)
    {
        setInt("breedingStock", item);
    }
    /**
    ...
    {
        return new BOSObjectType("86DAC5FA");
    }
}
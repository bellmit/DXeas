...
public class AbstractCommecialChikenApplyFodderFodderPlanEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCommecialChikenApplyFodderFodderPlanEntryInfo()
    {
        this("id");
    }
    protected AbstractCommecialChikenApplyFodderFodderPlanEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**

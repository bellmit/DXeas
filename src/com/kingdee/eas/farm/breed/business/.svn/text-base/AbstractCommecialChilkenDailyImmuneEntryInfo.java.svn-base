...
public class AbstractCommecialChilkenDailyImmuneEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCommecialChilkenDailyImmuneEntryInfo()
    {
        this("id");
    }
    protected AbstractCommecialChilkenDailyImmuneEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
    ...
    {
        return new BOSObjectType("FED96D86");
    }
}
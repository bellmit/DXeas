...
public class JournalTimesFarmToFarmEntry extends CoreBillEntryBase implements IJournalTimesFarmToFarmEntry
{
    public JournalTimesFarmToFarmEntry()
    {
        super();
        registerInterface(IJournalTimesFarmToFarmEntry.class, this);
    }
    public JournalTimesFarmToFarmEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IJournalTimesFarmToFarmEntry.class, this);
    }
    ...
    private JournalTimesFarmToFarmEntryController getController() throws BOSException
    {
        return (JournalTimesFarmToFarmEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getJournalTimesFarmToFarmEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

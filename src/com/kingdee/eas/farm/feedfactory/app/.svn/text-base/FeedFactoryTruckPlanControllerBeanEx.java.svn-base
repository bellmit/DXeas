...
public class FeedFactoryTruckPlanControllerBeanEx extends com.kingdee.eas.farm.feedfactory.app.FeedFactoryTruckPlanControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feedfactory.app.FeedFactoryTruckPlanControllerBeanEx");
    protected void _getFodderPlan(Context ctx, IObjectValue model)throws BOSException
    {
	     super._getFodderPlan(ctx, model);
    }
}				

...
public class JournalTimesControllerBean extends AbstractJournalTimesControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feedfactory.app.JournalTimesControllerBean");
}
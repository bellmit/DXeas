...
public class FeedTruckControllerBean extends AbstractFeedTruckControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feedfactory.app.FeedTruckControllerBean");
}
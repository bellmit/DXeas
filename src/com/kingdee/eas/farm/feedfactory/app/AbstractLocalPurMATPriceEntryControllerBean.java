...
public abstract class AbstractLocalPurMATPriceEntryControllerBean extends CoreBillEntryBaseControllerBean implements LocalPurMATPriceEntryController
{
    protected AbstractLocalPurMATPriceEntryControllerBean()
    {
    }
    ...
    public LocalPurMATPriceEntryInfo getLocalPurMATPriceEntryInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
          ...
          return (LocalPurMATPriceEntryInfo)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } catch (EASBizException ex0) {
            throw ex0;
    ...
    public LocalPurMATPriceEntryCollection getLocalPurMATPriceEntryCollection(Context ctx) throws BOSException
    {
        try {
          ...
          return (LocalPurMATPriceEntryCollection)svcCtx.getMethodReturnValue();
        } catch (BOSException ex) {
            throw ex;
        } finally {
            super.cleanUpServiceState();
    ...
    {
    	return (CoreBillEntryBaseCollection)(getLocalPurMATPriceEntryCollection(ctx).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getLocalPurMATPriceEntryCollection(ctx, view).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBillEntryBaseCollection getCoreBillEntryBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (CoreBillEntryBaseCollection)(getLocalPurMATPriceEntryCollection(ctx, oql).cast(CoreBillEntryBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx) throws BOSException
    {
    	return (CoreBaseCollection)(getLocalPurMATPriceEntryCollection(ctx).cast(CoreBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (CoreBaseCollection)(getLocalPurMATPriceEntryCollection(ctx, view).cast(CoreBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (CoreBaseCollection)(getLocalPurMATPriceEntryCollection(ctx, oql).cast(CoreBaseCollection.class));
    }
}
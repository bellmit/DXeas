 ...
 * output class name
 */
public abstract class AbstractJournalTimesListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractJournalTimesListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractJournalTimesListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractJournalTimesListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.feedfactory.app.JournalTimesListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.feedfactory.client", "JournalTimesListUI");
    }

 ...
 * output class name
 */
public class FeedFactoryBaseDataListUI extends AbstractFeedFactoryBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeedFactoryBaseDataListUI.class);
    
    /**
     * output class constructor
     */
    public FeedFactoryBaseDataListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.feedfactory.client.FeedFactoryBaseDataTreeEditUI.class.getName();
    }

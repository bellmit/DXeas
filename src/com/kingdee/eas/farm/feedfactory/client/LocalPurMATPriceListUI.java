 ...
 * output class name
 */
public class LocalPurMATPriceListUI extends AbstractLocalPurMATPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LocalPurMATPriceListUI.class);
    
    /**
     * output class constructor
     */
    public LocalPurMATPriceListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class JournalTimesListUI extends AbstractJournalTimesListUI
{
    private static final Logger logger = CoreUIObject.getLogger(JournalTimesListUI.class);
    
    /**
     * output class constructor
     */
    public JournalTimesListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.feedfactory.client.JournalTimesTreeEditUI.class.getName();
    }

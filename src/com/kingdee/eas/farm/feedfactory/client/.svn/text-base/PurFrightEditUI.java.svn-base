 ...
 * output class name
 */
public class PurFrightEditUI extends AbstractPurFrightEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurFrightEditUI.class);
    
    /**
     * output class constructor
     */
    public PurFrightEditUI() throws Exception
    {
        super();
    }
    /**
...
//    private void kdtTransEntry_editStoped(KDTEditEvent e) {
//		// TODO Auto-generated method stub
//    	if(kdtEntrys.getColumnKey(e.getColIndex()).equalsIgnoreCase("qty")) {
//    		BigDecimal qty=UIRuleUtil.getBigDecimal(kdtEntrys.getCell(e.getRowIndex(),"qty").getValue());
//    		int n=MsgBox.showConfirm2("更改？ ");
//			if(n==0){
//				
//			}
//				
...
//	};
    ...
    {
        super.prmtpurOrder_dataChanged(e);
    }

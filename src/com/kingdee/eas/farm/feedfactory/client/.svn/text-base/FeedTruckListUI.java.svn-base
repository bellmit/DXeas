 ...
 * output class name
 */
public class FeedTruckListUI extends AbstractFeedTruckListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeedTruckListUI.class);
    
    /**
     * output class constructor
     */
    public FeedTruckListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.feedfactory.client.FeedTruckTreeEditUI.class.getName();
    }

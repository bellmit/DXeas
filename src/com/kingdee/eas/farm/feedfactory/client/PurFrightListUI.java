 ...
 * output class name
 */
public class PurFrightListUI extends AbstractPurFrightListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurFrightListUI.class);
    
    /**
     * output class constructor
     */
    public PurFrightListUI() throws Exception
    {
        super();
    }

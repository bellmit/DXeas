 ...
 * output class name
 */
public abstract class AbstractFarmCodeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFarmCodeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractFarmCodeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractFarmCodeListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.foodtrac.app.FarmCodeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.foodtrac.client", "FarmCodeListUI");
    }

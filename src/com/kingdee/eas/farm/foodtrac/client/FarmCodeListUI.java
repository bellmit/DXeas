 ...
 * output class name
 */
public class FarmCodeListUI extends AbstractFarmCodeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmCodeListUI.class);
    
    /**
     * output class constructor
     */
    public FarmCodeListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.foodtrac.client.FarmCodeTreeEditUI.class.getName();
    }

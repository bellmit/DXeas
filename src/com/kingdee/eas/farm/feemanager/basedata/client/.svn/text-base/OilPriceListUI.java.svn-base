 ...
 * output class name
 */
public class OilPriceListUI extends AbstractOilPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OilPriceListUI.class);
    
    /**
     * output class constructor
     */
    public OilPriceListUI() throws Exception
    {
    ...
    public OilPriceListUI(EntityViewInfo evi) throws Exception
    {
...
//        this.setFilterForQuery(fi);
    ...
    {
        return com.kingdee.eas.farm.feemanager.basedata.client.OilPriceTreeEditUI.class.getName();
    }

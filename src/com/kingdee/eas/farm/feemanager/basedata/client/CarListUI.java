 ...
 * output class name
 */
public class CarListUI extends AbstractCarListUI
{
	private static final Logger logger = CoreUIObject.getLogger(CarListUI.class);

	/**
	 * output class constructor
	 */
	public CarListUI() throws Exception
	{
		super();
	...
	public CarListUI(EntityViewInfo evi) throws Exception
	{
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception
	{
		...
		ICar  intenface= (ICar) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
			...
			intenface.audit(intenface.getCarInfo(pk));
		}
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
	{
		...
		for(int j=0;j<billIdlist.length;j++){
			// 反核准操作
			IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
			intenface.unAudit(intenface.getCarInfo(pk));		
		}
	...
	{
		return com.kingdee.eas.farm.feemanager.basedata.client.CarTreeEditUI.class.getName();
	}

 ...
 * output class name
 */
public abstract class AbstractOilStandPriceListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOilStandPriceListUI.class);
    ...
    protected ActionUnreview actionUnreview = null;
		...
		public AbstractOilStandPriceListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractOilStandPriceListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOilStandPriceListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.feemanager.basedata.app", "OilStandPriceQuery");
        //actionReview
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.feemanager.basedata.app.OilStandPriceListUIHandler";
	}
...
com.kingdee.eas.farm.feemanager.basedata.OilStandPriceInfo editData = (com.kingdee.eas.farm.feemanager.basedata.OilStandPriceInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.feemanager.basedata.OilStandPriceFactory.getRemoteInstance().unreview(editData);
    ...
    protected class ActionReview extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOilStandPriceListUI.this, "ActionReview", "actionReview_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOilStandPriceListUI.this, "ActionUnreview", "actionUnreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.feemanager.basedata.client", "OilStandPriceListUI");
    }

 ...
 * output class name
 */
public class OilStandPriceListUI extends AbstractOilStandPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OilStandPriceListUI.class);
    
    /**
     * output class constructor
     */
    public OilStandPriceListUI() throws Exception
    {
    ...
    public OilStandPriceListUI(EntityViewInfo evi) throws Exception
    {
...
//        this.setFilterForQuery(fi);
    ...
    {
        return com.kingdee.eas.farm.feemanager.basedata.client.OilStandPriceTreeEditUI.class.getName();
    }

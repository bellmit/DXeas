 ...
 * output class name
 */
public class CarriageFormatEditUI extends AbstractCarriageFormatEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(CarriageFormatEditUI.class);

	/**
	 * output class constructor
	 */
	public CarriageFormatEditUI() throws Exception
	{
		super();
		//图标初始化
	...
	public void setDataObject(IObjectValue dataObject) 
	{
		...
		if(STATUS_ADDNEW.equals(getOprtState())) {
			editData.put("treeid",(com.kingdee.eas.farm.feemanager.basedata.CarriageFormatTreeInfo)getUIContext().get(UIContext.PARENTNODE));
		}
	}

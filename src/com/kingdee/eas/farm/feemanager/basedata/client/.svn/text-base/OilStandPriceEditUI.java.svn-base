 ...
 * output class name
 */
public class OilStandPriceEditUI extends AbstractOilStandPriceEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(OilStandPriceEditUI.class);

	/**
	 * output class constructor
	 */
	public OilStandPriceEditUI() throws Exception {
		super();
		//图标初始化
	...
	public void actionSubmit_actionPerformed(ActionEvent e) throws Exception {
		...
		//System.out.println("财务组织ID"+this.prmtcompanyorgunit.getCurrentCtrlUnit
		// ().getId().toString());

		HashMap<Object, Object> result = CalfrightFacadeFactory
				.getRemoteInstance().oilsjudg(str);
		IRowSet rs = (IRowSet) result.get("result");
		if(rs.size()!=0){
		MsgBox.showWarning("相应时间段已有标准，禁止重复添加！");
		SysUtil.abort();
		}
	...
	public void actionRemove_actionPerformed(ActionEvent e) throws Exception {
		...
		if (FarmCommUtils.checkBillStatus(this.editData.getState(),
				BillBaseStatusEnum.AUDITED)) {
			MsgBox.showWarning("单据已经核审，禁止删除！");
			SysUtil.abort();
		}
	}
	...
	/**
	 * output actionReview_actionPerformed
	 */
	...
	/**
	 * output actionUnreview_actionPerformed
	 */
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.farm.feemanager.basedata.OilStandPriceFactory
				.getRemoteInstance();
	}
	...
	public void setDataObject(IObjectValue dataObject) {
		...
		if (STATUS_ADDNEW.equals(getOprtState())) {
			editData
					.put(
							"treeid",
							(com.kingdee.eas.farm.feemanager.basedata.OilStandPriceTreeInfo) getUIContext()
	...
	protected com.kingdee.bos.dao.IObjectValue createNewData() {
		...
		CompanyOrgUnitInfo companyOrgUnitinfo = (CompanyOrgUnitInfo) prmtcompanyorgunit
				.getValue();

		// String str =
		// "where fCompanyOrgUnitid = '"+companyOrgUnitinfo.getId().
		// toString()+"'";
		String str = SysContext.getSysContext().getCurrentFIUnit().getId()
				.toString();
		System.out.println("财务组织ID："

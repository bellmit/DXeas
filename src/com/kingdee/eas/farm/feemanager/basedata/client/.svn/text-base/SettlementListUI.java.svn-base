 ...
 * output class name
 */
public class SettlementListUI extends AbstractSettlementListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettlementListUI.class);
    
    /**
     * output class constructor
     */
    public SettlementListUI() throws Exception
    {
    ...
    public SettlementListUI(EntityViewInfo evi) throws Exception
    {
...
//        this.setFilterForQuery(fi);
    ...
    {
        return com.kingdee.eas.farm.feemanager.basedata.client.SettlementTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class CarriageFormatListUI extends AbstractCarriageFormatListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CarriageFormatListUI.class);
    
    /**
     * output class constructor
     */
    public CarriageFormatListUI() throws Exception
    {
        super();CompanyOrgUnitInfo currAdminOrg = SysContext.getSysContext().getCurrentFIUnit();
	...
	public CarriageFormatListUI(EntityViewInfo evi) throws Exception
    {
...
//        this.setFilterForQuery(fi);
    ...
    {
        return com.kingdee.eas.farm.feemanager.basedata.client.CarriageFormatTreeEditUI.class.getName();
    }

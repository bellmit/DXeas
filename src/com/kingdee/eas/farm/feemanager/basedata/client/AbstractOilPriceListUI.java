 ...
 * output class name
 */
public abstract class AbstractOilPriceListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOilPriceListUI.class);
    ...
    protected ActionUnreview actionUnreview = null;
		...
		public AbstractOilPriceListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractOilPriceListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOilPriceListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.feemanager.basedata.app", "OilPriceQuery");
        //actionReview
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.feemanager.basedata.app.OilPriceListUIHandler";
	}
...
com.kingdee.eas.farm.feemanager.basedata.OilPriceInfo editData = (com.kingdee.eas.farm.feemanager.basedata.OilPriceInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.feemanager.basedata.OilPriceFactory.getRemoteInstance().unreview(editData);
    ...
    protected class ActionReview extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOilPriceListUI.this, "ActionReview", "actionReview_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOilPriceListUI.this, "ActionUnreview", "actionUnreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.feemanager.basedata.client", "OilPriceListUI");
    }

...
public class CarriageFormatTreeControllerBean extends AbstractCarriageFormatTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.CarriageFormatTreeControllerBean");
}
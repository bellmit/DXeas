...
public class OilStandPriceTreeControllerBean extends AbstractOilStandPriceTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.OilStandPriceTreeControllerBean");
}
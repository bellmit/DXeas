...
public class OilPriceControllerBean extends AbstractOilPriceControllerBean
{
    @Override
	protected void _review(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub
    	OilPriceInfo info = (OilPriceInfo) model;
	...
	private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.OilPriceControllerBean");
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException,
			EASBizException {
		// TODO Auto-generated method stub
		OilPriceInfo info = OilPriceFactory.getLocalInstance(ctx).getOilPriceInfo(pk);
		if (info.getState().equals(BillBaseStatusEnum.AUDITED)) {
	...
	protected IObjectPK _submit(Context ctx, IObjectValue model)
		...
		// TODO Auto-generated method stub
		OilPriceInfo  tinfo=(OilPriceInfo)model;

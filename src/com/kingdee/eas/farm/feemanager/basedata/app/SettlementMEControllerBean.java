...
public class SettlementMEControllerBean extends AbstractSettlementMEControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.SettlementMEControllerBean");
}
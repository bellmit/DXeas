...
public class OilPriceTreeControllerBean extends AbstractOilPriceTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.OilPriceTreeControllerBean");
}
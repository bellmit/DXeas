...
public class SettlementCEControllerBean extends AbstractSettlementCEControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.SettlementCEControllerBean");
}
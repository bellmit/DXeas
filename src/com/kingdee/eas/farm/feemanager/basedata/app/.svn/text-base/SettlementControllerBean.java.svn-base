...
import com.kingdee.eas.farm.feemanager.basedata.SettlementFactory;
...
public class SettlementControllerBean extends AbstractSettlementControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.SettlementControllerBean");

	@Override
	protected void _review(Context ctx, IObjectValue model) throws BOSException {
		// TODO Auto-generated method stub
		SettlementInfo info = (SettlementInfo) model;
	...
	protected IObjectPK _save(Context ctx, IObjectValue model)
		...
		// TODO Auto-generated method stub
		SettlementInfo tinfo=(SettlementInfo)model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException,
			EASBizException {
		// TODO Auto-generated method stub
		SettlementInfo info = SettlementFactory.getLocalInstance(ctx).getSettlementInfo(pk);
		if (info.getState().equals(BillBaseStatusEnum.AUDITED)) {

...
public class DriverTreeControllerBean extends AbstractDriverTreeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.DriverTreeControllerBean");
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		...
		try {
			...
			sql.append(" select count(*) FCount from CT_FM_Driver where FTreeID='").append(pk.toString()).append("'");

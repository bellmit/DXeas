...
public class DriverControllerBeanEx extends com.kingdee.eas.farm.feemanager.basedata.app.DriverControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.feemanager.basedata.app.DriverControllerBeanEx");

...
public class SettlementE extends CoreBillEntryBase implements ISettlementE
{
    public SettlementE()
    {
        super();
        registerInterface(ISettlementE.class, this);
    }
    public SettlementE(Context ctx)
    {
        super(ctx);
        registerInterface(ISettlementE.class, this);
    }
    ...
    private SettlementEController getController() throws BOSException
    {
        return (SettlementEController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSettlementEInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettlementEInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettlementEInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettlementECollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettlementECollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettlementECollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class TransportationrecordAssEntry extends CoreBillEntryBase implements ITransportationrecordAssEntry
{
    public TransportationrecordAssEntry()
    {
        super();
        registerInterface(ITransportationrecordAssEntry.class, this);
    }
    public TransportationrecordAssEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITransportationrecordAssEntry.class, this);
    }
    ...
    private TransportationrecordAssEntryController getController() throws BOSException
    {
        return (TransportationrecordAssEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordAssEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

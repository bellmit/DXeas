...
public class TransportationrecordCarEntry extends CoreBillEntryBase implements ITransportationrecordCarEntry
{
    public TransportationrecordCarEntry()
    {
        super();
        registerInterface(ITransportationrecordCarEntry.class, this);
    }
    public TransportationrecordCarEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITransportationrecordCarEntry.class, this);
    }
    ...
    private TransportationrecordCarEntryController getController() throws BOSException
    {
        return (TransportationrecordCarEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTransportationrecordCarEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
import com.kingdee.eas.farm.rpt.CCTowerFodderDetailPlanRptFacadeFactory;
 ...
 *
 */
public class CCTowerFodderDetailPlanRptDataSource extends AbstractJavaDataSet{
	private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.rpt.app.CCTowerFodderDetailPlanRptDataSource");
...
//	private 
	...
	public IRowSet[] getCustomRowSet(Window parent, String otherDataCenter)
		...
		IRowSet rowset = CCTowerFodderDetailPlanRptFacadeFactory.getRemoteInstance().getRptData(param);

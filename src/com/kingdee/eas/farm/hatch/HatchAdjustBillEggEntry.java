...
public class HatchAdjustBillEggEntry extends CoreBillEntryBase implements IHatchAdjustBillEggEntry
{
    public HatchAdjustBillEggEntry()
    {
        super();
        registerInterface(IHatchAdjustBillEggEntry.class, this);
    }
    public HatchAdjustBillEggEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IHatchAdjustBillEggEntry.class, this);
    }
    ...
    private HatchAdjustBillEggEntryController getController() throws BOSException
    {
        return (HatchAdjustBillEggEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchAdjustBillEggEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

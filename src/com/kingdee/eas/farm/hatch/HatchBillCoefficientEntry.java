...
public class HatchBillCoefficientEntry extends CoreBillEntryBase implements IHatchBillCoefficientEntry
{
    public HatchBillCoefficientEntry()
    {
        super();
        registerInterface(IHatchBillCoefficientEntry.class, this);
    }
    public HatchBillCoefficientEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IHatchBillCoefficientEntry.class, this);
    }
    ...
    private HatchBillCoefficientEntryController getController() throws BOSException
    {
        return (HatchBillCoefficientEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchBillCoefficientEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
import com.kingdee.eas.farm.hatch.HatchEggReceivingBillFactory;
...
public class HatchEggReceivingBillControllerBean extends AbstractHatchEggReceivingBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.hatch.app.HatchEggReceivingBillControllerBean");

	@Override
	protected IObjectPK _save(Context ctx, IObjectValue model)
			throws BOSException, EASBizException {
		// 状态设置为保存
		HatchEggReceivingBillInfo info =  (HatchEggReceivingBillInfo)model;
...
//		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException,
		...
		HatchEggReceivingBillInfo info =  HatchEggReceivingBillFactory.getLocalInstance(ctx).getHatchEggReceivingBillInfo(pk);
		if(BillBaseStatusEnum.AUDITED.equals(info.getBaseStatus())){
	...
	protected IObjectPK _submit(Context ctx, IObjectValue model)
			throws BOSException, EASBizException {
		HatchEggReceivingBillInfo billInfo = (HatchEggReceivingBillInfo)model;
    	if(billInfo != null  && 
	...
	protected void _audit(Context ctx, IObjectValue model) throws BOSException {
		HatchEggReceivingBillInfo billInfo = (HatchEggReceivingBillInfo)model;
			...
			//if(billInfo != null && billInfo.getBaseStatus() != null && BillBaseStatusEnum.SUBMITED.equals(billInfo.getBaseStatus())){
				...
				// 更新单据状态
				AppCommon.updateModelStatus(ctx, "CT_FM_HatchEggReceivingBill", billInfo.getId().toString(), BillBaseStatusEnum.AUDITED);
	...
	protected void _unAudit(Context ctx, IObjectValue model)
		...
		//if(billInfo != null && billInfo.getBaseStatus() != null && BillBaseStatusEnum.AUDITED.equals(billInfo.getBaseStatus())){
			...
			// 更新单据状态
			AppCommon.updateModelStatus(ctx, "CT_FM_HatchEggReceivingBill", billInfo.getId().toString(), BillBaseStatusEnum.TEMPORARILYSAVED);
			billInfo.setBaseStatus( BillBaseStatusEnum.SUBMITED);
		//}else{

 ...
 * output class name
 */
public abstract class AbstractHatchHouseListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHatchHouseListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractHatchHouseListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractHatchHouseListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.hatch.app.HatchHouseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.hatch.client", "HatchHouseListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.hatch.client.HatchHouseEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.hatch.HatchHouseFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.hatch.HatchHouseInfo objectValue = new com.kingdee.eas.farm.hatch.HatchHouseInfo();		
        return objectValue;
    }

 ...
 * output class name
 */
public class HatchBabyBillEditUI extends AbstractHatchBabyBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchBabyBillEditUI.class);
    
    /**
     * output class constructor
     */
    public HatchBabyBillEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
        super.prmttransferBoxBill_dataChanged(e);
    }
    ...
    {
        super.prmtcommercialStoorg_dataChanged(e);
    }

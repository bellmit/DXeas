 ...
 * output class name
 */
public class HatchBillListUI extends AbstractHatchBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchBillListUI.class);
    
    /**
     * output class constructor
     */
    public HatchBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractHatchingBoxListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHatchingBoxListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractHatchingBoxListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractHatchingBoxListUI() throws Exception
    {
        super();
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.hatch.app.HatchingBoxListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.hatch.client", "HatchingBoxListUI");
    }

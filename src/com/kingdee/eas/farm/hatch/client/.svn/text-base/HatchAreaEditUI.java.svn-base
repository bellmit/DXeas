 ...
 * output class name
 */
public class HatchAreaEditUI extends AbstractHatchAreaEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchAreaEditUI.class);
     ...
     */
    public HatchAreaEditUI() throws Exception
    {
        super();
    ...
    private void initUIComp(){
    	...
    	fiSto.getFilterItems().add(new  FilterItemInfo("currStoOrg.id",hatchBaseInfo.getId().toString(),CompareType.EQUALS));

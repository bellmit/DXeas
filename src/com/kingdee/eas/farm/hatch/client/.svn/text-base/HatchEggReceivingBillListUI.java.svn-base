 ...
 * output class name
 */
public class HatchEggReceivingBillListUI extends AbstractHatchEggReceivingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchEggReceivingBillListUI.class);
    
    /**
     * output class constructor
     */
    public HatchEggReceivingBillListUI() throws Exception
    {
        super();
    }
    ...
    public void actionEdit_actionPerformed(ActionEvent e) throws Exception
    {
    	if(this.getBizInterface().getValue(new ObjectUuidPK(getSelectedKeyValue())).get("baseStatus").equals(BillBaseStatusEnum.AUDITED_VALUE)){
			MsgBox.showWarning("µ¥¾ÝÒÑÉóºË£¬½ûÖ¹±à¼­£¡");
			SysUtil.abort();
		}
    ...
    {
    	if(this.getBizInterface().getValue(new ObjectUuidPK(getSelectedKeyValue())).get("baseStatus").equals(BillBaseStatusEnum.AUDITED_VALUE)){
			MsgBox.showWarning("µ¥¾ÝÒÑÉóºË£¬½ûÖ¹É¾³ý£¡");
			SysUtil.abort();
		}

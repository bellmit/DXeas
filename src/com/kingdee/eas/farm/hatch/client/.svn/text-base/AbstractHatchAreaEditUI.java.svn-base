 ...
 * output class name
 */
public abstract class AbstractHatchAreaEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHatchAreaEditUI.class);
    ...
    protected com.kingdee.eas.farm.hatch.HatchAreaInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHatchAreaEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHatchAreaEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,prmthatchFactory,txtDescription,txtSimpleName}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(61, 55, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(61, 88, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(61, 173, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(61, 210, 270, 19));
        this.add(kDLabelContainer4, null);
        conthatchFactory.setBounds(new Rectangle(61, 123, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.hatch.app.HatchAreaEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.hatch.HatchAreaInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.hatch.client", "HatchAreaEditUI");
    }

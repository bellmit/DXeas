 ...
 * output class name
 */
public abstract class AbstractIncubatorEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractIncubatorEditUI.class);
    ...
    protected com.kingdee.eas.farm.hatch.IncubatorInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractIncubatorEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractIncubatorEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(55, 37, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(55, 70, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(49, -215, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(55, 213, 270, 19));
        this.add(kDLabelContainer4, null);
        contmaxQty.setBounds(new Rectangle(55, 103, 270, 19));
        this.add(contmaxQty, null);
        conthatchArea.setBounds(new Rectangle(66, 296, 270, 19));
        this.add(conthatchArea, null);
        conthatchFactory.setBounds(new Rectangle(55, 178, 270, 19));
        this.add(conthatchFactory, null);
        conthatchHouse.setBounds(new Rectangle(55, 136, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.hatch.app.IncubatorEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.hatch.IncubatorInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.hatch.client", "IncubatorEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtmaxQty.getValue())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"最大孵化量"});
		}

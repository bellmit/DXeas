 ...
 * output class name
 */
public class HatchStandardListUI extends AbstractHatchStandardListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchStandardListUI.class);
    
    /**
     * output class constructor
     */
    public HatchStandardListUI() throws Exception
    {
        super();
    }
...
//		super.actionCancelCancel_actionPerformed(e);
    ...
    {
        return com.kingdee.eas.farm.hatch.client.HatchStandardTreeEditUI.class.getName();
    }

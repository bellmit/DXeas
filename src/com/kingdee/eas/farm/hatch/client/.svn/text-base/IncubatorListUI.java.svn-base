...
/**
 * 孵化箱output class name
 */
public class IncubatorListUI extends AbstractIncubatorListUI
{
    private static final Logger logger = CoreUIObject.getLogger(IncubatorListUI.class);
     ...
     */
    public IncubatorListUI() throws Exception
    {
        super();
//        try{
...
//        }
    ...
    {
        return com.kingdee.eas.farm.hatch.client.IncubatorTreeEditUI.class.getName();
    }

...
/**
 * 转雏箱output class name
 */
public class HatchingBoxListUI extends AbstractHatchingBoxListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchingBoxListUI.class);
     ...
     */
    public HatchingBoxListUI() throws Exception
    {
        super();
//        try{
...
//        }
    ...
    {
        return com.kingdee.eas.farm.hatch.client.HatchingBoxTreeEditUI.class.getName();
    }

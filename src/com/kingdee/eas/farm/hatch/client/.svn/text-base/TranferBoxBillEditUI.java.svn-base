 ...
 * output class name
 */
public class TranferBoxBillEditUI extends AbstractTranferBoxBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(TranferBoxBillEditUI.class);
    
    /**
     * output class constructor
     */
    public TranferBoxBillEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
        super.txtfertilizerQty_dataChanged(e);
    }
    ...
    {
        super.txtunFertilizerQty_dataChanged(e);
    }
    ...
    {
        super.txtsmellyLossQty_dataChanged(e);
    }
    ...
    {
        super.txtaddleQty_dataChanged(e);
    }

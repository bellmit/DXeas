 ...
 * output class name
 */
public abstract class AbstractHatchHouseEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHatchHouseEditUI.class);
    ...
    protected com.kingdee.eas.farm.hatch.HatchHouseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHatchHouseEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHatchHouseEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmthatchArea,prmthatchFactory}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(60, 46, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(60, 84, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(60, 163, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(60, 205, 270, 19));
        this.add(kDLabelContainer4, null);
        conthatchArea.setBounds(new Rectangle(46, 323, 270, 19));
        this.add(conthatchArea, null);
        conthatchFactory.setBounds(new Rectangle(60, 125, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.hatch.app.HatchHouseEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.prmthatchArea.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.hatch.HatchHouseInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.hatch.client", "HatchHouseEditUI");
    }

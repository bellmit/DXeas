 ...
 * output class name
 */
public class TranferBoxBillListUI extends AbstractTranferBoxBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TranferBoxBillListUI.class);
    
    /**
     * output class constructor
     */
    public TranferBoxBillListUI() throws Exception
    {
        super();
    }

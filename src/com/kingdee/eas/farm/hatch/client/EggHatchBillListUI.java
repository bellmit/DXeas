 ...
 * output class name
 */
public class EggHatchBillListUI extends AbstractEggHatchBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggHatchBillListUI.class);
    
    /**
     * output class constructor
     */
    public EggHatchBillListUI() throws Exception
    {
        super();
    }

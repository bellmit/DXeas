 ...
 * output class name
 */
public class HatchBabyBillListUI extends AbstractHatchBabyBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchBabyBillListUI.class);
    
    /**
     * output class constructor
     */
    public HatchBabyBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class HatchHouseEditUI extends AbstractHatchHouseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchHouseEditUI.class);
    StorageOrgUnitInfo currStoOrg;  // 当前库存组织
    HatchBaseDataInfo hatchBaseInfo;  // 当前孵化场
    /**
     * output class constructor
     */
    public HatchHouseEditUI() throws Exception
    {
        super();
...
//	        currStoOrg = SysContext.getSysContext().getCurrentStorageUnit();
//	        if(currStoOrg == null){
//	        	MsgBox.showInfo("当前未在任何孵化场，不能操作上孵厅");
//	        	SysUtil.abort();
//	        }
//	        
...
//        }
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.hatch.HatchHouseTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

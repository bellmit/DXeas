 ...
 * output class name
 */
public class HatchHouseListUI extends AbstractHatchHouseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(HatchHouseListUI.class);
    StorageOrgUnitInfo currStoOrg;  // 当前库存组织
	 HatchBaseDataInfo hatchBaseInfo;  // 当前孵化场
    /**
     * output class constructor
     */
    public HatchHouseListUI() throws Exception
    {
        super();
...
//    	// 如果当前在养殖场，则过滤 养殖场
//    	if(currStoOrg != null){
//    		filterInfo.getFilterItems().add(new FilterItemInfo("hatchFactory.name",currStoOrg.getId().toString(),CompareType.EQUALS));
    	filterInfo.getFilterItems().add(new FilterItemInfo("hatchFactory1.name",currStoOrg.getName(),CompareType.EQUALS));
//    	}
    ...
    {
        return com.kingdee.eas.farm.hatch.client.HatchHouseTreeEditUI.class.getName();
    }

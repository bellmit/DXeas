 ...
 * output class name
 */
public class EggCandlingBillListUI extends AbstractEggCandlingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EggCandlingBillListUI.class);
    
    /**
     * output class constructor
     */
    public EggCandlingBillListUI() throws Exception
    {
        super();
    }

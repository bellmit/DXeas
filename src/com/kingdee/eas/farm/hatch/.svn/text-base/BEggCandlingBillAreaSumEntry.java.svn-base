...
public class BEggCandlingBillAreaSumEntry extends CoreBillEntryBase implements IBEggCandlingBillAreaSumEntry
{
    public BEggCandlingBillAreaSumEntry()
    {
        super();
        registerInterface(IBEggCandlingBillAreaSumEntry.class, this);
    }
    public BEggCandlingBillAreaSumEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBEggCandlingBillAreaSumEntry.class, this);
    }
    ...
    private BEggCandlingBillAreaSumEntryController getController() throws BOSException
    {
        return (BEggCandlingBillAreaSumEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBEggCandlingBillAreaSumEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class HatchStandardEntry extends CoreBillEntryBase implements IHatchStandardEntry
{
    public HatchStandardEntry()
    {
        super();
        registerInterface(IHatchStandardEntry.class, this);
    }
    public HatchStandardEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IHatchStandardEntry.class, this);
    }
    ...
    private HatchStandardEntryController getController() throws BOSException
    {
        return (HatchStandardEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getHatchStandardEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchStandardEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchStandardEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchStandardEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchStandardEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHatchStandardEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class BHatchBabyBillSourceEntry extends CoreBillEntryBase implements IBHatchBabyBillSourceEntry
{
    public BHatchBabyBillSourceEntry()
    {
        super();
        registerInterface(IBHatchBabyBillSourceEntry.class, this);
    }
    public BHatchBabyBillSourceEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBHatchBabyBillSourceEntry.class, this);
    }
    ...
    private BHatchBabyBillSourceEntryController getController() throws BOSException
    {
        return (BHatchBabyBillSourceEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillSourceEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

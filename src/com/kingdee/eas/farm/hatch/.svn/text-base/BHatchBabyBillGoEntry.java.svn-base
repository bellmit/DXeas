...
public class BHatchBabyBillGoEntry extends CoreBillEntryBase implements IBHatchBabyBillGoEntry
{
    public BHatchBabyBillGoEntry()
    {
        super();
        registerInterface(IBHatchBabyBillGoEntry.class, this);
    }
    public BHatchBabyBillGoEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBHatchBabyBillGoEntry.class, this);
    }
    ...
    private BHatchBabyBillGoEntryController getController() throws BOSException
    {
        return (BHatchBabyBillGoEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBHatchBabyBillGoEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

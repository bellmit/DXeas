...
public class EggHatchBillEntryEggEntry extends CoreBillEntryBase implements IEggHatchBillEntryEggEntry
{
    public EggHatchBillEntryEggEntry()
    {
        super();
        registerInterface(IEggHatchBillEntryEggEntry.class, this);
    }
    public EggHatchBillEntryEggEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEggHatchBillEntryEggEntry.class, this);
    }
    ...
    private EggHatchBillEntryEggEntryController getController() throws BOSException
    {
        return (EggHatchBillEntryEggEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEggHatchBillEntryEggEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

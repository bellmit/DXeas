...
public class billStatus extends StringEnum
{
    ...
    public static final String CANCELCANCEL_VALUE = "4";//alias=启用
    public static final String CANCEL_VALUE = "5";//alias=禁用

    public static final billStatus Addnew = new billStatus("Addnew", ADDNEW_VALUE);

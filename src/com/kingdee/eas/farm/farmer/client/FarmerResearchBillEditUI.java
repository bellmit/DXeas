 ...
 * output class name
 */
public class FarmerResearchBillEditUI extends AbstractFarmerResearchBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerResearchBillEditUI.class);
    
    /**
     * output class constructor
     */
    public FarmerResearchBillEditUI() throws Exception
    {
        super();
    }
    /**

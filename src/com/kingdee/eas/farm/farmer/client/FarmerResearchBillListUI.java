 ...
 * output class name
 */
public class FarmerResearchBillListUI extends AbstractFarmerResearchBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerResearchBillListUI.class);
    
    /**
     * output class constructor
     */
    public FarmerResearchBillListUI() throws Exception
    {
        super();
    }

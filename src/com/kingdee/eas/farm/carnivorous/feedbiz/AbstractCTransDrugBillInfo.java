...
public class AbstractCTransDrugBillInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractCTransDrugBillInfo()
    {
        this("id");
    }
    protected AbstractCTransDrugBillInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.farm.carnivorous.feedbiz.CTransDrugBillEntryCollection());
    }
    /**
     * Object: 药品调整单 's 分录 property 
     */
    public com.kingdee.eas.farm.carnivorous.feedbiz.CTransDrugBillEntryCollection getEntrys()
    {
        return (com.kingdee.eas.farm.carnivorous.feedbiz.CTransDrugBillEntryCollection)get("entrys");
    }
    /**
     * Object:药品调整单's 是否生成凭证property 
     */
    ...
    /**
     * Object: 药品调整单 's 调入批次合同 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调出批次合同 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调出养殖品种 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调入养殖品种 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调出户业务员 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调入户业务员 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调入成本中心 property 
     */
    ...
    /**
     * Object: 药品调整单 's 调出成本中心 property 
     */

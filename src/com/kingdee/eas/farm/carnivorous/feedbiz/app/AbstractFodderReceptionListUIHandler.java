 ...
 * output class name
 */
public abstract class AbstractFodderReceptionListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionViewStdUse(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewStdUse(request,response,context);
	}
	protected void _handleActionViewStdUse(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

 ...
 * output class name
 */
public abstract class AbstractConFeedContractListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionUpdateFeed(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionUpdateFeed(request,response,context);
	}
	protected void _handleActionUpdateFeed(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}
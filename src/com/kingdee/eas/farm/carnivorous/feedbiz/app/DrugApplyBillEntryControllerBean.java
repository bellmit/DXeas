...
public class DrugApplyBillEntryControllerBean extends AbstractDrugApplyBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.feedbiz.app.DrugApplyBillEntryControllerBean");
}
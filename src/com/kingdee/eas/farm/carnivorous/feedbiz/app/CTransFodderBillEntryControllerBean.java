...
public class CTransFodderBillEntryControllerBean extends AbstractCTransFodderBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.feedbiz.app.CTransFodderBillEntryControllerBean");
}
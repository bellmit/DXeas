...
public class DrugReceiveBillEntryControllerBean extends AbstractDrugReceiveBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.feedbiz.app.DrugReceiveBillEntryControllerBean");
}
...
public class BatchContractBillControllerBeanEx extends com.kingdee.eas.farm.carnivorous.feedbiz.app.BatchContractBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.feedbiz.app.BatchContractBillControllerBeanEx");
    protected void _viewGuaranteeBill(Context ctx, IObjectValue model)throws BOSException
    {
	     super._viewGuaranteeBill(ctx, model);
    }
}				

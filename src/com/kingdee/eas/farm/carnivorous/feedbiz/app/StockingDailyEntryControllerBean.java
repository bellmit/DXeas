...
public class StockingDailyEntryControllerBean extends AbstractStockingDailyEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.feedbiz.app.StockingDailyEntryControllerBean");
}
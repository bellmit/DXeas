 ...
 * output class name
 */
public abstract class AbstractViewFeedUseUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractViewFeedUseUI.class);
     ...
     */
    public AbstractViewFeedUseUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractViewFeedUseUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 250, 200));
        this.setLayout(null);
        kDTextArea1.setBounds(new Rectangle(9, 7, 233, 183));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.feedbiz.app.ViewFeedUseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.feedbiz.client", "ViewFeedUseUI");
    }

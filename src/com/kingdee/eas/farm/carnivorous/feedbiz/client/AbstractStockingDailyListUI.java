 ...
 * output class name
 */
public abstract class AbstractStockingDailyListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStockingDailyListUI.class);
     ...
     */
    public AbstractStockingDailyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStockingDailyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.feedbiz.app", "StockingDailyQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.feedbiz.app.StockingDailyListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("batch.baseStatus"));
...
com.kingdee.eas.farm.carnivorous.feedbiz.StockingDailyInfo editData = (com.kingdee.eas.farm.carnivorous.feedbiz.StockingDailyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.carnivorous.feedbiz.StockingDailyFactory.getRemoteInstance().reShareCoalAndDiesel(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionGenNextBill extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionGenNextBill", "actionGenNextBill_actionPerformed", e);
        }
    }
    ...
    protected class ActionReShareCoalAndDiesel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStockingDailyListUI.this, "ActionReShareCoalAndDiesel", "actionReShareCoalAndDiesel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.feedbiz.client", "StockingDailyListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","company.name","week","weekDay","description","isInit","baseStatus","dieselFual","coalFual","electricityQty","outSideTFrom","outSideTTo","outHumidityFrom","outHumidityTo","weather","creator.name","createTime","auditor.name","auditTime","fuel","lastUpdateTime","auditor.number","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","transInQty","farmer.name","batch.baseStatus","farm.name"};
    }

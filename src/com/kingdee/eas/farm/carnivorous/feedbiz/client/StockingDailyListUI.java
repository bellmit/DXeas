 ...
 * output class name
 */
public class StockingDailyListUI extends AbstractStockingDailyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StockingDailyListUI.class);
    
    /**
     * output class constructor
     */
    public StockingDailyListUI() throws Exception
    {
        super();
    }
	@Override
    ...
    /**
     * output actionReShareCoalAndDiesel_actionPerformed
     */
    public void actionReShareCoalAndDiesel_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionReShareCoalAndDiesel_actionPerformed(e);
    }

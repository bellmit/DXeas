 ...
 * output class name
 */
public abstract class AbstractAddDriverUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAddDriverUI.class);
     ...
     */
    public AbstractAddDriverUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAddDriverUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contDriver.setBounds(new Rectangle(22, 43, 270, 19));
        this.add(contDriver, null);
        btnConfirm.setBounds(new Rectangle(113, 105, 73, 21));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.feedbiz.app.AddDriverUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.feedbiz.client", "AddDriverUI");
    }

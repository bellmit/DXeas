 ...
 * output class name
 */
public abstract class AbstractBatchAndInv extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBatchAndInv.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kDTable1;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton kDWorkButton1;
    /**
     * output class constructor
     */
    public AbstractBatchAndInv() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBatchAndInv.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDTable1.setBounds(new Rectangle(35, 18, 344, 594));
        this.add(kDTable1, null);
        kDWorkButton1.setBounds(new Rectangle(468, 22, 195, 72));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.feedbiz.app.BatchAndInvHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.feedbiz.client", "BatchAndInv");
    }

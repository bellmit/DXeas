 ...
 * output class name
 */
public class CTransDrugBillListUI extends AbstractCTransDrugBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CTransDrugBillListUI.class);
    
    /**
     * output class constructor
     */
    public CTransDrugBillListUI() throws Exception
    {
        super();
    }

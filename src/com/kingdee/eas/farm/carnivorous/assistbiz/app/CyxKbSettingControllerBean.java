...
import com.kingdee.eas.farm.carnivorous.assistbiz.CyxKbSettingFactory;
...
public class CyxKbSettingControllerBean extends AbstractCyxKbSettingControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.assistbiz.app.CyxKbSettingControllerBean");
    
    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		CyxKbSettingInfo info = (CyxKbSettingInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		CyxKbSettingInfo info = CyxKbSettingFactory.getLocalInstance(ctx).getCyxKbSettingInfo(pk);

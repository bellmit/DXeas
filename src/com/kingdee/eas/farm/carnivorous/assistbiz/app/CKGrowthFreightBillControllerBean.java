...
public class CKGrowthFreightBillControllerBean extends AbstractCKGrowthFreightBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.assistbiz.app.CKGrowthFreightBillControllerBean");
    
    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		CKGrowthFreightBillInfo info = (CKGrowthFreightBillInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		CKGrowthFreightBillInfo info = CKGrowthFreightBillFactory.getLocalInstance(ctx).getCKGrowthFreightBillInfo(pk);

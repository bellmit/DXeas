 ...
 * output class name
 */
public class CKGrowthFreightBillEditUI extends AbstractCKGrowthFreightBillEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(CKGrowthFreightBillEditUI.class);

	/**
	 * output class constructor
	 */
	public CKGrowthFreightBillEditUI() throws Exception
	{
		super();
	}
	@Override

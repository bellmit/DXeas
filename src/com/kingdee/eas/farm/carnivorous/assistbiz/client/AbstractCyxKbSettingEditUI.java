 ...
 * output class name
 */
public abstract class AbstractCyxKbSettingEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCyxKbSettingEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contQCItem;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtQCItem;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.eas.farm.carnivorous.assistbiz.CyxKbSettingInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractCyxKbSettingEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCyxKbSettingEditUI.class.getName());
        ...
        this.contQCItem = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtQCItem = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contQCItem.setName("contQCItem");
        ...
        this.prmtQCItem.setName("prmtQCItem");
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;int</c:NumberFormat></c:Style><c:Style id=\"sCol1\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol2\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style><c:Style id=\"sCol3\"><c:NumberFormat>&amp;double</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"seq\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"minValue\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol1\" /><t:Column t:key=\"maxValue\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol2\" /><t:Column t:key=\"kbAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"true\" t:index=\"-1\" t:styleID=\"sCol3\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{seq}</t:Cell><t:Cell>$Resource{minValue}</t:Cell><t:Cell>$Resource{maxValue}</t:Cell><t:Cell>$Resource{kbAmount}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
		
        this.kdtEntrys.setFormatXml(resHelper.translateString("kdtEntrys",kdtEntrysStrXML));

                this.kdtEntrys.putBindContents("editData",new String[] {"seq","minValue","maxValue","kbAmount"});
        ...
        KDFormattedTextField kdtEntrys_kbAmount_TextField = new KDFormattedTextField();
        kdtEntrys_kbAmount_TextField.setName("kdtEntrys_kbAmount_TextField");
        kdtEntrys_kbAmount_TextField.setVisible(true);
        kdtEntrys_kbAmount_TextField.setEditable(true);
        kdtEntrys_kbAmount_TextField.setHorizontalAlignment(2);
        kdtEntrys_kbAmount_TextField.setDataType(1);
        	kdtEntrys_kbAmount_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_kbAmount_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_kbAmount_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_kbAmount_CellEditor = new KDTDefaultCellEditor(kdtEntrys_kbAmount_TextField);
        this.kdtEntrys.getColumn("kbAmount").setEditor(kdtEntrys_kbAmount_CellEditor);
        // contcustomer		
        ...
        // contQCItem		
        this.contQCItem.setBoundLabelText(resHelper.getString("contQCItem.boundLabelText"));		
        this.contQCItem.setBoundLabelLength(100);		
        this.contQCItem.setBoundLabelUnderline(true);		
        this.contQCItem.setVisible(true);
        // txtNumber		
        ...
        // prmtQCItem		
        this.prmtQCItem.setQueryInfo("com.kingdee.eas.farm.carnivorous.basedata.app.RewardAndPunishItemQuery");		
        this.prmtQCItem.setVisible(true);		
        this.prmtQCItem.setEditable(true);		
        this.prmtQCItem.setDisplayFormat("$name$");		
        this.prmtQCItem.setEditFormat("$number$");		
        this.prmtQCItem.setCommitFormat("$number$");		
        this.prmtQCItem.setRequired(true);
        		EntityViewInfo eviprmtQCItem = new EntityViewInfo ();
		eviprmtQCItem.setFilter(com.kingdee.eas.framework.FrameWorkUtils.getF7FilterInfoByAuthorizedOrg(com.kingdee.eas.basedata.org.OrgType.getEnum("Company"),"FICompany.id"));
		prmtQCItem.setEntityViewInfo(eviprmtQCItem);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtbreedData,baseStatus,kdtEntrys,txtDescription,txtNumber,prmtFICompany,prmtcustomer,prmtQCItem}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 766, 644));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 766, 644));
        kDLabelContainer1.setBounds(new Rectangle(58, 23, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(58, 23, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer4.setBounds(new Rectangle(58, 155, 641, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(58, 155, 641, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFICompany.setBounds(new Rectangle(58, 67, 270, 19));
        this.add(contFICompany, new KDLayout.Constraints(58, 67, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbreedData.setBounds(new Rectangle(438, 67, 270, 19));
        this.add(contbreedData, new KDLayout.Constraints(438, 67, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbaseStatus.setBounds(new Rectangle(438, 23, 270, 19));
        this.add(contbaseStatus, new KDLayout.Constraints(438, 23, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(53, 211, 655, 403));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.carnivorous.assistbiz.CyxKbSettingEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(53, 211, 655, 403, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contcustomer.setBounds(new Rectangle(58, 111, 270, 19));
        this.add(contcustomer, new KDLayout.Constraints(58, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contQCItem.setBounds(new Rectangle(438, 111, 270, 19));
        this.add(contQCItem, new KDLayout.Constraints(438, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDLabelContainer1
        ...
        //contQCItem
        contQCItem.setBoundEditor(prmtQCItem);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.farm.carnivorous.assistbiz.CyxKbSettingEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("Entrys.kbAmount", java.math.BigDecimal.class, this.kdtEntrys, "kbAmount.text");
		...
		dataBinder.registerBinding("QCItem", com.kingdee.eas.farm.carnivorous.basedata.RewardAndPunishItemInfo.class, this.prmtQCItem, "data");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.assistbiz.app.CyxKbSettingEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.assistbiz.CyxKbSettingInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("Entrys.kbAmount", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("QCItem", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("Entrys.kbAmount"));
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
        	...
        	sic.add(new SelectorItemInfo("QCItem.id"));
        	sic.add(new SelectorItemInfo("QCItem.number"));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCyxKbSettingEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCyxKbSettingEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.assistbiz.client", "CyxKbSettingEditUI");
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		for (int i=0,n=kdtEntrys.getRowCount();i<n;i++) {
			if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(kdtEntrys.getCell(i,"kbAmount").getValue())) {
				throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"扣补金额"});
			}
		}
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtQCItem.getData())) {

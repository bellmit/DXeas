...
import com.kingdee.eas.farm.carnivorous.assistbiz.IFreightMileageBill;
 ...
 * output class name
 */
public class FreightMileageBillListUI extends AbstractFreightMileageBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FreightMileageBillListUI.class);
    
    /**
     * output class constructor
     */
    public FreightMileageBillListUI() throws Exception
    {
        super();
    }
 ...
 /**
    ...
    {
		IFreightMileageBill  intenface= (IFreightMileageBill) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
			...
			intenface.audit(intenface.getFreightMileageBillInfo(pk));
		}
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getFreightMileageBillInfo(pk));		
		}

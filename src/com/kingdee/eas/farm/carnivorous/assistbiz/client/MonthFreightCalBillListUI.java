 ...
 * output class name
 */
public class MonthFreightCalBillListUI extends AbstractMonthFreightCalBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthFreightCalBillListUI.class);
    
    /**
     * output class constructor
     */
    public MonthFreightCalBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class CyxKbSettingEditUI extends AbstractCyxKbSettingEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(CyxKbSettingEditUI.class);
	private F7ContextManager f7Manager;

	/**
	 * output class constructor
	 */
	public CyxKbSettingEditUI() throws Exception
	{
		super();
	}
	@Override
	...
	protected void beforeStoreFields(ActionEvent arg0) throws Exception {
		...
		for(int i=0;i<kdtEntrys.getRowCount();i++){
			if(kdtEntrys.getCell(i, "minValue").getValue()==null||kdtEntrys.getCell(i, "maxValue").getValue()==null){
				MsgBox.showWarning("起始值和终止值不能为空(可填0)");
				SysUtil.abort();
			}
		}
	}

...
public class CKGrowthFreightBillEntry extends CoreBillEntryBase implements ICKGrowthFreightBillEntry
{
    public CKGrowthFreightBillEntry()
    {
        super();
        registerInterface(ICKGrowthFreightBillEntry.class, this);
    }
    public CKGrowthFreightBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKGrowthFreightBillEntry.class, this);
    }
    ...
    private CKGrowthFreightBillEntryController getController() throws BOSException
    {
        return (CKGrowthFreightBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKGrowthFreightBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

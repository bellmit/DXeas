...
public class ChickenRecBillButcherEntry extends CoreBillEntryBase implements IChickenRecBillButcherEntry
{
    public ChickenRecBillButcherEntry()
    {
        super();
        registerInterface(IChickenRecBillButcherEntry.class, this);
    }
    public ChickenRecBillButcherEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChickenRecBillButcherEntry.class, this);
    }
    ...
    private ChickenRecBillButcherEntryController getController() throws BOSException
    {
        return (ChickenRecBillButcherEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillButcherEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

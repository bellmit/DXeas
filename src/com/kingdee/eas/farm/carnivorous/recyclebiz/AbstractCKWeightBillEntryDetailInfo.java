...
public class AbstractCKWeightBillEntryDetailInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCKWeightBillEntryDetailInfo()
    {
        this("id");
    }
    protected AbstractCKWeightBillEntryDetailInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.farm.carnivorous.recyclebiz.CKWeightBillEntryInfo getParent1()
    {
        return (com.kingdee.eas.farm.carnivorous.recyclebiz.CKWeightBillEntryInfo)get("parent1");
    }
    public void setParent1(com.kingdee.eas.farm.carnivorous.recyclebiz.CKWeightBillEntryInfo item)
    {
        put("parent1", item);
    }
    /**

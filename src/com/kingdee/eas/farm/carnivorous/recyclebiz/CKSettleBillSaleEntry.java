...
public class CKSettleBillSaleEntry extends CoreBillEntryBase implements ICKSettleBillSaleEntry
{
    public CKSettleBillSaleEntry()
    {
        super();
        registerInterface(ICKSettleBillSaleEntry.class, this);
    }
    public CKSettleBillSaleEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKSettleBillSaleEntry.class, this);
    }
    ...
    private CKSettleBillSaleEntryController getController() throws BOSException
    {
        return (CKSettleBillSaleEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillSaleEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

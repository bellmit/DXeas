...
public class ChickenRecBillEntry extends CoreBillEntryBase implements IChickenRecBillEntry
{
    public ChickenRecBillEntry()
    {
        super();
        registerInterface(IChickenRecBillEntry.class, this);
    }
    public ChickenRecBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChickenRecBillEntry.class, this);
    }
    ...
    private ChickenRecBillEntryController getController() throws BOSException
    {
        return (ChickenRecBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChickenRecBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

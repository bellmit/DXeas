...
public class CKSettleBillOtherEntry extends CoreBillEntryBase implements ICKSettleBillOtherEntry
{
    public CKSettleBillOtherEntry()
    {
        super();
        registerInterface(ICKSettleBillOtherEntry.class, this);
    }
    public CKSettleBillOtherEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKSettleBillOtherEntry.class, this);
    }
    ...
    private CKSettleBillOtherEntryController getController() throws BOSException
    {
        return (CKSettleBillOtherEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillOtherEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

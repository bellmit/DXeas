...
public class CKSettleBillQCEntry extends CoreBillEntryBase implements ICKSettleBillQCEntry
{
    public CKSettleBillQCEntry()
    {
        super();
        registerInterface(ICKSettleBillQCEntry.class, this);
    }
    public CKSettleBillQCEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKSettleBillQCEntry.class, this);
    }
    ...
    private CKSettleBillQCEntryController getController() throws BOSException
    {
        return (CKSettleBillQCEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillQCEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

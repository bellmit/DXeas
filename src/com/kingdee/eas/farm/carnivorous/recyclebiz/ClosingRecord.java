...
public class ClosingRecord extends AbstractBizCtrl implements IClosingRecord
{
    public ClosingRecord()
    {
        super();
        registerInterface(IClosingRecord.class, this);
    }
    public ClosingRecord(Context ctx)
    {
        super(ctx);
        registerInterface(IClosingRecord.class, this);
    }
    ...
    private ClosingRecordController getController() throws BOSException
    {
        return (ClosingRecordController)getBizController();
    }
    /**

...
public class CSlaughterBillQCEntry extends CoreBillEntryBase implements ICSlaughterBillQCEntry
{
    public CSlaughterBillQCEntry()
    {
        super();
        registerInterface(ICSlaughterBillQCEntry.class, this);
    }
    public CSlaughterBillQCEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICSlaughterBillQCEntry.class, this);
    }
    ...
    private CSlaughterBillQCEntryController getController() throws BOSException
    {
        return (CSlaughterBillQCEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCSlaughterBillQCEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

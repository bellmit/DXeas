...
public class ChickenRecBillWeigntEntry extends CoreBillEntryBase implements IChickenRecBillWeigntEntry
{
    public ChickenRecBillWeigntEntry()
    {
        super();
        registerInterface(IChickenRecBillWeigntEntry.class, this);
    }
    public ChickenRecBillWeigntEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChickenRecBillWeigntEntry.class, this);
    }
    ...
    private ChickenRecBillWeigntEntryController getController() throws BOSException
    {
        return (ChickenRecBillWeigntEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChickenRecBillWeigntEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

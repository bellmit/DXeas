 ...
 * output class name
 */
public class LiveBirdWgtBillListUI extends AbstractLiveBirdWgtBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LiveBirdWgtBillListUI.class);
    
    /**
     * output class constructor
     */
    public LiveBirdWgtBillListUI() throws Exception
    {
        super();
    }

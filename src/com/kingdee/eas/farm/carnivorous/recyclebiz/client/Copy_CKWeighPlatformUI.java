 ...
 * output class name
 */
public class Copy_CKWeighPlatformUI extends AbstractCopy_CKWeighPlatformUI
{
    private static final Logger logger = CoreUIObject.getLogger(Copy_CKWeighPlatformUI.class);
    
    /**
     * output class constructor
     */
    public Copy_CKWeighPlatformUI() throws Exception
    {
        super();
    }
    ...
    {
        super.btnShowOrder_actionPerformed(e);
    }
    ...
    {
        super.btnAllSave_actionPerformed(e);
    }
    ...
    {
        super.btnWeight_actionPerformed(e);
    }

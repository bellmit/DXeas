 ...
 * output class name
 */
public abstract class AbstractMarketFilterUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtYieldRate1;
     ...
     */
    public AbstractMarketFilterUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketFilterUI.class.getName());
        ...
        this.txtYieldRate1 = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.txtYieldRate1.setName("txtYieldRate1");
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contMarketPrice.setBounds(new Rectangle(17, 38, 270, 19));
        this.add(contMarketPrice, null);
        contYieldRate.setBounds(new Rectangle(17, 102, 270, 19));
        this.add(contYieldRate, null);
        btnConfirm.setBounds(new Rectangle(93, 153, 87, 21));
        this.add(btnConfirm, null);
        txtYieldRate1.setBounds(new Rectangle(117, 102, 170, 19));
        this.add(txtYieldRate1, null);
        //contMarketPrice
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.MarketFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "MarketFilterUI");
    }

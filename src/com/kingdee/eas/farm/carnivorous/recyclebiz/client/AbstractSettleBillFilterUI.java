 ...
 * output class name
 */
public abstract class AbstractSettleBillFilterUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSettleBillFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDButton all;
    protected com.kingdee.bos.ctrl.swing.KDButton btnNull;
    protected com.kingdee.bos.ctrl.swing.KDButton btnAnti;
    protected com.kingdee.bos.ctrl.swing.KDButton btnBegin;
    protected com.kingdee.eas.framework.CoreBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSettleBillFilterUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSettleBillFilterUI.class.getName());
        ...
        this.all = new com.kingdee.bos.ctrl.swing.KDButton();
        this.btnNull = new com.kingdee.bos.ctrl.swing.KDButton();
        this.btnAnti = new com.kingdee.bos.ctrl.swing.KDButton();
        ...
        this.btnNull.setName("btnNull");
        this.btnAnti.setName("btnAnti");
        ...
        // kDPanel1		
        this.kDPanel1.setBorder(BorderFactory.createLineBorder(Color.black));
        // kDTable1
		String kDTable1StrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"select\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"0\" /><t:Column t:key=\"batch\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"1\" /><t:Column t:key=\"farmer\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"2\" /><t:Column t:key=\"farm\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{select}</t:Cell><t:Cell>$Resource{batch}</t:Cell><t:Cell>$Resource{farmer}</t:Cell><t:Cell>$Resource{farm}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        // btnNull		
        this.btnNull.setText(resHelper.getString("btnNull.text"));
        // btnAnti		
        this.btnAnti.setText(resHelper.getString("btnAnti.text"));
        // btnBegin		
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contBeginDate.setBounds(new Rectangle(14, 30, 270, 19));
        this.add(contBeginDate, null);
        contEndDate.setBounds(new Rectangle(344, 29, 270, 19));
        this.add(contEndDate, null);
        btnConfirm.setBounds(new Rectangle(694, 26, 73, 21));
        this.add(btnConfirm, null);
        kDPanel1.setBounds(new Rectangle(26, 87, 744, 37));
        this.add(kDPanel1, null);
        kDTable1.setBounds(new Rectangle(26, 127, 744, 444));
        ...
        //kDPanel1
        kDPanel1.setLayout(null);        kDLabel1.setBounds(new Rectangle(333, 10, 310, 19));
        kDPanel1.add(kDLabel1, null);
        all.setBounds(new Rectangle(18, 10, 73, 21));
        kDPanel1.add(all, null);
        btnNull.setBounds(new Rectangle(126, 10, 73, 21));
        kDPanel1.add(btnNull, null);
        btnAnti.setBounds(new Rectangle(223, 10, 73, 21));
        kDPanel1.add(btnAnti, null);
        btnBegin.setBounds(new Rectangle(645, 6, 90, 21));
        kDPanel1.add(btnBegin, null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.SettleBillFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "SettleBillFilterUI");
    }

 ...
 * output class name
 */
public abstract class AbstractLiveBirdWgtBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLiveBirdWgtBillListUI.class);
     ...
     */
    public AbstractLiveBirdWgtBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLiveBirdWgtBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.app", "LiveBirdWgtBillQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.LiveBirdWgtBillListUIHandler";
	}
...
com.kingdee.eas.farm.carnivorous.recyclebiz.LiveBirdWgtBillInfo editData = (com.kingdee.eas.farm.carnivorous.recyclebiz.LiveBirdWgtBillInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.carnivorous.recyclebiz.LiveBirdWgtBillFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLiveBirdWgtBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLiveBirdWgtBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLiveBirdWgtBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLiveBirdWgtBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "LiveBirdWgtBillListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","FICompany.name","auditTime","farmer.name","farm.name","batchContract.number","batch.name","billStatus","settlePolicy.name","inDate","batchQty","carTimes","roadLine.name","preHouseTare","preHouseGross","preHouseSuttle","deathQty","preHouseQty","deathWgt","socialQty","socialWgt","overWgtQty","overWgtWgt","settleQty","averageWgt","SaleEntrys.purchaseOrg.name","SaleEntrys.customer.name","SaleEntrys.car.number","SaleEntrys.driver.drivername","person.name"};
    }

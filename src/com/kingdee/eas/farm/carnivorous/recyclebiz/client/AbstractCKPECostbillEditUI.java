 ...
 * output class name
 */
public abstract class AbstractCKPECostbillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCKPECostbillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpeCost;
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkisNextPeriod;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtpeCost;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtbreedData;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtcompany;
    protected com.kingdee.eas.farm.carnivorous.recyclebiz.CKPECostbillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCKPECostbillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCKPECostbillEditUI.class.getName());
        ...
        this.contpeCost = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.chkisNextPeriod = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.txtpeCost = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.txtpeCost.setName("txtpeCost");
        ...
        // contpeCost		
        this.contpeCost.setBoundLabelText(resHelper.getString("contpeCost.boundLabelText"));		
        this.contpeCost.setBoundLabelLength(100);		
        this.contpeCost.setBoundLabelUnderline(true);		
        this.contpeCost.setVisible(true);
        // kDSeparator8
        // chkFivouchered		
        ...
        // chkisNextPeriod		
        this.chkisNextPeriod.setText(resHelper.getString("chkisNextPeriod.text"));		
        this.chkisNextPeriod.setVisible(true);		
        this.chkisNextPeriod.setHorizontalAlignment(2);		
        this.chkisNextPeriod.setEnabled(false);
        // prmtCreator		
        ...
        // txtunitCost		
        this.txtunitCost.setVisible(true);		
        ...
        // txtpeCost		
        this.txtpeCost.setVisible(true);		
        this.txtpeCost.setHorizontalAlignment(2);		
        this.txtpeCost.setDataType(1);		
        this.txtpeCost.setSupportedEmpty(true);		
        this.txtpeCost.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtpeCost.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtpeCost.setPrecision(2);		
        this.txtpeCost.setRequired(false);		
        this.txtpeCost.setEnabled(false);
        // prmtbreedData		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtperiod,prmtfarmer,prmtfarm,prmtbatchContract,txtsettleWgt,txtunitCost,txtpeCost,prmtbreedData,prmtcompany,chkisNextPeriod}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 480));
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(41, 400, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(331, 400, 270, 19));
        this.add(contCreateTime, null);
        contLastUpdateUser.setBounds(new Rectangle(41, 431, 270, 19));
        this.add(contLastUpdateUser, null);
        contLastUpdateTime.setBounds(new Rectangle(331, 431, 270, 19));
        this.add(contLastUpdateTime, null);
        contNumber.setBounds(new Rectangle(24, 37, 270, 19));
        this.add(contNumber, null);
        contperiod.setBounds(new Rectangle(375, 37, 270, 19));
        this.add(contperiod, null);
        contfarmer.setBounds(new Rectangle(24, 94, 270, 19));
        this.add(contfarmer, null);
        contfarm.setBounds(new Rectangle(375, 94, 270, 19));
        this.add(contfarm, null);
        contbatchContract.setBounds(new Rectangle(701, 94, 270, 19));
        this.add(contbatchContract, null);
        contsettleWgt.setBounds(new Rectangle(701, 151, 270, 19));
        this.add(contsettleWgt, null);
        contunitCost.setBounds(new Rectangle(375, 151, 270, 19));
        this.add(contunitCost, null);
        contpeCost.setBounds(new Rectangle(24, 209, 270, 19));
        this.add(contpeCost, null);
        kDSeparator8.setBounds(new Rectangle(-8, 374, 1034, 8));
        this.add(kDSeparator8, null);
        chkFivouchered.setBounds(new Rectangle(375, 209, 157, 19));
        this.add(chkFivouchered, null);
        contbreedData.setBounds(new Rectangle(24, 151, 270, 19));
        this.add(contbreedData, null);
        contcompany.setBounds(new Rectangle(701, 37, 270, 19));
        this.add(contcompany, null);
        chkisNextPeriod.setBounds(new Rectangle(701, 209, 270, 19));
        this.add(chkisNextPeriod, null);
        //contCreator
        ...
        //contpeCost
        contpeCost.setBoundEditor(txtpeCost);
        //contbreedData
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("isNextPeriod", boolean.class, this.chkisNextPeriod, "selected");
		...
		dataBinder.registerBinding("peCost", java.math.BigDecimal.class, this.txtpeCost, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKPECostbillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.recyclebiz.CKPECostbillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isNextPeriod", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("peCost", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "CKPECostbillEditUI");
    }
    /**

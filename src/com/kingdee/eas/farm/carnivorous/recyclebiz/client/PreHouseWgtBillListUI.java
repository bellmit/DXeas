 ...
 * output class name
 */
public class PreHouseWgtBillListUI extends AbstractPreHouseWgtBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PreHouseWgtBillListUI.class);
    
    /**
     * output class constructor
     */
    public PreHouseWgtBillListUI() throws Exception
    {
        super();
	...
	{	
		...
		IPreHouseWgtBill iBill = PreHouseWgtBillFactory.getRemoteInstance();
		PreHouseWgtBillInfo info;
		int num=selIDs.length;
		String error="";
		for (int i = 0;i<selIDs.length; i++) {
			info = iBill.getPreHouseWgtBillInfo(new ObjectUuidPK(selIDs[i]));
    ...
    private void initControl() throws Exception{
		...
		this.tblMain.getColumn("actualArriveTime").getStyleAttributes().setNumberFormat("yyyy-MM-dd HH:mm:ss");
	}
	/**
	 * 行选择 改变事件
	 * @param rowIndex

 ...
 * output class name
 */
public class CKPECostbillListUI extends AbstractCKPECostbillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CKPECostbillListUI.class);
    
    /**
     * output class constructor
     */
    public CKPECostbillListUI() throws Exception
    {
        super();
    }

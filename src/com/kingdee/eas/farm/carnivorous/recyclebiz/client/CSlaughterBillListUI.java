 ...
 * output class name
 */
public class CSlaughterBillListUI extends AbstractCSlaughterBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CSlaughterBillListUI.class);
    
    /**
     * output class constructor
     */
    public CSlaughterBillListUI() throws Exception
    {
        super();
    }

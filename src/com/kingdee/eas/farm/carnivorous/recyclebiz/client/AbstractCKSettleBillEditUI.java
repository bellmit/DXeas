...
public abstract class AbstractCKSettleBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.txtviewItemAmt.setPrecision(2);		
    ...
    public void initUIContentLayout()
    {
        ...
        contfarmeronlyPro.setBounds(new Rectangle(15, 278, 270, 19));
        kDPanel1.add(contfarmeronlyPro, new KDLayout.Constraints(15, 278, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contfarmerOnlyProOne.setBounds(new Rectangle(300, 278, 270, 19));
        kDPanel1.add(contfarmerOnlyProOne, new KDLayout.Constraints(300, 278, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
...
vo.put("recType","0");
        ...
        contmarginOccupyFee.setBounds(new Rectangle(13, 346, 270, 19));
        kDPanel4.add(contmarginOccupyFee, new KDLayout.Constraints(13, 346, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbatchOccupyMargin.setBounds(new Rectangle(587, 338, 270, 19));
        kDPanel4.add(contbatchOccupyMargin, new KDLayout.Constraints(587, 338, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contstandardMargin.setBounds(new Rectangle(299, 209, 270, 19));
        kDPanel4.add(contstandardMargin, new KDLayout.Constraints(299, 209, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsingleMargin.setBounds(new Rectangle(860, 84, 270, 19));
        kDPanel4.add(contsingleMargin, new KDLayout.Constraints(860, 84, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contconFeedSubsidies.setBounds(new Rectangle(583, 310, 270, 19));
        kDPanel4.add(contconFeedSubsidies, new KDLayout.Constraints(583, 310, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contkbConFeedPolicy.setBounds(new Rectangle(859, 314, 270, 19));
        kDPanel4.add(contkbConFeedPolicy, new KDLayout.Constraints(859, 314, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcontractCKWgt.setBounds(new Rectangle(577, 111, 270, 19));
        kDPanel4.add(contcontractCKWgt, new KDLayout.Constraints(577, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contlFeedWgt.setBounds(new Rectangle(299, 240, 270, 19));
        kDPanel4.add(contlFeedWgt, new KDLayout.Constraints(299, 240, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contfreightPrice.setBounds(new Rectangle(582, 144, 270, 19));
        kDPanel4.add(contfreightPrice, new KDLayout.Constraints(582, 144, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contfreightSubsidiesStd.setBounds(new Rectangle(860, 146, 270, 19));
        kDPanel4.add(contfreightSubsidiesStd, new KDLayout.Constraints(860, 146, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdeductMargin.setBounds(new Rectangle(13, 250, 270, 19));
        kDPanel4.add(contdeductMargin, new KDLayout.Constraints(13, 250, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttotalMargin.setBounds(new Rectangle(299, 271, 270, 19));
        kDPanel4.add(conttotalMargin, new KDLayout.Constraints(299, 271, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contenableMargin.setBounds(new Rectangle(860, 215, 270, 19));
        kDPanel4.add(contenableMargin, new KDLayout.Constraints(860, 215, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdeductAdPayAmt.setBounds(new Rectangle(299, 302, 270, 19));
        kDPanel4.add(contdeductAdPayAmt, new KDLayout.Constraints(299, 302, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contkYFKOccupyFee.setBounds(new Rectangle(860, 281, 270, 19));
        kDPanel4.add(contkYFKOccupyFee, new KDLayout.Constraints(860, 281, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contdyfBalance.setBounds(new Rectangle(860, 246, 270, 19));
        kDPanel4.add(contdyfBalance, new KDLayout.Constraints(860, 246, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contmoneyOccupyDays.setBounds(new Rectangle(299, 337, 270, 19));
        kDPanel4.add(contmoneyOccupyDays, new KDLayout.Constraints(299, 337, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contconFeedPolicySub.setBounds(new Rectangle(860, 115, 270, 19));
        kDPanel4.add(contconFeedPolicySub, new KDLayout.Constraints(860, 115, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contpayOweMonery.setBounds(new Rectangle(13, 281, 270, 19));
        kDPanel4.add(contpayOweMonery, new KDLayout.Constraints(13, 281, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contoutSaleKbAmt.setBounds(new Rectangle(583, 242, 270, 19));
        kDPanel4.add(contoutSaleKbAmt, new KDLayout.Constraints(583, 242, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contunLockedMargin.setBounds(new Rectangle(860, 53, 270, 19));
        kDPanel4.add(contunLockedMargin, new KDLayout.Constraints(860, 53, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contadPayBalance.setBounds(new Rectangle(13, 316, 270, 19));
        kDPanel4.add(contadPayBalance, new KDLayout.Constraints(13, 316, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contQCKbDetail.setBounds(new Rectangle(15, 379, 273, 22));
        kDPanel4.add(contQCKbDetail, new KDLayout.Constraints(15, 379, 273, 22, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contotherKbDetail.setBounds(new Rectangle(299, 375, 272, 24));
        kDPanel4.add(contotherKbDetail, new KDLayout.Constraints(299, 375, 272, 24, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contimmuneCost.setBounds(new Rectangle(13, 111, 270, 19));
        kDPanel4.add(contimmuneCost, new KDLayout.Constraints(13, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contimmuneCostOne.setBounds(new Rectangle(295, 111, 270, 19));
        kDPanel4.add(contimmuneCostOne, new KDLayout.Constraints(295, 111, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcleanHouse.setBounds(new Rectangle(13, 144, 270, 19));
        kDPanel4.add(contcleanHouse, new KDLayout.Constraints(13, 144, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcleanHouseOne.setBounds(new Rectangle(299, 144, 270, 19));
        kDPanel4.add(contcleanHouseOne, new KDLayout.Constraints(299, 144, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        chknoCalFodderPunish.setBounds(new Rectangle(14, 172, 270, 19));
        kDPanel4.add(chknoCalFodderPunish, new KDLayout.Constraints(14, 172, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chknoCalDrupPunish.setBounds(new Rectangle(14, 196, 270, 19));
        kDPanel4.add(chknoCalDrupPunish, new KDLayout.Constraints(14, 196, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contmRatePAmt
...
vo.put("calUnit","0");
        ...
        kDPanel17.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1170, 538));        contreserveRiskCost.setBounds(new Rectangle(10, 12, 270, 19));
        kDPanel17.add(contreserveRiskCost, new KDLayout.Constraints(10, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbrokenCost.setBounds(new Rectangle(289, 12, 270, 19));
        kDPanel17.add(contbrokenCost, new KDLayout.Constraints(289, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contlongBorrowReturn.setBounds(new Rectangle(573, 76, 270, 19));
        kDPanel17.add(contlongBorrowReturn, new KDLayout.Constraints(573, 76, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conttranCost.setBounds(new Rectangle(573, 12, 270, 19));
        kDPanel17.add(conttranCost, new KDLayout.Constraints(573, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contactualPayAmt.setBounds(new Rectangle(10, 142, 270, 19));
        kDPanel17.add(contactualPayAmt, new KDLayout.Constraints(10, 142, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contspecialPermitAmt.setBounds(new Rectangle(289, 108, 270, 19));
        kDPanel17.add(contspecialPermitAmt, new KDLayout.Constraints(289, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contspecialBorrowinst.setBounds(new Rectangle(573, 44, 270, 19));
        kDPanel17.add(contspecialBorrowinst, new KDLayout.Constraints(573, 44, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contlongBorrowAmount.setBounds(new Rectangle(289, 76, 270, 19));
        kDPanel17.add(contlongBorrowAmount, new KDLayout.Constraints(289, 76, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contequipmentReAmt.setBounds(new Rectangle(10, 108, 270, 19));
        kDPanel17.add(contequipmentReAmt, new KDLayout.Constraints(10, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contborrowAmiunt.setBounds(new Rectangle(289, 44, 270, 19));
        kDPanel17.add(contborrowAmiunt, new KDLayout.Constraints(289, 44, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contmarginGAmount.setBounds(new Rectangle(10, 76, 270, 19));
        kDPanel17.add(contmarginGAmount, new KDLayout.Constraints(10, 76, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcoalCost.setBounds(new Rectangle(860, 12, 270, 19));
        kDPanel17.add(contcoalCost, new KDLayout.Constraints(860, 12, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contmarginProfit.setBounds(new Rectangle(10, 44, 270, 19));
        kDPanel17.add(contmarginProfit, new KDLayout.Constraints(10, 44, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contgetChickCost.setBounds(new Rectangle(10, 170, 270, 19));
        kDPanel17.add(contgetChickCost, new KDLayout.Constraints(10, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcleanHouseCost.setBounds(new Rectangle(289, 170, 270, 19));
        kDPanel17.add(contcleanHouseCost, new KDLayout.Constraints(289, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(289, 142, 556, 19));
        kDPanel17.add(contDescription, new KDLayout.Constraints(289, 142, 556, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcleanTowerCost.setBounds(new Rectangle(573, 170, 270, 19));
        kDPanel17.add(contcleanTowerCost, new KDLayout.Constraints(573, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contnowAccountBac.setBounds(new Rectangle(10, 200, 270, 19));
        kDPanel17.add(contnowAccountBac, new KDLayout.Constraints(10, 200, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contassetsOccupy.setBounds(new Rectangle(860, 170, 270, 19));
        kDPanel17.add(contassetsOccupy, new KDLayout.Constraints(860, 170, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contnoPfoRetAmt.setBounds(new Rectangle(573, 108, 270, 19));
        kDPanel17.add(contnoPfoRetAmt, new KDLayout.Constraints(573, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkactualVoucher.setBounds(new Rectangle(10, 227, 270, 19));
        kDPanel17.add(chkactualVoucher, new KDLayout.Constraints(10, 227, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkpreVoucher.setBounds(new Rectangle(10, 248, 270, 19));
        kDPanel17.add(chkpreVoucher, new KDLayout.Constraints(10, 248, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chktransVoucher.setBounds(new Rectangle(10, 269, 270, 19));
        kDPanel17.add(chktransVoucher, new KDLayout.Constraints(10, 269, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkhasPay.setBounds(new Rectangle(10, 291, 270, 19));
        kDPanel17.add(chkhasPay, new KDLayout.Constraints(10, 291, 270, 19, 0));
        contcompanyTC.setBounds(new Rectangle(860, 44, 270, 19));
        kDPanel17.add(contcompanyTC, new KDLayout.Constraints(860, 44, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contdiverCt.setBounds(new Rectangle(860, 76, 270, 19));
        kDPanel17.add(contdiverCt, new KDLayout.Constraints(860, 76, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contreserveRiskCost

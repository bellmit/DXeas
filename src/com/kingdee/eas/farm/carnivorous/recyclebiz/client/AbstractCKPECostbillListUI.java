 ...
 * output class name
 */
public abstract class AbstractCKPECostbillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCKPECostbillListUI.class);
     ...
     */
    public AbstractCKPECostbillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCKPECostbillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.app", "CKPECostbillQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKPECostbillListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("peCost"));
        sic.add(new SelectorItemInfo("Fivouchered"));
        sic.add(new SelectorItemInfo("breedData.name"));
        sic.add(new SelectorItemInfo("company.name"));
        sic.add(new SelectorItemInfo("isNextPeriod"));
        return sic;
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCKPECostbillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractCKPECostbillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "CKPECostbillListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.farm.carnivorous.recyclebiz.client.CKPECostbillEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.recyclebiz.CKPECostbillFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.recyclebiz.CKPECostbillInfo objectValue = new com.kingdee.eas.farm.carnivorous.recyclebiz.CKPECostbillInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","Fivouchered","FICompany.name","period.number","farmer.name","farm.name","batchContract.number","breedData.name","settleWgt","unitCost","peCost","company.name","isNextPeriod"};
    }



	protected String getTDFileName() {
    	return "/bim/farm/carnivorous/recyclebiz/CKPECostbill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKPECostbillQuery");
	}

...
com.kingdee.eas.farm.carnivorous.recyclebiz.CKCostAllocateBillFactory.getRemoteInstance().costAmt(editData);
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","FICompany.name","allAmount","billStatus","period.number","entrys.farmer.name","entrys.farm.name","entrys.batchContract.number","auditTime","costCenter.name","entrys.breeddata.name","entrys.costCenter.name"};
    }

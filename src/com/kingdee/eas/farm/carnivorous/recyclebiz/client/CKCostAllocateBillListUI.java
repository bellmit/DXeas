 ...
 * output class name
 */
public class CKCostAllocateBillListUI extends AbstractCKCostAllocateBillListUI
{
	private static final Logger logger = CoreUIObject.getLogger(CKCostAllocateBillListUI.class);

	/**
	 * output class constructor
	 */
	public CKCostAllocateBillListUI() throws Exception
	{
		super();
	}
	/**

...
com.kingdee.eas.farm.carnivorous.recyclebiz.ChickenRecBillFactory.getRemoteInstance().unAudit(editData);
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","FICompany.name","auditTime","farmer.name","farm.name","batchContract.number","batch.name","billStatus","settlePolicy.name","inDate","batchQty","person.name","farmAddress","farmType","farmerPhone","breedData.name","feedDays","customerName"};
    }

 ...
 * output class name
 */
public abstract class AbstractChickenRecBillListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractChickenRecBillListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnBatchSubmit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnManageCarSeq;
    protected ActionTDPrint actionTDPrint = null;
    protected ActionTDPrintPreview actionTDPrintPreview = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    protected ActionManageCarSeq actionManageCarSeq = null;
    protected ActionBatchSubmit actionBatchSubmit = null;
    public final static String STATUS_VIEW = "VIEW";
    /**
     * output class constructor
     */
    public AbstractChickenRecBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractChickenRecBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.app", "ChickenRecBillQuery");
        //actionRemove
        ...
        //actionManageCarSeq
        this.actionManageCarSeq = new ActionManageCarSeq(this);
        getActionManager().registerAction("actionManageCarSeq", actionManageCarSeq);
        this.actionManageCarSeq.setExtendProperty("canForewarn", "true");
        this.actionManageCarSeq.setExtendProperty("userDefined", "true");
        this.actionManageCarSeq.setExtendProperty("isObjectUpdateLock", "false");
         this.actionManageCarSeq.addService(new com.kingdee.eas.framework.client.service.PermissionService());
         this.actionManageCarSeq.addService(new com.kingdee.eas.framework.client.service.ForewarnService());
        //actionBatchSubmit
        ...
        // btnManageCarSeq
        this.btnManageCarSeq.setAction((IItemAction)ActionProxyFactory.getProxy(actionManageCarSeq, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnManageCarSeq.setText(resHelper.getString("btnManageCarSeq.text"));		
        this.btnManageCarSeq.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_demandhistorydata"));
    ...
    public void initUIToolBarLayout()
    {
        ...
        this.toolBar.add(btnManageCarSeq);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.recyclebiz.app.ChickenRecBillListUIHandler";
	}
...
com.kingdee.eas.farm.carnivorous.recyclebiz.ChickenRecBillInfo editData = (com.kingdee.eas.farm.carnivorous.recyclebiz.ChickenRecBillInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.carnivorous.recyclebiz.ChickenRecBillFactory.getRemoteInstance().unAudit(editData);
    ...
    /**
     * output actionManageCarSeq_actionPerformed method
     */
    public void actionManageCarSeq_actionPerformed(ActionEvent e) throws Exception
    {
    }
	...
	public RequestContext prepareActionManageCarSeq(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionManageCarSeq() {
    	return false;
    }
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }

    /**
     * output ActionManageCarSeq class
     */     
    protected class ActionManageCarSeq extends ItemAction {     
    
        public ActionManageCarSeq()
        {
            this(null);
        }

        public ActionManageCarSeq(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionManageCarSeq.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionManageCarSeq.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionManageCarSeq.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionManageCarSeq", "actionManageCarSeq_actionPerformed", e);
        }
    }
    ...
    protected class ActionBatchSubmit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractChickenRecBillListUI.this, "ActionBatchSubmit", "actionBatchSubmit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.recyclebiz.client", "ChickenRecBillListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","FICompany.name","auditTime","farmer.name","farm.name","batchContract.number","batch.name","billStatus","settlePolicy.name","inDate","batchQty","person.name","farmAddress","farmType","farmerPhone","breedData.name","feedDays","customerName","isManu","isSaleOut"};
    }

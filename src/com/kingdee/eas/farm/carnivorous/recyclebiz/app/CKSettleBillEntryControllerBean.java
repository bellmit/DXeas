...
public class CKSettleBillEntryControllerBean extends AbstractCKSettleBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKSettleBillEntryControllerBean");
}
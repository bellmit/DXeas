...
public class ClosingRecordControllerBean extends AbstractClosingRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.ClosingRecordControllerBean");
}
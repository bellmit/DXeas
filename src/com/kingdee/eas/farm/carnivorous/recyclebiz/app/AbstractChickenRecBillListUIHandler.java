 ...
 * output class name
 */
public abstract class AbstractChickenRecBillListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionManageCarSeq(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionManageCarSeq(request,response,context);
	}
	protected void _handleActionManageCarSeq(RequestContext request,ResponseContext response, Context context) throws Exception {
	}

...
public class CKCostAllocateBillControllerBeanEx extends com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKCostAllocateBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKCostAllocateBillControllerBeanEx");
    protected void _execAllocate(Context ctx, IObjectValue model)throws BOSException
    {
	     super._execAllocate(ctx, model);
    }
}				

...
public class CKSettleBillQCEntryControllerBean extends AbstractCKSettleBillQCEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKSettleBillQCEntryControllerBean");
}
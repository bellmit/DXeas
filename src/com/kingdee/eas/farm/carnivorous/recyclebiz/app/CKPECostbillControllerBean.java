...
public class CKPECostbillControllerBean extends AbstractCKPECostbillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKPECostbillControllerBean");
}
...
public class CKWeightBillEntryControllerBean extends AbstractCKWeightBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.recyclebiz.app.CKWeightBillEntryControllerBean");
}
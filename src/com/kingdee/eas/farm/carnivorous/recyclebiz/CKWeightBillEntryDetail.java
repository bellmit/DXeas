...
public class CKWeightBillEntryDetail extends CoreBillEntryBase implements ICKWeightBillEntryDetail
{
    public CKWeightBillEntryDetail()
    {
        super();
        registerInterface(ICKWeightBillEntryDetail.class, this);
    }
    public CKWeightBillEntryDetail(Context ctx)
    {
        super(ctx);
        registerInterface(ICKWeightBillEntryDetail.class, this);
    }
    ...
    private CKWeightBillEntryDetailController getController() throws BOSException
    {
        return (CKWeightBillEntryDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKWeightBillEntryDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

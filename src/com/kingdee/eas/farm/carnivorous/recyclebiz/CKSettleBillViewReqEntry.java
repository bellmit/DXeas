...
public class CKSettleBillViewReqEntry extends CoreBillEntryBase implements ICKSettleBillViewReqEntry
{
    public CKSettleBillViewReqEntry()
    {
        super();
        registerInterface(ICKSettleBillViewReqEntry.class, this);
    }
    public CKSettleBillViewReqEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKSettleBillViewReqEntry.class, this);
    }
    ...
    private CKSettleBillViewReqEntryController getController() throws BOSException
    {
        return (CKSettleBillViewReqEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKSettleBillViewReqEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

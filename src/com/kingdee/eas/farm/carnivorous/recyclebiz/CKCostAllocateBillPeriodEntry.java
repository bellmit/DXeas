...
public class CKCostAllocateBillPeriodEntry extends CoreBillEntryBase implements ICKCostAllocateBillPeriodEntry
{
    public CKCostAllocateBillPeriodEntry()
    {
        super();
        registerInterface(ICKCostAllocateBillPeriodEntry.class, this);
    }
    public CKCostAllocateBillPeriodEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICKCostAllocateBillPeriodEntry.class, this);
    }
    ...
    private CKCostAllocateBillPeriodEntryController getController() throws BOSException
    {
        return (CKCostAllocateBillPeriodEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCKCostAllocateBillPeriodEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class MarginUnlockBillEntryControllerBean extends AbstractMarginUnlockBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basebiz.app.MarginUnlockBillEntryControllerBean");
}
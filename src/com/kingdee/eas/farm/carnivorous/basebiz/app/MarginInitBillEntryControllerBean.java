...
public class MarginInitBillEntryControllerBean extends AbstractMarginInitBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basebiz.app.MarginInitBillEntryControllerBean");
}
 ...
 * output class name
 */
public class MarginUnlockBillListUI extends AbstractMarginUnlockBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginUnlockBillListUI.class);
    
    /**
     * output class constructor
     */
    public MarginUnlockBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class FarmerGuaranteeBillListUI extends AbstractFarmerGuaranteeBillListUI
{
	private static final Logger logger = CoreUIObject.getLogger(FarmerGuaranteeBillListUI.class);

	/**
	 * output class constructor
	 */
	public FarmerGuaranteeBillListUI() throws Exception
	{
		super();
	}
	/**

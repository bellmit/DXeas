...
public class AbstractInvestmentPolicyEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractInvestmentPolicyEntryInfo()
    {
        this("id");
    }
    protected AbstractInvestmentPolicyEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.farm.carnivorous.basedata.InvestmentPolicyInfo getParent()
    {
        return (com.kingdee.eas.farm.carnivorous.basedata.InvestmentPolicyInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.farm.carnivorous.basedata.InvestmentPolicyInfo item)
    {
        put("parent", item);
    }
    /**

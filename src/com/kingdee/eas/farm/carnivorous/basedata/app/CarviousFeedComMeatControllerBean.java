...
public class CarviousFeedComMeatControllerBean extends AbstractCarviousFeedComMeatControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.CarviousFeedComMeatControllerBean");
    
    
    
    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
    	CarviousFeedComMeatInfo info = (CarviousFeedComMeatInfo ) model;		
	...
	protected void _cancelCancel(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		...
		if(checkIsHasSame(ctx, info)){
			throw new EASBizException(new NumericExceptionSubItem("001","当天已有同一品种的料肉比标准,执行失败!"));
		}
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		CarviousFeedComMeatInfo info = CarviousFeedComMeatFactory.getLocalInstance(ctx).getCarviousFeedComMeatInfo(pk);
	...
	private Boolean checkIsHasSame(Context ctx,CarviousFeedComMeatInfo info) {
		// TODO Auto-generated method stub
		Boolean isHas=false;

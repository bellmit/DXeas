...
public class MarketPolicyControllerBean extends AbstractMarketPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.MarketPolicyControllerBean");
    @Override
	protected void _audit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		MarketPolicyInfo info = (MarketPolicyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		MarketPolicyInfo info = MarketPolicyFactory.getLocalInstance(ctx).getMarketPolicyInfo(pk);
		if (info.getBillStatus().equals(BillBaseStatusEnum.AUDITED) ) {

...
import com.kingdee.eas.farm.carnivorous.basedata.BorrowDayRateFactory;
...
public class BorrowDayRateControllerBean extends AbstractBorrowDayRateControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.BorrowDayRateControllerBean");
    
    

	protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		BorrowDayRateInfo info = (BorrowDayRateInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		BorrowDayRateInfo info = BorrowDayRateFactory.getLocalInstance(ctx).getBorrowDayRateInfo(pk);

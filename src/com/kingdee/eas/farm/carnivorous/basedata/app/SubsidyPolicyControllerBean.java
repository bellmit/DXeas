...
import com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyFactory;
import com.kingdee.bos.dao.IObjectPK;
...
public class SubsidyPolicyControllerBean extends AbstractSubsidyPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.SubsidyPolicyControllerBean");
    
    
    
	@Override
	protected void _save(Context ctx, IObjectPK pk, IObjectValue model) throws BOSException, EASBizException {
		SubsidyPolicyInfo info = (SubsidyPolicyInfo) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		SubsidyPolicyInfo info = SubsidyPolicyFactory.getLocalInstance(ctx).getSubsidyPolicyInfo(pk);

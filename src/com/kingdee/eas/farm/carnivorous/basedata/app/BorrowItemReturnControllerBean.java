...
import com.kingdee.eas.farm.carnivorous.basedata.BorrowItemReturnFactory;
...
public class BorrowItemReturnControllerBean extends AbstractBorrowItemReturnControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.BorrowItemReturnControllerBean");
    

    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
    	BorrowItemReturnInfo info = (BorrowItemReturnInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		BorrowItemReturnInfo info = BorrowItemReturnFactory.getLocalInstance(ctx).getBorrowItemReturnInfo(pk);

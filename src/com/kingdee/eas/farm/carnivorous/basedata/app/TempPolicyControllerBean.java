...
public class TempPolicyControllerBean extends AbstractTempPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.TempPolicyControllerBean");
    
    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		TempPolicyInfo info = (TempPolicyInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		TempPolicyInfo info = TempPolicyFactory.getLocalInstance(ctx).getTempPolicyInfo(pk);

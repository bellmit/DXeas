...
public class RandPPolicyControllerBean extends AbstractRandPPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.RandPPolicyControllerBean");

    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		RandPPolicyInfo info = (RandPPolicyInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		RandPPolicyInfo info = RandPPolicyFactory.getLocalInstance(ctx).getRandPPolicyInfo(pk);

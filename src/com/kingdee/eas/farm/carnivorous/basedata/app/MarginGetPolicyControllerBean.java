...
public class MarginGetPolicyControllerBean extends AbstractMarginGetPolicyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.MarginGetPolicyControllerBean");
	...
	throws BOSException, EASBizException {
    	MarginGetPolicyInfo info = (MarginGetPolicyInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		MarginGetPolicyInfo info = MarginGetPolicyFactory.getLocalInstance(ctx).getMarginGetPolicyInfo(pk);

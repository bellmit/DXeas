...
import com.kingdee.eas.farm.carnivorous.basedata.FarmerTypeFactory;
...
public class FarmerTypeControllerBean extends AbstractFarmerTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.FarmerTypeControllerBean");
    
    @Override
	protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		FarmerTypeInfo info = (FarmerTypeInfo ) model;
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FarmerTypeInfo info = FarmerTypeFactory.getLocalInstance(ctx).getFarmerTypeInfo(pk);

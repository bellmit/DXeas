...
import com.kingdee.eas.farm.carnivorous.basedata.FodderStdFactory;
...
public class FodderStdControllerBean extends AbstractFodderStdControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.farm.carnivorous.basedata.app.FodderStdControllerBean");
    
    protected IObjectPK _save(Context ctx, IObjectValue model)
	throws BOSException, EASBizException {
		FodderStdInfo info = (FodderStdInfo ) model;		
	...
	protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
		// TODO Auto-generated method stub
		FodderStdInfo info = FodderStdFactory.getLocalInstance(ctx).getFodderStdInfo(pk);

 ...
 * output class name
 */
public class FreightCalPointEditUI extends AbstractFreightCalPointEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(FreightCalPointEditUI.class);

	/**
	 * output class constructor
	 */
	public FreightCalPointEditUI() throws Exception
	{
		super();
	}
	@Override

 ...
 * output class name
 */
public class FodderStdEditUI extends AbstractFodderStdEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(FodderStdEditUI.class);

	/**
	 * output class constructor
	 */
	public FodderStdEditUI() throws Exception
	{
		super();
	}
	@Override

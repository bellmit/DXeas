...
import com.kingdee.eas.farm.carnivorous.basedata.ICatchCKTeam;
 ...
 * output class name
 */
public class CatchCKTeamListUI extends AbstractCatchCKTeamListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CatchCKTeamListUI.class);
    
    /**
     * output class constructor
     */
    public CatchCKTeamListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception  {
		ICatchCKTeam  intenface= (ICatchCKTeam) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
			...
			intenface.audit(intenface.getCatchCKTeamInfo(pk));
		}
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getCatchCKTeamInfo(pk));		
		}

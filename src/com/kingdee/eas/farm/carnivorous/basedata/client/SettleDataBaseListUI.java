 ...
 * output class name
 */
public class SettleDataBaseListUI extends AbstractSettleDataBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleDataBaseListUI.class);
    
    /**
     * output class constructor
     */
    public SettleDataBaseListUI() throws Exception
    {
        super();
    }

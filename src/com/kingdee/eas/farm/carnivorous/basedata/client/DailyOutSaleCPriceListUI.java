 ...
 * output class name
 */
public class DailyOutSaleCPriceListUI extends AbstractDailyOutSaleCPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DailyOutSaleCPriceListUI.class);
    
    /**
     * output class constructor
     */
    public DailyOutSaleCPriceListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IDailyOutSaleCPrice  intenface= (IDailyOutSaleCPrice) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getDailyOutSaleCPriceInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getDailyOutSaleCPriceInfo(pk));		
		}

 ...
 * output class name
 */
public abstract class AbstractMarginPolicyEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarginPolicyEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.MarginPolicyInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractMarginPolicyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarginPolicyEditUI.class.getName());
        ...
        this.contsingleMargin.setBoundLabelLength(100);		
        ...
        // txtsingleMargin		
        this.txtsingleMargin.setVisible(true);		
        ...
        // txtminMargin		
        this.txtminMargin.setVisible(true);		
        ...
        this.txtminMargin.setPrecision(10);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkbeginDate,pkendDate,baseStatus,prmtbreed,txtsingleMargin}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 387, 470));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(44, 48, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(44, 88, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer4.setBounds(new Rectangle(44, 410, 270, 19));
        this.add(kDLabelContainer4, null);
        contFICompany.setBounds(new Rectangle(44, 128, 270, 19));
        this.add(contFICompany, null);
        contbeginDate.setBounds(new Rectangle(44, 168, 270, 19));
        this.add(contbeginDate, null);
        contendDate.setBounds(new Rectangle(44, 208, 270, 19));
        this.add(contendDate, null);
        contbaseStatus.setBounds(new Rectangle(44, 248, 270, 19));
        this.add(contbaseStatus, null);
        contbreed.setBounds(new Rectangle(44, 288, 270, 19));
        this.add(contbreed, null);
        contsingleMargin.setBounds(new Rectangle(44, 328, 270, 19));
        this.add(contsingleMargin, null);
        contminMargin.setBounds(new Rectangle(44, 368, 270, 19));
        this.add(contminMargin, null);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.MarginPolicyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.MarginPolicyInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMarginPolicyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMarginPolicyEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "MarginPolicyEditUI");
    }

 ...
 * output class name
 */
public class MarginGetPolicyEditUI extends AbstractMarginGetPolicyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginGetPolicyEditUI.class);
    
    /**
     * output class constructor
     */
    public MarginGetPolicyEditUI() throws Exception
    {
        super();
    }
    /**

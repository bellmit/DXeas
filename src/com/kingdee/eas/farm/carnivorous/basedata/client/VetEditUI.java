 ...
 * output class name
 */
public class VetEditUI extends AbstractVetEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(VetEditUI.class);

	/**
	 * output class constructor
	 */
	public VetEditUI() throws Exception
	{
		super();
	}

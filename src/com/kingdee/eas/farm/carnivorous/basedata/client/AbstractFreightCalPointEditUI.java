 ...
 * output class name
 */
public abstract class AbstractFreightCalPointEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFreightCalPointEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.FreightCalPointInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFreightCalPointEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFreightCalPointEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {prmtFICompany,txtName,txtNumber,baseStatus,prmtadminOrgUnit}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 352, 446));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(36, 97, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(36, 151, 270, 19));
        this.add(kDLabelContainer2, null);
        contFICompany.setBounds(new Rectangle(36, 43, 270, 19));
        this.add(contFICompany, null);
        contbaseStatus.setBounds(new Rectangle(36, 205, 270, 19));
        this.add(contbaseStatus, null);
        contadminOrgUnit.setBounds(new Rectangle(36, 262, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.FreightCalPointEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.FreightCalPointInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFreightCalPointEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFreightCalPointEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "FreightCalPointEditUI");
    }

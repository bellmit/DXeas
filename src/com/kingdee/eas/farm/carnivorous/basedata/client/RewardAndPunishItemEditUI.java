 ...
 * output class name
 */
public class RewardAndPunishItemEditUI extends AbstractRewardAndPunishItemEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(RewardAndPunishItemEditUI.class);

	/**
	 * output class constructor
	 */
	public RewardAndPunishItemEditUI() throws Exception
	{
		super();
	}
	@Override
	...
	private void setFilter() {
		// TODO Auto-generated method stub
		String  companyNumber=((IPropertyContainer)prmtFICompany.getValue()).getString("number");
		EntityViewInfo ev= new EntityViewInfo();
		FilterInfo filterInfo=new FilterInfo();
		filterInfo.getFilterItems().add(new FilterItemInfo("companyID.number",companyNumber,CompareType.LIKE));
		ev.setFilter(filterInfo);
		prmtsubject.setEntityViewInfo(ev);
	}
	...
	protected void verifyInput(ActionEvent e) throws Exception {
		// TODO Auto-generated method stub
		super.verifyInput(e);
//		if(punishType.getSelectedItem()!=null&&punishType.getSelectedItem()==PunishType.forWeight&&txtcoe.getBigDecimalValue()==null){
//			MsgBox.showWarning("扣重类型未维护换算系数!");
//			SysUtil.abort();
//		}
	}

 ...
 * output class name
 */
public class InputSeedPlanEditUI extends AbstractInputSeedPlanEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(InputSeedPlanEditUI.class);

	/**
	 * output class constructor
	 */
	public InputSeedPlanEditUI() throws Exception
	{
		super();
	}

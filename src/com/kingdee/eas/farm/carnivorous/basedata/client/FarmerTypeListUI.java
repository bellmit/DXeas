...
import com.kingdee.eas.farm.carnivorous.basedata.IFarmerType;
 ...
 * output class name
 */
public class FarmerTypeListUI extends AbstractFarmerTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerTypeListUI.class);
    
    /**
     * output class constructor
     */
    public FarmerTypeListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IFarmerType  intenface= (IFarmerType) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getFarmerTypeInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getFarmerTypeInfo(pk));		 
		}

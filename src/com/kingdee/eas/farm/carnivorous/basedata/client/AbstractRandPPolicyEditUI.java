 ...
 * output class name
 */
public abstract class AbstractRandPPolicyEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRandPPolicyEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contrandPItem;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contbreedData;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contQCPWgtMultiple;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtrandPItem;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtbreedData;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtQCPWgtMultiple;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnUnAudit;
    protected com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractRandPPolicyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRandPPolicyEditUI.class.getName());
        ...
        this.contrandPItem = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contbreedData = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contQCPWgtMultiple = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtrandPItem = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.prmtbreedData = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtQCPWgtMultiple = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contrandPItem.setName("contrandPItem");
        this.contbreedData.setName("contbreedData");
        this.contQCPWgtMultiple.setName("contQCPWgtMultiple");
        ...
        this.prmtrandPItem.setName("prmtrandPItem");
        this.prmtbreedData.setName("prmtbreedData");
        this.txtQCPWgtMultiple.setName("txtQCPWgtMultiple");
        ...
        // contrandPItem		
        this.contrandPItem.setBoundLabelText(resHelper.getString("contrandPItem.boundLabelText"));		
        this.contrandPItem.setBoundLabelLength(100);		
        this.contrandPItem.setBoundLabelUnderline(true);		
        this.contrandPItem.setVisible(true);
        // contbreedData		
        ...
        // contQCPWgtMultiple		
        this.contQCPWgtMultiple.setBoundLabelText(resHelper.getString("contQCPWgtMultiple.boundLabelText"));		
        this.contQCPWgtMultiple.setBoundLabelLength(100);		
        this.contQCPWgtMultiple.setBoundLabelUnderline(true);		
        this.contQCPWgtMultiple.setVisible(true);
        // txtNumber		
        ...
        // prmtrandPItem		
        this.prmtrandPItem.setQueryInfo("com.kingdee.eas.farm.carnivorous.basedata.app.RewardAndPunishItemQuery");		
        this.prmtrandPItem.setVisible(true);		
        this.prmtrandPItem.setEditable(true);		
        this.prmtrandPItem.setDisplayFormat("$name$");		
        this.prmtrandPItem.setEditFormat("$number$");		
        this.prmtrandPItem.setCommitFormat("$number$");		
        this.prmtrandPItem.setRequired(true);
        		EntityViewInfo eviprmtrandPItem = new EntityViewInfo ();
		eviprmtrandPItem.setFilter(com.kingdee.eas.framework.FrameWorkUtils.getF7FilterInfoByAuthorizedOrg(com.kingdee.eas.basedata.org.OrgType.getEnum("Company"),"FICompany.id"));
		prmtrandPItem.setEntityViewInfo(eviprmtrandPItem);
        ...
        // txtQCPWgtMultiple		
        this.txtQCPWgtMultiple.setVisible(true);		
        this.txtQCPWgtMultiple.setHorizontalAlignment(2);		
        this.txtQCPWgtMultiple.setDataType(1);		
        this.txtQCPWgtMultiple.setSupportedEmpty(true);		
        this.txtQCPWgtMultiple.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtQCPWgtMultiple.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtQCPWgtMultiple.setPrecision(4);		
        this.txtQCPWgtMultiple.setRequired(true);
        // tBtnAudit
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,prmtcreator,pkcreateTime,baseStatus,prmtauditor,pkauditTime,txtbaseQty,prmtcompany,calType,txtbasePrice,kdtPolicyEntry,txtformulaTxt,pkbeginDate,pkendDate,prmtrandPItem,prmtbreedData,txtQCPWgtMultiple}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer1.setBounds(new Rectangle(38, 14, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(38, 14, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer4.setBounds(new Rectangle(924, 133, 269, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(924, 133, 269, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contcompany.setBounds(new Rectangle(345, 48, 270, 19));
        this.add(contcompany, new KDLayout.Constraints(345, 48, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDSeparator6.setBounds(new Rectangle(38, 108, 890, 10));
        this.add(kDSeparator6, new KDLayout.Constraints(38, 108, 890, 10, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contcalType.setBounds(new Rectangle(38, 118, 270, 19));
        this.add(contcalType, new KDLayout.Constraints(38, 118, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbasePrice.setBounds(new Rectangle(931, 154, 270, 19));
        this.add(contbasePrice, new KDLayout.Constraints(931, 154, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contendDate.setBounds(new Rectangle(345, 82, 270, 19));
        this.add(contendDate, new KDLayout.Constraints(345, 82, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contrandPItem.setBounds(new Rectangle(38, 48, 270, 19));
        this.add(contrandPItem, new KDLayout.Constraints(38, 48, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbreedData.setBounds(new Rectangle(657, 48, 270, 19));
        this.add(contbreedData, new KDLayout.Constraints(657, 48, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contQCPWgtMultiple.setBounds(new Rectangle(657, 82, 270, 19));
        this.add(contQCPWgtMultiple, new KDLayout.Constraints(657, 82, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDLabelContainer1
        ...
        kdtPolicyEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtPolicyEntry,new com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyPolicyEntryInfo(),null,false);
        ...
        //contrandPItem
        contrandPItem.setBoundEditor(prmtrandPItem);
        //contbreedData
        contbreedData.setBoundEditor(prmtbreedData);
        //contQCPWgtMultiple
        contQCPWgtMultiple.setBoundEditor(txtQCPWgtMultiple);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("PolicyEntry", com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyPolicyEntryInfo.class, this.kdtPolicyEntry, "userObject");
		...
		dataBinder.registerBinding("randPItem", com.kingdee.eas.farm.carnivorous.basedata.RewardAndPunishItemInfo.class, this.prmtrandPItem, "data");
		dataBinder.registerBinding("breedData", com.kingdee.eas.farm.stocking.basedata.BreedDataInfo.class, this.prmtbreedData, "data");
		dataBinder.registerBinding("QCPWgtMultiple", java.math.BigDecimal.class, this.txtQCPWgtMultiple, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.RandPPolicyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("randPItem", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("breedData", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("QCPWgtMultiple", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("randPItem.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("randPItem.id"));
        	sic.add(new SelectorItemInfo("randPItem.number"));
        	sic.add(new SelectorItemInfo("randPItem.name"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("QCPWgtMultiple"));
        return sic;
    }        
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.RandPPolicyFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRandPPolicyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRandPPolicyEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "RandPPolicyEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.RandPPolicyEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(prmtrandPItem.getData())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"奖惩项目"});
		}
		...
		if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtQCPWgtMultiple.getValue())) {
			throw new com.kingdee.eas.common.EASBizException(com.kingdee.eas.common.EASBizException.CHECKBLANK,new Object[] {"质检扣重倍数"});
		}

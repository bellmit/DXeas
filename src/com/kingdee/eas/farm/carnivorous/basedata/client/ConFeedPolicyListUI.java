 ...
 * output class name
 */
public class ConFeedPolicyListUI extends AbstractConFeedPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ConFeedPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public ConFeedPolicyListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IConFeedPolicy  conFeedPolicy= (IConFeedPolicy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				conFeedPolicy.audit(conFeedPolicy.getConFeedPolicyInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				conFeedPolicy.unAudit(conFeedPolicy.getConFeedPolicyInfo(pk));		
		}
...
//		super.actionCancelCancel_actionPerformed(e);
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.ConFeedPolicyTreeEditUI.class.getName();
    }

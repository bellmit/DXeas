 ...
 * output class name
 */
public abstract class AbstractTempPolicyListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTempPolicyListUI.class);
     ...
     */
    public AbstractTempPolicyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTempPolicyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.app", "TempPolicyQuery");
        //actionAudit
        ...
        this.tblMain.addKDTSelectListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTSelectListener() {
            public void tableSelectChanged(com.kingdee.bos.ctrl.kdf.table.event.KDTSelectEvent e) {
                ...
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","simpleName","description","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","id","FICompany.name","baseStatus","bizDate","dateRelate","beginDate","endDate","materialType","calUnit","kbPrice","avgWgtFrom","avgWgtTo","forAll","Entrys.seq","Entrys.farmer.name","Entrys.farm.name","breedData.name"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.TempPolicyListUIHandler";
	}
...
com.kingdee.eas.farm.carnivorous.basedata.TempPolicyInfo editData = (com.kingdee.eas.farm.carnivorous.basedata.TempPolicyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.carnivorous.basedata.TempPolicyFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTempPolicyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTempPolicyListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "TempPolicyListUI");
    }

 ...
 * output class name
 */
public class ConFeedPolicyEditUI extends AbstractConFeedPolicyEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ConFeedPolicyEditUI.class);
    
    /**
     * output class constructor
     */
    public ConFeedPolicyEditUI() throws Exception
    {
        super();
    }
...
@Override
    ...
    public void setDataObject(IObjectValue dataObject) 
    {
        ...
        if(STATUS_ADDNEW.equals(getOprtState())) {
            editData.put("treeid",(com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyTreeInfo)getUIContext().get(UIContext.PARENTNODE));
        }
    }

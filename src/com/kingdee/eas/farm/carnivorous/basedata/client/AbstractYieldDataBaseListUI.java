 ...
 * output class name
 */
public abstract class AbstractYieldDataBaseListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractYieldDataBaseListUI.class);
    ...
    protected ActionUnAudit actionUnAudit = null;
		...
		public AbstractYieldDataBaseListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractYieldDataBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractYieldDataBaseListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.app", "YieldDataBaseQuery");
        //actionAudit
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.YieldDataBaseListUIHandler";
	}
...
com.kingdee.eas.farm.carnivorous.basedata.YieldDataBaseInfo editData = (com.kingdee.eas.farm.carnivorous.basedata.YieldDataBaseInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
...
com.kingdee.eas.farm.carnivorous.basedata.YieldDataBaseFactory.getRemoteInstance().unAudit(editData);
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractYieldDataBaseListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractYieldDataBaseListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "YieldDataBaseListUI");
    }

...
import com.kingdee.eas.farm.carnivorous.basedata.IBrowerItem;
 ...
 * output class name
 */
public class BrowerItemListUI extends AbstractBrowerItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BrowerItemListUI.class);
    
    /**
     * output class constructor
     */
    public BrowerItemListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.BrowerItemTreeEditUI.class.getName();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IBrowerItem  intenface= (IBrowerItem) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getBrowerItemInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getBrowerItemInfo(pk));		
		}

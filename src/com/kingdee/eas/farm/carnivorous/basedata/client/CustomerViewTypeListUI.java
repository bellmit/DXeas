 ...
 * output class name
 */
public class CustomerViewTypeListUI extends AbstractCustomerViewTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerViewTypeListUI.class);
    
    /**
     * output class constructor
     */
    public CustomerViewTypeListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		ICustomerViewType  intenface= (ICustomerViewType) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getCustomerViewTypeInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getCustomerViewTypeInfo(pk));		
		}

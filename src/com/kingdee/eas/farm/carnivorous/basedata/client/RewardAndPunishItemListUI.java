 ...
 * output class name
 */
public class RewardAndPunishItemListUI extends AbstractRewardAndPunishItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RewardAndPunishItemListUI.class);
    
    /**
     * output class constructor
     */
    public RewardAndPunishItemListUI() throws Exception
    {
        super();
    }
    @Override
...
//        super.actionAudit_actionPerformed(e);
		...
		IRewardAndPunishItem  intenface= (IRewardAndPunishItem) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getRewardAndPunishItemInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getRewardAndPunishItemInfo(pk));		
		}

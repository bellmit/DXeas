...
import com.kingdee.eas.farm.carnivorous.basedata.IRandPPolicy;
 ...
 * output class name
 */
public class RandPPolicyListUI extends AbstractRandPPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RandPPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public RandPPolicyListUI() throws Exception
    {
        super();
    }
    @Override
    ...
    {
		IRandPPolicy  intenface= (IRandPPolicy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
			...
			intenface.audit(intenface.getRandPPolicyInfo(pk));
		}
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getRandPPolicyInfo(pk));		
		}
...
//		super.actionCancelCancel_actionPerformed(e);
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.RandPPolicyTreeEditUI.class.getName();
    }

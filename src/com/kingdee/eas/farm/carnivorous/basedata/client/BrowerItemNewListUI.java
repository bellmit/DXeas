 ...
 * output class name
 */
public class BrowerItemNewListUI extends AbstractBrowerItemNewListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BrowerItemNewListUI.class);
    
    /**
     * output class constructor
     */
    public BrowerItemNewListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IBrowerItemNew  intenface= (IBrowerItemNew) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getBrowerItemNewInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getBrowerItemNewInfo(pk));		
		}

 ...
 * output class name
 */
public abstract class AbstractAvgWgtSectionListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAvgWgtSectionListUI.class);
    /**
     * output class constructor
     */
    public AbstractAvgWgtSectionListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.AvgWgtSectionListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "AvgWgtSectionListUI");
    }

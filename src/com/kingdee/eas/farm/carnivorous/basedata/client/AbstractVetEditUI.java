 ...
 * output class name
 */
public abstract class AbstractVetEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractVetEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.VetInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractVetEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractVetEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 357, 323));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(47, 93, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(47, 145, 270, 19));
        this.add(kDLabelContainer2, null);
        contFICompany.setBounds(new Rectangle(47, 41, 270, 19));
        this.add(contFICompany, null);
        contbaseStatus.setBounds(new Rectangle(47, 197, 270, 19));
        this.add(contbaseStatus, null);
        contdescription.setBounds(new Rectangle(47, 250, 266, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.VetEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.VetInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractVetEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractVetEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "VetEditUI");
    }

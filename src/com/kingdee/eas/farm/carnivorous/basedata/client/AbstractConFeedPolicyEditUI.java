 ...
 * output class name
 */
public abstract class AbstractConFeedPolicyEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractConFeedPolicyEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsubsidy;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contbaseStatus;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contenableYear;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtsubsidy;
    protected com.kingdee.bos.ctrl.swing.KDComboBox baseStatus;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtenableYear;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtfarmerType;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractConFeedPolicyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractConFeedPolicyEditUI.class.getName());
        ...
        this.contsubsidy = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contbaseStatus = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contenableYear = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtsubsidy = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.baseStatus = new com.kingdee.bos.ctrl.swing.KDComboBox();
        this.txtenableYear = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contsubsidy.setName("contsubsidy");
        this.contbaseStatus.setName("contbaseStatus");
        this.contenableYear.setName("contenableYear");
        ...
        this.txtsubsidy.setName("txtsubsidy");
        this.baseStatus.setName("baseStatus");
        this.txtenableYear.setName("txtenableYear");
        ...
        // contsubsidy		
        this.contsubsidy.setBoundLabelText(resHelper.getString("contsubsidy.boundLabelText"));		
        this.contsubsidy.setBoundLabelLength(100);		
        this.contsubsidy.setBoundLabelUnderline(true);		
        this.contsubsidy.setVisible(true);
        // contbaseStatus		
        ...
        // contenableYear		
        this.contenableYear.setBoundLabelText(resHelper.getString("contenableYear.boundLabelText"));		
        this.contenableYear.setBoundLabelLength(100);		
        this.contenableYear.setBoundLabelUnderline(true);		
        this.contenableYear.setVisible(true);
        // contfarmerType		
        ...
        this.prmtbreed.setVisible(true);		
        ...
        this.subsidyType.addItems(EnumUtils.getEnumList("com.kingdee.eas.farm.carnivorous.basedata.SubsidyType").toArray());		
        this.subsidyType.setRequired(false);
        // txtsubsidy		
        this.txtsubsidy.setVisible(true);		
        this.txtsubsidy.setHorizontalAlignment(2);		
        this.txtsubsidy.setDataType(1);		
        this.txtsubsidy.setSupportedEmpty(true);		
        this.txtsubsidy.setMinimumValue( new java.math.BigDecimal("-1.0E18"));		
        this.txtsubsidy.setMaximumValue( new java.math.BigDecimal("1.0E18"));		
        this.txtsubsidy.setPrecision(2);		
        this.txtsubsidy.setRequired(false);
        // baseStatus		
        ...
        // txtenableYear		
        this.txtenableYear.setVisible(true);		
        this.txtenableYear.setHorizontalAlignment(2);		
        this.txtenableYear.setDataType(0);		
        this.txtenableYear.setSupportedEmpty(true);		
        this.txtenableYear.setRequired(false);
        // prmtfarmerType		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkbeginDate,prmtbreed,subsidyType,txtsubsidy,baseStatus,txtenableYear,prmtfarmerType}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 402, 543));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(55, 27, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(55, 67, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer4.setBounds(new Rectangle(55, 107, 270, 19));
        this.add(kDLabelContainer4, null);
        contFICompany.setBounds(new Rectangle(55, 147, 270, 19));
        this.add(contFICompany, null);
        contbeginDate.setBounds(new Rectangle(55, 187, 270, 19));
        this.add(contbeginDate, null);
        contendDate.setBounds(new Rectangle(55, 227, 270, 19));
        this.add(contendDate, null);
        contbreed.setBounds(new Rectangle(55, 307, 270, 19));
        this.add(contbreed, null);
        contsubsidyType.setBounds(new Rectangle(55, 387, 270, 19));
        this.add(contsubsidyType, null);
        contsubsidy.setBounds(new Rectangle(55, 427, 270, 19));
        this.add(contsubsidy, null);
        contbaseStatus.setBounds(new Rectangle(55, 471, 270, 19));
        this.add(contbaseStatus, null);
        contenableYear.setBounds(new Rectangle(55, 267, 270, 19));
        this.add(contenableYear, null);
        contfarmerType.setBounds(new Rectangle(55, 347, 270, 19));
        this.add(contfarmerType, null);
        //kDLabelContainer1
        ...
        //contsubsidy
        contsubsidy.setBoundEditor(txtsubsidy);
        //contbaseStatus
        contbaseStatus.setBoundEditor(baseStatus);
        //contenableYear
        contenableYear.setBoundEditor(txtenableYear);
        //contfarmerType
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("subsidyType", com.kingdee.eas.farm.carnivorous.basedata.SubsidyType.class, this.subsidyType, "selectedItem");
		dataBinder.registerBinding("subsidy", java.math.BigDecimal.class, this.txtsubsidy, "value");
		...
		dataBinder.registerBinding("enableYear", int.class, this.txtenableYear, "value");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.ConFeedPolicyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("enableYear", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("enableYear"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractConFeedPolicyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractConFeedPolicyEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "ConFeedPolicyEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.ConFeedPolicyEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyInfo objectValue = new com.kingdee.eas.farm.carnivorous.basedata.ConFeedPolicyInfo();

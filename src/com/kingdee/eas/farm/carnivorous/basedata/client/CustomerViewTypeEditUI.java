 ...
 * output class name
 */
public class CustomerViewTypeEditUI extends AbstractCustomerViewTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerViewTypeEditUI.class);
    
    /**
     * output class constructor
     */
    public CustomerViewTypeEditUI() throws Exception
    {
        super();
    }
    @Override

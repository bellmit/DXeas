...
import com.kingdee.eas.farm.carnivorous.basedata.IMarginBreedPolicy;
 ...
 * output class name
 */
public class MarginBreedPolicyListUI extends AbstractMarginBreedPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginBreedPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public MarginBreedPolicyListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
    	...
    	IMarginBreedPolicy  intenface= (IMarginBreedPolicy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audtit(intenface.getMarginBreedPolicyInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getMarginBreedPolicyInfo(pk));		
		}

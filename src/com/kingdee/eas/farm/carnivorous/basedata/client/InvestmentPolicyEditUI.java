 ...
 * output class name
 */
public class InvestmentPolicyEditUI extends AbstractInvestmentPolicyEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(InvestmentPolicyEditUI.class);
	/**
	 * output class constructor
	 */
	public InvestmentPolicyEditUI() throws Exception
	{
		super();
	}
	/**
	...
	protected void setFieldsNull(AbstractObjectValue arg0) {
		...
		InvestmentPolicyInfo newInfo = (InvestmentPolicyInfo) arg0;
		InvestmentPolicyEntryCollection entryColl = newInfo.getEntry();
		Calendar c = null;
		Calendar c1 = null;
		for(int i = 0; i < entryColl.size(); i++){
			InvestmentPolicyEntryInfo entryInfo = entryColl.get(i);
			//获取原来的结束日期

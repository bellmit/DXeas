 ...
 * output class name
 */
public abstract class AbstractBreedSeedPriceEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBreedSeedPriceEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.BreedSeedPriceInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractBreedSeedPriceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBreedSeedPriceEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 388, 381));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(24, 21, 340, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(24, 68, 340, 19));
        this.add(kDLabelContainer2, null);
        kdtEntry.setBounds(new Rectangle(13, 217, 354, 153));
        kdtEntry_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntry,new com.kingdee.eas.farm.carnivorous.basedata.BreedSeedPriceEntryInfo(),null,false);
        this.add(kdtEntry_detailPanel, null);
        contcompany.setBounds(new Rectangle(24, 100, 340, 19));
        this.add(contcompany, null);
        contbeginDate.setBounds(new Rectangle(24, 128, 340, 19));
        this.add(contbeginDate, null);
        contendDate.setBounds(new Rectangle(24, 156, 340, 19));
        this.add(contendDate, null);
        contbillStatus.setBounds(new Rectangle(24, 187, 340, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entry", com.kingdee.eas.farm.carnivorous.basedata.BreedSeedPriceEntryInfo.class, this.kdtEntry, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.BreedSeedPriceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.BreedSeedPriceInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBreedSeedPriceEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBreedSeedPriceEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "BreedSeedPriceEditUI");
    }

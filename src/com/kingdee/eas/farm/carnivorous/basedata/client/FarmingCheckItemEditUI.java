 ...
 * output class name
 */
public class FarmingCheckItemEditUI extends AbstractFarmingCheckItemEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmingCheckItemEditUI.class);
    
    /**
     * output class constructor
     */
    public FarmingCheckItemEditUI() throws Exception
    {
        super();
    }
    @Override

 ...
 * output class name
 */
public class SubsidyPolicyEditUI extends AbstractSubsidyPolicyEditUI
{
	private static final Logger logger = CoreUIObject.getLogger(SubsidyPolicyEditUI.class);

	/**
	 * output class constructor
	 */
	public SubsidyPolicyEditUI() throws Exception
	{
		super();
	}
	...
	public void onLoad() throws Exception {
		...
		this.contsubsidyType.setVisible(false);
	...
	public void setDataObject(IObjectValue dataObject) 
	{
		...
		if(STATUS_ADDNEW.equals(getOprtState())) {
			editData.put("treeid",(com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyTreeInfo)getUIContext().get(UIContext.PARENTNODE));
		}
	}

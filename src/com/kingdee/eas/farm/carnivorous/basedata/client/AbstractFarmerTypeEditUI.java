 ...
 * output class name
 */
public abstract class AbstractFarmerTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFarmerTypeEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.FarmerTypeInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFarmerTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFarmerTypeEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {baseStatus}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 375, 275));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(59, 72, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(59, 110, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer4.setBounds(new Rectangle(59, 189, 270, 19));
        this.add(kDLabelContainer4, null);
        contFICompany.setBounds(new Rectangle(59, 34, 270, 19));
        this.add(contFICompany, null);
        contbaseStatus.setBounds(new Rectangle(59, 148, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.FarmerTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.FarmerTypeInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFarmerTypeEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFarmerTypeEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "FarmerTypeEditUI");
    }

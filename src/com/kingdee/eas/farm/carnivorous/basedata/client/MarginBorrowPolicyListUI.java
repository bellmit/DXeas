...
import com.kingdee.eas.farm.carnivorous.basedata.IMarginBorrowPolicy;
 ...
 * output class name
 */
public class MarginBorrowPolicyListUI extends AbstractMarginBorrowPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarginBorrowPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public MarginBorrowPolicyListUI() throws Exception
    {
        super();
    }
...
//        super.actionAudit_actionPerformed(e);
		...
		IMarginBorrowPolicy  intenface= (IMarginBorrowPolicy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
				...
				intenface.audit(intenface.getMarginBorrowPolicyInfo(pk));
		}
...
//        super.actionAudit_actionPerformed(e);
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getMarginBorrowPolicyInfo(pk));		
		}

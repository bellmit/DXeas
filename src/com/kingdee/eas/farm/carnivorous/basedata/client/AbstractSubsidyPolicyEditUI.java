 ...
 * output class name
 */
public abstract class AbstractSubsidyPolicyEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSubsidyPolicyEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractSubsidyPolicyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSubsidyPolicyEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {baseStatus,pkbeginDate,pkendDate,subsidyType,txtamount}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 382, 259));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(56, 39, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(56, 82, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer4.setBounds(new Rectangle(341, 140, 269, 19));
        this.add(kDLabelContainer4, null);
        contFICompany.setBounds(new Rectangle(56, 125, 270, 19));
        this.add(contFICompany, null);
        contbaseStatus.setBounds(new Rectangle(53, 162, 270, 19));
        this.add(contbaseStatus, null);
        contbeginDate.setBounds(new Rectangle(342, 167, 270, 19));
        this.add(contbeginDate, null);
        contendDate.setBounds(new Rectangle(342, 210, 270, 19));
        this.add(contendDate, null);
        contsubsidyType.setBounds(new Rectangle(342, 253, 270, 19));
        this.add(contsubsidyType, null);
        contamount.setBounds(new Rectangle(342, 296, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.SubsidyPolicyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSubsidyPolicyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSubsidyPolicyEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "SubsidyPolicyEditUI");
    }

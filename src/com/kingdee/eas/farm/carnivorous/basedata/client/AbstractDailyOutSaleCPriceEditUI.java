 ...
 * output class name
 */
public abstract class AbstractDailyOutSaleCPriceEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDailyOutSaleCPriceEditUI.class);
    ...
    protected com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractDailyOutSaleCPriceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDailyOutSaleCPriceEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {pkbizDate,prmtbreedData,baseStatus,kdtEntrys,txtDescription,txtNumber,prmtFICompany}));
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer1.setBounds(new Rectangle(46, 35, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(46, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer4.setBounds(new Rectangle(380, 75, 270, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(380, 75, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contFICompany.setBounds(new Rectangle(712, 35, 270, 19));
        this.add(contFICompany, new KDLayout.Constraints(712, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbizDate.setBounds(new Rectangle(380, 35, 270, 19));
        this.add(contbizDate, new KDLayout.Constraints(380, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbreedData.setBounds(new Rectangle(46, 75, 270, 19));
        this.add(contbreedData, new KDLayout.Constraints(46, 75, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbaseStatus.setBounds(new Rectangle(712, 75, 270, 19));
        this.add(contbaseStatus, new KDLayout.Constraints(712, 75, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kdtEntrys.setBounds(new Rectangle(46, 140, 942, 449));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(46, 140, 942, 449, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
vo.put("maxSymbol","<");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.DailyOutSaleCPriceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceInfo)ov;
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.farm.carnivorous.basedata.DailyOutSaleCPriceFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDailyOutSaleCPriceEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDailyOutSaleCPriceEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "DailyOutSaleCPriceEditUI");
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.DailyOutSaleCPriceEditUI.class.getName();
    }

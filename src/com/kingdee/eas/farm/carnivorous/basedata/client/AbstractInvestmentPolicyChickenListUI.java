...
public abstract class AbstractInvestmentPolicyChickenListUI extends com.kingdee.eas.framework.client.ListUI
{
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("materialNuo.number"));
        sic.add(new SelectorItemInfo("materialNuo.name"));

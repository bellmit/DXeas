 ...
 * output class name
 */
public abstract class AbstractSubsidyPolicyListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSubsidyPolicyListUI.class);
    ...
    protected ActionUnAudit actionUnAudit = null;
		...
		public AbstractSubsidyPolicyListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractSubsidyPolicyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSubsidyPolicyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.app", "SubsidyPolicyQuery");
        //actionAudit
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.farm.carnivorous.basedata.app.SubsidyPolicyListUIHandler";
	}
...
com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo editData = (com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyFactory.getRemoteInstance().audit(editData);
    }
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
        if (getSelectedKeyValue() == null) return;
com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo editData = (com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyInfo)getBizInterface().getValue(new com.kingdee.bos.dao.ormapping.ObjectUuidPK(BOSUuid.read(getSelectedKeyValue())));
com.kingdee.eas.farm.carnivorous.basedata.SubsidyPolicyFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSubsidyPolicyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSubsidyPolicyListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.farm.carnivorous.basedata.client", "SubsidyPolicyListUI");
    }
    ...
    {
        return com.kingdee.eas.farm.carnivorous.basedata.client.SubsidyPolicyEditUI.class.getName();
    }

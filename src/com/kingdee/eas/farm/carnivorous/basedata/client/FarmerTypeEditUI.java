 ...
 * output class name
 */
public class FarmerTypeEditUI extends AbstractFarmerTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FarmerTypeEditUI.class);
    
    /**
     * output class constructor
     */
    public FarmerTypeEditUI() throws Exception
    {
        super();
    }
    @Override

...
import com.kingdee.eas.farm.carnivorous.basedata.ITempPolicy;
 ...
 * output class name
 */
public class TempPolicyListUI extends AbstractTempPolicyListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TempPolicyListUI.class);
    
    /**
     * output class constructor
     */
    public TempPolicyListUI() throws Exception
    {
        super();
    }
    ...
    {
		ITempPolicy  intenface= (ITempPolicy) getBizInterface();
		...
		for(int j=0;j<billIdlist.length;j++){
			...
			intenface.audit(intenface.getTempPolicyInfo(pk));
		}
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
		...
		for(int j=0;j<billIdlist.length;j++){
				// 反核准操作
				IObjectPK pk = new ObjectStringPK(billIdlist[j].toString());
				intenface.unAudit(intenface.getTempPolicyInfo(pk));		
		}

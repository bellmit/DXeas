...
public class AbstractBrowerItemInfo extends com.kingdee.eas.framework.DataBaseInfo implements Serializable 
{
    public AbstractBrowerItemInfo()
    {
        this("id");
    }
    protected AbstractBrowerItemInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object: 借款项目 's 组别 property 
     */
    public com.kingdee.eas.farm.carnivorous.basedata.BrowerItemTreeInfo getTreeid()
    {
        return (com.kingdee.eas.farm.carnivorous.basedata.BrowerItemTreeInfo)get("treeid");
    }
    public void setTreeid(com.kingdee.eas.farm.carnivorous.basedata.BrowerItemTreeInfo item)
    {
        put("treeid", item);
    }
    /**

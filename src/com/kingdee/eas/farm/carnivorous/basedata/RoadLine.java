...
public class RoadLine extends DataBase implements IRoadLine
{
    public RoadLine()
    {
        super();
        registerInterface(IRoadLine.class, this);
    }
    public RoadLine(Context ctx)
    {
        super(ctx);
        registerInterface(IRoadLine.class, this);
    }
    ...
    private RoadLineController getController() throws BOSException
    {
        return (RoadLineController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRoadLineInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getRoadLineInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoadLineInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoadLineCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoadLineCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoadLineCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

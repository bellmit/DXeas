...
public class SystemSettingMarginTypeEntry extends CoreBillEntryBase implements ISystemSettingMarginTypeEntry
{
    public SystemSettingMarginTypeEntry()
    {
        super();
        registerInterface(ISystemSettingMarginTypeEntry.class, this);
    }
    public SystemSettingMarginTypeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISystemSettingMarginTypeEntry.class, this);
    }
    ...
    private SystemSettingMarginTypeEntryController getController() throws BOSException
    {
        return (SystemSettingMarginTypeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSystemSettingMarginTypeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

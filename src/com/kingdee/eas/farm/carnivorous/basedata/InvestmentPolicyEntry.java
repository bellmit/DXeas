...
public class InvestmentPolicyEntry extends CoreBillEntryBase implements IInvestmentPolicyEntry
{
    public InvestmentPolicyEntry()
    {
        super();
        registerInterface(IInvestmentPolicyEntry.class, this);
    }
    public InvestmentPolicyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IInvestmentPolicyEntry.class, this);
    }
    ...
    {
        return new BOSObjectType("60E10D2B");
    }
    private InvestmentPolicyEntryController getController() throws BOSException
    {
        return (InvestmentPolicyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvestmentPolicyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

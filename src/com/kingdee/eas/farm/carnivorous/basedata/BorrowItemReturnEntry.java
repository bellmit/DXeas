...
public class BorrowItemReturnEntry extends CoreBillEntryBase implements IBorrowItemReturnEntry
{
    public BorrowItemReturnEntry()
    {
        super();
        registerInterface(IBorrowItemReturnEntry.class, this);
    }
    public BorrowItemReturnEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBorrowItemReturnEntry.class, this);
    }
    ...
    private BorrowItemReturnEntryController getController() throws BOSException
    {
        return (BorrowItemReturnEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBorrowItemReturnEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

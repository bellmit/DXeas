...
public class MarginBreedPolicyEntry extends CoreBillEntryBase implements IMarginBreedPolicyEntry
{
    public MarginBreedPolicyEntry()
    {
        super();
        registerInterface(IMarginBreedPolicyEntry.class, this);
    }
    public MarginBreedPolicyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMarginBreedPolicyEntry.class, this);
    }
    ...
    private MarginBreedPolicyEntryController getController() throws BOSException
    {
        return (MarginBreedPolicyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarginBreedPolicyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

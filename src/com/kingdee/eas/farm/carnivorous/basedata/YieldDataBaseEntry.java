...
public class YieldDataBaseEntry extends CoreBillEntryBase implements IYieldDataBaseEntry
{
    public YieldDataBaseEntry()
    {
        super();
        registerInterface(IYieldDataBaseEntry.class, this);
    }
    public YieldDataBaseEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IYieldDataBaseEntry.class, this);
    }
    ...
    private YieldDataBaseEntryController getController() throws BOSException
    {
        return (YieldDataBaseEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getYieldDataBaseEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

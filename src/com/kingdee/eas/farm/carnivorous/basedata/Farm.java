...
public class Farm extends DataBase implements IFarm
{
    public Farm()
    {
        super();
        registerInterface(IFarm.class, this);
    }
    public Farm(Context ctx)
    {
        super(ctx);
        registerInterface(IFarm.class, this);
    }
    ...
    private FarmController getController() throws BOSException
    {
        return (FarmController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFarmInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getFarmInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFarmCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

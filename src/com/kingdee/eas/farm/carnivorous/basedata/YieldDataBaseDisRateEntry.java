...
public class YieldDataBaseDisRateEntry extends CoreBillEntryBase implements IYieldDataBaseDisRateEntry
{
    public YieldDataBaseDisRateEntry()
    {
        super();
        registerInterface(IYieldDataBaseDisRateEntry.class, this);
    }
    public YieldDataBaseDisRateEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IYieldDataBaseDisRateEntry.class, this);
    }
    ...
    private YieldDataBaseDisRateEntryController getController() throws BOSException
    {
        return (YieldDataBaseDisRateEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getYieldDataBaseDisRateEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class AbstractOtherStorageBillEntryDetailInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractOtherStorageBillEntryDetailInfo()
    {
        this("id");
    }
    protected AbstractOtherStorageBillEntryDetailInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.weighbridge.OtherStorageBillEntryInfo getParent1()
    {
        return (com.kingdee.eas.weighbridge.OtherStorageBillEntryInfo)get("parent1");
    }
    public void setParent1(com.kingdee.eas.weighbridge.OtherStorageBillEntryInfo item)
    {
        put("parent1", item);
    }
    /**

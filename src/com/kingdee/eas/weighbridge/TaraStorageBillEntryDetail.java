...
public class TaraStorageBillEntryDetail extends CoreBillEntryBase implements ITaraStorageBillEntryDetail
{
    public TaraStorageBillEntryDetail()
    {
        super();
        registerInterface(ITaraStorageBillEntryDetail.class, this);
    }
    public TaraStorageBillEntryDetail(Context ctx)
    {
        super(ctx);
        registerInterface(ITaraStorageBillEntryDetail.class, this);
    }
    ...
    {
        return new BOSObjectType("9B563978");
    }
    private TaraStorageBillEntryDetailController getController() throws BOSException
    {
        return (TaraStorageBillEntryDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaraStorageBillEntryDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

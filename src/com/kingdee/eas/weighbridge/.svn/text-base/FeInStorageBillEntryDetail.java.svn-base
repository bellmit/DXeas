...
public class FeInStorageBillEntryDetail extends CoreBillEntryBase implements IFeInStorageBillEntryDetail
{
    public FeInStorageBillEntryDetail()
    {
        super();
        registerInterface(IFeInStorageBillEntryDetail.class, this);
    }
    public FeInStorageBillEntryDetail(Context ctx)
    {
        super(ctx);
        registerInterface(IFeInStorageBillEntryDetail.class, this);
    }
    ...
    private FeInStorageBillEntryDetailController getController() throws BOSException
    {
        return (FeInStorageBillEntryDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeInStorageBillEntryDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

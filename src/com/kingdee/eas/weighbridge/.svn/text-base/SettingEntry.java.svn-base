...
public class SettingEntry extends CoreBillEntryBase implements ISettingEntry
{
    public SettingEntry()
    {
        super();
        registerInterface(ISettingEntry.class, this);
    }
    public SettingEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISettingEntry.class, this);
    }
    ...
    private SettingEntryController getController() throws BOSException
    {
        return (SettingEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSettingEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettingEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettingEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettingEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettingEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSettingEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

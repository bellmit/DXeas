...
public class AbstractTaraStorageBillInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractTaraStorageBillInfo()
    {
        this("id");
    }
    protected AbstractTaraStorageBillInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.weighbridge.TaraStorageBillEntryCollection());
    }
    /**
     * Object: 皮重过磅单 's 过磅记录 property 
     */
    public com.kingdee.eas.weighbridge.TaraStorageBillEntryCollection getEntrys()
    {
        return (com.kingdee.eas.weighbridge.TaraStorageBillEntryCollection)get("entrys");
    }
    /**
     * Object:皮重过磅单's 是否生成凭证property 
     */
    ...
    /**
     * Object: 皮重过磅单 's 当前库存组织 property 
     */
    ...
    /**
     * Object: 皮重过磅单 's 来源库存组织 property 
     */
    ...
    /**
     * Object:皮重过磅单's 是否自动生成出入库单据property 
     */
    ...
    /**
     * Object: 皮重过磅单 's 当前财务组织 property 
     */
    ...
    /**
     * Object: 皮重过磅单 's 目标财务组织 property 
     */

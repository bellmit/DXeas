 ...
 * output class name
 */
public class FeInStorageBillEditUI extends AbstractFeInStorageBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeInStorageBillEditUI.class);
    
    /**
     * output class constructor
     */
    public FeInStorageBillEditUI() throws Exception
    {
        super();
    }
    /**

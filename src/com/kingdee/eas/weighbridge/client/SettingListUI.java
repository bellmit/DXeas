 ...
 * output class name
 */
public class SettingListUI extends AbstractSettingListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettingListUI.class);
    
    /**
     * output class constructor
     */
    public SettingListUI() throws Exception
    {
        super();
    }
	...
	protected FilterInfo getDefaultFilterForQuery() {
		...
		String mac="";
		try {
			mac = ComReaderUtils.getLocalMac();
		} catch (Exception e) {
			e.printStackTrace();
		} 
		FilterInfo fliterInfo=super.getDefaultFilterForQuery();
		fliterInfo.getFilterItems().clear();
		fliterInfo.getFilterItems().add(new FilterItemInfo("mac",mac,CompareType.EQUALS));

 ...
 * output class name
 */
public abstract class AbstractTaraStorageBillPlatformUI extends  com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaraStorageBillPlatformUI.class);
     ...
     */
    public AbstractTaraStorageBillPlatformUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaraStorageBillPlatformUI.class.getName());
        ...
        // txtTare
        // txtGross		
        this.txtGross.setVisible(false);		
    ...
    public void initUIContentLayout()
    {
        ...
        tbList.setBounds(new Rectangle(13, 350, 991, 263));
        this.add(tbList, new KDLayout.Constraints(13, 350, 991, 263, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contCar.setBounds(new Rectangle(94, 9, 200, 19));
        this.add(contCar, new KDLayout.Constraints(94, 9, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer3.setBounds(new Rectangle(41, 250, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(41, 250, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer4.setBounds(new Rectangle(41, 191, 270, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(41, 191, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer5.setBounds(new Rectangle(626, 4, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(626, 4, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer9.setBounds(new Rectangle(41, 97, 270, 19));
        this.add(kDLabelContainer9, new KDLayout.Constraints(41, 97, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contImpurity.setBounds(new Rectangle(203, 6, 130, 19));
        this.add(contImpurity, new KDLayout.Constraints(203, 6, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contImpurity2.setBounds(new Rectangle(343, 6, 130, 19));
        this.add(contImpurity2, new KDLayout.Constraints(343, 6, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        chkIsTemp.setBounds(new Rectangle(24, 9, 68, 19));
        this.add(chkIsTemp, new KDLayout.Constraints(24, 9, 68, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        conttongType.setBounds(new Rectangle(41, 129, 270, 19));
        this.add(conttongType, new KDLayout.Constraints(41, 129, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        AllWeighted.setBounds(new Rectangle(37, 29, 122, 36));
        this.add(AllWeighted, new KDLayout.Constraints(37, 29, 122, 36, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDAllWeight.setBounds(new Rectangle(827, 22, 160, 67));
        this.add(kDAllWeight, new KDLayout.Constraints(827, 22, 160, 67, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        frame.setBounds(new Rectangle(42, 161, 270, 19));
        this.add(frame, new KDLayout.Constraints(42, 161, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCar
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.TaraStorageBillPlatformUIHandler";
	}
    ...
    protected class actionAllWeighted extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTaraStorageBillPlatformUI.this, "actionAllWeighted", "actionAllWeighted_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "TaraStorageBillPlatformUI");
    }

 ...
 * output class name
 */
public class SelectSaleOrderUI extends AbstractSelectSaleOrderUI
{
    private static final Logger logger = CoreUIObject.getLogger(SelectSaleOrderUI.class);
     ...
     */
    public SelectSaleOrderUI() throws Exception
    {
        super();
    }
    /**
...
//    						SysUtil.abort();
    				...
    				OrderWeightInfo orderInfo = orderMaps.get(row.getCell("billID").getValue().toString());

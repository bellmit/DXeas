 ...
 * output class name
 */
public class PurorderUpdateLogListUI extends AbstractPurorderUpdateLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PurorderUpdateLogListUI.class);
    
    /**
     * output class constructor
     */
    public PurorderUpdateLogListUI() throws Exception
    {
        super();
    }

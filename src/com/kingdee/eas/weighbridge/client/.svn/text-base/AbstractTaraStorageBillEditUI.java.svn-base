 ...
 * output class name
 */
public abstract class AbstractTaraStorageBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaraStorageBillEditUI.class);
    ...
    protected com.kingdee.eas.weighbridge.TaraStorageBillInfo editData = null;
     ...
     */
    public AbstractTaraStorageBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaraStorageBillEditUI.class.getName());
        ...
        this.continTime.setVisible(false);
        // contoutTime		
        ...
        this.pkinTime.setVisible(false);
        // pkoutTime		
        ...
        this.txttareWeight.setVisible(false);
        // prmtstorageOrgUnit		
        ...
        this.prmtorderStorageOrgUnit.setVisible(false);
        // prmtweighman		
        ...
        this.prmtorderCompany.setVisible(false);
        // prmtcompany		
        ...
        // txtpurOrderNumber		
        this.txtpurOrderNumber.setVisible(false);		
        ...
        // carcassType		
        this.carcassType.setVisible(false);		
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(33, 244, 913, 196));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.weighbridge.TaraStorageBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(33, 244, 913, 196, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtDetail.setBounds(new Rectangle(34, 454, 913, 48));
        kdtDetail_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtDetail,new com.kingdee.eas.weighbridge.TaraStorageBillEntryDetailInfo(),null,false);
        this.add(kdtDetail_detailPanel, new KDLayout.Constraints(34, 454, 913, 48, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contsupplier.setBounds(new Rectangle(675, 184, 270, 19));
        this.add(contsupplier, new KDLayout.Constraints(675, 184, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contpurOrderNumber.setBounds(new Rectangle(626, 211, 270, 19));
        this.add(contpurOrderNumber, new KDLayout.Constraints(626, 211, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.weighbridge.TaraStorageBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.Detail", com.kingdee.eas.weighbridge.TaraStorageBillEntryDetailInfo.class, this.kdtDetail, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.TaraStorageBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.weighbridge.TaraStorageBillInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"model")));
    ...
    {
        com.kingdee.eas.weighbridge.TaraStorageBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.weighbridge.TaraStorageBillFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    {
        com.kingdee.eas.weighbridge.TaraStorageBillFactory.getRemoteInstance().updateSourceBill(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTaraStorageBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaraStorageBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUpdateSourceBill extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaraStorageBillEditUI.this, "ActionUpdateSourceBill", "actionUpdateSourceBill_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "TaraStorageBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.weighbridge.client.TaraStorageBillEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/weighbridge/TaraStorageBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.weighbridge.app.TaraStorageBillQuery");
	}

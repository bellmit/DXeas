 ...
 * output class name
 */
public abstract class AbstractPurorderUpdateLogListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPurorderUpdateLogListUI.class);
    /**
     * output class constructor
     */
    public AbstractPurorderUpdateLogListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.PurorderUpdateLogListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "PurorderUpdateLogListUI");
    }

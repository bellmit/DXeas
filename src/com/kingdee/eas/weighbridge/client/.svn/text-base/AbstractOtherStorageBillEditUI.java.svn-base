 ...
 * output class name
 */
public abstract class AbstractOtherStorageBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOtherStorageBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contorderCompany;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contSendCar;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtorderCompany;
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtSendCar;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem btnUpdateSourceBill;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnUnAudit;
    protected com.kingdee.eas.weighbridge.OtherStorageBillInfo editData = null;
     ...
     */
    public AbstractOtherStorageBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOtherStorageBillEditUI.class.getName());
        ...
        this.contorderCompany = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.contSendCar = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.prmtorderCompany = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.prmtSendCar = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contorderCompany.setName("contorderCompany");
        ...
        this.contSendCar.setName("contSendCar");
        ...
        this.prmtorderCompany.setName("prmtorderCompany");
        ...
        this.prmtSendCar.setName("prmtSendCar");
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","mateiralName","model","Unit","qty","tare","gross","frame","tare2","impurity","impurity2","suttle","weighTime","weighTimeGross","weighTime2","price","sourceBillID","sourceBillEntryID"});
        ...
        KDFormattedTextField kdtEntrys_frame_TextField = new KDFormattedTextField();
        kdtEntrys_frame_TextField.setName("kdtEntrys_frame_TextField");
        kdtEntrys_frame_TextField.setVisible(true);
        kdtEntrys_frame_TextField.setEditable(true);
        kdtEntrys_frame_TextField.setHorizontalAlignment(2);
        kdtEntrys_frame_TextField.setDataType(0);
        KDTDefaultCellEditor kdtEntrys_frame_CellEditor = new KDTDefaultCellEditor(kdtEntrys_frame_TextField);
        this.kdtEntrys.getColumn("frame").setEditor(kdtEntrys_frame_CellEditor);
        ...
        this.contoutTime.setVisible(false);
        // conttareWeight		
        ...
        // contorderCompany		
        this.contorderCompany.setBoundLabelText(resHelper.getString("contorderCompany.boundLabelText"));		
        this.contorderCompany.setBoundLabelLength(100);		
        this.contorderCompany.setBoundLabelUnderline(true);		
        this.contorderCompany.setVisible(false);
        // contcompany		
        ...
        this.chkisAutoCreateToInvBill.setVisible(false);
        // contcarNum		
        ...
        this.contpurOrderNumber.setBoundLabelLength(100);		
        ...
        this.contsendCarNum.setVisible(false);
        // contcarcassType		
        ...
        // contSendCar		
        this.contSendCar.setBoundLabelText(resHelper.getString("contSendCar.boundLabelText"));		
        this.contSendCar.setBoundLabelLength(100);		
        this.contSendCar.setBoundLabelUnderline(true);		
        this.contSendCar.setVisible(true);
        // prmtCreator		
        ...
        this.pkoutTime.setVisible(false);
        // txttareWeight		
        ...
        // prmtorderCompany		
        this.prmtorderCompany.setEditable(true);		
        this.prmtorderCompany.setDisplayFormat("$name$");		
        this.prmtorderCompany.setEditFormat("$number$");		
        this.prmtorderCompany.setCommitFormat("$number$");		
        this.prmtorderCompany.setRequired(false);
        // prmtcompany		
        ...
        this.prmtsendCarNum.setVisible(false);		
        ...
        // prmtSendCar		
        this.prmtSendCar.setQueryInfo("com.kingdee.eas.custom.dx.weight.app.CarSendBillQuery");		
        this.prmtSendCar.setEditable(true);		
        this.prmtSendCar.setDisplayFormat("$number$");		
        this.prmtSendCar.setEditFormat("$number$");		
        this.prmtSendCar.setCommitFormat("$number$");		
        this.prmtSendCar.setRequired(false);
        // tBtnAudit
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(33, 244, 913, 206));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.weighbridge.OtherStorageBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(33, 244, 913, 206, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contcar.setBounds(new Rectangle(33, 81, 270, 19));
        this.add(contcar, new KDLayout.Constraints(33, 81, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        conttareWeight.setBounds(new Rectangle(33, 154, 270, 19));
        this.add(conttareWeight, new KDLayout.Constraints(33, 154, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtDetail.setBounds(new Rectangle(34, 460, 913, 42));
        kdtDetail_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtDetail,new com.kingdee.eas.weighbridge.OtherStorageBillEntryDetailInfo(),null,false);
        this.add(kdtDetail_detailPanel, new KDLayout.Constraints(34, 460, 913, 42, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contbizType.setBounds(new Rectangle(33, 45, 270, 19));
        this.add(contbizType, new KDLayout.Constraints(33, 45, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contsupplier.setBounds(new Rectangle(350, 45, 270, 19));
        this.add(contsupplier, new KDLayout.Constraints(350, 45, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contorderCompany.setBounds(new Rectangle(676, 154, 270, 19));
        this.add(contorderCompany, new KDLayout.Constraints(676, 154, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contcarNum.setBounds(new Rectangle(33, 117, 270, 19));
        this.add(contcarNum, new KDLayout.Constraints(33, 117, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contpurOrderNumber.setBounds(new Rectangle(676, 185, 270, 19));
        this.add(contpurOrderNumber, new KDLayout.Constraints(676, 185, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contsendCarNum.setBounds(new Rectangle(673, 212, 270, 19));
        this.add(contsendCarNum, new KDLayout.Constraints(673, 212, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contcarcassType.setBounds(new Rectangle(351, 210, 270, 19));
        this.add(contcarcassType, new KDLayout.Constraints(351, 210, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contSendCar.setBounds(new Rectangle(33, 213, 270, 19));
        this.add(contSendCar, new KDLayout.Constraints(33, 213, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        //contorderCompany
        contorderCompany.setBoundEditor(prmtorderCompany);
        //contcompany
        ...
        //contSendCar
        contSendCar.setBoundEditor(prmtSendCar);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.weighbridge.OtherStorageBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.frame", int.class, this.kdtEntrys, "frame.text");
		dataBinder.registerBinding("entrys.Detail.seq", int.class, this.kdtDetail, "seq.text");
		dataBinder.registerBinding("entrys.Detail", com.kingdee.eas.weighbridge.OtherStorageBillEntryDetailInfo.class, this.kdtDetail, "userObject");
		...
		dataBinder.registerBinding("orderCompany", com.kingdee.eas.basedata.org.CompanyOrgUnitInfo.class, this.prmtorderCompany, "data");
		...
		dataBinder.registerBinding("SendCar", com.kingdee.eas.custom.dx.weight.CarSendBillInfo.class, this.prmtSendCar, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.OtherStorageBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.weighbridge.OtherStorageBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.frame", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("orderCompany", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("SendCar", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntrys.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"model")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.frame"));
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("orderCompany.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("orderCompany.id"));
        	sic.add(new SelectorItemInfo("orderCompany.number"));
        	sic.add(new SelectorItemInfo("orderCompany.name"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("SendCar.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("SendCar.id"));
        	sic.add(new SelectorItemInfo("SendCar.number"));
		}
        return sic;
    }        
    ...
    {
        com.kingdee.eas.weighbridge.OtherStorageBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.weighbridge.OtherStorageBillFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    {
        com.kingdee.eas.weighbridge.OtherStorageBillFactory.getRemoteInstance().updateSourceBill(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOtherStorageBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOtherStorageBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUpdateSourceBill extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOtherStorageBillEditUI.this, "ActionUpdateSourceBill", "actionUpdateSourceBill_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "OtherStorageBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.weighbridge.client.OtherStorageBillEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.weighbridge.OtherStorageBillFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.weighbridge.OtherStorageBillInfo objectValue = new com.kingdee.eas.weighbridge.OtherStorageBillInfo();
    	...
    	return "/bim/weighbridge/OtherStorageBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.weighbridge.app.OtherStorageBillQuery");
	}

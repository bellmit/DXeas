 ...
 * output class name
 */
public class OtherStorageBillEditUI extends AbstractOtherStorageBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherStorageBillEditUI.class);
    
    /**
     * output class constructor
     */
    public OtherStorageBillEditUI() throws Exception
    {
        super();
    }
    /**

 ...
 * output class name
 */
public class InStorageBillListUI extends AbstractInStorageBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InStorageBillListUI.class);
    
    /**
     * output class constructor
     */
    public InStorageBillListUI() throws Exception
    {
        super();
    }
	...
	public void onShow() throws Exception {
		...
		private void customInitControl() {
			...
			this.tblMain.getHead().getRow(0).getCell(this.tblMain.getColumnIndex("description")).setValue("风干鸡数量");
			this.tblMain.getHead().getRow(0).getCell(this.tblMain.getColumnIndex("entrys.impurity")).setValue("垫料重量");
			this.tblMain.getHead().getRow(0).getCell(this.tblMain.getColumnIndex("entrys.impurity2")).setValue("风干鸡重量");
		}
		/**
		 * 行选择 改变事件
		 * @param rowIndex

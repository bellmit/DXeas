 ...
 * output class name
 */
public abstract class AbstractOrderSelectUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOrderSelectUI.class);
     ...
     */
    public AbstractOrderSelectUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOrderSelectUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDTable1.setBounds(new Rectangle(5, 7, 790, 500));
        this.add(kDTable1, null);
        btnQuery.setBounds(new Rectangle(474, 542, 73, 21));
        this.add(btnQuery, null);
        btnOK.setBounds(new Rectangle(225, 539, 73, 21));
        this.add(btnOK, null);
        kDSeparator2.setBounds(new Rectangle(12, 521, 782, 10));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.OrderSelectUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "OrderSelectUI");
    }

 ...
 * output class name
 */
public class StorageBillEditBillListUI extends AbstractStorageBillEditBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StorageBillEditBillListUI.class);
    
    /**
     * output class constructor
     */
    public StorageBillEditBillListUI() throws Exception
    {
        super();
    }

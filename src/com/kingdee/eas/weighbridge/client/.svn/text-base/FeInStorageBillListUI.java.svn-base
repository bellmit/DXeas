 ...
 * output class name
 */
public class FeInStorageBillListUI extends AbstractFeInStorageBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FeInStorageBillListUI.class);
    
    /**
     * output class constructor
     */
    public FeInStorageBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class InStorageBillEditUI extends AbstractInStorageBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(InStorageBillEditUI.class);
    
    /**
     * output class constructor
     */
    public InStorageBillEditUI() throws Exception
    {
        super();
...
//			return;
//		}
//		this.contDescription.setBoundLabelText("风干鸡数量");
//		this.kdtEntrys.checkParsed();
//		this.kdtEntrys.getHead().getRow(0).getCell(this.kdtEntrys.getColumnIndex("impurity")).setValue("垫料重量");
//		this.kdtEntrys.getHead().getRow(0).getCell(this.kdtEntrys.getColumnIndex("impurity2")).setValue("风干鸡重量");
//	}

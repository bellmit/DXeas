 ...
 * output class name
 */
public class SettingEditUI extends AbstractSettingEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettingEditUI.class);
    
    /**
     * output class constructor
     */
    public SettingEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    protected com.kingdee.bos.dao.IObjectValue createNewData()
    {
        ...
        if(storageInfo.isIsBizUnit())
        	objectValue.setStorageOrgUnit(storageInfo);
        return objectValue;
    }
	@Override
	protected void btnGetMac_actionPerformed(ActionEvent e) throws Exception {
		String macStr=ComReaderUtils.getLocalMac();
		this.txtmac.setText(macStr);
	}
	@Override
	public void onShow() throws Exception {
		...
		fromStorageF7.setIsCUFilter(true);
		this.prmtstorageOrgUnit.setSelector(fromStorageF7);
		...
		F7MaterialSimpleSelector m7 = new F7MaterialSimpleSelector(this, kdtMaterialEntrys_material_PromptBox);
		kdtMaterialEntrys_material_PromptBox.setSelector(m7);

 ...
 * output class name
 */
public abstract class AbstractWeightPlatformBaseUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWeightPlatformBaseUI.class);
    protected com.kingdee.eas.framework.CoreBillBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWeightPlatformBaseUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWeightPlatformBaseUI.class.getName());
        ...
        this.MenuItemPCVoucher.setVisible(false);		
        this.menuItemDelPCVoucher.setVisible(false);		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.WeightPlatformBaseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "WeightPlatformBaseUI");
    }

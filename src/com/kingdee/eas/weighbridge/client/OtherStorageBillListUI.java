 ...
 * output class name
 */
public class OtherStorageBillListUI extends AbstractOtherStorageBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(OtherStorageBillListUI.class);
    
    /**
     * output class constructor
     */
    public OtherStorageBillListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public abstract class AbstractFeInStorageBillEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeInStorageBillEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpurnumber;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpurid;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsupplier;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contQCNumber;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtpurnumber;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtpurid;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtsupplier;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtQCNumber;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton tBtnUnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnAudit;
    protected com.kingdee.bos.ctrl.swing.KDMenuItem mBtnUnAudit;
    protected com.kingdee.eas.weighbridge.FeInStorageBillInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFeInStorageBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeInStorageBillEditUI.class.getName());
        ...
        this.contpurnumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contpurid = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contsupplier = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contQCNumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtpurnumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtpurid = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.prmtsupplier = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.txtQCNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contpurnumber.setName("contpurnumber");
        this.contpurid.setName("contpurid");
        this.contsupplier.setName("contsupplier");
        this.contQCNumber.setName("contQCNumber");
        ...
        this.txtpurnumber.setName("txtpurnumber");
        this.txtpurid.setName("txtpurid");
        this.prmtsupplier.setName("prmtsupplier");
        this.txtQCNumber.setName("txtQCNumber");
		...
		public void editStopped(KDTEditEvent e) {
			try {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","material","mateiralName","model","Unit","qty","tare","gross","tare2","tempSuttle","suttle","actualSuttle","weighTime","weighTimeGross","weighTime2","Impurity","Impurity2","QcWeight","OtherWeight"});
        ...
        KDFormattedTextField kdtEntrys_QcWeight_TextField = new KDFormattedTextField();
        kdtEntrys_QcWeight_TextField.setName("kdtEntrys_QcWeight_TextField");
        kdtEntrys_QcWeight_TextField.setVisible(true);
        kdtEntrys_QcWeight_TextField.setEditable(true);
        kdtEntrys_QcWeight_TextField.setHorizontalAlignment(2);
        kdtEntrys_QcWeight_TextField.setDataType(1);
        	kdtEntrys_QcWeight_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_QcWeight_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_QcWeight_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_QcWeight_CellEditor = new KDTDefaultCellEditor(kdtEntrys_QcWeight_TextField);
        this.kdtEntrys.getColumn("QcWeight").setEditor(kdtEntrys_QcWeight_CellEditor);
        KDFormattedTextField kdtEntrys_OtherWeight_TextField = new KDFormattedTextField();
        kdtEntrys_OtherWeight_TextField.setName("kdtEntrys_OtherWeight_TextField");
        kdtEntrys_OtherWeight_TextField.setVisible(true);
        kdtEntrys_OtherWeight_TextField.setEditable(true);
        kdtEntrys_OtherWeight_TextField.setHorizontalAlignment(2);
        kdtEntrys_OtherWeight_TextField.setDataType(1);
        	kdtEntrys_OtherWeight_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_OtherWeight_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_OtherWeight_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_OtherWeight_CellEditor = new KDTDefaultCellEditor(kdtEntrys_OtherWeight_TextField);
        this.kdtEntrys.getColumn("OtherWeight").setEditor(kdtEntrys_OtherWeight_CellEditor);
        // contcar		
        ...
        // contpurnumber		
        this.contpurnumber.setBoundLabelText(resHelper.getString("contpurnumber.boundLabelText"));		
        this.contpurnumber.setBoundLabelLength(100);		
        this.contpurnumber.setBoundLabelUnderline(true);		
        this.contpurnumber.setVisible(true);
        // contpurid		
        this.contpurid.setBoundLabelText(resHelper.getString("contpurid.boundLabelText"));		
        this.contpurid.setBoundLabelLength(100);		
        this.contpurid.setBoundLabelUnderline(true);		
        this.contpurid.setVisible(false);
        // contsupplier		
        ...
        // contQCNumber		
        this.contQCNumber.setBoundLabelText(resHelper.getString("contQCNumber.boundLabelText"));		
        this.contQCNumber.setBoundLabelLength(100);		
        this.contQCNumber.setBoundLabelUnderline(true);		
        this.contQCNumber.setVisible(true);
        // prmtCreator		
        ...
        // txtpurnumber		
        this.txtpurnumber.setVisible(true);		
        this.txtpurnumber.setHorizontalAlignment(2);		
        this.txtpurnumber.setMaxLength(100);		
        this.txtpurnumber.setRequired(false);
        // txtpurid		
        this.txtpurid.setVisible(false);		
        this.txtpurid.setHorizontalAlignment(2);		
        this.txtpurid.setMaxLength(100);		
        this.txtpurid.setRequired(false);		
        this.txtpurid.setEnabled(false);
        // prmtsupplier		
        ...
        // txtQCNumber		
        this.txtQCNumber.setVisible(true);		
        this.txtQCNumber.setHorizontalAlignment(2);		
        this.txtQCNumber.setMaxLength(100);		
        this.txtQCNumber.setRequired(false);
        // tBtnAudit
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(33, 254, 913, 125));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.weighbridge.FeInStorageBillEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(33, 254, 913, 125, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtDetail.setBounds(new Rectangle(34, 388, 913, 114));
        kdtDetail_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtDetail,new com.kingdee.eas.weighbridge.FeInStorageBillEntryDetailInfo(),null,false);
        this.add(kdtDetail_detailPanel, new KDLayout.Constraints(34, 388, 913, 114, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contpurnumber.setBounds(new Rectangle(676, 184, 270, 19));
        this.add(contpurnumber, new KDLayout.Constraints(676, 184, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contpurid.setBounds(new Rectangle(873, 505, 270, 19));
        this.add(contpurid, new KDLayout.Constraints(873, 505, 270, 19, 0));
        contsupplier.setBounds(new Rectangle(33, 216, 270, 19));
        this.add(contsupplier, new KDLayout.Constraints(33, 216, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contQCNumber.setBounds(new Rectangle(352, 217, 270, 19));
        this.add(contQCNumber, new KDLayout.Constraints(352, 217, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
        ...
        //contpurnumber
        contpurnumber.setBoundEditor(txtpurnumber);
        //contpurid
        contpurid.setBoundEditor(txtpurid);
        //contsupplier
        contsupplier.setBoundEditor(prmtsupplier);
        //contQCNumber
        contQCNumber.setBoundEditor(txtQCNumber);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.weighbridge.FeInStorageBillEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.QcWeight", java.math.BigDecimal.class, this.kdtEntrys, "QcWeight.text");
		dataBinder.registerBinding("entrys.OtherWeight", java.math.BigDecimal.class, this.kdtEntrys, "OtherWeight.text");
		dataBinder.registerBinding("entrys.Detail.seq", int.class, this.kdtDetail, "seq.text");
		dataBinder.registerBinding("entrys.Detail", com.kingdee.eas.weighbridge.FeInStorageBillEntryDetailInfo.class, this.kdtDetail, "userObject");
		...
		dataBinder.registerBinding("purnumber", String.class, this.txtpurnumber, "text");
		dataBinder.registerBinding("purid", String.class, this.txtpurid, "text");
		dataBinder.registerBinding("supplier", com.kingdee.eas.basedata.master.cssp.SupplierInfo.class, this.prmtsupplier, "data");
		dataBinder.registerBinding("QCNumber", String.class, this.txtQCNumber, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.FeInStorageBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.weighbridge.FeInStorageBillInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.QcWeight", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.OtherWeight", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("purnumber", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("purid", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("supplier", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("QCNumber", ValidateHelper.ON_SAVE);    		
	}
...
kdtEntrys.getCell(rowIndex,"model").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"material").getValue(),"model")));
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.QcWeight"));
    	sic.add(new SelectorItemInfo("entrys.OtherWeight"));
        ...
        sic.add(new SelectorItemInfo("purnumber"));
        sic.add(new SelectorItemInfo("purid"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
        ...
        sic.add(new SelectorItemInfo("QCNumber"));
        return sic;
    }        
    ...
    {
        com.kingdee.eas.weighbridge.FeInStorageBillFactory.getRemoteInstance().audit(editData);
    }
    ...
    {
        com.kingdee.eas.weighbridge.FeInStorageBillFactory.getRemoteInstance().unAudit(editData);
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFeInStorageBillEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFeInStorageBillEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "FeInStorageBillEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.weighbridge.client.FeInStorageBillEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.weighbridge.FeInStorageBillFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.weighbridge.FeInStorageBillInfo objectValue = new com.kingdee.eas.weighbridge.FeInStorageBillInfo();

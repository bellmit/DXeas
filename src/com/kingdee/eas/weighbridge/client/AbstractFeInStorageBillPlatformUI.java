 ...
 * output class name
 */
public abstract class AbstractFeInStorageBillPlatformUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeInStorageBillPlatformUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kdtQcarnumber;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtQCRate;
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtOtherWgt;
     ...
     */
    public AbstractFeInStorageBillPlatformUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeInStorageBillPlatformUI.class.getName());
        ...
        this.kdtQcarnumber = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtQCRate = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        this.txtOtherWgt = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.kdtQcarnumber.setName("kdtQcarnumber");
        ...
        this.txtQCRate.setName("txtQCRate");
        this.txtOtherWgt.setName("txtOtherWgt");
        ...
        // kdtQcarnumber		
        this.kdtQcarnumber.setBoundLabelText(resHelper.getString("kdtQcarnumber.boundLabelText"));		
        this.kdtQcarnumber.setBoundLabelUnderline(true);		
        this.kdtQcarnumber.setBoundLabelLength(100);
        // kDLabelContainer16		
        ...
        this.kDLabelContainer16.setBoundLabelLength(60);
        // kDLabelContainer18		
        ...
        this.kDLabelContainer20.setBoundLabelLength(60);
        // prmtCar
        // prmtMaterial		
        ...
        // txtQCRate		
        this.txtQCRate.setEnabled(false);		
        this.txtQCRate.setVisible(false);
        // txtOtherWgt
        // btnSaveWeigh		
    ...
    public void initUIContentLayout()
    {
        ...
        kDSeparator2.setBounds(new Rectangle(-6, 323, 1034, 11));
        this.add(kDSeparator2, new KDLayout.Constraints(-6, 323, 1034, 11, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        tbList.setBounds(new Rectangle(13, 383, 991, 230));
        this.add(tbList, new KDLayout.Constraints(13, 383, 991, 230, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contCar.setBounds(new Rectangle(111, 121, 200, 19));
        this.add(contCar, new KDLayout.Constraints(111, 121, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(41, 150, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(41, 150, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer3.setBounds(new Rectangle(41, 180, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(41, 180, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer4.setBounds(new Rectangle(41, 211, 270, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(41, 211, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer5.setBounds(new Rectangle(41, 296, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(41, 296, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer10.setBounds(new Rectangle(41, 332, 270, 19));
        this.add(kDLabelContainer10, new KDLayout.Constraints(41, 332, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer11.setBounds(new Rectangle(379, 332, 270, 19));
        this.add(kDLabelContainer11, new KDLayout.Constraints(379, 332, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnQuery.setBounds(new Rectangle(923, 357, 63, 19));
        this.add(btnQuery, new KDLayout.Constraints(923, 357, 63, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSupplier.setBounds(new Rectangle(718, 92, 270, 19));
        this.add(contSupplier, new KDLayout.Constraints(718, 92, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contOrderStorageOrgUnit.setBounds(new Rectangle(718, 92, 270, 19));
        this.add(contOrderStorageOrgUnit, new KDLayout.Constraints(718, 92, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contImpurity.setBounds(new Rectangle(41, 239, 130, 19));
        this.add(contImpurity, new KDLayout.Constraints(41, 239, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer15.setBounds(new Rectangle(-716, 327, 270, 19));
        this.add(kDLabelContainer15, new KDLayout.Constraints(-716, 327, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer17.setBounds(new Rectangle(41, 356, 270, 19));
        this.add(kDLabelContainer17, new KDLayout.Constraints(41, 356, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer13.setBounds(new Rectangle(379, 356, 270, 19));
        this.add(kDLabelContainer13, new KDLayout.Constraints(379, 356, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contImpurity2.setBounds(new Rectangle(181, 237, 130, 19));
        this.add(contImpurity2, new KDLayout.Constraints(181, 237, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        chkIsTemp.setBounds(new Rectangle(41, 123, 68, 19));
        this.add(chkIsTemp, new KDLayout.Constraints(41, 123, 68, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtQcarnumber.setBounds(new Rectangle(719, 330, 275, 19));
        this.add(kdtQcarnumber, new KDLayout.Constraints(719, 330, 275, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer16.setBounds(new Rectangle(41, 268, 130, 19));
        this.add(kDLabelContainer16, new KDLayout.Constraints(41, 268, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer18.setBounds(new Rectangle(921, 49, 270, 19));
        this.add(kDLabelContainer18, new KDLayout.Constraints(921, 49, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer19.setBounds(new Rectangle(742, 25, 270, 19));
        this.add(kDLabelContainer19, new KDLayout.Constraints(742, 25, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer20.setBounds(new Rectangle(181, 266, 130, 19));
        this.add(kDLabelContainer20, new KDLayout.Constraints(181, 266, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCar
        ...
        //kdtQcarnumber
        kdtQcarnumber.setBoundEditor(txtQcarnumber);
        //kDLabelContainer16
        kDLabelContainer16.setBoundEditor(txtQCwgt);
        //kDLabelContainer18
        kDLabelContainer18.setBoundEditor(txtPrice);
        //kDLabelContainer19
        kDLabelContainer19.setBoundEditor(txtQCRate);
        //kDLabelContainer20
        kDLabelContainer20.setBoundEditor(txtOtherWgt);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.FeInStorageBillPlatformUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "FeInStorageBillPlatformUI");
    }

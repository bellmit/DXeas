 ...
 * output class name
 */
public abstract class AbstractGrossStorageBillPlatformUI extends com.kingdee.eas.weighbridge.client.WeightPlatformBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGrossStorageBillPlatformUI.class);
     ...
     */
    public AbstractGrossStorageBillPlatformUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGrossStorageBillPlatformUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tbList.setBounds(new Rectangle(13, 402, 991, 211));
        this.add(tbList, new KDLayout.Constraints(13, 402, 991, 211, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contCar.setBounds(new Rectangle(111, 127, 200, 19));
        this.add(contCar, new KDLayout.Constraints(111, 127, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer2.setBounds(new Rectangle(41, 156, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(41, 156, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kDLabelContainer5.setBounds(new Rectangle(41, 288, 270, 19));
        this.add(kDLabelContainer5, new KDLayout.Constraints(41, 288, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contImpurity.setBounds(new Rectangle(41, 252, 130, 19));
        this.add(contImpurity, new KDLayout.Constraints(41, 252, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contImpurity2.setBounds(new Rectangle(181, 252, 130, 19));
        this.add(contImpurity2, new KDLayout.Constraints(181, 252, 130, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        chkIsTemp.setBounds(new Rectangle(41, 127, 68, 19));
        this.add(chkIsTemp, new KDLayout.Constraints(41, 127, 68, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        conttongType.setBounds(new Rectangle(41, 315, 270, 19));
        this.add(conttongType, new KDLayout.Constraints(41, 315, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCar
        ...
        cmbIsAuto2Inv.setBounds(new Rectangle(131, 29, 207, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.weighbridge.app.GrossStorageBillPlatformUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.weighbridge.client", "GrossStorageBillPlatformUI");
    }

 ...
 * output class name
 */
public class WeighBridgeListUI extends AbstractWeighBridgeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WeighBridgeListUI.class);
    
    /**
     * output class constructor
     */
    public WeighBridgeListUI() throws Exception
    {
        super();
    ...
    {
        return com.kingdee.eas.weighbridge.client.WeighBridgeTreeEditUI.class.getName();
    }

 ...
 * output class name
 */
public class TaraStorageBillListUI extends AbstractTaraStorageBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TaraStorageBillListUI.class);
    
    /**
     * output class constructor
     */
    public TaraStorageBillListUI() throws Exception
    {
        super();
    }

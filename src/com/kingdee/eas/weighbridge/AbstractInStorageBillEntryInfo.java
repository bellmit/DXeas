...
public class AbstractInStorageBillEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractInStorageBillEntryInfo()
    {
        this("id");
    }
    protected AbstractInStorageBillEntryInfo(String pkField)
    {
        super(pkField);
        put("Detail", new com.kingdee.eas.weighbridge.InStorageBillEntryDetailCollection());
    }
    /**
     * Object: 过磅记录 's 单据头 property 
     */
    public com.kingdee.eas.weighbridge.InStorageBillInfo getParent()
    {
        return (com.kingdee.eas.weighbridge.InStorageBillInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.weighbridge.InStorageBillInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public com.kingdee.eas.weighbridge.InStorageBillEntryDetailCollection getDetail()
    {
        return (com.kingdee.eas.weighbridge.InStorageBillEntryDetailCollection)get("Detail");
    }
    /**

...
public class AbstractTaraStorageBillEntryDetailInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractTaraStorageBillEntryDetailInfo()
    {
        this("id");
    }
    protected AbstractTaraStorageBillEntryDetailInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.weighbridge.TaraStorageBillEntryInfo getParent1()
    {
        return (com.kingdee.eas.weighbridge.TaraStorageBillEntryInfo)get("parent1");
    }
    public void setParent1(com.kingdee.eas.weighbridge.TaraStorageBillEntryInfo item)
    {
        put("parent1", item);
    }
    /**

...
public class AbstractOtherStorageBillEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractOtherStorageBillEntryInfo()
    {
        this("id");
    }
    protected AbstractOtherStorageBillEntryInfo(String pkField)
    {
        super(pkField);
        put("Detail", new com.kingdee.eas.weighbridge.OtherStorageBillEntryDetailCollection());
    }
    /**
     * Object: 过磅记录 's 单据头 property 
     */
    public com.kingdee.eas.weighbridge.OtherStorageBillInfo getParent()
    {
        return (com.kingdee.eas.weighbridge.OtherStorageBillInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.weighbridge.OtherStorageBillInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public com.kingdee.eas.weighbridge.OtherStorageBillEntryDetailCollection getDetail()
    {
        return (com.kingdee.eas.weighbridge.OtherStorageBillEntryDetailCollection)get("Detail");
    }
    /**

...
public class OtherStorageBillControllerBeanEx extends com.kingdee.eas.weighbridge.app.OtherStorageBillControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.weighbridge.app.OtherStorageBillControllerBeanEx");

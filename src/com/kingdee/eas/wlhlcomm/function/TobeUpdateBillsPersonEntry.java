...
public class TobeUpdateBillsPersonEntry extends CoreBillEntryBase implements ITobeUpdateBillsPersonEntry
{
    public TobeUpdateBillsPersonEntry()
    {
        super();
        registerInterface(ITobeUpdateBillsPersonEntry.class, this);
    }
    public TobeUpdateBillsPersonEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITobeUpdateBillsPersonEntry.class, this);
    }
    ...
    private TobeUpdateBillsPersonEntryController getController() throws BOSException
    {
        return (TobeUpdateBillsPersonEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTobeUpdateBillsPersonEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }

...
public class BillUpdateLogControllerBean extends AbstractBillUpdateLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.wlhlcomm.function.app.BillUpdateLogControllerBean");
}
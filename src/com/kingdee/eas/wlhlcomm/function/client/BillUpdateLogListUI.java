 ...
 * output class name
 */
public class BillUpdateLogListUI extends AbstractBillUpdateLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BillUpdateLogListUI.class);
    
    /**
     * output class constructor
     */
    public BillUpdateLogListUI() throws Exception
    {
        super();
    }

 ...
 * output class name
 */
public class TobeUpdateBillsListUI extends AbstractTobeUpdateBillsListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TobeUpdateBillsListUI.class);
    
    /**
     * output class constructor
     */
    public TobeUpdateBillsListUI() throws Exception
    {
        super();
    }
